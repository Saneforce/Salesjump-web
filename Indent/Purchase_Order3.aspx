<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Purchase_Order3.aspx.cs" Inherits="Stockist_Purchase_Order3" %>
        ...
        $(document).ready(function () {
            ...
            $(document).on("change", "#To_Address", function () {
                if ($('#To_Address').val() != '0') {
                    if (Allrate.length > 0) {
                        ...
                        //    }
                        //});
                        alert('Rate is not available for this distributor. Kindly contact the administrator!');
            ...
            function AddRow(type) {
                ...
                $(".ddlProd").on("change", function () {
                    ...
                    comp = ComDetails.filter(function (w) {
                        return ( w.HO_ID == compVal);//Dist_state_code == w.State_Code &&
                    });
