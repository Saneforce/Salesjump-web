...
namespace Bus_EReport
{
    public class AdminSetup
    {
        ...
        public DataSet getLeave_Cancel(string sfcode, string FYear, string FMonth)
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsAdmin = null;

            strQry = "exec getLeaveCancel '" + sfcode + "','" + FYear + "','" + FMonth + "'";
        ...
        public DataSet GetEmployees_sp(string div_code, string sf_code)
        {
            DB_EReporting db_ER = new DB_EReporting();
        ...
        public int insert_acmas(string sf_code, string sf_name, string srf_code, byte geoneed, byte geotrack, byte geofencing, byte eddysumry, string div_code, Int16 sf_type)
        {
            DB_EReporting db_ER = new DB_EReporting();

            int iReturn = -1;

            strQry = "exec [Insert_acctable] '" + sf_code + "','" + sf_name + "','" + geoneed + "','" + geotrack + "','" + geofencing + "','" + eddysumry + "','" + div_code + "','" + sf_type + "'";
            try
            {
                iReturn = db_ER.ExecQry(strQry);
            }
        ...
        public int insert_target_setting(string Div_Code, string code, string tvalues, string months, string years)
        {
            DB_EReporting db_ER = new DB_EReporting();

            int iReturn = -1;

            strQry = "exec Insert_Target_Setting '" + Div_Code + "','" + code + "','" + tvalues + "','" + months + "','" + years + "'";
            try
            {
                iReturn = db_ER.ExecQry(strQry);
            }
        ...
        public DataSet Get_target_setting_Values(string Div_Code, string year, string months = "0")
        {
            DB_EReporting db_ER = new DB_EReporting();
            DataSet dsTarget = null;
            strQry = "select t.id,code,TVALUES,months,years from Trans_Target_Settings T inner join Mas_Target_Settings M on m.id=t.id where T.DIVISION_CODE = '" + Div_Code + "'  and years='" + year + "' and ('" + months + "'='0' or months='" + months + "')";
            try
            {
                dsTarget = db_ER.Exec_DataSet(strQry);
            }
        ...
        public DataSet getMas_Forms(string Div)
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsAdmin = null;

            strQry = "exec getMas_Forms '" + Div + "'";
        ...
        public DataSet getMas_Tables()
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsAdmin = null;

            strQry = "select * from Mas_Tables";
        ...
        public DataSet Create_Forms(string Div, string Frmid, string FrmName, string Created, string Apneed, string ischild, string Parentid, string Frmtyp, string Addnew, string Targetfrm)
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsAdmin = null;

            strQry = "exec Create_Forms '" + Div + "','" + Frmid + "','" + FrmName + "','" + Created + "'," + Apneed + "," + ischild + ",'" + Parentid + "'," + Targetfrm + ",'" + Frmtyp + "'";
        ...
        public DataSet getForm_Fields(string Frmid)
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsAdmin = null;

            strQry = "exec getForm_Fields " + Frmid + "";
        ...
        public DataSet getTable_Columns(string tblname)
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsAdmin = null;

            strQry = "exec getTable_Columns " + tblname + "";
        ...
        public class SaveFormField
        {
            ...
            [JsonProperty("FrmID")]
            public object hidfrmid { get; set; }
        ...
        public string saveFormFields(SaveFormField sd, string cusxml)
        {
            int iReturn = -1;
            ...
            try
            {
             ...
             {
                        new SqlParameter("@Fld_Id", sd.hfldid),
                        new SqlParameter("@Frm_ID", sd.hidfrmid),
                        new SqlParameter("@Div", sd.divcode),
                        new SqlParameter("@Fld_Name", sd.fldname),
                        new SqlParameter("@Fld_Type", sd.sfldtyp),
                        new SqlParameter("@Fld_Src_Name", sd.Fld_Src_Name),
                        new SqlParameter("@Fld_Src_Field", sd.Fld_Src_Field),
                        new SqlParameter("@Fld_Length", sd.maxlen),
                        new SqlParameter("@Fld_Symbol", sd.currtyp),
                        new SqlParameter("@Fld_Mandatory", sd.Fld_Mandatory),
                        new SqlParameter("@Active_flag", sd.Active_flag),
                        new SqlParameter("@Order_by", sd.Order_by),
                        new SqlParameter("@Control_id", sd.Control_id),
                        new SqlParameter("@cusxml", cusxml),
                        new SqlParameter("@Fldtyp", sd.Fldtype)
             };
			try
			{
				db.Exec_NonQueryWithParamNew("Create_Forms_Fields", CommandType.StoredProcedure, parameters);
				msg = "Success";
			}
			catch (Exception ex)
			{
                ...
                /*using (SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["Ereportcon"].ToString()))
                {
                    using (SqlCommand cmd = con.CreateCommand())
                    {
                        ...
                        cmd.CommandText = "Create_Forms_Fields";
