<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="AddQuizQuestions.aspx.cs"
    Inherits="MasterFiles_Options_AddQuizQuestions" %>
...
<head runat="server">
            ...
            $("#<%=btnUpdate.ClientID%>").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        alert("Question has been Updated successfully"); windowload();
                    },
    ...
    <script src="../../js/Quiz_JS/PreviewQuiz_JS.js" type="text/javascript"></script>
    ...
    <form id="form1" runat="server">
      <div class="row">
        <div class="col-lg-12 sub-header">
            Quiz Question Preview <button type="button" class="btn btn-primary" style="float:right;" id="btnback">Back</button>
        </div>
    </div>
    <br />
    <div>
        ...
        <br />
        <center>
            <asp:GridView ID="grdSurveyQuestions" runat="server" OnRowCreated="grdSurveyQuestions_RowCreated"
                ...
                EmptyDataRowStyle-BackColor="White" EmptyDataRowStyle-Font-Size="Small" CssClass="mGrid">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Question" ItemStyle-HorizontalAlign="Left">
                        <ItemStyle BorderColor="LightGray" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Left" />
                        <ItemTemplate>
                            <asp:Label ID="lblQuestion" Visible='<%# !(bool) IsInEditMode %>' runat="server"
                                Text='<%#Eval("Question_Text") %>'></asp:Label>
                            <asp:TextBox ID="txtQuestion" Visible='<%# IsInEditMode %>' runat="server" Text='<%# Eval("Question_Text") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div style="margin-left: 40%">
            <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="BUTTON" Style="height: 26px;
                width: 60px" OnClick="btnEdit_Click" />
            <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="BUTTON" Style="height: 26px;
                width: 60px" />
        </div>
        <%-- <div>
