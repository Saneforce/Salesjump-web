...
<div id="wrapper">
        ...
        <tr>
            <td class="style1">
             ...
             <td  style="margin-left:20%">
              <asp:Label ID="LblDiv" runat="server" Style="text-transform: capitalize;
                    font-size: 14px; text-align: left; margin-top: 0px" ForeColor="BlueViolet" Font-Bold="True"
 ...
 <asp:LinkButton ID="lnkQueries" runat="server" Text="Queries" ForeColor="Red" Font-Size="Medium" Font-Bold="true" ></asp:LinkButton>
	...
	<ul id="menu">
		<li><a href="../../../../Default1.aspx" onclick="ShowProgress()";>Home</a></li>
			...
			<ul>
             <%--<li><a href="#"><asp:Label ID="lblTerritory1" Text="Territory" runat="server"></asp:Label>  &raquo;</a>
                ...
                <li><a href="../../../../MasterFiles/MR/ListedDoctor/RoutePlan_Catgwise.aspx">Classic (Categorywise)</a></li>
                  <li><a href="../../E-Report_DotNet/MasterFiles/Reports/rptRoutePlan.aspx" onclick="ShowProgress();">View</a></li>
                 <li><a href="../../E-Report_DotNet/MasterFiles/Reports/RoutePlan_Status.aspx" onclick="ShowProgress();">Status</a></li>
		...
		<li><a href="#">MIS Reports &raquo;</a>
            <ul>
            <%--    <li><a href="../E-Report_DotNet/MasterFiles/MR_DCRAnalysis.aspx" onclick="ShowProgress();">DCR Analysis</a></li>
