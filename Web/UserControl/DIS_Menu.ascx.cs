...
using System.Data;
using Bus_EReport;
public partial class UserControl_DIS_Menu : System.Web.UI.UserControl
{
    string _isErr;
    string _sURL;
    ...
    protected void btnSend_Click(object sender, EventArgs e)
    {
        ...
        if (txtQuery.Text != "")
        {
            if (iReturn > 0)
            {
                ...
                // ScriptManager.RegisterStartupScript(this.Page, typeof(System.Web.UI.Page), "ShowEmailPreview", "alert('Send Successfully');", true);
