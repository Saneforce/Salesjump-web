...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <link href="../asset/css/nucleo-svg.css" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="../assetscss/argon-dashboard.css?v=2.0.4" rel="stylesheet" />
    <style>
        th {
            white-space: nowrap;
        }
        ...
        .sm-st-info {
            ...
            padding-bottom: 2px;
            position: relative;
            border-bottom: 0.5px solid #23b7e5;
            overflow: hidden; /* hide the content that goes beyond the border */
        }
        /*.sm-st-info {
            ...
            padding-bottom: 2px;
            position: relative;
            border-bottom: 0.5px solid #7266ba;
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="sm-st clearfix retail">
                    ...
                    <div class="sm-st-info sm-st-info-red">
                        <span>
            ...
            <div class="col-md-3" style="display:none;">
                <div class="sm-st clearfix  DSMCnt">
                    ...
                    <div class="sm-st-info sm-st-info-violet" styel="border-bottom: 1px solid #7266ba;">
                        <span>
            ...
            <div class="col-md-3">
                <div class="sm-st clearfix Pri_order_count">
                    ...
                    <p class="mb-0" style="display:none">
                        <span class="text-success text-sm font-weight-bolder"><asp:Label ID="Pri_order_count_1" runat="server"></asp:Label></span> than last month
                    </p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="sm-st clearfix sec_order_count">
                    ...
                    <div class="sm-st-info sm-st-info-green">
                        <span>
                            <asp:Label ID="sec_order_count" runat="server"></asp:Label></span>Sale Orders
                    </div>
                    <p class="mb-0" style="display:none">
                        <span class="text-danger text-sm font-weight-bolder"><asp:Label ID="sec_order_count_1" runat="server"></asp:Label></span>
                        since last Week
                    </p>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".retail").on("click", function () {
                window.open('SuperStockist/New_Distributor_Master.aspx?', '_self');
            });
            ...
            $(".sec_order_count").on("click", function () {
               ...
               // }
                //else {
					...
					window.open('SuperStockist/Sales/Orders/SS_Myorders.aspx', '_self');
                   //window.location.href='SS_Myorders.aspx';
               // }
            });
            ...
            $(".Pri_order_count").on("click", function () {
                ...
                window.open('SuperStockist/Purchase/Order/SS_Purchase_Order_List.aspx?', '_self');
            });
        });
    </script>
