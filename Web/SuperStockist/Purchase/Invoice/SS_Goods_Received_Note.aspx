<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Goods_Received_Note.aspx.cs" Inherits="SuperStockist_Purchase_Invoice_SS_Goods_Received_Note" %>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    url: "SS_Goods_Received_Note.aspx/getscheme",
                ...
                if ($('#<%=hdnmode.ClientID %>').val() == "1") {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SS_Goods_Received_Note.aspx/Get_AllValues",
                ...
                function orderdetails() {
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SS_Goods_Received_Note.aspx/GetOrderNo",
                        dataType: "json",
                        success: function (data) {
                            $.each(data.d, function () {
                                $('#PonoSelect').append($("<option></option>").val(this['Order_NO']).html(this['Order_NO'])).trigger('chosen:updated').css("width", "100%");;;
                            });
                        },
                        error: function (result) {
                            alert(JSON.stringify(result));
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Goods_Received_Note.aspx/GetSuppilerByOrder",
                    dataType: "json",
                    success: function (data) {
                ...
                $(document).on('change', '#grnDate', function () {
                    ...
                    if (pono == "" || pono == "0") {
                        toastr.info('Attention', 'choose PO NO First!');
                ...
                $(document).on('change', '#grnDisDate', function () {
                    ...
                    if (pono == "" || pono == "0") {
                        ...
                        toastr.info('Attention', 'Choose GRN Date First!');
                        //rjalert('Error!', 'Choose GRN Date First!..', 'error');
                        $('#grnDisDate').val('');
                        return false;
                    }
                    else if ($('#grnDisDate').val() > $('#grnDate').val()) {
                        toastr.warning('Caution', 'Dispatch date is not greater than GRN date');
                ...
                $(document).on("change", "#PonoSelect", function () {
                    ...
                    $.ajax({
                        ...
                        url: "SS_Goods_Received_Note.aspx/GetProduct",
                        dataType: "json",
                        success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Goods_Received_Note.aspx/GetCurrStock",
                    dataType: "json",
                    success: function (data) {
                        StkDetail = data.d;
                ...
                $(document).on('keyup', 'input[name=txtGood]', function () {
                    ...
                    if (Number(qty) < Number($(this).val())) {
                        $(this).val('');
                        // $(this).val(oldVal);
                        toastr.warning('Caution', 'Goods Value Must below ' + qty + '..!');
                        // rjalert('Error!', 'Goods Value Must below ' + qty + '..!', 'error');
                        ...
                        if ($(this).val() != '') {
                            ...
                            toastr.info('<div><a href="" target="">Do you want to Add the balance quantity to pending order</a></div><div><button type="button" id="okBtn" class="btn btn-primary">OK</button><button type="button" id="surpriseBtn" class="btn" style="margin: 0 8px 0 8px">Cancel</button></div>', "Attention", {
                                ...
                                onShown: function (toast) {
                                    ...
                                    $("#surpriseBtn").click(function () {
                                        ...
                                        toastr.info('Attention', 'Quantity Will not added to the pending order', {closeButton: true,
                                            debug: false,
                                            newestOnTop: true,
                                            progressBar: true,
                                            positionClass: "toast-bottom-right"});
                            ...
                            //toastr.warning('<div><input class="input-small" value="textbox"/>&nbsp;<a href="" target="_blank"></a></div><div><button type="button" id="okBtn" class="btn btn-primary">Close me</button><button type="button" id="surpriseBtn" class="btn" style="margin: 0 8px 0 8px">Surprise me</button></div>');
                            //toastr.info("Do you want to Add the balance quantity to pending order!?", "Confirmation", {
                            //    timeOut: 0,
                            //    extendedTimeOut: 0,
                            //    closeButton: true,
                            //    tapToDismiss: false,
                            ...
                            //    onShown: function (toast) {
                            //        if (toast && toast.el) {
                            //            $(toast.el).find(".toast-actions").append(
                            ...
                            //    }
                            //});
                            //customToastr("Do you want to Add the balance quantity to pending order! ?").then(function (result) {
                            //    if (result) {
                            ...
                            //    } else {
                            //        // User clicked cancel or closed the toast
                            //          row.find('.setting').attr('sett', 'No');
                            ...
                            //});
                            //toastr.confirm('Do you want to Add the balance quantity to pending order!', {
                            //    onOk: function () {
                            //        // code to execute if OK button is clicked
                            //        var ckh = [];
                            //        var ro = row;
                            ...
                            //    },
                            //    onCancel: function () {
                            //        // code to execute if Cancel button is clicked
                            //        row.find('.setting').attr('sett', 'No');
                            //        toastr.info('Attention', 'Quantity Will not added to the pending order');
                ...
                $(document).on('keyup', 'input[name=txtPoqty]', function () {
                    ...
                    if (Number(TotCrrQty) > Number(poq)) {
                        ...
                        toastr.error('Error', 'PO QTY Value Must Above ' + TotCrrQty + ' ..!');
                ...
                $.ajax({
                    ...
                    url: "SS_Goods_Received_Note.aspx/getratenew",
                    dataType: "json",
                    success: function (data) {
                ...
                $(document).on('click', '.btnsave', function () {
                    ...
                    if (buttoncount == "1") {
                        ...
                        if (grnDate.length <= 0) {
                            buttoncount = 0;
                            toastr.error('Error', 'Enter GRN Date!!');
                        ...
                        if (poname == "0") {
                            buttoncount = 0;
                            toastr.error('Error', 'Select PO NO!!');
                        ...
                        if (Supplier == 0) {
                            buttoncount = 0;
                            toastr.error('Error', 'Select Supplier Name!!');
                        ...
                        if (grnChallan.length <= 0) {
                            buttoncount = 0;
                            toastr.error('Error', 'Enter PI No.!!');
                        ...
                        if (grnDisDt.length <= 0) {
                            buttoncount = 0;
                            toastr.error('Error', 'Enter Dispatch  Date!!');
                        ...
                        if (received == "") {
                            buttoncount = 0;
                            toastr.error('Error', 'Enter Received By!!');
                        ...
                        if (auth == "") {
                            buttoncount = 0;
                            toastr.error('Error', 'Enter Authorised By');
                        ...
                        $('#ProductTable >tbody >tr').each(function () {
                            ...
                            if ($(this).find("#batchtext").val() == '') {
                                //batch_count++;
                                buttoncount = 0;
                                toastr.error('Error', 'Enter Batch No!!!');
                        ...
                        if (che == 0) {
                            if (pendord.length > 0) {
                                ...
                                $.ajax({
                                    ...
                                    contentType: "application/json; charset=utf-8",
                                    async: false,
                                    url: "SS_Goods_Received_Note.aspx/SavePurchaseOrder",
                            ...
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "SS_Goods_Received_Note.aspx/SaveDate",
                                ...
                                success: function (data) {
                                    if (data.d == "Success") {
                                        ...
                                        toastr.options = {
                                            "positionClass": "toast-bottom-right",
                                            "onHidden": function () { window.location.href = "../Invoice/SS_Goods_Received_List.aspx"; }
                                        }
                ...
                $(document).on('focus', '#grnPono', function () {
                    ...
                    if (txt == 0) {
                        toastr.warning('Alert', 'Select Supplier Name!');
                        //rjalert('Error!', 'Select Supplier Name!', 'error');
                        // alert('Select Supplier Name');
                        $('#ddlsupplier').focus();
                        return false;
                ...
                $(document).on('blur', '#grnPono', function () {
                    ...
                    if (txt.length > 0) {
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "SS_Goods_Received_Note.aspx/GetPOQTY",
                            data: "{'data':'" + txt + "'}",
                            dataType: "json",
                            success: function (data) {
                                // console.log(data.d);
