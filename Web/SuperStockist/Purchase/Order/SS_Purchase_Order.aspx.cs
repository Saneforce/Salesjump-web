...
public partial class SuperStockist_Purchase_Order_SS_Purchase_Order : System.Web.UI.Page
{
    ...
    public static DataSet getcompanydetails(string div_code, string stk_code)
    {
        ...
        string strQry = "EXEC get_SS_comDetails '" + div_code + "','" + stk_code + "'";
    ...
    public static DataSet Save_Primary(string Stockist_Code, string div_code, string Head, string Details, string Tax_Details, string sf_code)
    {
        ...
        string strQry = "Exec [sv_SS_PrimaryOrder] '" + Stockist_Code + "','" + div_code + "','" + Head + "','" + Details + "','" + Tax_Details + "','" + sf_code + "'";
