...
public partial class SuperStockist_Purchase_Order_Purchase_Order_Edit : System.Web.UI.Page
{
    ...
    public static DataSet getallPriorderbystockist(string Stockist_Code, string Div_Code, string Order_No)
    {
        ...
        string strQry = "sp_getss_pri_orderby_ordno '" + Order_No + "','" + Stockist_Code + "','" + Div_Code + "'";
    ...
    public static string EditPurchaseOrder(string HeadData, string DetailsData, string TaxData, string orderid)
    {
        ...
        using (var scope = new TransactionScope())
        {
            try
            {
                ...
                {
                    Details += "<Prod PCode=\"" + Product_details[i].PCd + "\" PName=\"" + Product_details[i].PName + "\" c_Qty=\"" + Product_details[i].Qty + "\" Qty=\"" + Product_details[i].Qty + "\"  Rate=\"" + Product_details[i].Rate + "\" Free=\"" + Product_details[i].free + "\"  Dis=\"" + Product_details[i].dis + "\"  Dis_value=\"" + Product_details[i].dis_value + "\" Off_Pro_Code=\"" + Product_details[i].Off_Pro_code + "\" Off_Pro_Name=\"" + Product_details[i].Off_Pro_name + "\" Off_Pro_Unit=\"" + Product_details[i].Off_Pro_Unit + "\" Productunitcode=\"" + Product_details[i].umo_unit + "\" tax=\"" + Product_details[i].Tax_value + "\" con_fac=\"" + Product_details[i].con_fac + "\" produnit=\"" + Product_details[i].produnit + "\" eQty=\"" + Product_details[i].eQty + "\" />";
                }
                Details += "</ROOT>";
    ...
    public static DataSet Save_Primary(string Stockist_Code, string div_code, string Head, string Details, string Tax_Details, string sf_code, string orderid)
    {
        DataSet ds = null;
        DB_EReporting db_ER = new DB_EReporting();
        string strQry = "Exec [Edit_SS_PrimaryOrder] '" + Stockist_Code + "','" + div_code + "','" + Head + "','" + Details + "','" + Tax_Details + "','" + sf_code + "','" + orderid + "'";
    ...
    public static DataSet getProdall(string divcode, string state_code, string stk)
    {
        ...
        string strQry = "EXEC get_ss_product_details_view '" + divcode + "','" + state_code + "','" + stk + "'";
    ...
    public static DataSet get_rate_For_Primary(string Div_Code, string Stockist_Code, string State)
    {
        DataSet ds = null;
        DB_EReporting db_ER = new DB_EReporting();
        string strQry = "Exec Get_rate_SS_primaryrate '" + Div_Code + "','" + Stockist_Code + "','" + State + "'";
