<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="Purchase_Order_Edit.aspx.cs" Inherits="SuperStockist_Purchase_Order_Purchase_Order_Edit" %>
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var dopValue = Orders[0].DOP;

						if (dopValue !== null) {
							var today = new Date(dopValue);
							var dd = today.getDate();
							var mm = today.getMonth() + 1;
							var yyyy = today.getFullYear();
                ...
                function AddRow(type) {
                    ...
                    $(".ddlProd").on("change", function () {
                        ...
                        if (selected_company_code == '' || selected_company_code == 0) {
                            toastr.warning('Alert', 'Please select company!');
                            //$.confirm({
                            //    title: 'Confirm!',
                        ...
                        if (pro_filter.length > 0) {
                            ...
                            cal(itr);
                            //CalcAmt(itr);
                            toastr.warning('Alert', 'Product Already Selected!');
                            //$.confirm({
                            //    title: 'Confirm!',
                ...
                $(document).on('keyup', '.txtQty', function (e) {
                    ...
                    if (un == 'Select') {
                        toastr.info('Attention', 'Please Select UOM!');
                        //$.confirm({
                        //    title: 'Error!',
                ...
                svOrder = function () {
                    ...
                    if (approve == "1") {
                        ...
                        if (selectedvalue == "0") {
                            button_Click = 0;
                            toastr.info('Attention', 'Please Select TO!');
                            //$.confirm({
                            //    title: 'Error!',
                        ...
                        if (NewOrd.length == 0) {
                            approve = 0;
                            toastr.error('Error', 'Atleast select a Product!');
                            //$.confirm({
                            //    title: 'Error!',
                        ...
                        for (var i = 0; i < NewOrd.length; i++) {
                            ...
                            if (NewOrd[i].sPCd == '') {
                                approve = 0;
                                toastr.info('Attention', 'Select a Product!');
                                //$.confirm({
                                //    title: 'Error!',
                            ...
                            if (NewOrd[i].Qty == '') {
                                approve = 0;
                                toastr.warning('Caution', 'Remove the Product or Enter the Quantity!');
                                //$.confirm({
                                //    title: 'Error!',
                        ...
                        if (orderval > 0) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data.d.length > 0) {
                                        ...
                                        toastr.success('WOW', 'Purchase Ordered Updated Successfully!');
                                        //$.confirm({
                                        //    title: 'Success!',
                            ...
                            approve = 0;
                            toastr.warning('Caution', 'Order Minimum Value to create a Order!');
                            //$.confirm({
                            //    title: 'Error!',
            ...
            function ReloadTable() {
                ...
                for ($j = 0; $j < Orders.length; $j++) {
                    ...
                    NewOrd[idx].eQty = Orders[$j].Quantity;
                    NewOrd[idx].Free = 0;
                    NewOrd[idx].con_fac = Prod[0].Sample_Erp_Code;
                    NewOrd[idx].con_fac = Prod[0].Sample_Erp_Code;
            ...
            <div style="padding: 8px; margin-top: 0;" class="card">
                <div class="row">
                    ...
                    <div class="col-md-1">
                        ...
                        <textarea style="width: 284px; background-color: aliceblue" rows="4" class="form-control txtblue" id="txt_Ship_add"></textarea>
                    </div>
                </div>
