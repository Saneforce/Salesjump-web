...
public partial class SuperStockist_Purchase_Order_SS_Purchase_Order_List : System.Web.UI.Page
{
    ...
    public static string GetOrders(string Stockist_Code, string FDT, string TDT)
    {
        ...
        ds = getallorderdetails("exec [sp_ss_getpriorderlist] '" + Stockist_Code + "','" + Div_Code + "','" + FDT + "','" + TDT + "'");
