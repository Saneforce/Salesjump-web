...
<body>
    <div class="MainContainer">
        ...
        <div class="login-group">
            <div class="container"><form id="Form1" runat="server" class="form-horizontal" enctype="multipart/form-data">
						<div style="display:block;width:100%;height:80px;text-align:center"><img id="logoo" src="http://fmcg.sanfmcg.com/limg/demo_logo.png" style="height:50px;vertical-align:middle"></div>
                        <div class="wel-msg">
                            Welcome to SAN Sales<asp:HiddenField ID="HiddenField1" runat="Server" />
                        </div>
						<div class="form-cont">
							<div class="form-group">
								<i class='far fa-user' data-conn="<%=Globals.ConnString %>"></i>
                                <asp:TextBox ID="txtUserName" runat="server" placeholder="User Name" class="form-input" required=""></asp:TextBox>								
							</div>
							<div class="form-group">
								<i class="icpwd"></i> 
								<i class="far fa-lock"></i>
                                <asp:TextBox ID="txtPassWord" runat="server" class="form-input" placeholder="Password"
    ...
    </div><script type='text/javascript'>              DoesParentExists();</script>
</body>
</html>