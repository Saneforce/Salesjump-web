<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="New_Distributor_Master.aspx.cs" Inherits="SuperStockist_New_Distributor_Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<form runat="server">
        ...
        <div class="row" style="margin-bottom: 1rem;">
            ...
            <div class="col-lg-12 sub-header" style="display:none;">Distributor Master<span style="float: right"><a href="new_distributor_creation.aspx" class="btn btn-primary btn-update" id="newsf">Add Distributor</a></span></div>
        </div>
                ...
                <table class="table table-hover" id="OrderList" style="font-size: 12px">
                    <thead class="text-warning">
                        <tr style="background-color: #37a4c6; color: #fff; white-space: nowrap;">
                           ...
                           <th style="text-align: left;display:none; color: #fff">Route Count</th>
							<th style="text-align: left; color: #fff;display:none;">Retailers</th>%-->
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ReloadTable() {
            ...
            for ($i = st; $i < st + Number(PgRecords) ; $i++) {
                if ($i < Orders.length) {				
                    ...
                    $(tr).html("<td>" + ($i + 1) + "</td><td>" + Orders[$i].Stockist_Code + "</td><td>" + Orders[$i].ERP_Code + "</td><td>" + Orders[$i].Stockist_Name + "</td><td>" + Orders[$i].FieldForce_Name + "</td><td>" + Orders[$i].Territory_name + "</td><td class='rocount' style='display:none;'><a href='#'>" + filt.length + "</a></td><td class='dwnldrets' style='display:none;'><a href='#'>Download Retailers</a></td><td class='roPrice'><a href='#'>" + Orders[$i].Price_list_Name+"</a></td><td class='roedit'><a href='#'>Edit</a></td><td class='rodeact'><a href='#'>" + Orders[$i].Status + "</a></td>");
        ...
        function fillstate() {
            $.ajax({
                ...
                async: false,
                url: "New_Distributor_Master.aspx/getStates",
        ...
        function fillroute() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "New_Distributor_Master.aspx/getRouCount",
                data: "{'divcode':'<%=Session["div_code"]%>'}",
                dataType: "json",
                success: function (data) {
        ...
        function DownloadDistwiseOutlets($DistId) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: true,
                url: "New_Distributor_Master.aspx/DownloadDistwiseOutlets",
        ...
        function fillHQ(sst) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "New_Distributor_Master.aspx/getHQ",
        ...
        function fillSF(shq) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "New_Distributor_Master.aspx/getSF",
        ...
        function fillStockist(sfs) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "New_Distributor_Master.aspx/getStockist",
        ...
        function fillRoutes(sfs) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "New_Distributor_Master.aspx/getRoute_Retailers",
                ...
                if ((rocnt < 1 && flg == 1) || (flg == 0)) {
                    if (confirm("Do you want " + disstat + " the Distributor ?")) {
						$.ajax({
							...
							contentType: "application/json; charset=utf-8",
							async: false,
							url: "New_Distributor_Master.aspx/deactivateStockist",
