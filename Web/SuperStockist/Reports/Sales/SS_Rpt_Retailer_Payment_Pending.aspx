<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Rpt_Retailer_Payment_Pending.aspx.cs" Inherits="SuperStockist_Reports_Sales_SS_Rpt_Retailer_Payment_Pending" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row" style="position: relative;">
                            ...
                            <div id="chartContainer1" class="col-6 " style="height: 250px; max-width: 501px; float:right;right:572px; top: 0px; position: absolute"></div>
                        </div>
                       </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        function get_Years(from_mnth, to_mnth, type) {
            ...
            $.ajax({
                ...
                url: "SS_Rpt_Retailer_Payment_Pending.aspx/Get_Year_Data",
                dataType: "json",
                success: function (data) {
        ...
        $("#OrderEntry").on('click', 'tbody tr', function () {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Rpt_Retailer_Payment_Pending.aspx/Getorder_details",
    ...
    function loadData() {
        ...
        $.ajax({
            ...
            contentType: "application/json; charset=utf-8",
            async: false,
            url: "SS_Rpt_Retailer_Payment_Pending.aspx/Getpending_summary",
    ...
    function fetchPendingdetails(custcode, name, totord, totpenct, totbill, totcol, totpen) {
        $.ajax({
            ...
            contentType: "application/json; charset=utf-8",
            async: false,
            url: "SS_Rpt_Retailer_Payment_Pending.aspx/Getpending_details",
