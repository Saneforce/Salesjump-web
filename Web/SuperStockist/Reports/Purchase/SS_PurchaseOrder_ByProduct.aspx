<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_PurchaseOrder_ByProduct.aspx.cs" Inherits="SuperStockist_Reports_Purchase_SS_PurchaseOrder_ByProduct" %>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", ".btnview", function () {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: "SS_PurchaseOrder_ByProduct.aspx/Get_Primary_Details",
