<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Purchase_by_Vendor_details.aspx.cs" Inherits="SuperStockist_Reports_Purchase_SS_Purchase_by_Vendor_details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <form id="form1" runat="server">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <a href="SS_Purchase_by_Vendor.aspx" style="font-size: 17px;">Purchase by Vendor</a>
                </div>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            async: false,
            url: "SS_Purchase_by_Vendor_details.aspx/Get_Purchase_details",
            dataType: "json",
        ...
        function Bind_Details() {
            ...
            for ($i = 0; Item_details.length > $i; $i++) {
                ...
                if ($i < Item_details.length) {
                    ...
                    tr = $("<tr></tr>");
                    $(tr).html("<td style='display:none';>" + Item_details[$i].Sup_No + "</td><td>" + Item_details[$i].dat + "</td><td class='clck'><a id='clc' href='../../../../Superstockist/Reports/Purchase/SS_Puchase_Order_View.aspx?Order_No=" + Item_details[$i].Order_No + "&Stockist_Code=" + stockist_Code + "&Div_Code=" + Div_Code + "'>" + Item_details[$i].Order_No + "</td><td>" + Item_details[$i].Sup_Name + "</td><td align='right'>" + Item_details[$i].Order_Value.toFixed(2) + "</td>");
