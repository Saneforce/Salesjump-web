<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Invoice_Order_View.aspx.cs" Inherits="SuperStockist_Sales_Invoice_SS_Invoice_Order_View" %>
                    ...
                    <table class="table table-hover" id="OrderList">
                        <thead class="text-warning">
                            <tr>
                                ...
                                <th style="text-align: center; width: 8%;display:none;">Net</th>
...
<%--            <div class="col-sm-offset-8 form-horizontal" style="margin-top: 280px;">
			 ...
			 <div class="col-sm-offset-8 form-horizontal" style="margin-top: 82px;">
                <label class=" col-xs-3 control-label">
                    Tax Total :
                </label>
                <div class="col-sm-9">
                    <div class="input-group">
                        ...
                        <input data-cell="G1" id="Tot_t" data-format="0,0.00" class="form-control" readonly />
                    </div>
                </div>
            </div>
            <div class="col-sm-offset-8 form-horizontal" style="margin-top: 123px;">
                <label class=" col-xs-3 control-label">
                    Total :
                </label>
                <div class="col-sm-9">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: "SS_Invoice_Order_View.aspx/GetInvoiceOrderDetails",
                ...
                function ReloadTable() {
                    ...
                    for ($i = 0; $i < Orders.length; $i++) {
                        ...
                        var Gross = parseFloat(Orders[$i].qty) * parseFloat(Orders[$i].Price);
                        var amt = parseFloat(Orders[$i].qty) * parseFloat(Orders[$i].Price) - parseFloat(Orders[$i].Discount);
                        var gross = parseFloat(Orders[$i].qty) * parseFloat(Orders[$i].Price) - parseFloat(Orders[$i].Discount) + parseFloat(Orders[$i].Tax);
                        ...
                        $(tr).html("<td>" + slno + "</td><td>" + Orders[$i].Sale_Erp_Code + "</td>" +
                            ...
                            "<td align='left' style='display:none;'>" + parseFloat(amt).toFixed(2) + "</td>" +
                    ...
                    $("#OrderList").append('<tfoot><tr><th colspan="5"></th><th>Total</th><th>' + q_tot + '</th><th>' + f_tot + '</th><th>' + parseFloat(gross_total).toFixed(2) + '</th><th>' + dis_val_tot.toFixed(2) + '</th><th id="ttt" style="display:none;">' + Net_total.toFixed(2) + '</th><th id="tax_tot" style="text-align: right">' + tax_t.toFixed(2) + '</th><th id="gross_tot" style="text-align: right">' + Invoice_Total.toFixed(2) + '</th></tr></tfoot>');
                }
            });
