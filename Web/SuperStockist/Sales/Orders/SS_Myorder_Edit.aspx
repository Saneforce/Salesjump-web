<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Myorder_Edit.aspx.cs" Inherits="SuperStockist_Sales_Orders_SS_Myorder_Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card" style="padding: 8px; margin-top: 0px;">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="rou-name">Territary Name:</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-offset-8 form-horizontal div_gross" style="margin-top: 125px;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function loadmodal() {
            ...
            $.ajax({
                ...
                async: false,
                url: "SS_Myorder_Edit.aspx/Get_Product_Tax",
                dataType: "json",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorder_Edit.aspx/Get_Product_unit",
                dataType: "json",
                success: function (data) {
        ...
        function AddRow(type) {
            ...
            $('.ddlProd').each(function () {
                ...
                if (rr == '-1') {
                    ckselect += 1;
                    toastr.info('Attention', 'enter empty rows');
    ...
    if (selected_retailer_code && selected_retailer_code !== 0 && selected_retailer_code !== '--- Select Retailer Name---') {
        $('.second_row_div').show();
        var sPCd = $(this).val();
        $(this).closest("tr").attr('class', sPCd);
        var P_Name = itr.find('.ddlProd option:selected').text();
        var unt_rate = 0;
        var Repeat_filter = NewOrd.filter(function (s, key) {
        ...
        if (Cust_price_details.length > 0) {
            unt_rate = parseFloat(Cust_price_details[0].Rate) || 0;
        }

        $(itr).find('.tdRate').text(unt_rate.toFixed(2));
        ...
        $('.ddlProd').val('');
        $('.ddlProd').trigger('chosen:updated');
    }
});
        ...
        svOrder = function () {
            ...
            if (approve == "1") {
                ...
                if (retcode == "" || retcode == null) {
                    approve = 0;
                    toastr.error('Error', 'Select a Customer Name');
                ...
                if (recdate == "") {
                    approve = 0;
                    toastr.error('Error', 'Select a Order Date');
                ...
                for (var i = 0; i < NewOrd.length; i++) {
                    ...
                    if (NewOrd[i].sPCd == '') {
                        approve = 0;
                        toastr.Warning('Error', 'Select a Product');
                ...
                if (orderval > 0) {
                    ...
                    if (focus_count == 0) {
                        ...
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            async: false,
                            url: "SS_Myorder_Edit.aspx/saveorders",
                            ...
                            success: function (data) {
                                if (data.d == "Success") {
                                    toastr.options = {
                                        ...
                                        progressBar: true,
                                        "onHidden": function () {
                                            var url = "../Orders/SS_myOrders.aspx"
                                            window.open(url, '_self');
                                        }
                                    }

                                    toastr.success('Success', 'Secondary Ordered Updated Successfully');
                                    //$.confirm({
                                    //    title: 'Success!',
                        ...
                        approve = 0;
                        toastr.error('Error', 'Please Check the Quantity');
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorder_Edit.aspx/GetProducts",
                dataType: "json",
                success: function (data) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorder_Edit.aspx/GetSecOrderDetails",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorder_Edit.aspx/GetCustWise_price",
                dataType: "json",
                success: function (data) {
			...
			$("#OrderEntry").on("change", ".ddlProd", function () {
            ...
            if ($(this).val() != -1) {
                ...
                if (selected_retailer_code != '' && selected_retailer_code != 0 && selected_retailer_code != '--- Select Retailer Name---') {
                    ...
                    if (Prod.length == 0) {
                        toastr.info('Attention', 'Rate not available');
        ...
        $(document).on("click", ".Spinner-Modal>ul>li", function () {
           ...
           // });
            ...
            ans = Cust_Price.filter(function (a) {
                return (a.Product_Detail_Code == pc);// && a.Move_MailFolder_Id == umo);
           })
