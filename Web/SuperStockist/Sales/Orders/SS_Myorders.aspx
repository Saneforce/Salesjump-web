<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Myorders.aspx.cs" Inherits="SuperStockist_Sales_Orders_SS_Myorders" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row">
        <style>
            http://localhost:14802/css/bootstrap-select.min.css
            .daterangepicker {
                z-index: 10000000;
            }
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                <select class="form-control" id="rtname" style="width: 100%;" data-size="5">
                    <option value="0">Select Territory Name</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body table-responsive">
            <div style="white-space: nowrap">
                ...
                <input type="date" id="Inv_date" style="float: right; margin-right: 16px; margin-top: 4px;display: none;" />
                <label style="float: right; margin-right: 16px; margin-top: 6px;display: none;">Invoice Date :</label>
    ...
    <div class="modal fade" id="exampleModal" style="z-index: 1; overflow-y: auto;" tabindex="0" aria-hidden="true" data-keyboard="false" data-backdrop="static">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card" style="padding: 8px; margin-top: 0px;">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="rou-name">Territory Name:</label>
                                <span style="color: Red">*</span>
                                <select id="route-name" data-dropup-auto="false" data-width="100%" data-size="5">
                                </select>
                            </div>
                            <div class="col-sm-4">
                                <label for="recipient-name">Distributor Name:</label>
                                <span style="color: Red">*</span>
                                <select id="recipient-name" data-dropup-auto="false" data-width="100%" data-size="5" style="width:315px;">
								<option value="0" disabled>Select Distributor</option>
                                </select>
                                <br />
                                <br />
                            ...
                            <div class="col-sm-4">
                                <label for="recptdt">Date:</label><span style="color: Red">*</span>
                                <input type="text" class="form-control" id="recptdt" />
                            </div>
                            <%--<div class="col-sm-4">
                    ...
                    <div class="row">
						...
						<div class="col-sm-offset-8 form-horizontal div_gross" style="margin-top: 124px;">
                        ...
                        <div class="col-sm-offset-8 form-horizontal div_tcs" style="margin-top: 120px;display:none;">
                            <label class=" col-xs-3 control-label" style="font-size: 12.5px;">
                                TCS Amt :
                            </label>
                            <div class="col-sm-9">
                        ...
                        <div class="col-sm-offset-8 form-horizontal div_tds" style="margin-top: 160px;display:none;">
                            <label class=" col-xs-3 control-label" style="font-size: 12.5px;">
                                TDS Amt :
                            </label>
                            <div class="col-sm-9">
    ...
    <link href="../../../css/SpinnerInput.css" rel="stylesheet" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).on("click", ".btnAllPendingOrderSave", function () {
            ...
            if (count_chk > 0) {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: "SS_Myorders.aspx/AllPendingOrder",
                    ...
                    success: function (data) {
                        if (data.d == "success") {
                            toastr.options = {
                                ...
                                "onHidden": function () { loadData() }
                            }

                            toastr.success('Success', 'Secondary Ordered Successfully');

                            //$.confirm({
                            //    title: 'Success!',
                            //    content: 'Secondary Ordered Successfully!',
                            //    type: 'green',
                            //    typeAnimated: true,
                ...
                toastr.info('Attention', 'Please Select Atlease One Order.');
        ...
        $(document).on("click", ".btnMyOrderSave", function () {
            ...
            if (row.find('.Flag').val() == '0' || row.find('.Flag').val() == 'null') {
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Myorders.aspx/ChangeOrder",
                ...
                toastr.error('Error', 'Already ' + status + '!.');
        ...
        function ReloadTable(typ) {
            ...
            $(".ddlStatus>li>a").on("click", function () {
                ...
                if (Orders[fi_idx].Status == "Invoiced") {
                    toastr.error('Error', 'Already Order Invoiced Cannot Change the Status');
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SS_Myorders.aspx/SetNewStatus",
        ...
        function cancel(orderid, stockist, div, Status) {
            ...
            if (orderid != '' || stockist != '' || div != '') {
               if (window.confirm('Do you want to cancel this order ' + orderid + '?')) {
    // User clicked OK
    cancelorder(orderid, stockist, div);
        ...
        function cancelorder(orderid, stockist, div) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorders.aspx/cancelorder",
        ...
        function Edit_Screen(id, stk, div, flag, cust, order_date) {
            ...
            if (flag == 1) {
                toastr.success('Success', 'Order Invoiced');
                // rjalert('success!', 'Order Invoiced', 'success');
                //alert('Order Invoiced');
                return false;
            }
            else {
                var url = "../orders/SS_MyOrder_Edit.aspx?Order_No=" + id + "&Stockist_Code=" + stk + "&Div_Code=" + div + "&Cust_Code=" + cust + "&Order_Date=" + order_date + ""
        ...
        function popup(orderid, stk, div, sts, fdt, tdt) {
            ...
            set_local_storage();
            var url = "../Orders/SS_Myorderview.aspx?Order_No=" + orderid + "&Stockist_Code=" + stk + "&Div_Code=" + div + "&Status=" + sts + "&FDATE=" + fdt + "&TDATE=" + tdt + ""
            window.open(url, '_self');
        }
        ...
        function loadData() {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorders.aspx/GetOrders",
        ...
        function loadmodal() {
            ...
            $.ajax({
                ...
                url: "SS_Myorders.aspx/getratenew",
                dataType: "json",
                success: function (data) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorders.aspx/Get_Product_Tax",
                dataType: "json",
                success: function (data) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorders.aspx/GetProducts",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorders.aspx/bindretailer",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorders.aspx/Get_Product_Cat_Details",
                dataType: "json",
                success: function (data) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorders.aspx/Get_Route",
                dataType: "json",
                success: function (data) {
                    All_Route = JSON.parse(data.d) || [];
                    var route = $("#route-name"); var route = $("#rtname");
                    route.empty().append('<option selected="selected" value="0">Select Territory</option>');
                    $("#route-name").empty().append('<option selected="selected" value="0">Select Territory</option>');
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorders.aspx/GetCustWise_price",
                dataType: "json",
                success: function (data) {
        ...
        $('#route-name').on('change', function () {
            ...
            $('#recipient-name').append("<option selected='selected' value='0'>Select Distributor Name</option>");
            for (var i = 0; i < filtered_retailer.length; i++) {
                $('#recipient-name').append($('<option value="' + filtered_retailer[i].Stockist_Code + '">' + filtered_retailer[i].Stockist_Name1 + '</option>'));
            }
        ...
        $('#recipient-name').on('change', function () {
            ...
            $.ajax({
                ...
                url: "SS_Myorders.aspx/GetWise_price",
                dataType: "json",
                success: function (data) {
                    Cust_Price = JSON.parse(data.d) || [];
                },
            ...
            if (cusCode != "0" && cusCode != '') {
                ...
                Filtered_retailer = All_Retailer.filter(function (a) {
                    return a.Stockist_Code == cusCode
                });
        ...
        function AddRow(type) {
            ...
            $('.ddlProd').each(function () {
                ...
                if (rr == '-1') {
                    ckselect += 1;
                    toastr.error('Error', 'enter empty rows');
            ...
            if (ckselect == 0) {
                itm = {}
                itm.PCd = ''; itm.sPCd = ''; itm.s_pcode = ''; itm.mrp = ''; itm.PName = ''; itm.Unit = ''; itm.Rate = "0"; itm.Qty = 1; itm.Qty_c = 1; itm.Free = "0"; itm.Discount = "0"; itm.Dis_value = "0"; itm.Total_Tax = 0;
                ...
                $(".ddlProd").on("change", function () {
                    ...
                    if (retcode == "" || retcode == null) {
                        approve = 0;
                        toastr.info('Attention', 'Select a Customer Name.');
                    ...
                    if ($(this).val() != -1) {
                        ...
                        if (selected_retailer_code != '' && selected_retailer_code != 0 && selected_retailer_code != '--- Select Retailer Name---') {
                            ...
                            if (Prod.length == 0) {
                                toastr.warning('caution', 'Rate not available');
                            ...
                            $(document).find('.' + sPCd).each(function () {
                                ...
                                if (Unit_length >= row_length) {
                                    ...
                                    NewOrd[idx].umo_unit = '';
                                    CalcAmt($(itr));
                                    toastr.warning('caution', 'Product Units Already Selected');
                            ...
                            toastr.warning('caution', 'Please Select Retailer');
        ...
        $(document).on("click", ".Spinner-Modal>ul>li", function () {
            ...
            if (pro_filter.length > 0) {
                ...
                NewOrd[idx].umo_unit = '';
                CalcAmt(row);
                toastr.warning('caution', 'Product Unit Already Selected');
        ...
        svOrder = function () {
            ...
            if (approve == "1") {
                ...
                var retcode = $('#recipient-name :selected').val();
                var routename = $('#route-name :selected').val();
                var retnm = $('#recipient-name :selected').text();
                retnm = retnm.replace(/&/g, "&amp;");
                var recdate = $('#recptdt').val();
                var odate = recdate.split(' ');
                var ordate = odate[0].split('-');
                var fnldate = ordate[2] + '-' + ordate[1] + '-' + ordate[0] + ' ' + odate[1];
                if (routename == "" || routename == null) {
                    approve = 0;
                    toastr.error('Alert', 'Select a territory Name');
                    //  rjalert('Error!', 'Select a route Name.', 'error');
                    //alert('Select a Customer Name');
                    return false;
                } if (retcode == "" || retcode == null) {
                    approve = 0;
                    toastr.error('Alert', 'Select a Customer Name');
                    //rjalert('Error!', 'Select a Customer Name.', 'error');
                    //alert('Select a Customer Name');
                    return false;
                }
                if (recdate == "") {
                    approve = 0;
                    toastr.error('Alert', 'Select a Order Date');
                ...
                if (NewOrd.length == 0) {
                    approve = 0;
                    toastr.error('Alert', 'Atleast select a Product');
                ...
                for (var i = 0; i < NewOrd.length; i++) {
                    ...
                    if (NewOrd[i].sPCd == '') {
                        approve = 0;
                        toastr.error('Alert', 'Select a Product');
                    ...
                    if (NewOrd[i].Qty == '') {
                        approve = 0;
                        toastr.error('Alert', 'Remove the Product or Enter the Quantity');
                ...
                if (stock_chck == 0) {
                    ...
                    if (orderval > 0) {
                        ...
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            async: false,
                            url: "SS_Myorders.aspx/saveorders",
                            data: "{'NewOrd':'" + JSON.stringify(NewOrd) + "','NewOrd_Tax_Details':'" + JSON.stringify(Tax_Array) + "','Remark':'" + remark + "','Ordrval':'" + orderval + "','RetCode':'" + retcode + "','RecDate':'" + fnldate + "','Ntwt':'" + netwt + "','retnm':'" + retnm + "','Type':'0','ref_order':'','sub_total':'" + sub + "','dis_total':'" + dIs + "','tax_total':'" + tax + "','Extra_Tax_type':'" + Extra_Tax_Type + "','Extra_Tax_value':'" + Extra_Tax_Value + "','routename':'" + routename + "'}",
                            dataType: "json",
                            success: function (data) {
                                if (data.d.length > 0) {
                        ...
                        approve = 0;
                        toastr.error('Alert', 'Order Minimum Value to create a Order.');
                    ...
                    approve = 0;
                    toastr.error('Alert', 'Stock value is lesser than qunatity.');
        ...
        function loadscheme() {
            ...
            $.ajax({
                type: "Post",
                contentType: "application/json; charset=utf-8",
                url: "SS_Myorders.aspx/getscheme",
        ...
        $(document).on('keyup', '.txtQty', function (e) {
            ...
            if (un == 'Select') {
                toastr.Warning('Caution', 'Please Select UOM.');
        ...
        function Get_Tax_Details(order_id) {
            ...
            $.ajax({
                type: "Post",
                contentType: "application/json; charset=utf-8",
                url: "SS_Myorders.aspx/Get_Sec_Print_tax_Details",
        ...
        function loadDataPrint(order_id, stk, div, cust_code) {
            ...
            $.ajax({
                type: "Post",
                contentType: "application/json; charset=utf-8",
                url: "SS_Myorders.aspx/GetProductdetails",
                data: "{'Order_Id':'" + order_id + "'}",
                dataType: "json",
                async: false,
                success: function (data) {
        ...
        function loadDistributor(order_id, stk, div, cust_code) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "SS_Myorders.aspx/GetDistributor",
                ...
                success: function (data) {
                    ...
                    str1 += '<tr><td  align="left" style="padding-top: 0px;padding-bottom: 0px;font:12px TimesNewRomen;"><b></b>GSTN : &nbsp;' + AllOrdersdetails[a].RetgstTIN + '</td></tr>';
                    str1 += '<tr><td  align="left" style ="font: bold 14px TimesNewRomen;padding-top: 0px;padding-bottom: 0px;font:12px TimesNewRomen;"><b>' + AllOrdersdetails[a].Stockist_Name + '</b></td></tr>';
                    str1 += '<tr><td  align="left" style="width:275px;padding-top: 0px;padding-bottom: 0px;font:12px TimesNewRomen;">' + AllOrdersdetails[a].Stockist_Address + '</td></tr>';
                    ...
                    str2 += '<tr><td align="left" style="width:250px;padding-top: 0px;padding-bottom: 0px;font:12px TimesNewRomen;">' + AllOrdersdetails[a].SS_Address + '</td></tr>';
                    ...
                    str3 += '<tr><td align="left" style="padding-top:0px;padding-bottom:0px;font:12px TimesNewRomen;">Dist GSTN:-' + AllOrdersdetails[a].DistgstTIN + '</td></tr >';
