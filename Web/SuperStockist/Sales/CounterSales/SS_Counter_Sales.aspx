<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Counter_Sales.aspx.cs" Inherits="SuperStockist_Sales_CounterSales_SS_Counter_Sales" %>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                function loadfunction() {
                    ...
                    $.ajax({
                        ...
                        async: false,
                        url: "SS_Counter_Sales.aspx/GetProductDetails",
                        dataType: "json",
                    ...
                    $.ajax({
                        ...
                        url: "SS_Counter_Sales.aspx/getratenew",
                        dataType: "json",
                        success: function (data) {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SS_Counter_Sales.aspx/Get_All_Stock",
                        dataType: "json",
                        success: function (data) {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SS_Counter_Sales.aspx/Get_Product_unit",
                        dataType: "json",
                        success: function (data) {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SS_Counter_Sales.aspx/Get_Product_Tax",
                        dataType: "json",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "Post",
                        contentType: "application/json; charset=utf-8",
                        url: "SS_Counter_Sales.aspx/GetPayType",
                        dataType: "json",
                        success: function (data) {
                            if (data.d.length > 0) {
                ...
                $(document).on("change", "#txt_mob", function () {
                    ...
                    if (Mob_No == "") {
                        ...
                        $.ajax({
                            type: "Post",
                            contentType: "application/json; charset=utf-8",
                            url: "SS_Counter_Sales.aspx/GetCustomerDetails",
                ...
                $.ajax({
                    type: "Post",
                    contentType: "application/json; charset=utf-8",
                    url: "SS_Counter_Sales.aspx/getscheme",
                        ...
                        if (stock_chck == 0) {
                            ...
                            $('#tblCustomers > tbody > tr').each(function () {
                                ...
                                if (res.length > 0) {
                                    ...
                                    if (res[0].Move_MailFolder_Name == res[0].Product_Sale_Unit) {
                            ...
                            if (chk != false) {
                                ...
                                setTimeout(function () {
                                    $.ajax({
                                        ...
                                        async: false,
                                        contentType: "application/json; charset=utf-8",
                                        url: "SS_Counter_Sales.aspx/SaveDate",
                                        ...
                                        success: function (data) {
                                            ...
                                            //window.location.href = "../CreditNote/SS_Counter_Sales_List.aspx";
                                            var Respomse = confirm('Do You Want To Print Counter Sales')
                                            if (Respomse) { window.location.href = "../CreditNote/CounterSales_Print.aspx?Order_id=" + order + "&Stockist_Code=" + stockistcode + "&Div_Code=" + div_code + ""; } else { window.location.href = "../CreditNote/SS_Counter_Sales_List.aspx"; }
                                            // if (Respomse) { window.location.href = "../CreditNote/counter_sale_print.aspx?Order_id=" + order + "&Stockist_Code=" + stockistcode + "&Div_Code=" + div_code + ""; } else { window.location.href = "../CreditNote/SS_Counter_Sales_List.aspx"; }
                                            if (Respomse) { loadCountersale(); print(); } else { window.location.href = "../CreditNote/SS_Counter_Sales_List.aspx"; }
                                            loadCountersale();
                                            print();
                                            $('.spinnner_div').hide();
                                        },
            ...
            function loadCountersale() {
                ...
                $.ajax({
                    ...
                    async: false,
                    data: "{'Order_Id':'" + order + "'}",
                    url: "SS_Counter_Sales.aspx/GetcountersaleDetail",
                    dataType: "json",
                    success: function (data) {
                        $('.spinnner_div').show();
