<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Counter_Order_View.aspx.cs" Inherits="SuperStockist_Sales_CounterSales_SS_Counter_Order_View" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                async: false,
                url: "SS_Counter_Order_View.aspx/Get_Counter_Order_Details",
                dataType: "json",
