<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_CounterSales_Print.aspx.cs" Inherits="SuperStockist_Sales_CounterSales_SS_CounterSales_Print" %>
    ...
    <script>
        ...
        function loadCountersale() {
            $.ajax({
                ...
                async: false,
                url: "SS_CounterSales_Print.aspx/GetcountersaleDetail",
                data: "{}",
                dataType: "json",
                success: function (data) {
                    ...
                    str1 += '<tr><td  align="center" style="padding-top: 0px;padding-bottom: 0px;font:12px TimesNewRomen; "><b></b></td></tr>';
