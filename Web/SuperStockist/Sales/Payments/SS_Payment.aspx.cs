...
public partial class SuperStockist_Sales_Payments_SS_Payment : System.Web.UI.Page
{
    ...
    public static DataSet getretailerdetailsmyorder(string scode, string divcode)
    {
        ...
        try
        {
            ...
            string strQry = "EXEC spGet_SS_DistributorName '" + scode + "','" + divcode + "'";
    ...
    {
        ds = Get_invoiced_retailer(Stockist_Code, Div_Code.TrimEnd(','));
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }
    public static DataSet Get_invoiced_retailer(string Stockist_Code, string Div_Code)
    {
        DB_EReporting db_ER = new DB_EReporting();
        DataSet ds = null;
        ...
        string strQry = "EXEC Sp_get_SS_invoice_pending_cust_Name '" + Div_Code + "','" + Stockist_Code + "'";
        //string strQry = "EXEC Sp_get_invoice_pending_cust_Name '" + Div_Code + "','" + Stockist_Code + "'";
    ...
    {
        ds = Get_invoiced_retailer_order(Stockist_Code, Div_Code.TrimEnd(','), Customer_Code, From_Year, To_Year, From_Month, To_Month, Type);
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }
    public static DataSet Get_invoiced_retailer_order(string Stockist_Code, string Div_Code, string Customer_Code, string FromYear, string To_Year, string From_Month, string To_Month, string type)
    {
        DB_EReporting db_ER = new DB_EReporting();
        DataSet ds = null;
        string strQry = "Exec get_SS_pending_payment_details '" + Stockist_Code + "','" + Div_Code + "', '" + Customer_Code + "', '" + FromYear + "','" + To_Year + "','" + From_Month + "','" + To_Month + "','" + type + "'";
        //string strQry = "Exec get_pending_payment_details '" + Stockist_Code + "','" + Div_Code + "', '" + Customer_Code + "', '" + FromYear + "','" + To_Year + "','" + From_Month + "','" + To_Month + "','" + type + "'";
        try
        {
            ds = db_ER.Exec_DataSet(strQry);
        }
    ...
    public static string Get_customerWise_credit_note_details(string Customer_Code)
    {
        ...
        ds = Get_custWise_credit_note_details(Stockist_Code, Div_Code.TrimEnd(','), Customer_Code);
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }
    public static DataSet Get_custWise_credit_note_details(string Stockist_Code, string Div_Code, string Customer_Code)
    {
        DataSet ds = null;
        DB_EReporting db_ER = new DB_EReporting();

        string strQry = "Exec Sp_Get_SS_custWise_credit_note_details '" + Stockist_Code + "','" + Div_Code + "','" + Customer_Code + "'";
        //string strQry = "Exec sp_Get_custWise_credit_note_details '" + Stockist_Code + "','" + Div_Code + "','" + Customer_Code + "'";
    ...
    {
        ds = Get_Dsm_Details_bystockist(Stockist_Code);
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }
    public  static DataSet Get_Dsm_Details_bystockist(string Stockist_Code)
    {
        DB_EReporting db_ER = new DB_EReporting();
        DataSet ds = null;
        ...
        string strQry = "EXEC sp_get_SS_pay_dsm '" + Stockist_Code + "'";
        //string strQry = "EXEC sp_get_pay_dsm '" + Stockist_Code + "'";
    ...
    public static DataSet Save_adv_amt_for_retailer(string c_id, string adv_amt, string div, string stockist_code)
    {
        ...
        string strQry = "Exec sp_SS_Save_adv_for_retailer '" + c_id + "','" + adv_amt + "','" + div + "','" + stockist_code + "'";
    ...
    {
        ds = Get_Retailer_Advance(Customer_Code);
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }

    public static DataSet Get_Retailer_Advance(string Customer_Code)
    {
        DB_EReporting db_ER = new DB_EReporting();
        DataSet ds = null;
        string strQry = "Exec [sp_dis_adv] '" + Customer_Code + "'";
        //string strQry = "Exec sp_Ret_adv '" + Customer_Code + "'";
        try
        {
            ds = db_ER.Exec_DataSet(strQry);
        }
