<%@ Page Title="Product-Brand List" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master_SS.master" CodeFile="ProductBrandList.aspx.cs" Inherits="MasterFiles_ProductBrandList" EnableEventValidation="false" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "ProductBrandList.aspx/Get_product_details",
                data: "{'div':'<%=Session["div_code"]%>'}",
                dataType: "json",
                success: function (data) {
