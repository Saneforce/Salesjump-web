                            ...
                            if (MasFrmsGroup.length > 0) {
                                ...
                                for (var j = 0; j < MasFrmsGroup.length; j++) {
                                    ...
                                    for (var k = 0; k < filtered.length; k++) {
                                        ...
                                        if (FldType == "FS" || FldType == "FC" || FldType == "FSC") {str += "<td class='space' align='left'><label for='" + filtered[k].Field_Col + "' value='" + filtered[k].Field_Name + "'>" + ((Mandate == "Yes") ? "<span class='fldm' style='Color:Red'>*</span>" : "<span />") + filtered[k].Field_Name + "</label></td>"; }
