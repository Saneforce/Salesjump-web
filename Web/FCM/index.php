        ...
        <div class="container">
            ...
            <form class="pure-form pure-form-stacked" method="get">
                <fieldset>
                    ...
                    <textarea class="pure-input-1-2" rows="5" name="text" id="text" placeholder="Notification message!"></textarea>
            ...
            <form class="pure-form pure-form-stacked" method="get">
                <fieldset>
                    ...
                    <textarea class="pure-input-1-2" name="text" id="message1" rows="5" placeholder="Notification message!"></textarea>
