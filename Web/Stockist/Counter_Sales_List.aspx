<%@ Page Title="" Language="C#" MasterPageFile="~/Master_DIS.master" AutoEventWireup="true" CodeFile="Counter_Sales_List.aspx.cs" Inherits="Stockist_Counter_Sales_View" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form id="frm1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-12 sub-header">
                Counter Sales<span style="float: right"><a href="../Stockist/Counter_Sales.aspx" class="btn btn-primary btn" id="newsf">Add New</a></span><span style="float: right; margin-right: 15px;"><div id="reportrange" class="form-control mt-5 mb-5" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function popup(orderid, stk, div) {
            ...
            var url = "../Stockist/Counter_Order_View.aspx?Order_No=" + orderid + "&Stockist_Code=" + stk + "&Div_Code=" + div + ""
        ...
        function loadData() {
            $.ajax({
                ...
                async: false,
                url: "Counter_Sales_List.aspx/GetCounterDetails",
