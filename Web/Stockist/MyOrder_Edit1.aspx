...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function add_new() {
            ...
            itm = {}
            itm.PCd = ''; itm.sPCd = ''; itm.s_pcode = ''; itm.PName = ''; itm.Unit = ''; itm.Rate = "0"; itm.Rate_in_peice = "0"; itm.Qty = 0; itm.Qty_c = 0; itm.Free = "0"; itm.Discount = "0"; itm.Dis_value = "0";
        ...
        function ReloadTable() {
            ...
            for (var st = 0; st < Orders.length; st++) {
                ...
                NewOrd[idx].Rate_in_peice = Orders[st].Rate_in_peice;
                ...
                if (ans.length > 0) {
                   ...
                   // getscheme(sale_p_code, cq, unit, row, fr, '', pc);
                    ...
                    if (umo == ans[0].Base_Unit_code) {
                        ...
                        NewOrd[idx].Rate = r;
                        NewOrd[idx].Rate_in_peice = Number(ans[0].RP_Base_Rate).toFixed(2);
                        CalcAmt(row);
                    }
                    else {
