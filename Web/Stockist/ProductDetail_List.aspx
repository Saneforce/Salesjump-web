            ...
            function ReloadTable() {
                ...
                for ($i = st; $i < st + PgRecords; $i++) {
                    if ($i < Orders.length) {
                        ...
                        $(tr).html("<td>" + ($i + 1) + "</td><td>" + Orders[$i].Sale_Erp_Code + "</td><td>" + Orders[$i].Product_Detail_Name + "</td><td>" + parseFloat(Orders[$i].MRP_Price).toFixed(2) + "</td><td>" + Orders[$i].product_unit + "/" + Orders[$i].Product_Sale_Unit + "</td><td>" + Orders[$i].HSN_Code + "</td><td>" + parseFloat(Orders[$i].Retailor_Price).toFixed(2) + "</td><td>" + Orders[$i].EAN_Code + "</td>");
