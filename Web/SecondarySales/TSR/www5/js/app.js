        ...
        .controller('MainCtrl', ['$rootScope', '$scope', '$state', '$ionicModal', '$ionicScrollDelegate', '$ionicPopup', '$location', 'fmcgLocalStorage', 'fmcgAPIservice', '$ionicSideMenuDelegate', 'geolocation', '$interval', 'notification', '$timeout', '$ionicLoading', '$filter', function ($rootScope, $scope, $state, $ionicModal, $ionicScrollDelegate, $ionicPopup, $location, fmcgLocalStorage, fmcgAPIservice, $ionicSideMenuDelegate, geolocation, $interval, notification, $timeout, $ionicLoading, $filter) {
            ...
            $scope.submit = function () {
              ...
              //  $scope.GeoChk = 1;
                ...
                $scope.showFlash = function() {
                    if (userData.callReport && userData.callReport.length > 0)
                        $ionicPopup.show({
                            ...
                            scope: $scope,
                            buttons: [{text: 'Close', type: 'button-assertive', onTap: function(e) {
                                        return true;
                                    }}, ]}).then(function(res) {
                ...
                $scope.instrumenttypes = [{ "id": 1, "name": "Cash" }, { "id": 2, "name": "Cheque" }, { "id": 3, "name": "RTGS" }]
                $scope.brand = fmcgLocalStorage.getData("brand") || [];
                $scope.DCRTypes = [{ "id": "Route Wise", "name": "Route Wise" }, { "id": "Retail Wise", "name": "Retail Wise" }];
                ...
                $scope.loadDatas = function(cMod, CDId) {
                    ...
                    $scope.Last_Updation_Date = fmcgLocalStorage.getData("Last_Updation_Date") || [];
                    $scope.LeaveTypes = fmcgLocalStorage.getData("LeaveTypes") || [];
                    $scope.instrumenttypes = [{ "id": 1, "name": "Cash" }, { "id": 2, "name": "Cheque" }]
                    $scope.brand = fmcgLocalStorage.getData("brand") || [];
                    $scope.Folders = fmcgLocalStorage.getData("folders") || [];
                    $scope.SubFolders = fmcgLocalStorage.getData("subfolders") || [];
            ...
            $timeout(uploadLocaations, 200);*/
                ...
                $scope.openModal = function (sdata, choice, repId) {
                    ...
                    $scope.SelMulti = 0;
                    var res = [];
                    if (",5,6,7,25,26,36,106,".indexOf("," + choice + ",") > -1)
                    {
...
//                                console.log(data)
        ...
        .controller('myTodyPlCtrl', ['$rootScope', '$scope', '$state', '$location', 'fmcgAPIservice', 'fmcgLocalStorage', '$ionicSideMenuDelegate', 'notification', '$ionicLoading', '$filter', function($rootScope, $scope, $state, $location, fmcgAPIservice, fmcgLocalStorage, $ionicSideMenuDelegate, notification, $ionicLoading, $filter) {
               ...
               // $scope.fmcgData.DCRToday = 0;
                ...
                if ($scope.Mypl.length > 0) {
                    if ($scope.Mypl[0].worktype != undefined) {
                        ...
                        if ($scope.Mypl[0].FWFlg == 'F' || $scope.Mypl[0].FWFlg == 'DH') {
            ...
            $scope.removeRow = function() {
                ...
                $scope.save = function() {
                 ...
                 else if ($scope.Mypln.worktype.selected.FWFlg == 'F')
                    {
      ...
      .controller('EditSummaryCtrl', ['$rootScope', '$scope', '$state', '$location', 'fmcgAPIservice', 'fmcgLocalStorage', '$ionicSideMenuDelegate', 'notification', '$ionicLoading', function ($rootScope, $scope, $state, $location, fmcgAPIservice, fmcgLocalStorage, $ionicSideMenuDelegate, notification, $ionicLoading) {
          ...
          $scope.gridOptions = {
              ...
              plugins: [new ngGridFlexibleHeightPlugin()],
              showFooter: true,
              columnDefs: [{ field: 'product_brd_sname', displayName: 'Brand Name', enableCellEdit: false, cellTemplate: 'partials/productCellTemplate.html' },
                  { field: 'RetailCount', displayName: "EC", enableCellEdit: true, editableCellTemplate: "partials/cellEditTemplate.html", width: 60 }]
          };
          $scope.prod = function () {
        ...
        .controller('homeCtrl', ['$rootScope', '$scope', '$state', '$ionicPopup', 'fmcgAPIservice', 'fmcgLocalStorage', 'notification', '$ionicLoading', '$ionicModal', '$ionicScrollDelegate', function($rootScope, $scope, $state, $ionicPopup, fmcgAPIservice, fmcgLocalStorage, notification, $ionicLoading, $ionicModal, $ionicScrollDelegate) {
            ...
            $scope.customers = [{
                ...
                $scope.gotoCust = function(cus)
                {
                    ...
                    if (Wtyps.length > 0 || $scope.Mypln.worktype.FWFlg == 'DH') {
                    ...
                    if (pln.length > 0)
                    {
                        if (pln[0]['dcrtype'] == "Route Wise" && cus==1) {
        ...
        .controller('screen3Ctrl', function($rootScope, $scope, $filter, $state, $ionicModal, $ionicSideMenuDelegate, fmcgAPIservice, fmcgLocalStorage, notification,$ionicLoading) {
            ...
            else
            {
                ...
                $scope.gridOptions = {
                    ...
                    plugins: [new ngGridFlexibleHeightPlugin()],
                    showFooter: true,
                    columnDefs: [{ field: 'product_Nm', displayName: 'Product', enableCellEdit: false, cellTemplate: 'partials/productCellTemplate.html', cellClass: 'grid-alignl' },
                        { field: 'Rate', displayName: 'Rate', enableCellEdit: false, cellTemplate: 'partials/productCellTemplate.html', width: 60, cellClass: 'grid-alignr' },
                        { field: 'rx_qty', displayName: QCap, enableCellEdit: true, editableCellTemplate: "partials/cellEditTemplate5.html", width: 60, cellClass: 'grid-alignr' },
                        { field: 'remove', displayName: '', enableCellEdit: false, cellTemplate: 'partials/removeButton.html', width: 50, "visible": $scope.prodShow }]
                };
            }
            $scope.Mypl = fmcgLocalStorage.getData("mypln") || [];
     ...
     .controller('stockUpdationPrimaryCtrl', function ($rootScope, $scope, $state, $ionicPopup, $ionicLoading, fmcgAPIservice, fmcgLocalStorage, notification, $filter) {
         ...
         if (scrTyp == 1 || scrTyp == 4) {
             ...
             $scope.gridOptions = {
                 ...
                 showFooter: true,
                 columnDefs: [{ field: 'product_Nm', displayName: 'Product', enableCellEdit: false, cellTemplate: 'partials/productCellTemplate.html' },
                     { field: 'recv_qty', displayName: "P.Stock", enableCellEdit: true, editableCellTemplate: "partials/cellEditTemplate.html", width: 70, "visible":true }]
        ...
        .controller('stockUpdationCtrl', function ($rootScope, $scope, $state, $ionicPopup, $ionicLoading, fmcgAPIservice, fmcgLocalStorage, notification, $filter) {
            ...
            if (scrTyp == 1 || scrTyp == 4)
            {
                ...
                $scope.gridOptions = {
                    ...
                    showFooter: true,
                    columnDefs: [{field: 'product_Nm', displayName: 'Product', enableCellEdit: false, cellTemplate: 'partials/productCellTemplate.html'},
                        { field: 'recv_qty', displayName: "P.Stock", enableCellEdit: true, editableCellTemplate: "partials/cellEditTemplate.html", width: 70, "visible": $scope.condClosing },
                        { field: 'cb_qty', displayName: "Box", enableCellEdit: true, editableCellTemplate: "partials/cellEditTemplate2.html", width: 55, "visible": $scope.condRecv },
                        { field: 'pieces', displayName: "Units", enableCellEdit: true, editableCellTemplate: "partials/cellEditTemplate4.html", width: 90, "visible": $scope.condRecv },
                        { field: 'remove', displayName: '', enableCellEdit: false, cellTemplate: 'partials/removeButton.html', width: 50, "visible": false }]
                        ...
                        fmcgAPIservice.getDataList('POST', 'table/list', ["vwActivity_CSH_Detail", '["*"]', , JSON.stringify(pklist), , 3, , , '["stk_meet_time"]']).success(function(response1) {
                            for (var j = 0, le = response1.length; j < le; j++) {
                                ...
                                if (response1[j]['instrument_type'] != "") {
                                    ...
                                    inst = instrumenttypes.filter(function (a) { return (a.name == response1[j]['instrument_type']); });
                    ...
                    */
                    html2canvas($(xelem), {
                        onrendered: function (canvas) {
                            ...
                            $('ion-nav-view').css("height", "");
                            $('body').css("overflow", 'hidden');
                            window.plugins.socialsharing.shareViaWhatsApp("Order Details", canvasImg, 'sample-file.pdf', function () { }, function (errormsg) { alert(errormsg) })
                        }
                    });
                }
            };
...
/*                    
                    ...
                    doc.save('sample-file.pdf');
                    window.plugins.socialsharing.shareViaWhatsApp("Day Report", null, 'sample-file.pdf', function () { }, function (errormsg) { alert(errormsg) })
                    */
                    html2canvas($(xelem), {
                        onrendered: function (canvas) {
                            var canvasImg = canvas.toDataURL("image/jpg");
                            ...
                            $('body').css("overflow", 'hidden');
                            window.plugins.socialsharing.shareViaWhatsApp("Day Report", canvasImg, null, function () { }, function (errormsg) { alert(errormsg) })
                        }
                    });
                }
                $scope.modal.sendEmail = function () {
                    ...
                    html2canvas($(xelem), {
                        onrendered: function (canvas) {
                            ...
                            $('.ion-content').css("height", "");
                            $('body').css("overflow", 'hidden');
                            window.plugins.socialsharing.share('', 'Day Report Dashboard', canvasImg, '');
                        }
                    });
                }
            };
