<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DIS_Home.aspx.cs" Inherits="MasterFiles_DIS_Home" %>
...
<body>
    ...
    <asp:Label ID="lblActivity" runat="server" Font-Size="Large" ForeColor="Green" Font-Italic="true" Font-Names="Verdana" Visible="false">Quick View</asp:Label> <br />
    <br />
...
<%--     <asp:Calendar ID="CalMgr" runat="server" BackColor="#FFFFCC" ForeColor="White" PrevMonthText="<img src='Images/PMonth.ico' border=0 align=top>" 
    ...
    <td align="center"><asp:Label ID="lblSC" runat="server"  Font-Size="Large" ForeColor="Green" Font-Names="Verdana" Font-Italic="true" Visible="false">Short Cut</asp:Label> 
    <br />
   <br />
