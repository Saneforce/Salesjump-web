 <%@ Page Title="Dashboard" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Default2.aspx.cs" Inherits="Default2"  EnableEventValidation="false" %>
...
document.getElementById("loaderSearchddlSFCode").style.display = '';
            ...
            <a>  <button id="Btn_order" type="button" runat="server" onserverclick="Submit_Click" class="sm-st clearfix" style="width:210px;height:93px;border-bottom-width:0px;border-right-width:0px;border-color:White;">
               ...
               <a class="sm-st-icon st-blue"><i class="glyphicon glyphicon-briefcase"></i></a>
                <div class="sm-st-info">
                    ...
                    <a><asp:Label ID="ordercount" runat="server" ></asp:Label></a>Today Orders</div>
                    </button>
                  </a>
 ...
 <div class="col-md-4" style="width:20px;height:20px;">
  <div style="text-align:center">
   ...
   <div id="chartContainer" style="height: 300px; width: 320%;"></div>
  ...
  <asp:Label ID="feildlabl" runat="server" Text="FieldForce:" 
            ...
            <asp:DropDownList ID="ddlFieldForce" runat="server" onchange="setTimeout('showLoader('Search1')',2000)" class="btn btn-info dropdown-toggle"  onselectedindexchanged="ddlFieldForce_SelectedIndexChanged" AutoPostBack="false"  style="padding: 2px; font-size: 73%; color:Black; height:17px; width:217px; background-color:#DCE775;" >
            </asp:DropDownList>
        <div class="dropdown"  >
          ...
          <asp:DropDownList ID="Distributor"  class="btn btn-info dropdown-toggle" onselectedindexchanged="Distributor_SelectedIndexChanged" AutoPostBack="false" style="padding: 2px; font-size: 73%; height: 20px; width: 90px;" 
                ...
                runat="server" onchange="setTimeout('showLoader('Search1')',2000)" Height="15px" Width="55px"  Font-Size="Smaller" >
