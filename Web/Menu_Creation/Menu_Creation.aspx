                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        ...
                        <input type="radio" id="rd_2" value="0" style="display:none;" name="rdBtn" />
						<label id="Tbarlbl2"  style="display:none;">No Needed</label>
                    </td>
                </tr>
                    <tr>                
                        <td rowspan="2">
...
<script type="text/javascript">
    ...
    $('#btnSave').click(function () {
        ...
        var id = $("#menuid").val();
        var tbar = (type != 0) ? $("input[name=rdBtn]:checked").attr('value') : 0;
