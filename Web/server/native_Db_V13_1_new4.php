...
if($PDets["damageorderdate"]=="" || $PDets["damageorderdate"]==null) $PDets["damageorderdate"]="";
 ...
 select ".$pk.",m.Product_Detail_Code," . $PDets["Qty"] . "," .
                ...
                //$Qtys=($rQty*$PDets["conversionQty"])+$rPQty;
                $sqlupd = "exec UpdStockistRetReturnStock '".$pk."','" . $vals["StkId"] . "','" . $PDets["id"] . "','" . date('Y-m-d H:i:s') . "','".$PDets["QType"]."'," . $Qtys . ",".$Divc.",'',''";
						  ...
						  $Route_code=$vals["Route_code"];
						   ...
						   $sql = "SELECT ISNULL(MAX(Sl_No),0)+1 as slNo FROM trans_payment_detail ";
                            ...
                            $pk = (int) $tRw[0]['slNo'];
							  ...
							  $sqlQry = "insert into trans_payment_detail(Sl_No,Sf_Code,Sf_Name,Cust_Id,Cus_Name,Amount,Pay_Mode,Pay_Date,Pay_Ref_No,Remarks,Distributor_Code,Route_code,eDate,PaymentName,advance_pay,div_code,invoice_no,Collected_by,type) Values('".$pk."','".$SfCode."','".$SfName."','".$Cust_ID."','".$Cust_Name."','".$Total_amount."','".$Mode."','". date('m-d-Y H:i:s') . "','".$Reference_No."','".$Remark."','".$Stk_Code."','".$Route_code."','".$Pay_Date."','".$Bk_name."','".$Advance_pay."','".$Owndiv."','".$invoice_no."','".$collect_by."','".$Type."')";
						  ...
						  $Route_code=$vals["Route_code"];
						   ...
						   $sql = "SELECT ISNULL(MAX(Sl_No),0)+1 as slNo FROM trans_van_payment_detail ";
                            ...
                            $pk = (int) $tRw[0]['slNo'];
							  ...
							  $sqlQry = "insert into trans_van_payment_detail(Sl_No,Sf_Code,Sf_Name,Cust_Id,Cus_Name,Amount,Pay_Mode,Pay_Date,Pay_Ref_No,Remarks,Distributor_Code,Route_code,eDate,PaymentName,advance_pay,div_code,invoice_no,Collected_by,type) Values('".$pk."','".$SfCode."','".$SfName."','".$Cust_ID."','".$Cust_Name."','".$Total_amount."','".$Mode."','". date('m-d-Y H:i:s') . "','".$Reference_No."','".$Remark."','".$SfCode."','".$Route_code."','".$Pay_Date."','".$Bk_name."','".$Advance_pay."','".$Owndiv."','".$invoice_no."','".$collect_by."','".$Type."')";
