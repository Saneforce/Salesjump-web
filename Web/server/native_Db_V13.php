			 ...
			 $respon['TPDCR_Deviation'] = $arr[0]['TPDCR_Deviation'];
			  $respon['MyplnEventCapture'] = $arr[0]['Mypln_Event_Capture'];
			   ...
			   $respon['TP_ND'] = $arr[0]['TP_ND'];
			   			   $respon['Claim_Need'] = $arr[0]['Claim_Need'];
...
GiftDesc Desc_Name,CONVERT(varchar,To_Date, 101)To_Date,CONVERT(varchar,From_Date, 101) From_Date,isnull(billed_products,'') billed_products
