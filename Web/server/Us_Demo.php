...
function GiftEnrolment() {
    ...
    $query = "select  GiftSlabID id,month(From_Date)GiftMonth,GiftName name,GiftDesc GiftName,CONVERT(varchar,To_Date, 101)To_Date  from mas_gift_slab where ActiveFlag='0' and Division_Code='" . $Owndiv . "' and isnull(Claim_deadline,convert(date,getdate()))>=convert(date,getdate()) ";
    return performQuery($query);
}
