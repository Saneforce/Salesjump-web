            ...
            // if (isset($tableData['Activity_POB_Report'])) {
                    ...
                    if (isset($tableData['Activity_Stk_POB_Report'])){
                        ...
                        for ($j = 0; $j < count($samp); $j++) {
							...
							$PName=$samp[$j]["product_Name"];
							//echo $samp[$j]["product_Name"];
							//N'" . $transOrderDetails[$i]['product_Name']. "'
                            $PPXML = $PPXML . "<Prod PCode=\"".$samp[$j]["product_code"]."\" PName=\"".$PName."\" CQty=\"".$samp[$j]["Qty"]."\" PQty=\"".$samp[$j]["PQty"]."\" CL=\"".$cl_qty_stock."\"  Free=\"".$Free_qty."\"  />";
