<%@ Page Title="" Language="C#" MasterPageFile="~/Master_DIS.master" AutoEventWireup="true" CodeFile="Invoice_Order_List.aspx.cs" Inherits="Stockist_Invoice_Order_Report" %>
    ...
    <form id="frm1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-12 sub-header">
                Sales Invoice<span style="float: right"><a href="../Stockist/Invoice_Entry_2.aspx" class="btn btn-primary btn" id="newsf">Add New</a></span><span style="float: right; margin-right: 15px;">
    ...
    <script language="javascript" type="text/javascript">
            ...
            for ($i = st; $i < st + PgRecords; $i++) {
                if ($i < Orders.length) {
                    ...
                    $(tr).html("<td>" + slno + "</td><td>" + Orders[$i].Trans_Inv_Slno + "</td><td>" + Orders[$i].Order_No + "</td><td>" + Orders[$i].Cus_Name + "</td><td>" + Orders[$i].Invoice_Date +
                        "</td><td>" + Orders[$i].Status + "</td><td style='text-align: right'>" + parseFloat(Orders[$i].Total).toFixed(2) + "</td><td style='text-align: right'><a href='Invoice_Order_View.aspx?Order_No=" + Orders[$i].Trans_Inv_Slno + "&Stockist_Code=" + stockist_Code + "&Div_Code=" + Div_Code + "&Status=" + Orders[$i].Status + "'><span class='glyphicon glyphicon-eye-open'></span></a></td><td style='text-align: right'><a href='#'  onClick='popup(\"" + Orders[$i].Trans_Inv_Slno + "\",\"" + stockist_Code + "\",\"" + Div_Code + "\",\"" + Orders[$i].Cus_Code + "\")'><span class='glyphicon glyphicon-print'></span></td>");
        ...
        function loadData() {
            $.ajax({
                ...
                async: false,
                url: "Invoice_Order_List.aspx/GetInvoiceDetails",
        ...
        function loaddivision() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Invoice_Order_List.aspx/GetDivision",
        ...
        function gstcalculi() {
            ...
            str += '<tr style="font:12px TimesNewRomen;"><td style="padding-top:0px;padding-bottom:0px;padding-left:10px;" colspan="2"><b>GST Desc</b></td><td style="padding-top: 0px;padding-bottom: 0px;"><b>GST%</b></td><td style="padding-top: 0px;padding-bottom: 0px;"><b>GST Amount</b></td><td style="padding-top: 0px;padding-bottom: 0px;" colspan="2"><b></b></td><td  colspan="4" style="padding-top:0px;padding-bottom:0px;"><b>Total Case:</b>&nbsp;&nbsp;' + totlcase + '</td><td style="padding-top:0px;padding-bottom:0px;"><b>Gross Value :</b>&nbsp;&nbsp;</td><td style="float:right;padding-top:0px;padding-bottom:0px;"><b>' + amt_without_tax.toFixed(2) + '</b></td><td></td></tr>';
            str += '<tr style="font:12px TimesNewRomen;"><td style="padding-top:0px;padding-bottom:0px;padding-left:10px;" colspan="2"><b>CGST</b></td><td style="padding-top: 0px;padding-bottom: 0px;">0</td><td style="padding-top:0px;padding-bottom:0px;">' + cgst.toFixed(2) + '</td><td style="padding-top:0px;padding-bottom:0px;" colspan="3"></td><td  colspan="3" style="padding-top:0px;padding-bottom:0px;"><b>Total Piece:</b>&nbsp;&nbsp;' + totalpie + '</td><td style="padding-top:0px;padding-bottom:0px;"><b>Scheme Amt :</b></td><td style="float:right;padding-top:0px;padding-bottom:0px;"><b>0.00</b></td><td></td></tr>';
            str += '<tr style="font:12px TimesNewRomen;"><td style="padding-top:0px;padding-bottom:0px;padding-left:10px;" colspan="2"><b>SGST</b></td><td style="padding-top: 0px;padding-bottom: 0px;">0</td><td style="padding-top:0px;padding-bottom:0px;">' + sgst.toFixed(2) + '</td><td style="padding-top:0px;padding-bottom:0px;" colspan="6"></td><td style="padding-top:0px;padding-bottom:0px;"><b>Cash Disc :</b>&nbsp;&nbsp;</td><td style="float:right;padding-top:0px;padding-bottom:0px;"><b>' + cashdis.toFixed(2) + '</b></td><td></td></tr>';
