...
public partial class MasterFiles_Route_Master : System.Web.UI.Page
{
    ...
    {
        Territory SFD = new Territory();
        DataSet ds = SFD.getSalesforce(div_code);
        return JsonConvert.SerializeObject(ds.Tables[0]);
    ...
    public static string getStockist()
    {
        ...
        Territory SFD = new Territory();
        DataSet ds = SFD.getStockist(div_code);
        return JsonConvert.SerializeObject(ds.Tables[0]);   
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                wb.Worksheets.Add(dsProd1, "Route");
                Response.Clear();
                Response.Buffer = true;
                Response.Charset = "";
