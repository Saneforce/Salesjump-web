<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chem_Cat_Trans.aspx.cs" Inherits="MasterFiles_Chem_Cat_Trans" %>
<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Transfer Chemists Category</title>
 <link type="text/css" rel="stylesheet" href="../css/style.css" />
    ...
    <script type="text/javascript">
        ...
        function ConfirmMessage() {
            var selectedvalue = confirm("Do you want to Transfer Category?") &&
...
<body>
    ...
    <ucl:Menu ID="menu1" runat="server" />
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
            <table border="0" cellpadding="5" cellspacing="5" id="tblCattransfer" align="center">
                <tr>
                    <td align="left">
                    
                        <asp:Label ID="lblTrans_From" runat="server" SkinID="lblMand" ><span style="Color:Red">*</span>Change From</asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td align="left">
                        <asp:Label ID="lblTrans_To" runat="server" SkinID="lblMand" ><span style="Color:Red">*</span>Change To</asp:Label>
                    </td>
                    <td>
        ...
        <center>
            ...
            <asp:Button ID="btnTransfer" runat="server" CssClass="BUTTON" Width="130px" Text="Transfer - Category" OnClick="btnTransfer_Click" />
        </center>
        <br />
        <center>
                ...
                <asp:Table ID="Table1" runat="server" BorderStyle="Solid" Width="300px" BorderWidth="1" CssClass="clp"
                    ...
                    <asp:TableRow>
                        <asp:TableCell BorderWidth="1" Width="80px" HorizontalAlign="Left">
                            <asp:Label ID="lblListed" runat="server" Text="Chemists Count" SkinID="lblMand"></asp:Label></asp:TableCell>
