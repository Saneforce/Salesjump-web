<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MultiDiv_Reporting_Team.aspx.cs" Inherits="MasterFiles_MultiDiv_Reporting_Team" %>
<%@ Register Src ="~/UserControl/MenuUserControl.ascx" TagName ="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Reporting Team Selection</title>
    ...
    <div>
     ...
     <center>
      <table border="0" cellpadding="1" cellspacing="1" id="tblLocationDtls" align="center" width ="50%">
        <tr>
            <td style="width:200;">
               <asp:HyperLink ID="hypDiv1" runat="server" NavigateUrl="~/MasterFiles/MultiDiv_Reporting_Team.aspx?div=1"></asp:HyperLink>                                 
            </td>
            <td style="width:200;">
               <asp:HyperLink ID="hypDiv2" runat="server" NavigateUrl="~/MasterFiles/MultiDiv_Reporting_Team.aspx?div=2"></asp:HyperLink>         
            </td>
            <td style="width:200;">
                <asp:HyperLink ID="hypDiv3" runat="server" NavigateUrl="~/MasterFiles/MultiDiv_Reporting_Team.aspx?div=3"></asp:HyperLink>        
            </td>
        </tr>
        <tr>
            <td style="width:200;">
               <asp:HyperLink ID="hypDiv4" runat="server" NavigateUrl="~/MasterFiles/MultiDiv_Reporting_Team.aspx?div=4"></asp:HyperLink>         
            </td>
            <td style="width:200;">
                <asp:HyperLink ID="hypDiv5" runat="server" NavigateUrl="~/MasterFiles/MultiDiv_Reporting_Team.aspx?div=5"></asp:HyperLink>        
            </td>
            <td style="width:200;">
               <asp:HyperLink ID="hypDiv6" runat="server" NavigateUrl="~/MasterFiles/MultiDiv_Reporting_Team.aspx?div=6"></asp:HyperLink>         
            </td>
