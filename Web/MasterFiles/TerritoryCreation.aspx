<%@ Page Title="Territory Creation" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="TerritoryCreation.aspx.cs"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#<%=btnSubmit.ClientID%>').click(function () {
                if ($('#<%=txtSubDivision_Sname.ClientID%>').val() == "") { alert("Please Enter Territory Code."); $('#<%=txtSubDivision_Sname.ClientID%>').focus(); return false; }
                if ($('#<%=txtSubDivision_Name.ClientID%>').val() == "") { alert("Please Enter Territory Name."); $('#<%=txtSubDivision_Name.ClientID%>').focus(); return false; }
                var SName = $('#<%=ddlState.ClientID%> :selected').text();
                if (SName == "--Select--") { alert("Please Select Zone Name."); $('#<%=ddlState.ClientID%>').focus(); return false; }
            });
        });
    </script>
</head>
                ...
                <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="lblShortName" runat="server" SkinID="lblMand" Height="19px"
                            Width="150px"><span style="Color:Red">*</span>Territory Code</asp:Label>
                    </td>
                    <td align="left" class="stylespc">
                ...
                <tr>
                  <td align="left" class="stylespc">
                        <asp:Label ID="lblDivisionName" runat="server" SkinID="lblMand" 
                            Height="18px" Width="120px"><span style="Color:Red">*</span>Territory Name</asp:Label>
                    </td>
                   <td align="left" class="stylespc">
                 ...
                 <tr>
                  <td align="left" class="stylespc">
                        <asp:Label ID="Lbl_Zone" runat="server" SkinID="lblMand" 
                            Height="18px" Width="120px"><span style="Color:Red">*</span>Zone</asp:Label>
                    </td>
                   <td align="left" class="stylespc">
