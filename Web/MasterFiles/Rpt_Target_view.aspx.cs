...
public partial class Rpt_Target_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblIDMonth.Text = "Fieldforce Name : " + Request.QueryString["SF_Name"].ToString();
  ...
  private void Product_details ()
    {
        ...
        dsSalesForce = pro.getproductname(divcode);
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.UserList_getMR(divcode, sf_code);
