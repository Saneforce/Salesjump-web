<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="DeleteMail.aspx.cs" Inherits="MasterFiles_DeleteMail" %>
        ...
        <script type="text/javascript">
            ...
            function ReloadTable() {
                ...
                for ($i = st; $i < st + PgRecords; $i++) {
                    if ($i < Orders.length) {
                        ...
                        {
                            $("#Read_table").append("<tr><td><input type='checkbox' class='case'></td><input type='hidden' id='hide' class='hiden' value=" + Orders[$i].Trans_Sl_No + " /><td><b><a class='MailReadid' style='white-space: nowrap; width: 200px; overflow: hidden;text-overflow: ellipsis;display: block;' href='ReadDeleteMail.aspx?Trans_Sl_No=" + Orders[$i].Trans_Sl_No + "'>" + Orders[$i].To_SFName + "</b></a></td><td><b>" + Orders[$i].Mail_Subject + "</b></td><td><b>" + Orders[$i].MonthDateYear + "</b></td>" + "</tr>");
                        }
                        else if (Orders[$i].MailRead == 1)
                        {
                            $("#Read_table").append("<tr><td><input type='checkbox' class='case'></td><input type='hidden' id='hide' class='hiden' value=" + Orders[$i].Trans_Sl_No + " /><td><a style='white-space: nowrap; width: 200px; overflow: hidden;text-overflow: ellipsis;display: block;' href='ReadDeleteMail.aspx?Trans_Sl_No=" + Orders[$i].Trans_Sl_No + "'>" + Orders[$i].To_SFName + "</a></td><td>" + Orders[$i].Mail_Subject + "</td><td>" + Orders[$i].MonthDateYear + "</td>" + "</tr>");
                        }
            ...
            $(document).ready(function () {
                <%-- $.ajax({
                    ...
                    url: "DeleteMail.aspx/GetDeleteData",
                    ...
                    if ($(".case:checked").length > 0) {
                        ...
                        $(".case:checked").each(function () {
                            ...
                            $.ajax({
                                ...
                                contentType: "application/json; charset=utf-8",
                                async: false,
                                url: "DeleteMail.aspx/PermanentDeleteData",
                    ...
                    if ($(".case:checked").length > 0) {
                        ...
                        $(".case:checked").each(function () {
                            ...
                            if (sellabel == "Inbox")
                            {
                                ...
                                var ip=0;
                            $('.case:checkbox:checked').parents("tr").remove();                                                       
                                data = { "ImportantMessage": selectlbl, "SocialMessage": social, "Promotions": promo, "System_Ip":ip, "Trans_Sl_No": inv_no, "DivCode": "<%=Session["div_code"]%>" }
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            async: false,
                            url: "DeleteMail.aspx/UpdateDelMsgData",
                            ...
                            else if (sellabel == "Social")
                            {
                                ...
                                var ip1 = 0;
                            $('.case:checkbox:checked').parents("tr").remove();                                                       
                            data = { "ImportantMessage": important, "SocialMessage": selectlbl, "Promotions": promo1, "System_Ip": ip1, "Trans_Sl_No": inv_no, "DivCode": "<%=Session["div_code"]%>" }
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            async: false,
                            ...
                            else
                            {
                                ...
                                var ip2 = 0;
                            $('.case:checkbox:checked').parents("tr").remove();                                                       
                            data = { "ImportantMessage": important1, "SocialMessage": soc, "Promotions": selectlbl, "System_Ip": ip2, "Trans_Sl_No": inv_no, "DivCode": "<%=Session["div_code"]%>" }
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            async: false,
