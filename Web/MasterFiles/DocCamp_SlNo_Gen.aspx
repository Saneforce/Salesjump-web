...
<head runat="server">
    <title>Customer Campaign Serial No Generation</title>
                        ...
                        <asp:GridView ID="grdDocCat" runat="server" Width="50%" HorizontalAlign="Center" EmptyDataText="No Records Found" 
                            ...
                            <Columns>                
                               <asp:TemplateField HeaderText="Doc_SubCatCode" Visible="false">
                                ...
                                <asp:BoundField DataField="Doc_SubCatSName" SortExpression="Doc_SubCatSName" HeaderStyle-ForeColor="white" ItemStyle-HorizontalAlign="Left" ShowHeader="true" HeaderText="Short Name" ItemStyle-Width="10%" />
                                <asp:BoundField DataField="Doc_SubCatName" SortExpression="Doc_SubCatName" HeaderStyle-ForeColor="white" ItemStyle-HorizontalAlign="Left" HeaderText="Sub-Category Name" ShowHeader="true" ItemStyle-Width="20%"/>
