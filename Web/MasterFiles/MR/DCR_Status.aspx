<%@ Page Title="DCR Status" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master_MR.master" CodeFile="DCR_Status.aspx.cs" Inherits="Reports_DCR_Status" %>
      ...
      $(document).ready(function () {
          ...
          $('#<%=btnSubmit.ClientID%>').click(function () {
              ...
              if ($('#<%=rdoType.ClientID %> input[type=radio]:checked').val() == "2") {
                  ...
                  { alert("Select Effective From Date."); $('#<%=txtEffFrom.ClientID%>').focus(); return false; }
              }
              var SFName = $('#<%=ddlFieldForce.ClientID%> :selected').text();
              if (SFName == "---Select Clear---") { alert("Select Field Force Name."); $('#<%=ddlFieldForce.ClientID%>').focus(); return false; }
