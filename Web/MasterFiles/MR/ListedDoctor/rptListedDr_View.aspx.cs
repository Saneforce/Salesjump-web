...
public partial class MasterFiles_MR_ListedDoctor_rptListedDr_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            lblHead.Text = "View All Listed Doctor Details";
        }

        Label1.Text = Session["sf_name"] + " - " + Session["Designation_Short_Name"] + " - " + Session["Sf_HQ"];


        if (Request.QueryString["mgr_code"] != null)
        {
            Doctor dc = new Doctor();
            dsDoctor = dc.getDoctorMgr_list(Request.QueryString["mgr_code"].ToString());
        ...
        {
            Doctor dc = new Doctor();
            dsDoctor = dc.getDoctorCategory_list(sf_code, catg, terr_code, type);
    ...
    protected void grdDoctor_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            if (dsTerritory.Tables[0].Rows.Count > 0)
            {
                ...
                //  e.Row.Cells[7].Style.Add("text-decoration","underline");
                //grdDoctor.Columns[7].SortExpression = "territory_Name";        
