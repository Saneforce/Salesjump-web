<%@ Page Title="DCR View" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master_MR.master" CodeFile="DCR_View.aspx.cs" Inherits="Reports_DCR_View" %>
    ...
    <div>
        ...
        <center>
            <table cellpadding="0" cellspacing="5">
                ...
                <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="Label2" runat="server" SkinID="lblMand" Text="Year"></asp:Label>
                    </td>
                    <td align="left">
                ...
                <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="Label1" runat="server" SkinID="lblMand" Text="Month"></asp:Label>
                    </td>
                    <td align="left">
