<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hospital_DeActivate.aspx.cs" Inherits="MasterFiles_MR_Hospital_Hospital_DeActivate" %>
...
<head runat="server">
    <title>Hospital DeActivate</title>
...
<body>
    ...
    <div class="div_fixed">
         <asp:Button ID="btnSave" runat="server" Text="De-Activate" Width="90px" Height="25px" CssClass="BUTTON" onclick="btnSave_Click" Visible="false" />
    </div>    
