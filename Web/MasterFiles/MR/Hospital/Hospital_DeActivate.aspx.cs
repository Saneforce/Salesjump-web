...
public partial class MasterFiles_MR_Hospital_Hospital_DeActivate : System.Web.UI.Page
{
    #region "Declaration"
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdHospital.Rows)
        {
            ...
            if ((Hospital_Code.Trim().Length > 0) && (bCheck == true))
            {
                ...
                Hospital hosp = new Hospital();
                iReturn = hosp.DeActivate(Hospital_Code);
            }
            else
            {
        ...
        if (iReturn != -1)
        {
            //menu1.Status = "Hospital De-Activated Successfully!!";
