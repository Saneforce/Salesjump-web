...
public partial class MasterFiles_MR_Hospital_rptHospital_Terr_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((terr_code != "-1"))
        {
            ...
            {
                // lblHead.Text = lblHead.Text + "(Territory: " + terr_Name + ")";
        ...
        if (Request.QueryString["mgr_code"] != null)
        {
            ...
            dsDoctor = hos.getHospitalDetails_terr(Request.QueryString["mgr_code"].ToString());

            if (dsDoctor.Tables[0].Rows.Count > 0)
            {
                grdHospital.Visible = true;
                grdHospital.DataSource = dsDoctor;
        ...
        {
            Hospital hos = new Hospital();
            dsDoctor = hos.getHospital_terr(sf_code, terr_code);
