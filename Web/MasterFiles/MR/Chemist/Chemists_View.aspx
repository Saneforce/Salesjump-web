        ...
        <table border="1" style="">
            <tr>
                <td align="left" class="stylespc">
                    <asp:Label ID="lblName" runat="server" Text="Chemists Name" ></asp:Label>
                </td>
                <td class="stylespc">
            ...
            <tr>
                <td align="left" class="stylespc">
                    <asp:Label ID="lblAddress" runat="server" Text="Chemists Address"></asp:Label>
                </td>
                <td class="stylespc">
                    <asp:TextBox ID="txtAddress" runat="server" Width="180px" Enabled="False" Text='<%#Eval("Chemists_Address1")%>'></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="left" class="stylespc">
            ...
            <tr>
               <td align="left" class="stylespc">
                    <asp:Label ID="lblPhone" runat="server" Text="Chemists Phone"></asp:Label>
                </td>
                <td class="stylespc">
