    ...
    <center>
        <table>
           <tr>
                ...
                <td align="left" class="stylespc">
                    <asp:TextBox ID="txtName" runat="server" TabIndex="1" SkinID="MandTxtBox" Width="200"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td align="left" class="stylespc">
                    <asp:TextBox ID="txtUserName" runat="server" TabIndex="2" SkinID="MandTxtBox" Width="200"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="left" class="stylespc">
               ...
               <td align="left" class="stylespc">
                    <asp:TextBox ID="txtPassword" runat="server" TabIndex="3" SkinID="MandTxtBox" MaxLength="15" TextMode="Password" Width="200"></asp:TextBox>
                </td>
            </tr>
     <%--      
            <tr>
            ...
            <tr>
               ...
               <td align="left" class="stylespc">
                    <asp:CheckBoxList ID="chkDivision" TabIndex="5" runat="server" DataTextField="division_name"
                        DataValueField="division_code" Font-Names="Verdana" Font-Size="X-Small" RepeatColumns="3"
