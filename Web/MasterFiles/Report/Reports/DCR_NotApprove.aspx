<%@ Page Title="Not Approved DCR Dates" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="DCR_NotApprove.aspx.cs" Inherits="Reports_DCR_NotApprove" %>
...
<body>
  ...
  <%--  <ucl:Menu ID="menu1" runat="server" /> --%>
        ...
        <table>
            <tr>
                <td align="left" class="stylespc" width="120px">
                    <asp:Label ID="Label1" runat="server" SkinID="lblMand" Text="From Range : "></asp:Label>
                </td>
                <td>
        ...
        <br />
        <asp:Button ID="btnSubmit" runat="server" CssClass="BUTTON" Width="70px" Height="25px" Text="Go" onclick="btnSubmit_Click"/>
