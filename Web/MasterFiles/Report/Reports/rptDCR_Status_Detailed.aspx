<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDCR_Status_Detailed.aspx.cs" Inherits="Reports_DCR_Status_Detailed" %>
    ...
    <div>
     ...
     <br />
        ...
        <table border="0" width="90%">
            <tr>
                <td align="center"> 
                    <asp:Label ID="lblHead" runat="server" Text="Daily Call Status for the month of " Font-Underline="True" Font-Size="Small" Font-Bold="True"></asp:Label>                    
                </td>
            </tr>
        </table>
        <br />
