...
public partial class MasterFiles_Reports_viewaldate_dcr : System.Web.UI.Page
{
    ...
    public string downloadaudio(string bucketName, string folderName, string fileName)
    {
        ...
        try
        {
            ...
            //Console.WriteLine("File downloaded locally on the server successfully.");
    ...
    public string playaudio(string sound)
    {
        ...
        wplayer.URL = imagepath;
        strsound = sound; string msg = string.Empty;
    ...
    {
        MasterFiles_Reports_viewaldate_dcr getdet = new MasterFiles_Reports_viewaldate_dcr();
        getdet.GetVoice_det(sound,audio);      
        string msg = string.Empty;      
        msg = "Success";
        return msg;
    }
    ...
    public  string GetVoice_det(string sound, string audio)
    {
        ...
        serverpath = serverfolder + Path.GetFileName(audio);
        //fileUpload1.SaveAs(serverpath);
        string msg = string.Empty;
        byte[] bytese = System.Convert.FromBase64String(sound);
        File.WriteAllBytes(serverpath, bytese);
        msg = "Success";
        return msg;
    }
}