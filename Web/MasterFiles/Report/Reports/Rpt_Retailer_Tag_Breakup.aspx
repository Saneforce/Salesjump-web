<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_Retailer_Tag_Breakup.aspx.cs" Inherits="MasterFiles_Reports_Rpt_Retailer_Tag_Breakup" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div class="row">
                <div class="col-sm-8">
                    <asp:Label ID="lblhead1" runat="server" Style="font-weight: bold; font-size: 12pt; padding: 0px 20px;">Retailer Tag Status</asp:Label>
                </div>
