...
public partial class Reports_DCRCount_rptDCRCount : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        StrVacant = Convert.ToInt16(Request.QueryString["StrVacant"].ToString());
    ...
    private void FillSF()
    {
        ...
        DataSet dsSalesForce1 = new DataSet();
        DataSet dsSalesPrevious = new DataSet();
        DataSet dsSalesCurrent = new DataSet();
        ...
        if (StrVacant == 0)
        {
            ...
            {
                dsSalesForce = sf.sp_UserListMr_FieldForce(sf_code, div_code, Month, Year); // 28-Aug-15 -Sridevi                
                dsSalesCurrent = sf.sp_Get_DCRCount_Current_Pending_date_Count(sf_code, div_code, Convert.ToString(Month), Year); // 28-Aug-15 -Sridevi 
            }
            else
            {
                dtSalesForce = sf.getAuditManagerTeam(div_code, sf_code, 0);

            }

            dsSalesForce.Tables[0].Columns.Add("date1");
            dsSalesForce.Tables[0].Columns.Add("date2");

            for (int i = 0; i < dsSalesForce.Tables[0].Rows.Count - 1; i++)
            {
                //dsSalesForce.Tables[0].Rows[i]["Date1"] = dsSalesPrevious.Tables[0].Rows[i]["date1"].ToString();
                dsSalesForce.Tables[0].Rows[i]["Date2"] = dsSalesCurrent.Tables[0].Rows[i]["date2"].ToString();
            }
        }
        else
        {
            if (DsAudit.Tables[0].Rows.Count > 0)
            {
                dtSalesForce = sf.getUserListReportingToAllNew(div_code, sf_code, 0, Session["sf_type"].ToString()); // 28-Aug-15 -Sridevi
            }
            else
            {
                dtSalesForce = sf.getAuditManagerTeam(div_code, sf_code, 0);
        ...
        {
            if (dsSalesForce.Tables[0].Rows[i]["Date2"].ToString() != "0" && dsSalesForce.Tables[0].Rows[i]["Date2"].ToString() != "")
            {
                iPendingCount += 1;
        ...
        //    TableCell tc_PreMonth = new TableCell();
        //    tc_PreMonth.BorderStyle = BorderStyle.Solid;
        //    tc_PreMonth.BorderWidth = 1;
        //    tc_PreMonth.Width = 50;
        //    tc_PreMonth.RowSpan = 1;
        //    tc_PreMonth.HorizontalAlign = HorizontalAlign.Center;
        //    Literal lit_PreMonth = new Literal();
        //    lit_PreMonth.Text = DateTime.Now.AddMonths(-1).ToString("MMM") + " Count";
        //    tc_PreMonth.Style.Add("font-weight", "bold");
        //    tc_PreMonth.Attributes.Add("Class", "tr_det_head");
        //    tc_PreMonth.Controls.Add(lit_PreMonth);
        //    tr_header.Cells.Add(tc_PreMonth);

        //    TableCell tc_CurtMonth = new TableCell();
        //    tc_CurtMonth.BorderStyle = BorderStyle.Solid;
        //    tc_CurtMonth.BorderWidth = 1;
        //    tc_CurtMonth.Width = 50;
        //    tc_CurtMonth.RowSpan = 1;
        //    tc_CurtMonth.HorizontalAlign = HorizontalAlign.Center;
        //    Literal lit_CurtMonth = new Literal();
        //    lit_CurtMonth.Text = DateTime.Now.ToString("MMM") + " Count";
        //    tc_CurtMonth.Style.Add("font-weight", "bold");
        //    tc_CurtMonth.Attributes.Add("Class", "tr_det_head");
        //    tc_CurtMonth.Controls.Add(lit_CurtMonth);
        //    tr_header.Cells.Add(tc_CurtMonth);
        ...
        //        dsDoc = dcs.get_All_dcr_Pending_date_Count(drFF["sf_code"].ToString(), DateTime.Now.AddMonths(-1).Month, DateTime.Now.Year);
        //        string strCount = string.Empty;
        //        if (dsDoc.Tables[0].Rows.Count > 0)
        //        {
        //            strCount = Convert.ToString(dsDoc.Tables[0].Rows.Count);
        //        }
        //        else
        //        {
        //            strCount = "";
        ...
        //        TableCell tc_det_doc_Prev_Month = new TableCell();
        //        tc_det_doc_Prev_Month.HorizontalAlign = HorizontalAlign.Center;
        //        tc_det_doc_Prev_Month.ForeColor = System.Drawing.Color.Red;
        //        Literal lit_det_doc_Prev_Month = new Literal();
        //        lit_det_doc_Prev_Month.Text = "&nbsp;" + strCount;
        //        tc_det_doc_Prev_Month.Style.Add("font-weight", "bold");
        //        tc_det_doc_Prev_Month.BorderStyle = BorderStyle.Solid;
        //        tc_det_doc_Prev_Month.BorderWidth = 1;
        //        tc_det_doc_Prev_Month.Controls.Add(lit_det_doc_Prev_Month);
        //        tc_det_doc_Prev_Month.Visible = true;
        //        tr_det.Cells.Add(tc_det_doc_Prev_Month);

        //        dsDoc = dcs.get_All_dcr_Pending_date_Count(drFF["sf_code"].ToString(), DateTime.Now.Month, DateTime.Now.Year);
        ...
        //        TableCell tc_det_Current_Month = new TableCell();
        //        tc_det_Current_Month.HorizontalAlign = HorizontalAlign.Center;
        //        tc_det_Current_Month.Style.Add("font-weight", "bold");
        //        tc_det_Current_Month.ForeColor = System.Drawing.Color.Red;
        //        Literal lit_det_doc_Currnt_Month = new Literal();
        //        lit_det_doc_Currnt_Month.Text = "&nbsp;" + strCount;
        //        tc_det_Current_Month.BorderStyle = BorderStyle.Solid;
        //        tc_det_Current_Month.BorderWidth = 1;
        //        tc_det_Current_Month.Controls.Add(lit_det_doc_Currnt_Month);
        //        tc_det_Current_Month.Visible = true;
        //        tr_det.Cells.Add(tc_det_Current_Month); 
        ...
        //            strDate = ldcrdate.ToString("dd/MM/yyyy");
        //        }
        ...
        //            dsDoc = dcs.get_All_dcr_Sf_Code_date_Count(drFF["sf_code"].ToString(), Convert.ToInt16(Month), Convert.ToInt16(Year));
        ...
        //            dsDcrCount = dcs.get_All_dcr_Pending_date_Count(drFF["sf_code"].ToString(), Convert.ToInt16(Month), Convert.ToInt16(Year));


        //            for (int i = 0; i < dsDcrCount.Tables[0].Rows.Count; i++)
        //            {
        //                if (dsDcrCount.Tables[0].Rows[i]["Temp"].ToString() == "1")
        //                {
        //                    tot_DcrPendingDate = dsDcrCount.Tables[0].Rows[i].ItemArray.GetValue(0).ToString();
        //                    iPendingDate += Convert.ToInt16(tot_DcrPendingDate.Substring(0, 2)) + "(<span style='color:Red'>" + dsDcrCount.Tables[0].Rows[i]["FieldWork_Indicator"].ToString() + "</span>)" + ", ";
        //                }
    ...
    protected void GvDcrCount_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string str = "";
                Label lblApproval_Pending_Dates = (Label)e.Row.FindControl("lblApproval_Pending_Dates");

                if (lblApproval_Pending_Dates.Text.Contains("LP"))
                {
                    lblApproval_Pending_Dates.Text = lblApproval_Pending_Dates.Text.Replace("LP", "<span style='color:Red'>" + "LP" + "</span>");
                }
            }
