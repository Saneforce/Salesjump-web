<%@ Page Title="Event Captures Report" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="DCR_Event_Captures_View.aspx.cs" Inherits="DCR_Event_Captures_View" %>
    ...
    <div>
        ...
        <center>
            <table cellpadding="0" cellspacing="5">
                ...
                <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="Label2" runat="server" SkinID="lblMand" Text="Date :" Visible="true"></asp:Label>
                    </td>
                    <td align="left">
                  <input name="txtFrom" type="date"  CssClass="TEXTAREA" MaxLength="5"
