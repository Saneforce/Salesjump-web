...
public partial class MasterFiles_Reports_Rpt_Retailer_Tag_Status : System.Web.UI.Page
{
    ...
    private void FillSF()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("exec getRetailerTagDets '" + Sf_Code + "','" + divcode + "','0'", con);
