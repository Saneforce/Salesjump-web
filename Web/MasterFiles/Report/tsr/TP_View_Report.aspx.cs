...
public partial class MasterFiles_Temp_TP_View_Report : System.Web.UI.Page
{
    ...
    {
        return "/MasterFiles/Report/tsr/rptTPView.aspx?sf_code=" + ddlFieldForce.SelectedValue.ToString() + "&cur_month=" + ddlMonth.SelectedValue.ToString() + "&cur_year=" + ddlYear.SelectedValue.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            string sURL = "/MasterFiles/Report/tsr/rptTPView.aspx?sf_code=" + ddlFieldForce.SelectedValue.ToString() + "&cur_month=" + ddlMonth.SelectedValue.ToString() + "&cur_year=" + ddlYear.SelectedValue.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString()
        ...
        {
            string sURL = "/MasterFiles/Report/tsr/rptTPView.aspx?sf_code=" + ddlFieldForce.SelectedValue.ToString() + "&cur_month=" + ddlMonth.SelectedValue.ToString() + "&cur_year=" + ddlYear.SelectedValue.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString() + "&level=-1"
                          + "&div_Code=" + div_code;
            string newWin = "window.open('" + sURL + "',null,'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');";
            Page.ClientScript.RegisterStartupScript(this.GetType(), "openwindow", newWin, true);
            //Page.ClientScript.RegisterStartupScript(this.GetType(), "newWindow", String.Format("<script>window.open('{0}', 'Cliente', 'toolbar=no,directories=no,status=no,menubar=no, scrollbars=yes,resizable=no', '800', '600','0','0', 'true'); </script>", sURL));
