<%@ Page Title="TP View Report" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master"
    CodeFile="TP_View_Report.aspx.cs" Inherits="MasterFiles_Temp_TP_View_Report" %>
    ...
    <head id="Head1">
        ...
        <script type="text/javascript">
            ...
            function showModalPopUp(sfcode, fmon, fyr, level, sf_name) {
                ...
                // /MasterFiles/Report/tsr/
                popUpObj = window.open("/MasterFiles/Report/tsr/rptTPView.aspx?sf_code=" + sfcode + "&cur_month=" + fmon + "&cur_year=" + fyr + "&level=-1" + "&sf_name=" + sf_name,
                    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
    ...
    "top=0"
        ...
        <script type="text/javascript">
            ...
            function NewWindow() {
                ...
                if (rodhyp >= 0) {
                    var sURL = "/MasterFiles/Report/tsr/rptTPView.aspx?sf_code=" + sf_Code + "&cur_month=" + Month1 + "&cur_year=" + Year1 + "&sf_name=" + Name + "&level=" + rodhyp;
                    window.open(sURL, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');

                }
                else {
                    var sURL = "/MasterFiles/Report/tsr/rptTPView.aspx?sf_code=" + sf_Code + "&cur_month=" + Month1 + "&cur_year=" + Year1 + "&sf_name=" + Name + "&level=-1";
                    window.open(sURL, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
