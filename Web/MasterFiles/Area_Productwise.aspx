<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Area_Productwise.aspx.cs" Inherits="MasterFiles_Area_Productwise" %>
<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Area - Productwise View</title>
...
<body>
    ...
    <asp:Label ID="lblProduct" runat="server" SkinID="lblMand" Text="Area Name"></asp:Label></td>
    <td align="left" class="stylespc">
