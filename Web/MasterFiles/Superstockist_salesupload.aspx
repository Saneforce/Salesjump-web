<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Superstockist_salesupload.aspx.cs" Inherits="MasterFiles_Superstockist_salesupload" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form id="form1" runat="server">
        <div><label style="font-size:25px">SuperStockist Sales Upload</label></div>
        <div class="card">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //    async: false,
            //    url: "Superstockist_salesupload.aspx/dd1divisionChanged",
            //    dataType: "json",
