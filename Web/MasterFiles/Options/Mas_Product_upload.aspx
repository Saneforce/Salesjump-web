<%@ Page Title="Product Detail Upload" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="Mas_Product_upload.aspx.cs"
    Inherits="MasterFiles_Options_Mas_Product_upload" %>
                ...
                <td>
                    <table width="95%" cellpadding="5px" cellspacing="5px" style="border: 1px solid Black; background-color:White">
                       ...
                       <td align="right" style="padding-right:4px;">
                           ...
                           <asp:Label ID="Lab_div" runat="server" Text="Select Division :"></asp:Label>
                           <asp:DropDownList ID="dd1division" SkinID="ddlRequired" runat="server" ValidationGroup="Val" AutoPostBack="true">
                                </asp:DropDownList>
                       </td>
                       </tr>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <asp:ImageButton ID="Button1" runat="server"  Width="160px" Height="30px" ImageUrl="~/Images/button_product-upload.png" ValidationGroup="Val" Text="Upload" OnClick="btnUpload_Click" />
                 ...
                 <td style="width:7%">
                  ...
                  <td style="width:8%">
                    <asp:Repeater ID="rptUOM" runat="server" >
                        <HeaderTemplate>
                            <div id="divdr" style="background-color:White;">
                               UOM</div>
                        </HeaderTemplate>
