        ...
        try
        {
            ...
            try
            {
                ...
                for (int i = 0; i < Dt.Rows.Count; i++)
                {
                    ...
                    int RowNo = i + 2;
                    dslst = lstDR.GetSF_code(columns[1], Div_Code, columns[0]);
                    ...
                    {
                        sMsg += "Unable to Upload This employee :" + columns[1].ToString() + " is not Mapped with this Distributor :"+ columns[0].ToString() + " . Excel Row No : " + (i + 2) + "</br>";

                    }
                    dsplst = lstDR.GetProd_code(columns[2], Div_Code);
                    ...
                    {
                        sMsg += "Please Check ProductCode :" + columns[2].ToString() + " . Excel Row No : " + (i + 2) + "</br>";
