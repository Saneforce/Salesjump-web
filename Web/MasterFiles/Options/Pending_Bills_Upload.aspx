<%@ Page Title="Pending Bills Upload" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
    CodeFile="Pending_Bills_Upload.aspx.cs" Inherits="MasterFiles_Options_Pending_Bills_Upload" %>
     ...
     <%--   <tr>
        ...
        <tr>
            <td style="padding-left: 80px;">
                ...
                <br />
                <asp:Label ID="Label6" Font-Size="11px" Font-Names="Verdana" runat="server" Text="1) Bill Date & Bill Due Date Must be in DD-MM-YYYY or DD/MM/YYYY Format"></asp:Label>
                <br />
                ...
                <br />
                 <br />
                <asp:Label ID="Label1" runat="server" Text="Error Occurred While Upload!:" ForeColor="Red"></asp:Label>
                <br />
				<br/>
                 <div id="dvStatus" style="display:block;width:80%;overflow:auto;height:120px;font-display:block;color:orangered;">
                  </div>
            </td>
        </tr>
        <tr>
