<%@ Page Title="DSM List" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="DSMList.aspx.cs" Inherits="MasterFiles_DSMList" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                if ($("#txtSubDivision_Sname").val() == "") { alert("Please Enter DSM Code."); $('#txtSubDivision_Sname').focus(); return false; }
                if ($("#txtSubDivision_Name").val() == "") { alert("Please Enter DSM Name."); $('#txtSubDivision_Name').focus(); return false; }
                        ...
                        <asp:GridView ID="grdSubDiv" runat="server" Width="85%" HorizontalAlign="Center"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Sub Division Code" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblsubdivCode" runat="server" Text='<%#Eval("DSM_code")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField  ItemStyle-Width="130px" HeaderText="DSM Code"
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <asp:TextBox ID="txtShortName" SkinID="TxtBxAllowSymb" runat="server" MaxLength="5"
                                            Text='<%# Bind("DSM_sname") %>' onkeypress="AlphaNumeric_NoSpecialChars(event);"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvsn" ControlToValidate="txtShortName" runat="server"
                                            ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblShortName" runat="server" Text='<%# Bind("DSM_sname") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="DSM_name" HeaderText="DSM Name" HeaderStyle-ForeColor="white"
                                    ItemStyle-HorizontalAlign="Left">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtSubDivName" SkinID="TxtBxAllowSymb" runat="server" MaxLength="50"
                                            onkeypress="AlphaNumeric_NoSpecialChars(event);" Text='<%# Bind("DSM_name") %>'></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvn" ControlToValidate="txtSubDivName" runat="server"
                                            ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSubDivName" runat="server" Text='<%# Bind("DSM_name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField  HeaderText="Distributor" HeaderStyle-ForeColor="white"
                                    ItemStyle-HorizontalAlign="Left" Visible="true">
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddlState" runat="server" SkinID="ddlRequired" Enabled="false">
                                        </asp:DropDownList>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblState" runat="server" Text='<%# Bind("Distributor_Name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Count" ItemStyle-HorizontalAlign="Center" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSubDiv_count" runat="server" Text='<%# Bind("Sub_Coun") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
								 <asp:TemplateField HeaderText="User Name" ItemStyle-HorizontalAlign="Center" Visible="true">
                                    <ItemTemplate>
                                        <asp:Label ID="lblUser_Name" runat="server" Text='<%# Bind("UserName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Password" ItemStyle-HorizontalAlign="Center" Visible="true">
                                    <ItemTemplate>
                                ...
                                <asp:HyperLinkField HeaderText="Edit" Text="Edit" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center"
                                    DataNavigateUrlFormatString="DSMCreation.aspx?Subdivision_Code={0}" DataNavigateUrlFields="DSM_Code">
                                ...
                                <asp:TemplateField HeaderText="Deactivate" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="140px">
                                    ...
                                    <ItemStyle ForeColor="DarkBlue" Font-Bold="False"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkbutDeactivate" runat="server" CommandArgument='<%# Eval("DSM_code") %>'
