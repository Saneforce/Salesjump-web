<%@ Page Title="Taluk List" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="TownList.aspx.cs" Inherits="MasterFiles_TownList" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                if ($("#txtSubDivision_Sname").val() == "") { alert("Please Enter Taluk Code."); $('#txtSubDivision_Sname').focus(); return false; }
                if ($("#txtSubDivision_Name").val() == "") { alert("Please Enter Taluk."); $('#txtSubDivision_Name').focus(); return false; }
       ...
       <%-- <ucl:Menu ID="menu1" runat="server" />--%>
        ...
        <table width="80%">
            <tr>
                <td style="width: 9.2%" />
                <td>
                    <asp:Button ID="btnNew" runat="server" CssClass="btn btn-primary btn-md" Text="Add"  OnClick="btnNew_Click" />
                </td>
            </tr>
        </table>
        <br />
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:GridView ID="grdSubDiv" runat="server" Width="85%" HorizontalAlign="Center"
                            ...
                            AllowSorting="True" OnSorting="grdSubDiv_Sorting" OnRowDataBound="grdSubDiv_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Sub Division Code" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblsubdivCode" runat="server" Text='<%#Eval("Town_code")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField  ItemStyle-Width="130px" HeaderText="Taluk Code"
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <asp:TextBox ID="txtShortName" SkinID="TxtBxAllowSymb" runat="server" MaxLength="10"
                                            Text='<%# Bind("Town_sname") %>' onkeypress="AlphaNumeric_NoSpecialChars(event);"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvsn" ControlToValidate="txtShortName" runat="server"
                                            ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblShortName" runat="server" Text='<%# Bind("Town_sname") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField  HeaderText="Taluk Name" HeaderStyle-ForeColor="white"
                                    ItemStyle-HorizontalAlign="Left">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtSubDivName" SkinID="TxtBxAllowSymb" runat="server" MaxLength="100"
                                            onkeypress="AlphaNumeric_NoSpecialChars(event);" Text='<%# Bind("Town_name") %>'></asp:TextBox>
                                         <asp:RequiredFieldValidator ID="rfvn" ControlToValidate="txtSubDivName" runat="server"
                                            ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSubDivName" runat="server" Text='<%# Bind("Town_name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField  HeaderText="District" HeaderStyle-ForeColor="white"
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblState" runat="server" Text='<%# Bind("Dist") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField  HeaderText="Territory" HeaderStyle-ForeColor="white"
                                    ItemStyle-HorizontalAlign="Center" Visible="true">
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddlTerritory" runat="server" SkinID="ddlRequired">
                                        </asp:DropDownList>
									  <asp:RequiredFieldValidator ID="RFValidator1_ddl1" InitialValue="0" runat="server" ErrorMessage="RequiredField" ControlToValidate="ddlTerritory"></asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblTerr" runat="server" Text='<%# Bind("Territory_Name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                               <%-- <asp:TemplateField HeaderText="District Count" ItemStyle-HorizontalAlign="Left" Visible="false">
                                    <ItemTemplate>
                                ...
                                <asp:HyperLinkField HeaderText="Edit" Text="Edit" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center"
                                    DataNavigateUrlFormatString="TownCreation.aspx?Subdivision_Code={0}" DataNavigateUrlFields="Town_Code">
                                ...
                                <asp:TemplateField HeaderText="Deactivate" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="140px">
                                    ...
                                    <ItemStyle ForeColor="DarkBlue" Font-Bold="False"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkbutDeactivate" runat="server" CommandArgument='<%# Eval("Town_Code") %>'
                                            CommandName="Deactivate" OnClientClick="return confirm('Do you want to Deactivate the Taluk');">Deactivate
                                        </asp:LinkButton>
                                        <asp:Label ID="lblimg" runat="server" Text="Deactivate" Visible="false">                                        
                                      <img src="../Images/deact1.png" alt="" width="55px" title="This Taluk Name Exists in Product or Fieldforce" />
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
