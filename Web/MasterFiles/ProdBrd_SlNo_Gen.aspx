<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProdBrd_SlNo_Gen.aspx.cs" Inherits="MasterFiles_ProdBrd_SlNo_Gen" %>
<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Product Brand Serial No - Generation</title>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:GridView ID="grdProBrd" runat="server" Width="50%" HorizontalAlign="Center" EmptyDataText="No Records Found"  
                            AutoGenerateColumns="false" AllowSorting="True" OnSorting="grdProBrd_Sorting"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="Product_Brd_SName" HeaderText="Brand Code" HeaderStyle-ForeColor="white"
                                ...
                                <asp:TemplateField SortExpression="Product_Brd_Name" HeaderText="Brand Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-ForeColor="white">
                                    <ItemStyle Width="20%" />
                                    <ItemTemplate>
