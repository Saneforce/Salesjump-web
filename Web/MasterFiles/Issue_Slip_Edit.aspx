<%@ Page Title="Issue Slip Edit" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master"
    CodeFile="Issue_Slip_Edit.aspx.cs" Inherits="MasterFiles_Issue_Slip_Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <head>
        <title>Closing Stock List</title>
    ...
    e.preventDefault(); //disable cut,copy,paste
                ...
                $(document).on('keyup', '[id*=Labqty]', function () {

                    if (!jQuery.trim($(this).val()) == '') {
                        if (!isNaN(parseFloat($(this).val()))) {
                            var row = $(this).closest("tr");

                            row.find('[id*=LabVal]').val(row.find('[id*=LabDP]').val() * row.find('[id*=Labqty]').val());
                ...
                $(document).on('keyup', '[id*=LabDP]', function () {
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="text-center">
                            <asp:Label ID="Iss_No" runat="server"></asp:Label>
                        </h4>
                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GrdDoctor" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                ...
                                                EmptyDataText="No Records Found" HorizontalAlign="Center" ShowHeader="true" BorderStyle="None"
                                                BorderWidth="1px" CellPadding="3" OnRowDataBound="GrdDoctor_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="140px" HeaderText="Stock Type" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <ItemTemplate>
                                                            ...
                                                            <%--   <asp:Label ID="lblStkType" runat="server" Text='<%# Bind("Stock_Type") %>'></asp:Label>--%>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-Width="120px" HeaderText="Rate" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="LabDP" Width="60px" Style="text-align: right;" MaxLength="8" CssClass="form-control"
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="120px" HeaderText="Qty" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="Labqty" Width="60px" Style="text-align: right;" MaxLength="8" CssClass="form-control"
                                                                runat="server" Text='<%# Bind("Qty") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-Width="140px" HeaderText="Value" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="LabVal" Width="60px" Style="text-align: right;" MaxLength="8" CssClass="form-control"
                                                                runat="server" Text='<%# Bind("Value") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-Width="140px" HeaderText="Reason" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="LabRea" Width="60px" Style="text-align: right;" MaxLength="8" CssClass="form-control"
                                                                runat="server" Text='<%# Bind("Reason") %>'></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
        ...
        <center>
            <div>
                <table>
                    <tr>
                        <td>
                            <asp:Button ID="btnSubmit" class="btn btn-secondary" runat="server" Text="update"
                                Visible="true" OnClick="btnSubmit_Click" />
                        </td>
                    </tr>
                </table>
        </center>
