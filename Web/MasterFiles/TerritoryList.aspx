<%@ Page Title="Territory List" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="TerritoryList.aspx.cs" Inherits="MasterFiles_TerritoryList" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnSubmit').click(function () {
                if ($("#txtSubDivision_Sname").val() == "") { alert("Please Enter Territory Code."); $('#txtSubDivision_Sname').focus(); return false; }
                if ($("#txtSubDivision_Name").val() == "") { alert("Please Enter Territory Name."); $('#txtSubDivision_Name').focus(); return false; }
                        ...
                        <asp:GridView ID="grdSubDiv" runat="server" Width="85%" HorizontalAlign="Center"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Sub Division Code" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblsubdivCode" runat="server" Text='<%#Eval("Territory_code")%>'></asp:Label>
										<asp:Label ID="lblFO_count" runat="server" Text='<%#Eval("FO_Coun")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="subdivision_sname" ItemStyle-Width="130px" HeaderText="Territory Code"
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <asp:TextBox ID="txtShortName" SkinID="TxtBxAllowSymb" runat="server" MaxLength="5"
                                            Text='<%# Bind("Territory_sname") %>' onkeypress="AlphaNumeric_NoSpecialChars(event);"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvsn" ControlToValidate="txtShortName" runat="server"
                                            ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblShortName" runat="server" Text='<%# Bind("Territory_sname") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="subdivision_name" HeaderText="Territory Name"
                                    HeaderStyle-ForeColor="white" ItemStyle-HorizontalAlign="Left">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtSubDivName" SkinID="TxtBxAllowSymb" runat="server" MaxLength="50"
                                            onkeypress="AlphaNumeric_NoSpecialChars(event);" Text='<%# Bind("Territory_name") %>'></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvn" ControlToValidate="txtSubDivName" runat="server"
                                            ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSubDivName" runat="server" Text='<%# Bind("Territory_name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="Zone" HeaderText="Zone" HeaderStyle-ForeColor="white"
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblState" runat="server" Text='<%# Bind("Zone") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                               <%-- <asp:TemplateField HeaderText="Rount Count" ItemStyle-HorizontalAlign="Center" Visible="false">
                                    <ItemTemplate>
                                ...
                                <asp:HyperLinkField HeaderText="Edit" Text="Edit" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center"
                                    DataNavigateUrlFormatString="TerritoryCreation.aspx?Subdivision_Code={0}" DataNavigateUrlFields="Territory_Code">
