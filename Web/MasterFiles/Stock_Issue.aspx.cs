...
public partial class MasterFiles_Stock_Issue : System.Web.UI.Page
{
    ...
    public static Products[] GetSno()
    {
        ...
        dsProduct = p.getSlno_stock(PDiv_code.TrimEnd(','));
        if (dsProduct != null)
        {
            foreach (DataRow row in dsProduct.Tables[0].Rows)
            {
                ...
                //pro.pCode = row["Product_Detail_Code"].ToString();
                //pro.pUOM = row["MRP_Price"].ToString();
                pro.pUOM_Name = "IS50-" + row["slno"].ToString();
    ...
    public static string SaveDate(string data)
    {
        ...
        using (var scope = new TransactionScope())
        {
            try
            {
                ...
                dsStock = prd.Get_Stock_issue_Head(Div_Code, GRN.TransH[0].transNo.ToString(), strgrn, GRN.TransH[0].stockistFrom.ToString(), GRN.TransH[0].stockistTo.ToString());

                if (dsStock.Tables[0].Rows.Count <= 0)
                {
                    int Trans_No = prd.Insert_Stock_issue_Head(Div_Code, SF_Code, GRN.TransH[0].transNo.ToString(), strgrn, GRN.TransH[0].stockistFrom.ToString(), GRN.TransH[0].stockistFrom_Nm.ToString(), GRN.TransH[0].stockistTo.ToString(), GRN.TransH[0].Auth_Nm.ToString());
                    for (int i = 0; i < GRN.TransD.Count; i++)
                    {
                        string val = GRN.TransD[i].pqty == "" ? "0" : GRN.TransD[i].pqty;
                        if (Convert.ToDecimal(val) > 0)
                        {
                            string irtn = prd.Insert_Stock_issue_Details1(Trans_No, GRN.TransD[i].pCode.ToString(), GRN.TransD[i].pName.ToString(), GRN.TransD[i].pType.ToString(), GRN.TransD[i].pType_Name.ToString(), GRN.TransD[i].prate.ToString(), GRN.TransD[i].pqty.ToString(), GRN.TransD[i].pval.ToString(), GRN.TransD[i].preason.ToString());
                            //stock update
                            ...
                            if (dsCurSkt.Tables[0].Rows.Count > 0)
                            {
                                ...
                                foreach (DataRow row in dsCurSkt.Tables[0].Rows)
                                {
                                    if (GRN.TransD[i].pType_Name.ToString() == "Good")
                                    {
                                        ...
                                        int num = prd.Update_Trans_CurrStock_Batchwise_Transfer1(Div_Code, GRN.TransH[0].stockistFrom.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "Good", GRN.TransD[i].oqty.ToString(), "-");

                                        string Trn_No = Convert.ToString(Trans_No);
                                        int ledIns = prd.Insert_Trans_Stock_Ledger(Div_Code, strgrn, GRN.TransH[0].stockistFrom.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "0", "0", "", Trn_No, GRN.TransH[0].stockistFrom_Nm.ToString(), GRN.TransH[0].stockistTo.ToString(), "ISS");
                                    ...
                                    else
                                    {
                                        ...
                                        string Trn_No = Convert.ToString(Trans_No);
                                        int num = prd.Update_Trans_CurrStock_Batchwise_Transfer1(Div_Code, GRN.TransH[0].stockistFrom.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "Damage", GRN.TransD[i].oqty.ToString(), "-");

                                        int ledIns = prd.Insert_Trans_Stock_Ledger(Div_Code, strgrn, GRN.TransH[0].stockistFrom.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), "0", upVal.ToString("0.00"), "0", "", Trn_No, GRN.TransH[0].stockistFrom_Nm.ToString(), GRN.TransH[0].stockistTo.ToString(), "ISS");

                                        //DataSet dsSkt = prd.Select_Trans_CurrStock_Distwise(Div_Code, GRN.TransH[0].stockistTo.ToString(), GRN.TransD[i].pCode.ToString());
                                        //if (dsSkt.Tables[0].Rows.Count > 0)
                                        //{
                                        //    int numup = prd.Update_Trans_CurrStock_Batchwise_Transfer(Div_Code, GRN.TransH[0].stockistTo.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "Damage", "+");
                                        //    int ledInsIn = prd.Insert_Trans_Stock_Ledger(Div_Code, strgrn, GRN.TransH[0].stockistTo.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), "0", upVal.ToString("0.00"), "1", "", "ISS");
                                        //}
                                        //else
                                        //{
                ...
                else
                {
                    ...
                    //string Trans_No = prd.Update_Stock_issue_Head1(tran_id, GRN.TransH[0].stockistFrom.ToString(), GRN.TransH[0].stockistTo.ToString(), GRN.TransH[0].Auth_Nm.ToString());
                    //iReturn = prd.Delete_Stock_issue_Details(tran_id);
                    //for (int i = 0; i < GRN.TransD.Count; i++)
                    //{
                    //    string val = GRN.TransD[i].pqty == "" ? "0" : GRN.TransD[i].pqty;
                    //    if (Convert.ToDecimal(val) > 0)
                    //    {
                    //        string irtn = prd.Insert_Stock_issue_Details2(tran_id, GRN.TransD[i].pCode.ToString(), GRN.TransD[i].pName.ToString(), GRN.TransD[i].pType.ToString(), GRN.TransD[i].pType_Name.ToString(), GRN.TransD[i].prate.ToString(), GRN.TransD[i].pqty.ToString(), GRN.TransD[i].pval.ToString(), GRN.TransD[i].preason.ToString());
                    ...
                    //                    int ledIns = prd.Insert_Trans_Stock_Ledger(Div_Code, strgrn, GRN.TransH[0].stockistFrom.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "0", "0", "", Trans_No, GRN.TransH[0].stockistFrom_Nm.ToString(), GRN.TransH[0].stockistTo.ToString(), "ISS");
                    ...
                    //                    //{
                    //                    //    int numup = prd.Update_Trans_CurrStock_Batchwise_Transfer(Div_Code, GRN.TransH[0].stockistTo.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "Good", "+");
                    //                    //    int ledInsIn = prd.Insert_Trans_Stock_Ledger(Div_Code, strgrn, GRN.TransH[0].stockistTo.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "0", "1", "", "TRS");
                    ...
                    //                    //{
                    //                    //    int numup = prd.Update_Trans_CurrStock_Batchwise_Transfer(Div_Code, GRN.TransH[0].stockistTo.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "Damage", "+");
                    //                    //    int ledInsIn = prd.Insert_Trans_Stock_Ledger(Div_Code, strgrn, GRN.TransH[0].stockistTo.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), "0", upVal.ToString("0.00"), "1", "", "TRS");
                    //                    //}
                    //                    //else
                    //                    //{
                    //                    //    int numup = prd.Insert_Trans_CurrStock_Batchwise(Div_Code, GRN.TransH[0].stockistTo.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), "0", upVal.ToString("0.00"));
                    ...
                    foreach (DataRow ul in dsUpdateLedger.Tables[0].Rows)
                    {
                        ...
                        if (ul["CalType"].ToString() == "0")
                        {
                            ...
                            {
                                num = prd.Update_Trans_CurrStock_Batchwise_Transfer1(Div_Code, ul["Dist_Code"].ToString(), ul["Prod_Code"].ToString(), ul["BatchNo"].ToString(), ul["GStock"].ToString(), "Good", "0", "+");
                            }
                            else
                            {
                                num = prd.Update_Trans_CurrStock_Batchwise_Transfer1(Div_Code, ul["Dist_Code"].ToString(), ul["Prod_Code"].ToString(), ul["BatchNo"].ToString(), ul["DStock"].ToString(), "Damage", "0", "+");
                            }
                        }
                            ...
                            if (dsCurSkt.Tables[0].Rows.Count > 0)
                            {
                                ...
                                foreach (DataRow row in dsCurSkt.Tables[0].Rows)
                                {
                                    if (GRN.TransD[i].pType_Name.ToString() == "Good")
                                    {
                                        ...
                                        int num = prd.Update_Trans_CurrStock_Batchwise_Transfer1(Div_Code, GRN.TransH[0].stockistFrom.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "Good", "0", "-");


                                        int ledIns = prd.Insert_Trans_Stock_Ledger(Div_Code, strgrn, GRN.TransH[0].stockistFrom.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "0", "0", "", tran_id, GRN.TransH[0].stockistFrom_Nm.ToString(), GRN.TransH[0].stockistTo.ToString(), "ISS");
                                    ...
                                    else
                                    {
                                        ...
                                        int num = prd.Update_Trans_CurrStock_Batchwise_Transfer1(Div_Code, GRN.TransH[0].stockistFrom.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), upVal.ToString("0.00"), "Damage", "0", "-");

                                        int ledIns = prd.Insert_Trans_Stock_Ledger(Div_Code, strgrn, GRN.TransH[0].stockistFrom.ToString(), GRN.TransD[i].pCode.ToString(), row["BatchNo"].ToString(), "0", upVal.ToString("0.00"), "0", "", tran_id, GRN.TransH[0].stockistFrom_Nm.ToString(), GRN.TransH[0].stockistTo.ToString(), "ISS");
    ...
    public static string Get_AllValues(string TransSlNo)
    {
        ...
        if (dsGoods.Tables[0].Rows.Count > 0)
        {
            ...
            //tranId = dsGoods.Tables[0].Rows[0]["Iss_No"].ToString();
