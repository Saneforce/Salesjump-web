...
public partial class MasterFiles_New_AreaList : System.Web.UI.Page
{
    string div_code;
    ...
    [WebMethod]
    public static string getfillarea(string divcode)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("exec getareaMaster '" + divcode + "'", con);
    ...
    [WebMethod]
    public static string deactivatearea(string arcode, string stat)
    {
        Stockist dv = new Stockist();
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            dsProd1 = LstDoc.getareamaster(div_code);
