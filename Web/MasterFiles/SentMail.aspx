<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="SentMail.aspx.cs" Inherits="MasterFiles_SentMail" %>
                  ...
                  <%--<span class="label label-primary pull-right">12</span></a></li>--%>
                        ...
                        <div class="col-md-9">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><i class="fa fa-envelope-o"></i> Sent</h3>
            ...
            function ReloadTable() {
                ...
                for ($i = st; $i < st + PgRecords; $i++) {
                    if ($i < Orders.length) {
                        ...
                        {
                            $("#Read_table").append("<tr><td><input type='hidden' id='hide' class='hiden' value=" + Orders[$i].Trans_Sl_No + " /><input type='checkbox' class='case'></td><td><b><a class='MailReadid' style='white-space: nowrap; width: 200px; overflow: hidden;text-overflow: ellipsis;display: block;' href='ReadSentMail.aspx?Trans_Sl_No=" + Orders[$i].Trans_Sl_No + "'>" + Orders[$i].To_SFName + "</b></a></td><td><b>" + Orders[$i].Mail_Subject + "</b></td><td><b>" + Orders[$i].MonthDateYear + "</b></td>" + "</tr>");
                        }
                        else if (Orders[$i].MailRead == 1)
                        {
                            $("#Read_table").append("<tr><td><input type='hidden' id='hide' class='hiden' value=" + Orders[$i].Trans_Sl_No + " /><input type='checkbox' class='case'></td><td><a style='white-space: nowrap; width: 200px; overflow: hidden;text-overflow: ellipsis;display: block;' href='ReadSentMail.aspx?Trans_Sl_No=" + Orders[$i].Trans_Sl_No + "'>" + Orders[$i].To_SFName + "</a></td><td>" + Orders[$i].Mail_Subject + "</td><td>" + Orders[$i].MonthDateYear + "</td>" + "</tr>");
                        }                                                    
                    }
                }
