<%@ Page Title="Channel Transfer" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master"
    CodeFile="Channel_Transfer.aspx.cs" Inherits="MasterFiles_Channel_Transfer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 $(document).ready(function () {
  ...
  $('#<%=btnchange.ClientID%>').click(function () {
                ...
                if (spec == "---Select---") { alert("Select Channel."); $('#<%=DDL_CHANNEL1.ClientID%>').focus(); return false; }
 var spec = $('#<%=DDL_CHANNEL2.ClientID%> :selected').text();
                if (spec == "---Select---") { alert("Select Channe2."); $('#<%=DDL_CHANNEL2.ClientID%>').focus(); return false; }
            });
    ...
    <div>
        <center>
            <table>
                <tr>
                    <td>
                        <asp:Label ID="Label2" runat="server" SkinID="lblMand" Text="Channel From"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" SkinID="lblMand" Text="Channel To"></asp:Label>
                    </td>
                    <td>
