<%@ Page Title="Monthly TP Plan Entry" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
    CodeFile="TourPlan_Admin.aspx.cs" Inherits="MasterFiles_TourPlan_Admin" %>
       ...
       <script type="text/javascript">
           ...
           function jsFunction() {
               ...
               $(document).ready(function(){
                ...
                $('#<%=Btn_Ok.ClientID%>').click(function () {
                 var SName = $('#<%=ddlFieldForce.ClientID%> :selected').text();
                if (SName == "---Select---") { alert("Please Select FieldForce."); $('#<%=ddlFieldForce.ClientID%>').focus(); return false; }
                 var SName1 = $('#<%=ddlMonth.ClientID%> :selected').text();
                if (SName1 == "---Select---") { alert("Please Select Month."); $('#<%=ddlMonth.ClientID%>').focus(); return false; }
                 var SName2 = $('#<%=ddlYear.ClientID%> :selected').text();
                if (SName2 == "---Select---") { alert("Please Select Year."); $('#<%=ddlYear.ClientID%>').focus(); return false; }
                  });
                ...
                $.ajax({
                    ...
                    url: "TourPlan_Admin.aspx/fillMoth",
                    ...
                    {                    
                        $.each(data.d, function (key, value) {
                            $('#<%=ddlYear.ClientID%>').val(value.Year);
                             $('#<%=ddlMonth.ClientID%>').val(value.Month);
                        });
                    }
                    else{
            ...
            <center>
                   ...
                   <%-- <tr>
                    ...
                    <tr valign="bottom">
                        <td colspan="5" align="center">
                            <asp:Label ID="lblHead" runat="server" Text="Monthly TP Plan Entry" Font-Size="Medium"
                                Font-Names="Verdana"></asp:Label>
                            <asp:Label ID="lblmon" runat="server" Font-Size="Medium" Font-Names="Verdana" ForeColor="Green"
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:Label ID="Lbl_Fld_Force" Visible="true" Font-Names="Verdana" runat="server"
                                Text="Field Force :"></asp:Label>
                            &nbsp;&nbsp
                            ...
                            <asp:DropDownList ID="ddlFieldForce" runat="server"  OnSelectedIndexChanged="ddlFieldForce_SelectedIndexChanged"
                                SkinID="ddlRequired" >
                            </asp:DropDownList>
                         ...
                         <asp:Label ID="Label2" runat="server" SkinID="lblMand" Text="Year" Visible="true"></asp:Label>
                            ...
                            <asp:ListItem Value="2020" Text="2020"></asp:ListItem>
                             ...
                             <asp:Button ID="Btn_Ok" CssClass="BUTTON" Width="60px" Height="26px" runat="server"
                                Text="GO" onclick="Btn_Ok_Click" OnClientClick="return val()"  />
                        </td>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="grdTP" runat="server" Width="85%" HorizontalAlign="Center" AutoGenerateColumns="false"
                                        GridLines="None" CssClass="mGrid" OnRowDataBound="grdTP_RowDataBound" AlternatingRowStyle-CssClass="alt">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Work Type" HeaderStyle-HorizontalAlign="Center">
                                              ...
                                              <asp:TemplateField HeaderText="FieldForce Name" HeaderStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddlFldForce" runat="server" SkinID="ddlRequired" Width="150px" 
                                                        DataTextField="sf_name" DataValueField="sf_code" onchange="ToggleOnOff(this)"
                                                        AutoPostBack="true" OnSelectedIndexChanged="select_indexchange1" Visible="false">
                                            ...
                                            <asp:TemplateField HeaderText="Distributor Name" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddldis" runat="server" SkinID="ddlRequired" Width="150px"
                    ...
                    <tr>
                        <td align="center">
                            <asp:Button ID="btnClear" CssClass="BUTTON" Width="85px" Height="26px" runat="server"
                                Text="Clear" OnClick="btnClear_Click" Visible="false" OnClientClick="return ClearValidate()" />
                            &nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnSave" CssClass="BUTTON" runat="server" Width="85px" Height="26px"
                                Text="Draft Save" OnClick="btnSave_Click" Visible="false" OnClientClick="return DraftValidateEmptyValue()" />
                            &nbsp;&nbsp;&nbsp;
                            <%--<asp:Button ID="btnSubmit" CssClass="BUTTON" Width="175px" Height="26px" runat="server"
                            Text="Send to Manager Approval" Visible="false" OnClick="btnSubmit_Click" OnClientClick="return ValidateEmptyValue()" />--%>
                            <asp:Button ID="btnApprove" CssClass="BUTTON" runat="server" Visible="false" Height="26px"
                                Width="90px" Text="Save" OnClick="btnApprove_Click" OnClientClick="return ValidateEmptyValueApprove()" />
                            &nbsp
