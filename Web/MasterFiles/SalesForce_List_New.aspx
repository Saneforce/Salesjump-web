<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="SalesForce_List_New.aspx.cs" Inherits="MasterFiles_SalesForce_List_New" %>
            ...
            <form id="frm1" runat="server">
                ...
                <div id="MyPopup" class="modal fade" role="dialog" style="z-index: 100000;">
                    <div class="modal-dialog" style="width: 80%; text-align: center; margin: auto; line-height: 0px;">
                        ...
                        <div class="modal-content">
                            ...
                            <div id="d1" style="overflow: auto; height: 558px; font-size: inherit;"></div>
                            <div class="modal-footer">
                ...
                <div class="row">
                    <div class="col-lg-12 sub-header">FieldForce<span style="float: right">
                        <a href="#" class="btn btn-primary btn-update" id="newsf">New ID Creation</a></span>
            ...
            <script language="javascript" type="text/javascript">
                ...
                function sfdeact(x) {
                    $.ajax({
                        ...
                        async: false,
                        url: "SalesForce_List_New.aspx/sfDeact",
                        data: "{'sfcode':'" + x + "'}",
                        dataType: "json",
                ...
                function loadData(sfcode) {
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SalesForce_List_New.aspx/GetList",
                ...
                function getdata() {
                    ...
                    $.ajax({
                        type: "Post",
                        contentType: "application/json; charset=utf-8",
                        url: "SalesForce_List_New.aspx/display",
                        dataType: "json",
                        success: function (data) {
                ...
                function getworkedwith($sffc) {
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SalesForce_List_New.aspx/getSFWorkedWith",
                        data: "{'sfcode':'" + $sffc + "'}",
                        dataType: "json",
                        success: function (data) {
                ...
                function getApprSFDets($appTyp) {
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SalesForce_List_New.aspx/getApprSFDets",
                ...
                function fillfilter() {
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SalesForce_List_New.aspx/getMGR",
                ...
                $(document).ready(function () {
                    ...
                    $(document).on('click', '#newsf', function () {
                        if ('<%=DBase_EReport.Global.ExpenseType%>' == '2' || '<%=Session["div_code"]%>' == '4' || '<%=Session["div_code"]%>' == '29' || '<%=Session["div_code"]%>' == '109' || '<%=Session["div_code"]%>' == '100' || '<%=Session["div_code"]%>' == '162' || '<%=Session["div_code"]%>' == '98') {
                            window.location.href = "SalesForce_ApprvHyr_New.aspx";
                        }
                        else {
                            window.location.href = "SalesForce_ApprvHyr_New.aspx";
                        }
                    ...
                    $(document).on('click', '.sfedit', function () {
                        ...
                        if ('<%=DBase_EReport.Global.ExpenseType%>' == '2' || '<%=Session["div_code"]%>' == '4' || '<%=Session["div_code"]%>' == '29' || '<%=Session["div_code"]%>' == '109' || '<%=Session["div_code"]%>' == '100' || '<%=Session["div_code"]%>' == '162' || '<%=Session["div_code"]%>' == '98') {
                            window.location.href = "SalesForce_ApprvHyr_New.aspx?sfcode=" + x;
                        }
                        else {
                            window.location.href = "SalesForce_ApprvHyr_New.aspx?sfcode=" + x;
                        }
                    ...
                    $('#svleave').on('click', function () {
                        ...
                        $.ajax({
                            ...
                            url: "SalesForce_List_New.aspx/svApprHierarchy",
                            dataType: "json",
                            success: function (data) {
                                var rmsg = data.d;
                                alert(rmsg);
                    ...
                    $('#btnsave').click(function () {
                        ...
                        $.ajax({
                            ...
                            url: "SalesForce_List_New.aspx/savedata",
                            dataType: "json",
                            success: function () {
