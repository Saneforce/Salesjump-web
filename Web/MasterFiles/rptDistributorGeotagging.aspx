<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptDistributorGeotagging.aspx.cs" Inherits="MasterFiles_rptDistributorGeotagging" %>
...
<head runat="server">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?sensor=false&key=fdbfnAAP_AIzaSyAER5hPywUW-5DRlyKJZEfsqgZlaqytxoU&libraries=geometry,places&ext=.js"></script>
        ...
        $(document).ready(function () {
            ...
            genTable = function () {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: "rptDistributorGeotagging.aspx/GetGEODistributorsOnly",
                    data: "{'SF_Code':'" + sfCode + "'}",
                    dataType: "json",
                    success: function (data) {
                        ...
                        if (dValue.length > 0) {
                            ...
                            $(tbl).find('tbody').append('<tr><td>No Records Found..!</td></tr>');
                        }
                    },
                    error: function (rs) {
                        console.log(rs);
            ...
            $(document).on('click', '#btnExcel', function (e) {
                ...
                a.download = 'GEO_Distributor.xls';
                a.click();
                e.preventDefault();
            });
            ...
            $(document).on('click', '#btnUntag', function () {
                ...
                if (confirm('Are you want Untag  Retailer..!')) {
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "rptDistributorGeotagging.aspx/untagDistributor",
                        data: "{'custCode':'" + $('#custCode').val() + "'}",
                        dataType: "json",
                        success: function (data) {
                            if (data.d == 'Sucess') {
                                alert('Sucessfully Untag Distributor..!');
                                genTable();
                                $("#dvMap").hide();
                            }
                            else {
            ...
            $(document).on('click', '#btnView', function (e) {
                ...
                var addrs = '';
                var geocodingAPI = "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + $(this).closest('tr').find('input[name="mlat"]').val() + "," + $(this).closest('tr').find('input[name="mlog"]').val() + "&key=sdfAAP_AIzaSyAER5hPywUW-5DRlyKJZEfsqgZlaqytxoU";
        ...
        <div id="dvMap">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center">
                    <div id="mapslocation" style="width: 500px; height: 400px"></div>
                </div>
            </div>
            <br />
            <div class="row">
                <div class="col-sm-5">
                    <label style="font-size: small !important">Distributor Name : </label>
