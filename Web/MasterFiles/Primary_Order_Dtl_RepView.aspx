<%@ Page Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Primary_Order_Dtl_RepView.aspx.cs" Inherits="MasterFiles_Primary_Order_Dtl_RepView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
            <title>Product Wise Primary Order Details</title>
             ...
             <script type="text/javascript">
                 $(document).ready(function () {
                     $(document).on('click', '.btnview', function () {
                         ...
                         var str = "";
                         if (div_code == "98") {
                             str = 'rptPrimary_Order_Dtl_RepView.aspx?&SFCode=' + sf_code + '&SFName=' + SFName + '&SubDiv=' + SubDivCode + "&FromDt=" + FromDt + "&ToDt=" + ToDt;
                         }
                         else {
                             str = 'rptPrimary_Order_Dtl_RepView.aspx?&SFCode=' + sf_code + '&SFName=' + SFName + '&SubDiv=' + SubDivCode + "&FromDt=" + FromDt + "&ToDt=" + ToDt;
                         }

                         window.open(str, "Primary_Order_Dtl", 'resizable=yes,toolbar=no,scrollbars=1,menubar=no,status=no,width=1100,height=700,left=0,top=0');
                     });
                                ...
                                <div class="col-md-5 inputGroupContainer">
                                    <div class="input-group" id="kk" runat="server">
                                        ...
                                        <asp:DropDownList ID="ddlFieldForce" runat="server" SkinID="ddlRequired" CssClass="form-control"
                                            Style="font-size: 17px;" Width="400">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
