<%@ Page Title="Zone List" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="ZoneList.aspx.cs" Inherits="MasterFiles_ZoneList" EnableEventValidation="false" %>
                        ...
                        <asp:GridView ID="grdSubDiv" runat="server" Width="85%" HorizontalAlign="Center"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Sub Division Code" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblsubdivCode" runat="server" Text='<%#Eval("Zone_code")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="Zone_sname" ItemStyle-Width="130px" HeaderText="Zone Code"
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <asp:TextBox ID="txtShortName" SkinID="TxtBxAllowSymb" runat="server" MaxLength="5"
                                            Text='<%# Bind("Zone_sname") %>' onkeypress="AlphaNumeric_NoSpecialChars(event);"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvsn" ControlToValidate="txtShortName" runat="server"
                                            ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblShortName" runat="server" Text='<%# Bind("Zone_sname") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="Zone_name" HeaderText="Zone Name" HeaderStyle-ForeColor="white"
                                    ItemStyle-HorizontalAlign="Left">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtSubDivName" SkinID="TxtBxAllowSymb" runat="server" MaxLength="50"
                                            onkeypress="AlphaNumeric_NoSpecialChars(event);" Text='<%# Bind("Zone_name") %>'></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvn" ControlToValidate="txtSubDivName" runat="server"
                                            ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSubDivName" runat="server" Text='<%# Bind("Zone_name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField SortExpression="Area" HeaderText="Area" HeaderStyle-ForeColor="white"
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblState" runat="server" Text='<%# Bind("Area") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:HyperLinkField HeaderText="Edit" Text="Edit" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center"
                                    DataNavigateUrlFormatString="ZoneCreation.aspx?Subdivision_Code={0}" DataNavigateUrlFields="Zone_Code">
                                ...
                                <asp:TemplateField HeaderText="Deactivate" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="140px">
                                    ...
                                    <ItemStyle ForeColor="DarkBlue" Font-Bold="False"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkbutDeactivate" runat="server" CommandArgument='<%# Eval("Zone_code") %>'
