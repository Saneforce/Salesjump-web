<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Retailer_Score_Card.aspx.cs" Inherits="MasterFiles_Retailer_Score_Card" %>
                    ...
                    <div class="col-md-6 inputGroupContainer">
                        <div class="input-group">
                            ...
                            <asp:DropDownList ID="Mode" runat="server" CssClass="form-control"
                                ...
                                <asp:ListItem Value="2" Text="Product" Selected="True"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#btnview', function () {
            ...
            if ($('#<%=ddlFieldForce.ClientID%>').val().toString() != "---Select Field Force---") {
                ...
                window.open("rpt_Retailer_Score_Card.aspx?Year=" + $('#<%=ddlFYear.ClientID%>').val() + "&Month=" + $('#<%=ddlFMonth.ClientID%>').val() + "&SF_Name=" + $('#<%=ddlFieldForce.ClientID%> :selected').text() + "&SF_Code=" + $('#<%=ddlFieldForce.ClientID%>').val() + "&Sub_Div=" + sub_div_code, "ModalPopUp", "toolbar=no," + "scrollbars=yes," + "location=no," + "statusbar=no," + "menubar=no," + "addressbar=no," + "resizable=yes," + "width=900," + "height=600," + "left = 0," + "top=0");
            }
            else {
