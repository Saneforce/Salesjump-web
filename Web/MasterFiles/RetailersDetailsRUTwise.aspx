<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RetailersDetailsRUTwise.aspx.cs" Inherits="MasterFiles_RetailersDetailsRUTwise" %>
...
<head runat="server">
 ...
 <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
    <script type="text/javascript">
        function popUp(Territory_Code, sfCode, Territory_Name) {

            strOpen = "RetailersDetailsRUTwiselist.aspx?TerritoryCode=" + Territory_Code + "&SFcode=" + sfCode + "&TerritoryName=" + Territory_Name
...
<asp:Label ID="lblsf" runat="server"></asp:Label>
    ...
    <div class="col-md-8" style="margin: 0px;">
          ...
          <div class="col-md-8" style="margin: 0px; top:60px">
            Distributer Name : <asp:Label ID="Label3" runat="server" Text="" ForeColor="Red"></asp:Label>
        </div>
        ...
        <asp:GridView ID="RetailerGrd" runat="server" AutoGenerateColumns="false" class="newStly">
            <Columns>  			       
                    ...
                    <asp:TemplateField HeaderText="Route">
                        <ItemTemplate>
                             <a href="javascript:popUp('<%# Eval("Territory_Code") %>','<%=sfCode%>','<%# Eval("Territory_Name") %>')">
                            <%# Eval("Territory_Name")%>
                        </ItemTemplate>
                    </asp:TemplateField>
