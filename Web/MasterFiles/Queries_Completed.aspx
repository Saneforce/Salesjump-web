<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Queries_Completed.aspx.cs" Inherits="MasterFiles_Queries_Completed" %>
...
<head runat="server">
   <link type="text/css" rel="stylesheet" href="../css/style.css" />
    ...
    <title>Query Completed List</title>
</head>
<body>
            ...
            <tbody>
                <tr>
                    <td colspan="2" align="center">
                        <asp:GridView ID="grdQuery" runat="server" Width="95%" HorizontalAlign="Center" OnRowDataBound="OnRowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="sf_code" HeaderStyle-ForeColor="White" Visible="false"
                                ...
                                <asp:TemplateField HeaderText="Completed Date" HeaderStyle-ForeColor="white" ItemStyle-HorizontalAlign="Left"
                                    HeaderStyle-Width="120px">
                                    <ItemTemplate>
                                        <asp:Label ID="lbldate" Width="120px" runat="server" Text='<%# Bind("Completed_Date") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                              <%--  <asp:TemplateField HeaderText="Status" HeaderStyle-ForeColor="white" HeaderStyle-Width="100px"
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkbutPending" runat="server" CommandArgument='<%# Eval("Query_Id") %>'
                                            CommandName="Deactivate" OnClientClick="return confirm('Do you want to Continue?');">Pending
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                            </Columns>
