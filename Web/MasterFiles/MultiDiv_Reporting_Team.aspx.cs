...
public partial class MasterFiles_MultiDiv_Reporting_Team : System.Web.UI.Page
{
    #region "Declaration"
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdSalesForce.Rows)
        {
            ...
            if (chksf.Checked)
            {
                isentered = true;
                SalesForce sf = new SalesForce();
                iReturn = sf.UpdateRepMgr(lblsfCode.Text.ToString(), Session["ff_code"].ToString());
            }
