<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Mas_Claim_Upload.aspx.cs" Inherits="MasterFiles_Mas_Claim_Upload" %>
                ...
                <td>
                    <table width="95%" cellpadding="5px" cellspacing="5px" style="border: 1px solid Black; background-color:White">
                       ...
                       <td align="right" style="padding-right:4px;">
                        ...
                        <tr>
                            <td align="center">
                                <asp:Button ID="Button1" runat="server"  Width="160px" Height="30px"  Text="Upload" OnClick="Button1_Click" />
                                <%--<asp:ImageButton ID="Button1" runat="server"  Width="160px" Height="30px" ImageUrl="~/Images/target-upload.png" Text="Upload" ValidationGroup="val" OnClick="btnUpload_Click" />
                               --%>
