<%@ Page Title="Stock Summary" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
    CodeFile="Stock_Summary.aspx.cs" Inherits="MasterFiles_Stock_Summary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <style type="text/css">
        ...
        #ProductTable tbody tr td:nth-child(3),#ProductTable Tbody tr td:nth-child(4)
        {
            text-align:right;
        }
    </style>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                async: false,
                url: "Stock_Summary.aspx/GetDistributor",
                dataType: "json",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Stock_Summary.aspx/GetProduct",
                dataType: "json",
                success: function (data) {
                    //console.log(data.d);
