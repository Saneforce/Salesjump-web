<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="ViewImportant.aspx.cs" Inherits="MasterFiles_ViewImportant" %>
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                     <table>
                                        <%--<tr>
                                            <td>
                                    <h3 class="box-title" id="h3inbox"><a href="MailBox.aspx"><img src="../FileImage/primary.png" />Inbox </a></h3>
                                                </td>
                                            <td><h3 class="box-title" id="h3Social"><a href="SocialMail.aspx"><img src="../FileImage/social.png" /> Social</a></h3></td>
                                            <td><h3 class="box-title" id="h3Promotions"><a href="PromotionMail.aspx"><img src="../FileImage/promotion-png.png" /> Promotions</a></h3></td>
                                            </tr>--%>                                       
                                         <tr>
                                             <td>
                                                 <h3 class="box-title" id="h3inbox"><i class="fa fa-circle-o text-red"></i> Important</h3>
                                             </td>
                                         </tr>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                // $(document).on('click', '.mailbox-star', function (e) {
                 ...
                 $(document).on('click', "#mailimportant", function (e) {
                ...
                function ReloadTable() {
                    ...
                    $("#Read_table").html("");
                    st = PgRecords * (pgNo - 1);
					 $("#Read_table").append("<tr><td></td><td></td><td><b>Team Name</b></td><td><b>Subject</b></td><td><b>Date</b></td></tr>");
                    for ($i = st; $i < st + PgRecords; $i++) {
                        if ($i < Orders.length) {
                            if (Orders[$i].MailRead == 0)
                            {
                                //$("#Read_table").append("<tr><td><input type='checkbox' class='case'></td><td id='mailimportant' title='Not Important' class='mailbox-important" + $i + "'><i class='fa fa-circle-o text-red'></i></td><input type='hidden' id='hide' class='hiden' value=" + Orders[$i].Trans_Sl_No + " /><input type='hidden' id='hideImpValue' class='hidenImpClass' value=" + Orders[$i].ImportantMessage + " /><td><b><a class='MailReadid' href='Read_Mail.aspx?Trans_Sl_No=" + Orders[$i].Trans_Sl_No + "'>" + Orders[$i].Mail_SF_From + "</b></a></td><td><b>" + Orders[$i].Mail_Subject + "</b></td><td><b>" + Orders[$i].MonthDateYear + "</b></td>" + "</tr>");
                                $("#Read_table").append("<tr><td><input type='checkbox' class='case'></td><td id='mailimportant' title='Not Important' class='mailbox-important" + $i + "'><i class='fa fa-circle-o text-red'></i></td><input type='hidden' id='hide' class='hiden' value=" + Orders[$i].Trans_Sl_No + " /><input type='hidden' id='hideImpValue' class='hidenImpClass' value=" + Orders[$i].ImportantMessage + " /><td><b><a class='MailReadid' href='Read_Mail.aspx?Trans_Sl_No=" + Orders[$i].Trans_Sl_No + "'>" + Orders[$i].Sf_Name + "</b></a></td><td><b>" + Orders[$i].Mail_Subject + "</b></td><td><b>" + Orders[$i].MonthDateYear + "</b></td>" + "</tr>");
                            }
                            else if (Orders[$i].MailRead == 1) {
                                $("#Read_table").append("<tr><td><input type='checkbox' class='case'></td><td id='mailimportant' title='Not Important' class='mailbox-important" + $i + "'><i class='fa fa-circle-o text-red'></i></td><input type='hidden' id='hide' class='hiden' value=" + Orders[$i].Trans_Sl_No + " /><input type='hidden' id='hideImpValue' class='hidenImpClass' value=" + Orders[$i].ImportantMessage + " /><td><a href='Read_Mail.aspx?Trans_Sl_No=" + Orders[$i].Trans_Sl_No + "'>" + Orders[$i].Sf_Name + "</a></td><td>" + Orders[$i].Mail_Subject + "</td><td>" + Orders[$i].MonthDateYear + "</td>" + "</tr>");
                            }
                ...
                $(document).ready(function () {
                    <%-- $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "ViewImportant.aspx/GetImportantData",
                    ...
                    if ($(".case:checked").length > 0) {
                        ...
                        $(".case:checked").each(function () {
                            ...
                            if (sellabel == "Social")
                            {
                                ...
                                var promo = 0;
                            //$('.case:checkbox:checked').parents("tr").remove();                                                       
                                data = { "ImportantMessage": Imp, "SocialMessage": selectlbl, "Promotions": promo, "Trans_Sl_No": inv_no, "DivCode": "<%=Session["div_code"]%>" }
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            async: false,
