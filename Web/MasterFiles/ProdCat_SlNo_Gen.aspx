                    ...
                    <td colspan="2" align="center">
                        <asp:GridView ID="grdProCat" runat="server" Width="50%" HorizontalAlign="Center" EmptyDataText="No Records Found"  
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="Product_Cat_SName" HeaderText="Category Code" HeaderStyle-ForeColor="white"
                                ...
                                <asp:TemplateField SortExpression="Product_Cat_Name" HeaderText="Category Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-ForeColor="white">
                                    <ItemStyle Width="20%" />
                                    <ItemTemplate>
