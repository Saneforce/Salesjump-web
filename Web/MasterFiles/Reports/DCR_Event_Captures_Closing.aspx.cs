...
public partial class MasterFiles_Reports_DCR_Event_Captures_Closing : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            string sURL = "rpt_Event_capture_Closing.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&cur_month=" + ddlMonth.SelectedValue + "&Sf_Name=" + ddlFieldForce.SelectedItem.Text + "&FDate=" + StartDate + "&TDate=" + endDate;
