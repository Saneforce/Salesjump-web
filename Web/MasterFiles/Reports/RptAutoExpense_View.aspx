<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptAutoExpense_View.aspx.cs" Inherits="MasterFiles_MR_RptAutoExpense" %>
...
<tr><td  align="right">
                                ...
                                <asp:GridView ID="expGrid" runat="server" Visible="false"  Width="40%" Font-Name="Verdana"  Font-Size="8pt" 
            HeaderStyle-BackColor="#FFEFD5"
            HeaderStyle-ForeColor="black" HorizontalAlign="Center"
                                AutoGenerateColumns="false" EmptyDataText="No Records Found" GridLines="None"
                                PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
...
<br />
 <table border="0" width="500px" align="center" id="tableId" runat="server" visible="false">

                             <tr>                                
                                <td class="tblHead" style="width:250px;"><b>Particulars</b></td>
                            ...
                            <tr>
                                <td><input type='text' value='' name='tP' size="50" maxlength='50' class='textbox' onkeypress='_fNvALIDeNTRY("-o-!!~~,",50)' onkeydown='if(event.shiftKey==true && event.keyCode==9){this.parentNode.previousSibling.focus();return false}' style="width:90%;height:19px" /></td>
                                <td>
                        ...
                        <asp:ListItem Selected="false" Text="-" Value="0"></asp:ListItem>
                                ...
                                <td><input type='text' value='' name='tAmt' maxlength='50' onkeypress='_fNvALIDeNTRY("D",7)' onkeyup='adminAdjustCalc(this,0);' class='textbox' style="width:90%;height:19px;text-align:right" />
							
                                 </td>
								<td><input type="button" value=" + " class='btnSave' onclick="_AdRowByCurrElem(this)" /></td>
...
<br />
        ...
        <asp:Button ID="btnDrftSave" runat="server" CssClass="BUTTON" Width="80px" Height="25px"
            ...
            Text="Process" Visible="false" OnClientClick="saveOtherExp()" OnClick="btnSave_Click" />
                    <asp:Button ID="bakfldfrce" runat="server" CssClass="BUTTON" Width="130px" Height="25px"
            Text="BacK To FieldForce" Visible="false" OnClientClick="saveOtherExp()" OnClick="btnField_Click" />
    </center>
