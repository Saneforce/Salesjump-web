...
<body>
	...
	<div class="w3-container">
             <div id="auditag" class="w3-modal">
                <div class="w3-modal-content" style="width: 500px;height: 150px;">
                    <div class="w3-container">
                        <div id="conten" style="padding: 2px;margin-left:50px;">
                            <button type="button" style="float:right;padding:5px;background: red;color: white;" onclick="pausefile()">x</button><br />
                        <label>Songname    :</label><input type="text" readonly="readonly" id="songnames" /><br /><br />
                        <audio id="listenaud" controls="controls"></audio>
                            </div>
                    </div>
                </div>
            </div>
        ...
        function openvoicelis(aud) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    document.getElementById('auditag').style.display = 'block' 
                    $("#songnames").val(audio);
                    const audioElement = document.getElementById("listenaud");                                                     
                    const newAudioSource = 'AudFiles/'+aud+'';             
                    audioElement.src = newAudioSource;                   
                    audioElement.load(); 
                    audioElement.play();         
                },
        ...
        function pausefile() {
            $.ajax({
                ...
                success: function (data) {
                    su = data.d;
                    if (su == "Success") {
                        document.getElementById('auditag').style.display = 'none';
                    }
                    else {
