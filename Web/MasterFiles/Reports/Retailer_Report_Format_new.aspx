<%@ Page Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Retailer_Report_Format_new.aspx.cs" Inherits="MasterFiles_Reports_Retailer_Report_Format_new" %>
    ...
    <script type="text/javascript">
        ...
        $('#btnsubmit').on('click', function () { 
           ...
           // var mod = '<%=Mode%>';
            ...
            if (mod == "SKU Summary") {
                var sURL = "tsr/rptSKU_Summarys_rep1.aspx?sf_code=" + sf + "&div_code=" + <%=div_code%> +
                ...
                sURL = "tsr/viewpromotion.aspx?sf_code=" + sf + "&div_code=" + <%=div_code%> + "&Mode=" + mod + "&Sf_Name=" + sfn + "&FDate=" + fdt + "&TDate=" + tdt
                    + "&Dst_name=" + distrunm + "&Dst_code=" + distru + "&st_name=" + statn + "&st_code=" + stat;
                window.open(sURL, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
			...
			<%--else if (mod == "TP MY Day Plan") {
			    ...
			    sURL = "tsr/Retailwise_sales_report.aspx?sf_code=" + sf + "&div_code=" + <%=div_code%> +
                    "&Mode= " + mod + "&Sf_Name=" + sfn + "&FDate=" + fdt + "&TDate=" + tdt
                    + "&Dst_name=" + distrunm + "&Dst_code=" + distru + "&st_name=" + statn + "&st_code=" + stat;
                window.open(sURL, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
			    ...
			    sURL = "tsr/Retailwise_closing_report.aspx?sf_code=" + sf + "&div_code=" + <%=div_code%> +
                    "&Mode= " + mod + "&Sf_Name=" + sfn + "&FDate=" + fdt + "&TDate=" + tdt
                    + "&Dst_name=" + distrunm + "&Dst_code=" + distru + "&st_name=" + statn + "&st_code=" + stat;                 
                window.open(sURL, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
			    ...
			    sURL = "tsr/Rpt_Retailer_Tag_Status.aspx?sf_code=" + sf + "&div_code=" + <%=div_code%> +
                    "&Mode= " + mod + "&Sf_Name=" + sfn + "&FDate=" + fdt + "&TDate=" + tdt
                    + "&Dst_name=" + distrunm + "&Dst_code=" + distru + "&st_name=" + statn + "&st_code=" + stat;                 
                window.open(sURL, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
			    ...
			    sURL = "tsr/Rpt_DCR_Event_Captures_View.aspx?sf_code=" + sf + "&div_code=" + <%=div_code%> +
                    "&Mode= " + mod + "&Sf_Name=" + sfn + "&FDate=" + fdt + "&TDate=" + tdt
                    + "&Dst_name=" + distrunm + "&Dst_code=" + distru + "&st_name=" + statn + "&st_code=" + stat+ "&mode_identi=" + ddlevent;                 
                window.open(sURL, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');            
            }
            else {
			    sURL = "tsr/Rpt_DCR_View.aspx?sf_code=" + sf + "&div_code=" + <%=div_code%> +
                    "&Mode= " + mod + "&Sf_Name=" + sfn + "&FDate=" + fdt + "&TDate=" + tdt
                    + "&Dst_name=" + distrunm + "&Dst_code=" + distru + "&st_name=" + statn + "&st_code=" + stat;
                window.open(sURL, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
