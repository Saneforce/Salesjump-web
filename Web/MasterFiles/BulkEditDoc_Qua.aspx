...
<head id="Head1" runat="server">
    <title>Bulk Edit - Customer Qualification</title>
        <style type="text/css">
            .modal
    {
        position: fixed;
            ...
            <tbody>               
                <tr>
                    <td colspan="2" align="center">
                        ...
                        <asp:GridView ID="grdDocQua" runat="server" Width="30%" HorizontalAlign="Center" EmptyDataText="No Records Found" 
                            ...
                            <Columns>                
                              ...
                              <%--  <asp:TemplateField HeaderText="Short Name" ItemStyle-HorizontalAlign="Left">
                                ...
                                <asp:TemplateField HeaderText="Qualification Name">
                                     <ItemTemplate>
                                        <asp:TextBox ID="txtDocQuaName"  SkinID="TxtBxAllowSymb" onkeypress="AlphaNumeric_NoSpecialChars(event);" runat="server" MaxLength="100" Text='<%# Bind("Doc_QuaName") %>'></asp:TextBox>
                                     </ItemTemplate>
                                </asp:TemplateField>                                       
                            </Columns>
