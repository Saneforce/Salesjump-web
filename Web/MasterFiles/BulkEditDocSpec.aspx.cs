...
public partial class MasterFiles_BulkEditDocSpec : System.Web.UI.Page
{
    #region "Declaration"
    ...
    private void FillDocSpe()
    {
        ...
        dsDocCat = dv.getDocSpe(div_code);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdDocCat.Rows)
        {
            ...
            iReturn = dv.RecordUpdateDocSpl(Convert.ToInt16(doc_cat_code), doc_cat_sname, doc_cat_name,div_code);
        ...
        if (err == false) 
        {
           // menu1.Status = "Doctor Speciality(s) have been updated Successfully";
        ...
        else if (err == true)
        {
            ...
            if (iReturn == -2)
            {
                ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>alert('Speciality Name Already Exist');</script>");
