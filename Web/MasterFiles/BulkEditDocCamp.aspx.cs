...
public partial class MasterFiles_BulkEditDocCamp : System.Web.UI.Page
{
    #region "Declaration"
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdDocCat.Rows)
        {
            ...
            iReturn = dv.RecordUpdateSubCat(Convert.ToInt16(doc_cat_code), doc_cat_sname, doc_cat_name,div_code);
