<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Promote.aspx.cs" Inherits="MasterFiles_Promote" %>
<%@ Register Src ="~/UserControl/MenuUserControl.ascx" TagName ="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Map Reporting Structure</title>
        ...
        <ucl:Menu ID="menu1" runat="server" /> 
           ...
           <table width="100%" align="center">
            <tbody>               
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>
                     <asp:Label ID="lblHeader" runat="server" Font-Size="Small"  Visible ="false" Font-Names="Bookman Old Style"  Font-Underline ="true"  ForeColor ="DarkViolet" ></asp:Label>
                    </td>
                 </tr>
                 <tr>
                    <td colspan="2" align="center">
                        <asp:GridView ID="grdSalesForce" runat="server" Width="85%" HorizontalAlign="Center" 
                            ...
                            <Columns>                
                                ...
                                </asp:TemplateField>  <asp:TemplateField SortExpression="Sf_UserName" HeaderText="User Name" HeaderStyle-ForeColor="white">
                                        <ControlStyle Width="90%"></ControlStyle>
                                ...
                                <asp:TemplateField HeaderText="Reporting To">
                                    ...
                                    <ItemStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black" HorizontalAlign="Left"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddlReporting_To" runat="server" DataSource ="<%# Fill_Reporting_To() %>" DataTextField="Sf_Name" DataValueField="sf_code">                                           
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                </asp:TemplateField>                                       
                            </Columns>
           ...
           <table width="100%" align="center">
            <tbody>               
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>
                     <asp:Label ID="lblHeader_Mgr" runat="server" Font-Size="Small"  Visible ="false" Font-Names="Bookman Old Style"  Font-Underline ="true"  ForeColor ="DarkViolet" ></asp:Label>
                    </td>
                 </tr>
                 <tr>
                    <td colspan="2" align="center">
                        <asp:GridView ID="grdSalesForce_Mgr" runat="server" Width="85%" HorizontalAlign="Center" 
                            onrowdatabound="grdSalesForce_Mgr_RowDataBound"
                            AutoGenerateColumns="false" GridLines="None" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
                            <HeaderStyle Font-Bold="False" />
                            <PagerStyle CssClass="pgr"></PagerStyle>
                            <SelectedRowStyle BackColor="BurlyWood"/>
