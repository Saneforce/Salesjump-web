<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JointWk_Analysis.aspx.cs" Inherits="MasterFiles_AnalysisReports_JointWk_Analysis" %>
...
<head runat="server">
    <title>Joint Work Analysis</title>
      <style type="text/css">
         .padding
        {
            padding:3px;
    ...
    td.stylespc
     ...
     <script type="text/javascript">
         ...
         function showModalPopUp(sfcode, fmon, fyr, tyear, tmonth, sf_name) {
             ...
             popUpObj = window.open("rptJointWk_Analysis.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &To_year=" + tyear + " &To_Month=" + tmonth + " &sf_name=" + sf_name,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
   ...
   <div id="Divid" runat="server">
    ...
    <center>
          <table>
                ...
                <tr>
                    <td align="left">
                        <asp:Label ID="lbMode" SkinID="lblMand"
                            runat="server" Text="Mode"></asp:Label>
                    </td>
               
                <td align="left">
                       <asp:DropDownList ID="ddlmode" runat="server" SkinID="ddlRequired" 
                          >
                       <asp:ListItem Value="0" Selected="True" Text="Based on MR - DCR"></asp:ListItem>
                       <asp:ListItem Value="1"  Text="Based on MGR - DCR"></asp:ListItem>
                       </asp:DropDownList>
                    </td>
                </tr>
            </table>
