...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, sf_name) {
            ...
            popUpObj = window.open("rptFieldwork_Analysis.aspx?sf_code=" + sfcode + "&Frm_Month=" + fmon + "&Frm_year=" + fyr + " &sf_name=" + sf_name,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
        ...
        <center>
            <table>
                ...
                <tr>
                    ...
                    <td align="left" class="stylespc">
                        <asp:DropDownList ID="ddlFrmYear" runat="server" Width="90px" SkinID="ddlRequired">
