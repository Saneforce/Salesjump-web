        ...
        <table width="90%">
            <tr>
                ...
                <td align="left">
                    ...
                    &nbsp;
                    <asp:Button ID="btnView" runat="server" CssClass="BUTTON" Width="70px" Height="25px"
                        Text="View" OnClick="btnView_Click" />
                    &nbsp;
                    <asp:Button ID="btnReactivate" runat="server" CssClass="BUTTON" Width="120px" Height="25px"
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:DataList ID="dlAlpha" RepeatDirection="Horizontal" OnItemCommand="dlAlpha_ItemCommand"
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnAlpha" Font-Names="Calibri" Font-Size="14px" ForeColor="#8A2EE6"
