<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="view_taluk.aspx.cs" Inherits="MasterFiles_view_taluk" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form runat="server">
        <div class="row" style="margin-bottom: 1rem;">
           ...
           <div class="col-lg-12 sub-header">Taluk Master<span style="float: right"><a href="Talukcreation.aspx" class="btn btn-primary btn-update" id="newsf">Add Taluk  </a></span></div>
        </div>
                ...
                <table class="table table-hover" id="OrderList" style="font-size: 12px">
                    <thead class="text-warning">
                        <tr style="background-color: #37a4c6; color: #fff; white-space: nowrap;">
                            ...
                            <th style="text-align: left; color: #fff;">Taluk Code</th>
                            <th style="text-align: left; color: #fff">Taluk Name</th>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function filldist() {
            $.ajax({
                ...
                async: false,
                url: "view_taluk.aspx/getfilldist",
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.roedit', function () {
                ...
                window.location.href = "Talukcreation.aspx?twncode=" + route_C + "";
            });
            $(document).on("click", ".rodeact", function () {
                var route_C = $(this).closest('tr').attr('rocode');
                let oindex = Orders.findIndex(x => x.TownCode == route_C);
                ...
                if ((rocnt < 1 && flg == 1) || (flg == 0)) {
                    if (confirm("Do you want " + disstat + " the Distributor ?")) {
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            async: false,
                            url: "view_taluk.aspx/deactivatedist",
