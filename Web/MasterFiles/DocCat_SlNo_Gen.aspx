...
<head runat="server">
    <title>Customer Category Serial No Generation</title>
                        ...
                        <asp:GridView ID="grdDocCat" runat="server" Width="50%" HorizontalAlign="Center" EmptyDataText="No Records Found" 
                            ...
                            <Columns>                
                              ...
                              <%--  <asp:BoundField DataField="Doc_Cat_Code" ShowHeader="true" HeaderText="DR Cat Code"  ItemStyle-Width="7%"  />--%>
                                <asp:BoundField DataField="Doc_Cat_SName" SortExpression="Doc_Cat_SName" ItemStyle-HorizontalAlign="Left" HeaderStyle-ForeColor="white" ShowHeader="true" HeaderText="Short Name" ItemStyle-Width="10%" />
                                <asp:BoundField DataField="Doc_Cat_Name" SortExpression="Doc_Cat_Name" ItemStyle-HorizontalAlign="Left" HeaderStyle-ForeColor="white" ShowHeader="true" HeaderText="Category Name"  ItemStyle-Width="20%"/>
