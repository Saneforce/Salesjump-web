<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Report.aspx.cs"
    Inherits="MIS_Reports_Visit_Details_Report" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, cmode) {
            ...
            popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&cMode=" + cmode,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
    ...
    <div>
        ...
        <center>
            ...
            <asp:Table ID="tbl" runat="server" BorderStyle="Solid" BorderWidth="1" GridLines="Both"
                Style="border-collapse: collapse; border: solid 1px Black;" Width="95%">
            </asp:Table>
