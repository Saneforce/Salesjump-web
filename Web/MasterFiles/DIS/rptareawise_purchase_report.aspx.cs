...
stCrtDtaPnt+="{label:\""+ drFF["Area_Name"].ToString()+"\",y:";
                ...
                //hq
                sURL = "rptzonewise_purchase_report.aspx?Area_Code=" + drFF["Area_code"] + "&Area_name=" + drFF["Area_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.areawise_purchase_value(drFF["Area_code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            sURL = "rpt_areawise_product_detail.aspx?Area_Code=" + drFF["Area_Code"] + "&Area_name=" + drFF["Area_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + " &sCurrentDate=" + sCurrentDate + "";
