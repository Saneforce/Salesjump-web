...
using Bus_EReport;
using System.Net;
public partial class MIS_Reports_rpt_trend_analysis : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Trend Analysis Details for  " + strFMonthName + " " + FYear ;
       
        //string st=theDate.ToString("yyyy-MM-dd")
        //DateTime dtt = Convert.ToDateTime(year + "-" + mnth.ToString() + "-" + t.ToString());
        //Response.Write(st);
       ...
       //Random rndm = new Random();
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                dsDoc = sf.Trend_analysis_stockist(drFF["Stockist_Code"].ToString(), divcode, st);
                ...
                dsDoc = sf.Trend_analysis_currentmonth(drFF["Stockist_Code"].ToString(), divcode, FYear, FMonth);
                ...
                //        dsDoc = sf.lost_Purchase_value_stockist(drFF["Stockist_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
