<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listeddr_adm_deAct_Approval.aspx.cs" Inherits="MasterFiles_MGR_Listeddr_adm_deAct_Approval" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>Listed Customer DeActivation - Approval</title>
...
<body>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:GridView ID="grdDoctor" runat="server" Width="85%" HorizontalAlign="Center" EmptyDataText="No Records Found"
                            ...
                            OnRowCreated="grdDoctor_RowCreated"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Listed Customer Name" HeaderStyle-ForeColor="Black" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
  ...
  <br />
  <center>
        <asp:Button ID="btnApprove" runat="server" CssClass="BUTTON" Text="Approve - Deactivate Lst.Drs" OnClick="btnApprove_Click" Visible="false" />&nbsp;
        <asp:Button ID="btnReject" runat="server" CssClass="BUTTON" Text="Reject - Add Lst.Drs" OnClick="btnReject_Click" Visible="false" />
        </center>
