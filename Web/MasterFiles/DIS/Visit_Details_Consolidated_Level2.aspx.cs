...
public partial class MIS_Reports_Visit_Details_Consolidated_Level2 : System.Web.UI.Page
{
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        RoundCallCoverage = Math.Round((decimal)dblCoverage, 2);

                        TableCell tc_det_coverage = new TableCell();
                        Literal lit_det_coverage = new Literal();
                        lit_det_coverage.Text = "&nbsp;" + RoundCallCoverage.ToString();
                        ...
                        lit_det_average.Text = "&nbsp;" + RoundCoverage.ToString();
