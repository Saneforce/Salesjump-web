...
public partial class MIS_Reports_rpt_areawise_product_detail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblProd.Text = "Purchase Register Areawise Product Detail  for the Period of " + strMonthName + " " + Year + " ";
    ...
    private void CreateDynamicTable()
    {
        ...
        dsDr = dr.areawise_purchase_productdetail(div_code, areacode, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate);
