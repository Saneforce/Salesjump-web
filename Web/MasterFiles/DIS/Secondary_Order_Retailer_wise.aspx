<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Secondary_Order_Retailer_wise.aspx.cs" Inherits="MIS_Reports_Secondary_Order_Retailer_wise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Purchase Register- Retailer Wise</title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                    ...
                    <asp:Label ID="lblHead" Text="Purchase Register-Retailer Wise" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
    ...
    <div>
        ...
        <div>
            ...
            <asp:Label ID="DistributorName" runat="server" Text="Distributor Name" 
                ...
                <asp:Label ID="dist" runat="server" Font-Size="12px" Font-Underline="false" ></asp:Label></td></tr></table>
            <br />
