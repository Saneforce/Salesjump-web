<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Secondary_Sales_View.aspx.cs" Inherits="MIS_Reports_Secondary_Sales_View" %>
<%@ Register Src="~/UserControl/DIS_Menu.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Secondary Sales-View</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(fmon, fyr,dis_name,subdiv,distributor) {
            ...
            popUpObj = window.open("rpt_Secondary_Sales_View.aspx?FMonth=" + fmon + "&FYear=" + fyr +"&Dist_Name=" + dis_name +"&subdivision=" + subdiv +"&Distributor="+distributor,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
...
<body>
    ...
    <tr><td> <asp:Label ID="Label2" runat="server" SkinID="lblMand" Text="Select Division" Visible="false"></asp:Label></td><td align="left">
                   <asp:DropDownList ID="subdiv" runat="server" SkinID="ddlRequired" CssClass="ddl"  AutoPostBack="true" onselectedindexchanged="subdiv_SelectedIndexChanged" Visible="false">
                   </asp:DropDownList>
               </td></tr>
 <tr><td> <asp:Label ID="Label1" runat="server" SkinID="lblMand" Text="Select Distributor" Visible="false"></asp:Label></td><td align="left">
                   <asp:DropDownList ID="Distributor" runat="server" SkinID="ddlRequired" CssClass="ddl" Visible="false">
 <asp:ListItem Value="0" Text="---Select---"></asp:ListItem>
                   </asp:DropDownList>
               </td></tr>
