    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (FYear <= TYear)
            {
                ...
                sURL = "rpt_retail_statewise_report.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString();
