...
using System.Data;
using Bus_EReport;
public partial class MIS_Reports_Visit_Details_Consolidated : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        FillColor();
        //btnGo.Attributes.Add("onclick", "javascript:showModalPopUp('" + ddlFieldForce.SelectedValue.ToString() + "', '" + ddlFMonth.SelectedValue.ToString() + "', '" + ddlFYear.SelectedValue.ToString() + "', '" + ddlTMonth.SelectedValue.ToString() + "', '" + ddlTYear.SelectedValue.ToString() + "', '" + ddlMode.SelectedValue.ToString() + "')");
    }
    ...
    //    {
    //        ClientScript.RegisterStartupScript(GetType(), "Meassage", "<SCRIPT LANGUAGE='javascript'>alert('To Month must be greater than From month');</script>");
    //        ddlTMonth.Focus();
    //    }
    //    else if (FYear > TYear)
    //    {
    ...
    //                {
    //                    sURL = "Visit_Details_Consolidated_Level1.aspx?sfcode=" + ddlMR.SelectedValue.ToString() + "&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&cMode=" + ddlMode.SelectedValue.ToString();
    //                }
    //                else
    //                {
    //                    sURL = "Visit_Details_Consolidated_Level1.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&cMode=" + ddlMode.SelectedValue.ToString();
    //                }
    //            }
    //            else
    //            {
