...
public partial class MasterFiles_TerritoryCreation : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (dsTerritory.Tables[0].Rows.Count > 0)
            {
                c3.Title = dsTerritory.Tables[0].Rows[0]["wrk_area_Name"] + " " + "Creation";
            }
        }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdTerritory.Rows)
        {
            ...
            Territory_Type = Territory_DisName.SelectedValue.ToString();
             ...
             if ((Territory_Name.Trim().Length > 0)  && (Territory_Type.Trim().Length > 0))
            {
                 ...
                 iReturn = terr.RecordAdd(Territory_Code, Territory_Name, Territory_Type, Session["sf_code"].ToString(), Target, min_prod,div_code);
            }
            else
            {
