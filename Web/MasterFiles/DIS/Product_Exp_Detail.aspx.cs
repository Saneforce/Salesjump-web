...
public partial class MIS_Reports_Product_Exp_Detail : System.Web.UI.Page
{
        ...
        else
        {
            if (FYear <= TYear)
            {
                ...
                if (ddlprod.SelectedValue != "-1")
                {
                    ...
                    {
                        sURL = "rptProduct_Exp_Detail.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&Prod=" + ddlprod.SelectedValue.ToString() + "&Prod_Name=" + ddlprod.SelectedItem.Text.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString();
                    }
                    else
                    {
                        sURL = "rptProduct_Exp_Detail.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&Prod=" + ddlprod.SelectedValue.ToString() + "&Prod_Name=" + ddlprod.SelectedItem.Text.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString();
                ...
                else
                {
                    ...
                    if (ddlprod.SelectedIndex > 0)
                    {
                        ...
                        else
                        {
                            ...
                            sURL = "rptProduct_Exp_Detail.aspx?sfcode=" + ddlMR.SelectedValue.ToString() + "&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&Prod=" + ddlprod.SelectedValue.ToString() + "&Prod_Name=" + ddlprod.SelectedItem.Text.ToString() + "&sf_name=" + ddlMR.SelectedItem.Text.ToString();
                        }
                    }
                    else
                    {
