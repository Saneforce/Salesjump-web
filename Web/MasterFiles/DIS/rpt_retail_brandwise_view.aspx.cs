...
using Bus_EReport;
using System.Net;
public partial class MIS_Reports_rpt_retail_brandwise_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //FillProd();
            lblProd.Text = "Retail Register Brand wise for the Period of " + strMonthName + " " + Year + " ";
    ...
    private void CreateDynamicTable()
    {
        ...
        if (type == "1")
        {
            dsDr = dr.retail_register_brandwisedetail_categorywise_stockist(div_code, Brand, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate, catcode, stockist_code);
        }

        if (type == "2")
        {
            dsDr = dr.retail_register_brandwisedetail_categorywise(div_code, Brand, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate, catcode, stockist_code);
        }
