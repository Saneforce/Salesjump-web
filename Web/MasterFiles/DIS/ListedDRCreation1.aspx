<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListedDRCreation1.aspx.cs"
...
<head runat="server">
    <title>Listed Retailer Creation</title>
            ...
            <asp:Table ID="Table1" runat="server" BorderStyle="Solid" Width="850px" BorderWidth="1"
                ...
                <asp:TableRow>
                    <asp:TableCell BorderWidth="1" HorizontalAlign="Left">
                        <asp:Label ID="lblListed" runat="server" Text="No of Listed Retailer - " SkinID="lblMand"></asp:Label>
                        <asp:Label ID="lblDrcount" runat="server" ForeColor="Red" Font-Bold="true"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell BorderWidth="1" HorizontalAlign="Left">
                        <asp:Label ID="lblappcnt" runat="server" Text="Listed Retailer Approval Pending - "
                            SkinID="lblMand"></asp:Label>
                        <asp:Label ID="lblapp" runat="server" ForeColor="Red" Font-Bold="true"></asp:Label></asp:TableCell>
                    <asp:TableCell BorderWidth="1" HorizontalAlign="Left">
                        <asp:Label ID="lblListeddr" runat="server" Text="Lst Retailer Deactivation Pending - "
                            SkinID="lblMand"></asp:Label>
                        ...
                        <asp:GridView ID="grdListedDR" runat="server" Width="85%" HorizontalAlign="Center"
                            ...
                            <Columns>
                              ...
                              <asp:TemplateField HeaderText="Code" HeaderStyle-HorizontalAlign="Center">
                                ...
                                <asp:TemplateField HeaderText="Listed Retailer Name" HeaderStyle-HorizontalAlign="Center">
                               ...
                               <%-- <asp:TemplateField HeaderText="Category" HeaderStyle-HorizontalAlign="Center">
                                ...
                                <asp:TemplateField HeaderText="Retailer Type" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
