...
stCrtDtaPnt+="{label:\""+ drFF["Territory_Name"].ToString()+"\",y:";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Territorywise_purchase_value(drFF["Territory_code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            sURL = "rpt_territorywise_product_detail.aspx?Territory_code=" + drFF["Territory_code"] + "&Territory_Name=" + drFF["Territory_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + " &sCurrentDate=" + sCurrentDate + "";
