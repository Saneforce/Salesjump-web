...
public partial class MIS_Reports_Top10_Exception : System.Web.UI.Page
{
   string div_code = string.Empty;
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        sURL = "rpttop10_exception.aspx?FYear=" + ddlFYear.SelectedValue.ToString() + "&viewby=" + viewdrop.SelectedItem.Text + "&viewtop=" + topdrop.SelectedItem.Text;
