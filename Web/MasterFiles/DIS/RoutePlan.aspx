...
<body>
    ...
    <ucl:Menu ID="menu1" runat="server" />
        ...
        <asp:Panel ID="pnlMain" runat="server" BorderStyle="Solid" BorderWidth="1" Width="90%" style="left:10px; top:130px; height:550px; position:absolute;">
        
        <table  width="15%">
          <tr>
                <td align ="center" >
                    <asp:Label ID="lblmon" runat="server"  Visible ="false" 
                        Font-Size="Small"   Font-Name="TimesNewRoman"  ForeColor = "Navy" ></asp:Label>
                    <asp:Label ID="lblHead" runat="server" Text="  Missed Doctor(s)  in Plan" Visible = "false" 
                        Font-Size="Small"  Font-Name="TimesNewRoman"  ForeColor = "Navy" ></asp:Label>
                       <%--  <asp:linkbutton ID="lnkReset" runat="server" Text="Reset Missed Doctor Plan" 
        ...
        <table style="width:100%">
            <tr>
                <td style="width:20%;">
                    <asp:Panel ID="pnlGiftUnlst" runat="server" Width="15%" style="left:20px; top:30px; height:500px; position:absolute;" BorderStyle="Solid" BorderWidth="1" ScrollBars="Vertical">
                        <table>
                            <tr>
                                <td>
                                    <asp:GridView ID="grdTerritory" runat="server" Width="100%" Height="100%" HorizontalAlign="Center" 
                                        AutoGenerateColumns="false"  onrowdatabound="grdTerritory_RowDataBound"
                                        OnRowCommand="grdTerritory_RowCommand" RowStyle-Height="20px" GridLines="None" CssClass="mGridImg" >
                ...
                <td style="width:60%;" valign="top" align ="center">
                    ...
                    style="left:500px; top:230px; width:32%; position:absolute;" Text="Please select any Route Plan from the Route Plan List...." Font-Size="Medium" BackColor="#FFFF99"></asp:Label>
                    <asp:Panel ID="pnlDoctor" runat="server" BorderStyle="Solid" BorderWidth="1" visible="false" style="left:220px; top:30px; width:55%; position:absolute;">
                        <table>
                            <tr>
                            <td align = "center" >
                            ...
                            <tr>
                                <td align="center">
                                    <asp:GridView ID="grdDoctor" runat="server" Width="98%" Height="100%" HorizontalAlign="Center" 
                            ...
                            <tr>
                                <td align="center">
                                    <asp:Button ID="btnSubmit" runat="server" Width="70px" Height="25px" Text="Update" CssClass="BUTTON"
...
--%>                    </asp:Panel>
                ...
                <td style="width:50%;">
                    <asp:Panel ID="pnlMove" runat="server" BorderStyle="Solid" BorderWidth="1" Visible="false" style="left:900px; top:30px; width:300px; position:absolute;">
                        <table>

                            <tr>
                                <td align="center">
                                    <asp:Label ID="lblTerr" runat="server" Text="Route Plan" SkinID="lblMand" ></asp:Label>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GrdCopyMove" runat="server" Width="100%" Height="100%" HorizontalAlign="Center" 
                                        AutoGenerateColumns="false" RowStyle-Height="20px" GridLines="None" CssClass="mGridImg" onrowdatabound="GrdCopyMove_RowDataBound"
                                        >
                                        <HeaderStyle Font-Bold="False" />
                                        <SelectedRowStyle BackColor="BurlyWood"/>
                                        <AlternatingRowStyle CssClass="alt"></AlternatingRowStyle>
