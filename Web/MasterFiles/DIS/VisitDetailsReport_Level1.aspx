<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VisitDetailsReport_Level1.aspx.cs" Inherits="MIS_Reports_VisitDetailsReport_Level1" %>
...
<script type = "text/javascript">
    ...
    function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, cmode) {
        popUpObj = window.open("VisitDetailsReport_Level2.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&cMode=" + cmode,
    "ModalPopUp_Level1",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
