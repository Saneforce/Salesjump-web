<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Basedonvisit_Level4.aspx.cs" Inherits="MIS_Reports_Visit_Details_Basedonvisit_Level4" %>
...
<script type = "text/javascript">
    ...
    function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, cmode) {
        popUpObj = window.open("Visit_Details_Basedonvisit_Level4.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&cMode=" + cmode,
    "ModalPopUp_Level4",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
