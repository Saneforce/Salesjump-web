<%@ Page Language="C#" AutoEventWireup="true" CodeFile="retail_lost_purchase.aspx.cs" Inherits="MIS_Reports_retail_lost_purchase" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, code) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rpt_retail_lost_purchase.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&dist_code=" + code,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
           ...
           <br />
             <table >
               ...
               <tr>
                   ...
                   <tr><td  > <asp:Label ID="seldist" runat="server"  Text="Select Distributor"  Width="110px"  SkinID="lblMand" Font-Bold="False" Height="26px"></asp:Label></td><td align="center">
                   <asp:DropDownList ID="Distributor" runat="server" SkinID="ddlRequired" CssClass="ddl">
                   </asp:DropDownList>
               </td></tr>                    
             </table>
