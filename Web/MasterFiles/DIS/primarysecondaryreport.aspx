<%@ Page Language="C#" AutoEventWireup="true" CodeFile="primarysecondaryreport.aspx.cs" Inherits="MIS_Reports_primarysecondaryreport" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp( fmon, fyr, tmon, tyr, stockist_code,stockist_name) {
            //popUpObj = window.open("VisitDetailsReport_Level1.aspx?sfcode=" + sfcode + "&cmon=" + cmon + "&cyr=" + cy,
            popUpObj = window.open("rpt_primary_vs_secondary.aspx?FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&scode=" + stockist_code+"&stockist_name=" + stockist_name,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
