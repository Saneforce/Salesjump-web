<%@ Page Title="Sale Register-Distributor Wise" Language="C#" AutoEventWireup="true" CodeFile="Sales_Distributor_Wise.aspx.cs" Inherits="MIS_Reports_Sales_Distributor_Wise" %>
<%@ Register Src="~/UserControl/DIS_Menu.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Sale Register-Distributor Wise</title>
  ...
  function showModalPopUp(sfcode, fmon, fyr,subdiv,tmon, tyr) {
            popUpObj = window.open("rpt_sales_register_distributor_wise.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&subdivision="+subdiv+"&TMonth=" + tmon + "&TYear=" + tyr,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
               ...
               <tr>
                   <td align="left" class="stylespc">
                    ...
                    <td align="left">
                        ...
                        <asp:Label ID="lblTYear" runat="server" SkinID="lblMand" Text=" Year" style="text-align:center" Width="60"></asp:Label>
                      ...
                      <tr><td> <asp:Label ID="Label2" runat="server" SkinID="lblMand" Text="Select Division" Visible="false"></asp:Label></td><td align="Center">
                   <asp:DropDownList ID="subdiv" runat="server" SkinID="ddlRequired"  AutoPostBack="true"
                       CssClass="ddl" Visible="false" >
                   </asp:DropDownList>
               </td></tr>                    
             </table>
