...
public partial class MIS_Reports_rpt_zonewise_product_detail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblProd.Text = "Purchase Register Zonewise Product Detail  for the Period of " + strMonthName + " " + Year + " ";
    ...
    private void CreateDynamicTable()
    {
        ...
        dsDr = dr.zonewise_purchase_productdetail(div_code, zonecode, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate);
