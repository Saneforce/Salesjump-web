...
public partial class MIS_Reports_rpt_retail_zonewise_report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retail Register -Zone Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
string stCrtDtaPnt = string.Empty;
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            lit_DR_Name.Text = "<center>Zone </center>";
...
stCrtDtaPnt+="{label:\""+ drFF["Zone_Name"].ToString()+"\",y:";
                ...
                //hq
                sURL = "rpt_retail_territorywise_report.aspx?Zone_Code=" + drFF["Zone_code"] + "&Zone_name=" + drFF["Zone_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.retail_Zonewise_purchase_value(drFF["Zone_code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            sURL = "rpt_retail_zonewise_product_detail.aspx?Zone_code=" + drFF["Zone_code"] + "&Zone_Name=" + drFF["Zone_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + " &sCurrentDate=" + sCurrentDate + "";
