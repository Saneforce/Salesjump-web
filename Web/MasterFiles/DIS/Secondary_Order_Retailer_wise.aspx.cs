...
string stCrtDtaPnt = string.Empty;
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            lit_DR_Code.Text = "<center>Retailer Code</center>";
            ...
            lit_DR_Name.Text = "<center>Retailer Name</center>";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            //hyp_lst_month.Attributes.Add("href", "javascript:showModalPopUp('" + drFF["Product_Brd_Code"] + "', '" + drFF["Product_Brd_Name"].ToString() + "', '" + cyear + "', '" + cmonth + "','" + sCurrentDate + "','2')");
