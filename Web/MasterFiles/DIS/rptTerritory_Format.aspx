     ...
     <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                    ...
                    <asp:Label ID="lblHead" Text="ListedCustomer - Product Visit" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
        ...
        <div>
                <table width="100%" align="center">
                    ...
                    <td width="2.5%"></td>
                        ...
                        <td align="left">
                        <asp:Label ID="lblprd_name" Text="Territory Name :" runat="server" SkinID="lblMand" Visible="false"></asp:Label>
                            <asp:Label ID="lblname" runat="server" SkinID="lblMand" Font-Bold="true" Visible="false"></asp:Label>
                        </td>
                    </tr>
                </table>
           </div>
