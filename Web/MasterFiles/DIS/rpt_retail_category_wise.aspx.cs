...
public partial class MIS_Reports_rpt_retail_category_wise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retail Register-Category Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    string stCrtDtaPnt = string.Empty;
        ...
        dsSalesForce = sf.GetcategoryName_Customer(divcode);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                stURL = "rpt_retail_Register_Brand_wise.aspx?Stockist_Code=" + stockist_code + "&Stockist_name=" + Stock_name + " &cat_Code=" + drFF["Product_Cat_Code"] + " &cat_name=" + drFF["Product_Cat_Name"].ToString() + "&FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + " &sCurrentDate=" + sCurrentDate + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.retail_category_wise_sale_value_stockist(drFF["Product_Cat_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate, stockist_code);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            stURL = "rpt_retail_categorywise_view.aspx?Stockist_Code=" + stockist_code + "&Stockist_name=" + Stock_name + " &cat_Code=" + drFF["Product_Cat_Code"] + " &cat_name=" + drFF["Product_Cat_Name"].ToString() + "&Year=" + cyear + "&Month=" + cmonth + " &sCurrentDate=" + sCurrentDate + "";
