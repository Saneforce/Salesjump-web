<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="ReadSentMail.aspx.cs" Inherits="MasterFiles_ReadSentMail" %>
        ...
        <script type="text/javascript">
            ...
            function filebind($imgs) {
                ...
                for ($i = st; $i < bfarray.length ; $i++) {
                    ...
                    if ($i < dd) {
                        ...
                        tb.append(tr);
                        cimg.append(tb);
                        //td1 = $("<td style='width: 150px;padding-left:40psx'><a href='#' class='fileDownloadPromise'>" + bfarray[$i] + "</a></td>");
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    url: "ReadSentMail.aspx/GetReadData",
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < Orders.length; i++) {                          
                            ...
                            //filebind(Orders[i].Mail_Attachement)
                              ...
                              $("#ReadMail").append("<div class='mailbox-read-info'><h3>" + Orders[i].Mail_Subject + "</h3><h5>To:" + Orders[i].To_SFName + "<span class='mailbox-read-time pull-right'>"
