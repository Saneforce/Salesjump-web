<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_Target_view.aspx.cs" Inherits="Rpt_Target_view" %>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                    ...
                    <asp:Label ID="lblHead" Text="PRODUCT TARGET ACHIEVEMENT"  SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
