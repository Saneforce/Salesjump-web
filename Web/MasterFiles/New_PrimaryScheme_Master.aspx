<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="New_PrimaryScheme_Master.aspx.cs" Inherits="MasterFiles_New_PrimaryScheme_Master " %>
        ...
        $(document).ready(function () {
           ...
           // $('#<%=txtTo.ClientID%>').val(today);
            ...
            $.ajax({
                ...
                async: false,
                url: "New_PrimaryScheme_Master.aspx/getDivision",
                dataType: "json",
            ...
            $(document).on('change', '#<%=txtName.ClientID %>', function () {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "New_PrimaryScheme_Master.aspx/Validate_Scheme_Name",
            ...
            $.ajax({
                ...
                url: "New_PrimaryScheme_Master.aspx/getreate",
                dataType: "json",
                success: function (data) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "New_PrimaryScheme_Master.aspx/get_view_unit",
                dataType: "json",
                success: function (data) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "New_PrimaryScheme_Master.aspx/Get_Product_unit",
                dataType: "json",
                success: function (data) {
            ...
            //        contentType: "application/json; charset=utf-8",
            //        async: false,
            //        url: "New_PrimaryScheme_Master.aspx/getProduct",
            //        data: "{'Type':'" + type + "'}",
            //        dataType: "json",
            //        success: function (data) {
            //            ProDtl = data.d;
            ...
            genSchemTbale = function () {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "New_PrimaryScheme_Master.aspx/getScheme",
                    dataType: "json",
                    success: function (data) {
                        SchDtl = data.d;
                        str = '';
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "New_PrimaryScheme_Master.aspx/getDistributor_for_primary",
                dataType: "json",
                success: function (data) {
                    stkDtl = data.d;
                },
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "New_PrimaryScheme_Master.aspx/getState",
                dataType: "json",
                success: function (data) {
                    sDt = data.d;
                    if (sDt.length > 0) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "New_PrimaryScheme_Master.aspx/getTerritory_for_Secondary",
                dataType: "json",
                success: function (data) {
           ...
           <%-- fillData = function (scData) {
            ...
            $(document).on('click', '.btnsave', function () {
                ...
                if (chk != false) {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "New_PrimaryScheme_Master.aspx/SaveScheme",
            ...
            $(document).on('click', '.btnDelete', function () {
                ...
                if (Ans == true) {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "New_PrimaryScheme_Master.aspx/DeleteScheme",
            ...
            //        contentType: "application/json; charset=utf-8",
            //        async: false,
            //        url: "New_PrimaryScheme_Master.aspx/getSchemeVAl",
