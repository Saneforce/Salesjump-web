<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listeddr_adm_deAct_Approve.aspx.cs" Inherits="MasterFiles_MGR_Listeddr_adm_deAct_Approve" %>
        ...
        <tbody>               
            <tr>
              ...
              <%--             <asp:TemplateField HeaderText="Click Here">
                               ...
                               <asp:HyperLinkField HeaderText="Click Here" Text="Click Here to Approve" DataNavigateUrlFormatString="Listeddr_adm_deAct_Approval.aspx?sfcode={0}"
