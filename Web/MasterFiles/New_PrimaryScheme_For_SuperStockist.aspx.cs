...
public partial class MasterFiles_New_PrimaryScheme_For_SuperStockist : System.Web.UI.Page
{
    ...
    public static DataSet Get_Primary_Scheme_Names(string DivCode)
    {
        ...
        string strQry = "select convert(varchar,Effective_To,103) EfDate,Scheme_Name from Mas_SuperStockist_Scheme where division_code='" + DivCode + "' and cast(convert(varchar,Effective_To,101)as datetime) >=cast(convert(varchar,getdate(),101)as datetime)  GROUP BY Scheme_Name,convert(varchar,Effective_To,103)";
    ...
    public static List<GSchemeVal> getSchemeVAl(string schemeName)
    {
        ...
        Product prd = new Product();
        ds = getprischemaval(div_code, schemeName);
        foreach (DataRow row in ds.Tables[0].Rows)
        {
    ...
    public static DataSet getprischemaval(string DivCode, string schemName)
    {
        DB_EReporting db_ER = new DB_EReporting();
        ...
        string strQry = "getSuperStokistschemaval '" + DivCode + "','" + schemName + "'";
    ...
    //        list.product_unit = row["product_unit"].ToString();
    //        list.Sample_Erp_Code = row["Sample_Erp_Code"].ToString();
    //        list.offer_product_Unit_code = row["offer_product_unit_Code"].ToString();
    //        list.free_Unit_code = row["Free_Unit_Code"].ToString();
    //        list.scheme_unit_code = row["Scheme_Unit_Code"].ToString();
    //        list.offer_unit = row["offer_product_unit"].ToString();
    ...
    public static DataSet getProductForCategory(string divcode, string cat_code, string nil_code)
    {
        DB_EReporting db_ER = new DB_EReporting();
        ...
        string strQry = "SELECT a.Product_Detail_Code, a.Product_Cat_Code, a.Product_Detail_Name + '-' + b.Product_Cat_Name as Product_Detail_Name " +
    ...
    public static string SaveScheme(string Data, string DistCode, string StateCode, string FDate, string TDate, string SchemeName, string Types, string insertType)
    {
        ...
        if (Types == "1")
        {
            ...
            {
                dsPro = getProductForCategory(div_code, items[i].pCode.ToString(), "");
            ...
            using (SqlConnection con = new SqlConnection(consString))
            {
                using (SqlCommand cmd = con.CreateCommand())
                {
                    ...
                    cmd.CommandText = "insertMasSuperStockistScheme";
    ...
    public static int insertSchemePri(string sxml, string fromDate, string ToDate, string insertType, string DistCode, string StateCode, string div_code)
    {
        ...
        {
            DB_EReporting db = new DB_EReporting();
            strQry = "EXEC insertMasSuperStockistScheme '" + sxml + "','" + fromDate + "','" + ToDate + "','" + insertType + "','" + DistCode + "','" + StateCode + "','" + div_code + "'";
    ...
    public static int Delete_priScheme_Values(string DivCode, string schemName)
    {
        int iReturn = -1;
        try
        {
            ...
            string strQry = "DELETE FROM  Mas_SuperStockist_Scheme WHERE  division_code='" + DivCode + "' and Scheme_Name='" + schemName + "'";
    ...
    public static string DeleteScheme(string schemeName)
    {
        ...
        Product prd = new Product();
        int cnt = Delete_priScheme_Values(div_code, schemeName);
        if (cnt > 0)
        {
            return "Success";
        }
    ...
    public static string validateScheme(string From_date, string State_Code, string InsertType, string To_date, string Scheme_name)
    {
        ...
        DataSet ds = new DataSet();
        Product prd = new Product();
        ds = validateSchemeByDate(dt2.ToString("yyyy-MM-dd"), State_Code.TrimEnd(','), div_code, InsertType, dt1.ToString("yyyy-MM-dd"), Scheme_name);
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }

    public static DataSet validateSchemeByDate(string dt2, string State_Code, string div_code, string InsertType, string tdate, string schemename)
    {
        ...
        try
        {
            string strQry = "exec sp_SuperStockist_schem_validate '" + dt2 + "','" + tdate + "','" + State_Code + "','" + InsertType + "','" + div_code + "','" + schemename + "'";
            ds = db_ER.Exec_DataSet(strQry);
        }
        catch (Exception ex)
        {
