<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorCategory.aspx.cs" Inherits="MasterFiles_DoctorCategory" %>
        ...
        $(document).ready(function () {
         //   $('input:text:first').focus();
            ...
            $('#btnSubmit').click(function () {
                if ($("#txtDoc_Cat_SName").val() == "") { alert("Enter Short Name."); $('#txtDoc_Cat_SName').focus(); return false; }
                if ($("#txtDocCatName").val() == "") { alert("Enter Category Name."); $('#txtDocCatName').focus(); return false; }
            });
        });
    </script>
</head>
<body>
    ...
    <div>
        ...
        <br />
        <center>
            <table border="0" cellpadding="3" cellspacing="3" id="tblDocCatDtls" align="center"
                >
                <tr>
