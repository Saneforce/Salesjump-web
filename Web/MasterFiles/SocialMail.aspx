<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="SocialMail.aspx.cs" Inherits="MasterFiles_SocialMail" %>
                  ...
                  <%--<span class="label label-primary pull-right">12</span></a></li>--%>
                        ...
                        <div class="col-md-9">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <%-- <h3 class="box-title"><i class="fa fa-circle-o text-red"></i> Social</h3>--%>
                                ...
                                <div class="box-body no-padding">
                                    <div class="mailbox-controls">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <select style="box-shadow: none; border: 0px; outline: 0px;" id="soclbl">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                <%-- $.ajax({
                    ...
                    url: "SocialMail.aspx/GetSocialData",
                ...
                loadData();
                    ...
                    $(document).on('change', '#soclbl', function (e) {
