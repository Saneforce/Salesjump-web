<%@ Page Title="Walk_in_Sequence" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Walk_in_Sequence.aspx.cs" Inherits="MasterFiles_Walk_in_Sequence" %>
  ...
  <!doctype html public "-//w3c//dtd xhtml 1.0 transitional//en" "http://www.w3.org/tr/xhtml1/dtd/xhtml1-transitional.dtd">
    ...
    <script type="text/javascript">
        ...
        function NewWindow() {
            ...
            window.open("rpt_Walk_in_Sequence.aspx?SF_Code=" + str + "&FYear=" + year + "&SF_Name=" + MR_name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');
