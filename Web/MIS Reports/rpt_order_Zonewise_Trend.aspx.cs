...
using Bus_EReport;
using System.Net;
public partial class MIS_Reports_rpt_order_Zonewise_Trend : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Order Zonewise Trend Analysis Details from  " + strFMonthName + " " + FYear;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.Order_Zonewise_Trend_analysis_Distributor_descending(divcode, fromdate, todate, subdivision, state_code, Area_code);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_order_territorywise_trend.aspx?Zone_code=" + drFF["Zone_code"] + "&Zone_name=" + drFF["Zone_name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&Area_code=" + Area_code + "&State_code=" + state_code + "&Subdivision=" + subdivision + "";
     ...
     viewby = "Zonewise";
                sURL = "rpt_Ordertrend_month.aspx?State_Code=" + state_code + "&Area_code=" + Area_code + "&Zone_code=" + drFF["Zone_code"] + "&Zone_name=" + drFF["Zone_name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                ...
                dsDoc = sf.Order_Zonewise_Trend_analysis_totalvalue(divcode, fromdate, todate, subdivision, state_code, Area_code);
