<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false"  CodeFile="rptPurchas_Register_Brandwise_view.aspx.cs" Inherits="MIS_Reports_rptPurchas_Register_Brandwise_view" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Purchase Register - Brand Wise View</title>
    ...
    <asp:Panel ID="pnlContents" runat="server" Width="100%">
        <table width="100%" align="center">
            ...
            <tr>
              ...
              <td align="center" >
               <asp:Label ID="lblfieldname" runat="server" Font-Size="14px" Text="Brand:" Font-Bold="true" ></asp:Label>
