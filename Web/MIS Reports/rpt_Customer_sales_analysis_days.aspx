<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Customer_sales_analysis_days.aspx.cs"
    EnableEventValidation="false" Inherits="MIS_Reports_rpt_Customer_sales_analysis_days" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                async: false,
                url: "rpt_Customer_sales_analysis_days.aspx/GetVisitedDtls",
