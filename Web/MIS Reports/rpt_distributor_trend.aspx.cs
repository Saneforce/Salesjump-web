...
public partial class MIS_Reports_rpt_distributor_trend : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Purchase Trend Analysis Details for  " + strFMonthName + " " + FYear;
    ...
    private void FillSF_MR()
    {
        ...
        if (sf_type == "1")
        {
            ...
            dsSalesForce = sf.Purchase_Trend_analysis_Distributor_descending_MR(divcode, fromdate, todate, subdivision, sfCode);

        }
        else
        {

            dsSalesForce = sf.Purchase_Trend_analysis_Distributor_descending_MGR(divcode, fromdate, todate, subdivision, sfCode);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_purchasetrend_monthwise.aspx?Stockist_Code=" + drFF["Stockist_Code"] + "&Stockist_Name=" + drFF["Stockist_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                ...
                dsDoc = sf.Purchase_Trend_analysis_totalvalue(divcode, fromdate, todate, subdivision);
    ...
    private void FillSF()
    {
        ...
        SalesForce sf = new SalesForce();
        //dsSalesForce = sf.GetStockName_Customer(divcode, subdivision);
        dsSalesForce = sf.Purchase_Trend_analysis_Distributor_descending(divcode, fromdate, todate, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
    ...
    private void FillCategorywise()
    {
        ...
        dsSalesForce = sf.Purchase_Trend_analysis_category_descending(divcode, fromdate, todate, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (hh != "")
                {
                    ff = Convert.ToDecimal(hh);
                    value1 = ff;
                    catsumtotal += Convert.ToDecimal(value1);
                    stCrtDtaPnt += Convert.ToString(value1) + "},";
                }
                else
                {
                ...
                sURL = "rpt_purchasetrend_monthwise.aspx?Product_Cat_Code=" + drFF["cat_code"] + "&Product_Cat_Name=" + drFF["Product_Cat_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                lit_det_sum.Attributes["onclick"] = "javascript:window.open('" + sURL + "' ,'','resizable=yes,toolbar=no,menubar=no,scrollbars=1,status=no,width=500,height=600,left=0,top=0,zoom=50%');";
                ...
                dsDoc = sf.Purchase_Trend_analysis_categorywise_total_value(divcode, fromdate, todate, subdivision);
    ...
    private void FillBrandwise()
    {
        ...
        dsSalesForce = sf.Purchase_Trend_analysis_Brandwise_descending(divcode, fromdate, todate, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_purchasetrend_monthwise.aspx?Product_Brd_Code=" + drFF["Product_Brd_Code"] + "&Product_Brd_Name=" + drFF["Product_Brd_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                lit_det_sum.Attributes["onclick"] = "javascript:window.open('" + sURL + "' ,'','resizable=yes,toolbar=no,menubar=no,scrollbars=1,status=no,width=500,height=600,left=0,top=0,zoom=50%');";
                ...
                dsDoc = sf.Purchase_Trend_analysis_brandwise_total_value(divcode, fromdate, todate, subdivision);
    ...
    private void FillProductwise()
    {
        ...
        dsSalesForce = sf.Purchase_Trend_analysis_Productwise_descending(divcode, fromdate, todate, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_single_product_monthwise.aspx?FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&product_name=" + drFF["Product_Detail_Name"].ToString() + "&product_code=" + drFF["Product_Detail_Code"].ToString() + "";
                ...
                dsDoc = sf.Purchase_Trend_analysis_productwise_total_value(divcode, fromdate, todate, subdivision);
