<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="sec_od_routeweekwise.aspx.cs" Inherits="MIS_Reports_sec_od_routeweekwise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Secondary Order Routewise Details </title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <asp:Label ID="lblHead" Text="Secondary Order Routewise Weekwise" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
        ...
        <div>
                <table width="100%" align="center">
                    <tr>
                        ...
                        <td align="Center">
                            <asp:Label ID="lblIDDist" Text="Distributor :" runat="server" SkinID="lblMand" Font-Bold="True" Font-Names="Verdana"></asp:Label>
                            <asp:Label ID="lblDist" runat="server" SkinID="lblMand"></asp:Label>
                        </td>
                        <td align="left">
                            <asp:Label ID="lblIDroute" Text="Route :" runat="server" SkinID="lblMand" Font-Bold="True" Font-Names="Verdana"></asp:Label>
