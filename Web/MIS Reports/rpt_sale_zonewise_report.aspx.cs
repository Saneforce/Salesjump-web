...
public partial class MIS_Reports_rpt_sale_zonewise_report : System.Web.UI.Page
{
...
string subdivision=string.Empty;
 ...
 subdivision = Request.QueryString["subdivision"].ToString();
        ...
        lblHead.Text = "Sale Register -Zone Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
stCrtDtaPnt+="{label:\""+ drFF["Zone_Name"].ToString()+"\",y:";
                ...
                //hq
                sURL = "rpt_sale_territorywise_purchase_report.aspx?Zone_Code=" + drFF["Zone_code"] + "&Zone_name=" + drFF["Zone_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "&subdivision=" + subdivision + "";
                ...
                if (months >= 0)
                {
                   ...
                   //     dsDoc = sf.sale_Zonewise_purchase_value(drFF["Zone_code"].ToString(), divcode, cmonth, cyear, subdivision);
dsDoc = sf.sale_Zonewise_purchase_value(zonecode: drFF["Zone_code"].ToString(), div_code: divcode, cmonth: cmonth,cyear: cyear, subdivision: subdivision,sf_code:sfCode);
...
stype = "1";
                            ...
                            sURL = "rpt_sale_zonewise_product_detail.aspx?Zone_code=" + drFF["Zone_code"] + "&Zone_Name=" + drFF["Zone_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + "&stype=" + stype + "&subdivision=" + subdivision + "";
