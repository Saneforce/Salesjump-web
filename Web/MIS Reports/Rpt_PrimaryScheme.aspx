<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Rpt_PrimaryScheme.aspx.cs" Inherits="MIS_Reports_Rpt_PrimaryScheme" %>
    ...
    <form id="Form1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-12 sub-header">
                Primary Stockist Scheme<span style="float: right; margin-right: 15px;">
        ...
        <script type="text/javascript">
            ...
            var pgNo = 1; PgRecords = 10; TotalPg = 0;searchKeys = 'Order_Date,Stockist_Name,Order_No,Product_Name,Offer_ProductNm,';
            ...
            function loadData() {
                $.ajax({
                    ...
                    url: "Rpt_PrimaryScheme.aspx/GetSprStk_Schm",
                    dataType: "json",
            ...
            function exportToExcel() {
                ...
                var tets = 'Report_Primary_Stockist_Scheme' + '.xls';   //create fname
            ...
            function ReloadTable() {
                ...
                for ($i = st; $i < st + PgRecords; $i++) {
                    if ($i < Orders.length) {
                        tr = $("<tr></tr>");
                        $(tr).html("<td>" + ($i + 1) + "</td><td>" + Orders[$i].Order_Date + "</td><td>" + Orders[$i].Stockist_Name + "</td><td>" + Orders[$i].Order_No + "</td><td>" + Orders[$i].Product_Name + "</td><td>" + Orders[$i].Offer_ProductNm + "</td><td>" + Orders[$i].CQty + "</td><td>" + Orders[$i].free + "</td><td>" + Orders[$i].discount + "</td>");
            ...
            function fillsf() {
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "Rpt_PrimaryScheme.aspx/GetSF",
