<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpt_retail_zonewise_product_detail.aspx.cs" Inherits="MIS_Reports_rpt_retail_zonewise_product_detail" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Retail Register Zonewise View</title>
   ...
   <asp:Panel ID="pnlbutton" runat="server">
        <table width="100%">
            <tr>
                ...
                <asp:Label ID="lblProd" runat="server" Text="Retail Register -ZoneWise" SkinID="lblMand" ></asp:Label>
                </td>
