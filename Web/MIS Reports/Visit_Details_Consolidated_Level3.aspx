<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Consolidated_Level3.aspx.cs"
    Inherits="MIS_Reports_Visit_Details_Consolidated_Level3" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, cmode) {
            popUpObj = window.open("Visit_Details_Consolidated_Level4.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&cMode=" + cmode,
    "Consolidated_Level3",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
    ...
    <div>
        ...
        <center>
            ...
            <asp:Panel ID="pnlContents" runat="server">
                ...
                <br />
                <asp:Table ID="tbl" Font-Size="8pt" runat="server" Style="border-collapse: collapse; border: solid 1px Black;"
                    BorderStyle="Solid" BorderWidth="1" GridLines="Both" Width="95%">
                </asp:Table>
            </asp:Panel>
        </center>
    </div>
