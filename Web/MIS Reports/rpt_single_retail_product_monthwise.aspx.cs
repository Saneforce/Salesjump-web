...
public partial class MIS_Reports_rpt_single_retail_product_monthwise : System.Web.UI.Page
{
...
tc_det_SNo.Style.Add("text-align","right");
   ...
   Monthsub = sf.getMonthName(cmonth.ToString()) + "-" + cyear;
                ...
                dsDoc = sf.retaill_Trend_analysis_Productwise_monthwise(product_code, divcode, cmonth, cyear);
                ...
                dsDoc = sf.retaill_Trend_analysis_Productwise_monthwise_total(subdivision, divcode, cmonth, cyear);
