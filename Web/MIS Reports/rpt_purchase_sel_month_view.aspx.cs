...
public partial class MIS_Reports_rpt_purchase_sel_month_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dist = Request.QueryString["Stockist_Code"].ToString();
        ...
        lblHead.Text = "Lost-Product View for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;


        lblMonth.Text = dist_name;
    ...
    private void FillSF()
    {
        ...
        //dsSalesForce = sf.lost_Purchase_value_view_sel_month(dist, divcode, frmdate, todate, subdivision);
        dsSalesForce = sf.lost_Purchase_value_stockist_purchase(stockistcode: dist, div_code: divcode, fdate: frmdate, todate: todate, subdivision: subdivision, sf_code: sf_code);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            lit_DR_Name.Text = "Last Purchased Date";
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                // dsDoc = sf.lost_Purchase_date_sel_month(drFF["Product_Detail_Code"].ToString(), FMonth, FYear, dist);
                dsDoc = sf.lost_Purchase_date_sel_month(productcode: drFF["Product_Detail_Code"].ToString(), cmonth: FMonth, cyear: FYear, stockistcode: dist, div_code: divcode, sf_code: sf_code);
