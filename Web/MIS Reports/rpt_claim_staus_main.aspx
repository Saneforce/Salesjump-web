<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="rpt_claim_staus_main.aspx.cs" Inherits="MIS_Reports_rpt_claim_staus_main" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $(document).on('click', '[id*=btnview]', function () {
                ...
                strOpen = "Claim_Approvals.aspx?sf_code=" + Team + "&ddldes=" + ddldes + "&ddldescription=" + ddldescription + "&giftype=" + Gifttype + "";
