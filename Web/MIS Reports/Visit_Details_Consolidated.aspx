<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Consolidated.aspx.cs" Inherits="MIS_Reports_Visit_Details_Consolidated" %>
...
<head runat="server">
    <title>Visit Details Consolidated Report</title>
...
<script type = "text/javascript">
    ...
    function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, cmode) {
        ...
        popUpObj = window.open("Visit_Details_Consolidated_Level1.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&cMode=" + cmode,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
      ...
      <script type="text/javascript">
          $(document).ready(function () {
              ...
              $('#btnGo').click(function () {
                  ...
                  var ddlTMonth = document.getElementById('<%=ddlTMonth.ClientID%>').value;
                  var ddlFYear = document.getElementById('<%=ddlFYear.ClientID%>').value;
                  var ddlTYear = document.getElementById('<%=ddlTYear.ClientID%>').value;
                      ...
                      if (ddlMode > 1) {
                          ...
                          if (ddlMR > 0) {
                              ...
                              showModalPopUp(ddlMode, ddlFMonth, ddlFYear, ddlTMonth, ddlTYear, ddlMode);
                          }
                          else {

                              showModalPopUp(sf_Code, ddlFMonth, ddlFYear, ddlTMonth, ddlTYear, ddlMode);
                          }
                      }
                      else {

                          showModalPopUp(sf_Code, ddlFMonth, ddlTMonth, ddlFYear, ddlTYear, ddlMode);
                      }
            ...
            <table>
                <tr>
                    ...
                    <td align="left">
                        ...
                        <asp:DropDownList ID="ddlFieldForce" runat="server" SkinID="ddlRequired" AutoPostBack="true" onselectedindexchanged="ddlFieldForce_SelectedIndexChanged">
                        </asp:DropDownList>
