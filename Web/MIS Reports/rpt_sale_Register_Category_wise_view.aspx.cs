...
public partial class MIS_Reports_rpt_sale_Register_Category_wise_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //FillProd();
            lblProd.Text = "Sale Register Category wise for the Period of " + strMonthName + " " + Year + " ";
...
protected void btnExport_Click(object sender, EventArgs e)
    ...
    private void CreateDynamicTable()
    {
        ...
        if (stype == "1")
        {
           dsDr = dr.sale_register_categorywisedetail_stockist(div_code, cat_code, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate, stockist);
        }

        if (stype == "2")
        {
            dsDr = dr.sale_register_categorywisedetail_stockist_total(div_code, Convert.ToInt16(Year), Convert.ToInt16(Month),stockist); 
        }
