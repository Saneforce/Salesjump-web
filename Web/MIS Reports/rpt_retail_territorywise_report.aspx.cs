...
public partial class MIS_Reports_rpt_retail_territorywise_report : System.Web.UI.Page
{
...
string stype = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retail Register -Territory Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_retail_distributorwise.aspx?Territory_code=" + drFF["Territory_code"] + "&Territory_Name=" + drFF["Territory_Name"].ToString() + "&FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&subdivision=" + subdivision + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.retail_Territorywise_purchase_value(drFF["Territory_code"].ToString(), divcode, cmonth, cyear, subdivision);
					 ...
					 stype = "1";
						 ...
						 sURL = "rpt_retail_territorywise_product_detail.aspx?Territory_code=" + drFF["Territory_code"] + "&Territory_Name=" + drFF["Territory_Name"].ToString() + "&CYear=" + cyear + "&CMonth=" + cmonth + "&stype=" + stype + "&subdivision=" + subdivision + "";
