...
tc_det_SNo.Style.Add("text-align","right");
                ...
                //hq
                sURL = "rpt_retail_territorywise_report.aspx?Zone_Code=" + drFF["Zone_code"] + "&Zone_name=" + drFF["Zone_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "&subdivision=" + subdivision + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.retail_Zonewise_purchase_value(drFF["Zone_code"].ToString(), divcode, cmonth, cyear, subdivision);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            if (tot_dr != "")
                            {
							 ...
							 sURL = "rpt_retail_zonewise_product_detail.aspx?Zone_code=" + drFF["Zone_code"] + "&Zone_Name=" + drFF["Zone_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + " &stype=" + stype + "&subdivision=" + subdivision + "";
