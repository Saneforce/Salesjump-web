<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpt_sale_lost_purchase_sel_month.aspx.cs" Inherits="MIS_Reports_rpt_sale_lost_purchase_sel_month" %>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                    ...
                    <asp:Label ID="lblHead" Text="Sale Lost-Product Details" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
