...
public partial class MIS_Reports_rptroutedeviationretview_mon : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retailer View for  " + FDate + TDate + " ";
    ...
    private void FillSF()
    {
        ...
        Order sf = new Order();
        dsSalesForce = sf.View_Retailerdetailview_mon(divcode, sf_code, FDate, TDate);
