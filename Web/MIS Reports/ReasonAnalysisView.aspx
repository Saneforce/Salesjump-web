<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
    CodeFile="ReasonAnalysisView.aspx.cs" Inherits="MIS_Reports_ReasonAnalysisView" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.btnview', function () {
                ...
                var str = 'ReasonAnalysisSFView.aspx?&SFCode=' + sf_code + '&FYear=' + Fyear + '&FMonth=' + FMonth + '&SFName=' + SFName + '&SubDiv=' + SubDivCode;
