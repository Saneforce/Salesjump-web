...
public partial class MIS_Reports_rpt_sale_territorywise_purchase_report : System.Web.UI.Page
{
...
stCrtDtaPnt+="{label:\""+ drFF["Territory_Name"].ToString()+"\",y:";
                ...
                if (months >= 0)
                {
                   ...
                   //     dsDoc = sf.sale_Territorywise_purchase_value(drFF["Territory_code"].ToString(), divcode, cmonth, cyear, subdivision);

dsDoc = sf.sale_Territorywise_purchase_value( territorycode: drFF["Territory_code"].ToString(), div_code: divcode, cmonth: cmonth,cyear: cyear,subdivision: subdivision,sf_code:sfCode);
                        ...
                        if (tot_dr != "0")
                        {
                         ...
                         stype = "1";
                            ...
                            sURL = "rpt_sale_territorywise_product_detail.aspx?Territory_code=" + drFF["Territory_code"] + "&Territory_Name=" + drFF["Territory_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + "&stype=" + stype + "&subdivision=" + subdivision + "";
