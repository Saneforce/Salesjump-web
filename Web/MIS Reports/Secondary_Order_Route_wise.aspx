<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Secondary_Order_Route_wise.aspx.cs"
    Inherits="MIS_Reports_Secondary_Order_Route_wise" %>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td width="60%" align="center">
                        <asp:Label ID="lblHead" Text="Purchase Register Route Wise" SkinID="lblMand" Font-Bold="true"
...
<td>
    ...
    <asp:Panel ID="pnlContents" runat="server" Width="100%">
        ...
        <table align="center">
            <tr>
                <td>
                    <asp:Label ID="DistributorName" runat="server" Text="Distributor Name" Font-Bold="True"
                        Font-Names="Andalus"/>
                </td>
                <td>
                    <asp:Label ID="dist" runat="server" Font-Size="12px" Font-Underline="True"></asp:Label>
                </td>
            </tr>
        </table>
        <br></br>
