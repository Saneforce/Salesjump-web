...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function popUp(SF_Code, Order_date, Sf_Name, div_no, Stockist_Name, Stockist_Code) {
                strOpen = "../MasterFiles/Reports/rpt_priorder_detailwise.aspx?Sf_Code=" + SF_Code + "&Activity_date=" + Order_date + "&To_date=" + Order_date + "&div_code=" + div_no + "&Sf_Name=" + Sf_Name + "&Stockist_Name=" + Stockist_Name + "&Stockist_Code=" + Stockist_Code;
        ...
        <form id="form1" runat="server">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td width="80%" align="center">
                                <a href="javascript:popUp('<%=sfCode%>','<%=divcode%>','<%=year%>')" ><b>Closing Stock  </b> </a> 
                            </td>
                            <td align="right">
                                <table>
                                    <tr>
            ...
            <asp:Panel ID="pnlContents" runat="server" Width="100%">
                <table border="0" id='1' width="90%">
                    <tr>
                        <td style=" text-align:center; font-size:x-large;  font-weight: bold;font-family: Andalus;">
                            <asp:Label ID="lblHead" Text="Retail Lost  Details" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr align="right">
                            ...
                            <asp:GridView ID="gvtotalorder" runat="server" Width="100%" HorizontalAlign="Center"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Order Taken By" ItemStyle-Width="270" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="10pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:HiddenField ID="Sf_code" runat="server" Value='<%#Eval("Sf_Code")%>'></asp:HiddenField>
                                    ...
                                    <asp:TemplateField HeaderText="Pay Type" ItemStyle-Width="270" HeaderStyle-BorderWidth="1"
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="PayType" runat="server" Font-Size="9pt" Text='<%#Eval("Pay_Type")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderText="Net weight" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                        ...
                                        <ItemTemplate>
                                            <%--<asp:Label ID="netval" runat="server" Font-Size="9pt" Text='<%#DataBinder.Eval(Container.DataItem, "net_weight", "{0:N2}")%>'></asp:Label>--%>
                                            <asp:Label ID="netval" runat="server" Font-Size="9pt" Text='<%#Eval("net_weight")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
									...
									<asp:TemplateField HeaderText="Quantity" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <%--<asp:Label ID="qty" runat="server" Font-Size="9pt" Text='<%#DataBinder.Eval(Container.DataItem, "quantity", "{0:N2}")%>'></asp:Label>--%>
                                            <asp:Label ID="qty" runat="server" Font-Size="9pt" Text='<%#Eval("quantity")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Collected Amount" ItemStyle-Width="270" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="10pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <asp:Label ID="toval" runat="server" Font-Size="9pt" Text='<%#Eval("Collected_Amount")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>                        
                                    ...
                                    <asp:TemplateField HeaderText="DisCount" ItemStyle-Width="270" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="10pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <asp:Label ID="discountpri" runat="server" Font-Size="9pt" Text='<%#Eval("discount")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Order Value" ItemStyle-Width="120" HeaderStyle-BorderWidth="1"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <a href="javascript:popUp('<%#Eval("SF_Code")%>','<%#Eval("Order_date")%>','<%#Eval("Sf_Name")%>','<%#Eval("Div_ID")%>','<%#Eval ("Stockist_Name")%>','<%#Eval("stockist_code")%>')">
