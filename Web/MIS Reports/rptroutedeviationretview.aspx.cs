...
public partial class MIS_Reports_rptroutedeviationretview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       date = Request.QueryString["date"].ToString();
        ...
        lblHead.Text = "Retailer View for  " + date + " ";
    ...
    private void FillSF()
    {
        ...
        Order sf = new Order();
        dsSalesForce = sf.View_Retailerdetailview_day(divcode, sf_code, date);
