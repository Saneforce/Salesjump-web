<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Retailer_Closing_New.aspx.cs" Inherits="MIS_Reports_Retailer_Closing_New" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function NewWindow() {
            ...
            if (ddlMR != -1 && ddlMR != 0 && MR_name != '') {
                window.open("rpt_new_retailer_closing_stock.aspx?SF_Code=" + ddlMR + "&date=" + date + "&SF_Name=" + MR_name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');

            }
            else {
                window.open("rpt_new_retailer_closing_stock.aspx?SF_Code=" + st + "&date=" + date + "&SF_Name=" + sf_name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');
    ...
    <form id="form1" runat="server">
        ...
        <div class="row">
            <asp:Label ID="lblFYear" runat="server" SkinID="lblMand" Text="Date" Style="text-align: right; padding: 8px 4px;"
                CssClass="col-md-4 control-label"></asp:Label>
            <div class="col-sm-6 inputGroupContainer">
                <div class="input-group">
