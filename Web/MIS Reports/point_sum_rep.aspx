<%@ Page Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="point_sum_rep.aspx.cs" Inherits="MIS_Reports_point_sum_rep" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnview').on('click', function () {
                ...
                var url = '';
                  ...
                  url = "view_point_sum_rep.aspx?sf_code=" + sfcode + "&div_code=" + <%=Session["div_code"]%> + "&subdiv=" + subdiv +
        ...
        function loadDivision(ssdiv) {
            $.ajax({
                ...
                async: false,
                url: "point_sum_rep.aspx/getDivision",
        ...
        function loadFieldForce() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "point_sum_rep.aspx/getFieldForce",
