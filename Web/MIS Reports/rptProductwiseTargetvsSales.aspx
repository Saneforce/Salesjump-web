<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptProductwiseTargetvsSales.aspx.cs"
    Inherits="MIS_Reports_rptProductwiseTargetvsSales" %>
        ...
        $(document).ready(function () {
            ...
            genReport = function () {
                if (pDs.length > 0) {
                    ...
                    while (cd <= td) {
                        str += '<th colspan="4"> ' + month[cd.getMonth()] + ' - ' + cd.getFullYear() + ' </th>';
                        st2 += '<th colspan="2">Target</th><th colspan="2">Sales</th>';
                        stkDt += '<th>QTY</th><th>VALUE</th><th>QTY</th><th>VALUE</th>';
                        st3 += '<th class="ogTc" colspan="2"></th><th class="ogSc" colspan="2"></th>';
                        st4 += '<th class="ogTQ"></th><th class="ogT"></th><th class="ogSQ"></th><th class="ogS"></th>';
                        cd.setMonth(cd.getMonth() + 1);
                        len++;
                    }
                    $(tbl).find('thead').append('<tr style="background-color: #496a9a; color: white;">' + str + '<th colspan="4">Total</th></tr>');
                    $(tbl).find('thead').append('<tr style="background-color: #496a9a; color: white;">' + st2 + '<th colspan="2">Target</th><th colspan="2">Sales</th></tr>');
                    $(tbl).find('thead').append('<tr style="background-color: #496a9a; color: white;">' + stkDt + '<th>QTY</th><th>VALUE</th><th>QTY</th><th>VALUE</th></tr>');
                    $(tbl).find('thead').append('<tr style="background-color: #496a9a; color: white;">' + st3 + '<th class="ogTcT" colspan="2"></th><th class="ogScT" colspan="2"></th></tr>');
                    $(tbl).find('thead').append('<tr style="background-color: #496a9a; color: white;">' + st4 + '<th class="ogTTQ"></th><th class="ogTT"></th><th class="ogSTQ"></th><th class="ogST"></th></tr>');
                    ...
                    for (var i = 0; i < pDs.length; i++) {
                        ...
                        while (md <= td) {
                            ...
                            if (md.getMonth() % 2 == 0) {
                                str += '<td  style="background-color: #b1adae;">' + TQ + '</td><td  style="background-color: #b1adae;">' + T + '</td><td style="background-color: #b1adae;">' + SQ + '</td><td  style="background-color: #b1adae;">' + S + '</td>';
                            }
                            else {
                                str += '<td>' + TQ + '</td><td>' + T + '</td><td>' + SQ + '</td><td>' + S + '</td>';
                            }

                            md.setMonth(md.getMonth() + 1);
                            j++;
                        }
                        $(tbl).find('tbody').append('<tr>' + str + ' <td style="background-color: #b3a46d; color: white;"> ' + TTQ + ' </td> <td style="background-color: #b3a46d; color: white;"> ' + TT + ' </td><td style="background-color: #b3a46d; color: white;">' + TSQ + '</td> <td style="background-color: #b3a46d; color: white;">' + TS + '</td> </tr> ');
                    }
                    var sum = 0;
            ...
            $.ajax({
                ...
                async: false,
                url: "rptProductwiseTargetvsSales.aspx/getProductTargetSale",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptProductwiseTargetvsSales.aspx/getdata",
                data: "{'SubDiv':'" + SubDiv + "'}",
                dataType: "json",
                success: function (data) {
                    pDs = data.d;
