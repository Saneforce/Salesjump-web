<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpt_sale_Register_Category_wise_view.aspx.cs" Inherits="MIS_Reports_rpt_sale_Register_Category_wise_view" %>
   ...
   <asp:Panel ID="pnlbutton" runat="server">
        <table width="100%">
            ...
            <td width="20%"></td><td></td>
                ...
                <asp:Label ID="lblProd" runat="server" Text="Sale Register -Category Wise" SkinID="lblMand" ></asp:Label>
                </td>
                <td align="right">
                    <table>
                        <tr>
