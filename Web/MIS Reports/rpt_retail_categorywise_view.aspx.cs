...
public partial class MIS_Reports_rpt_retail_categorywise_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cat_code = Request.QueryString["cat_Code"];
        ...
        {
            //FillProd();
            lblProd.Text = "Retail Register Catogory wise for the Period of " + strMonthName + " " + Year + " ";
            lblProd.Font.Bold = true;
            lblname.Text = cat_name;
            CreateDynamicTable();
        }
...
protected void btnExport_Click(object sender, EventArgs e)
    ...
    private void CreateDynamicTable()
    {
     ...
     if (stype == "1")
        {
 dsDr = dr.retail_register_categorywisedetail_stockist(div_code, cat_code, Convert.ToInt16(Year), Convert.ToInt16(Month), stockist);
        }

        if (stype == "2")
        {
 dsDr = dr.retail_register_categorywisedetail_stockist_total(div_code, Convert.ToInt16(Year), Convert.ToInt16(Month), stockist);
        }
        ...
        if (dsDr.Tables[0].Rows.Count > 0)
        {
            ...
            lit_det_head_hq.Text = "<b>Product Sale Unit</b>";
            ...
            foreach (DataRow drdoctor in dsDr.Tables[0].Rows)
            {
                ...
                tr_det_sno.HorizontalAlign = HorizontalAlign.Center;
