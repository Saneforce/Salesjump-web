<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Expense_Report_New.aspx.cs" Inherits="MIS_Reports_Expense_Report_New" %>
...
<!doctype html public "-//w3c//dtd xhtml 1.0 transitional//en" "http://www.w3.org/tr/xhtml1/dtd/xhtml1-transitional.dtd">
    ...
    <body>
        <form id="frm1" runat="server">
            ...
            <div class="row" style="margin-top: 5px"> 
                <asp:Label ID="Label3" CssClass="col-md-2  col-md-offset-3  control-label" Text="Type" runat="server">
                </asp:Label>
                <div class="col-md-2 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        <asp:DropDownList ID="ddltyp" CssClass="form-control"  runat="server">
