...
public partial class MIS_Reports_rpt_lost_purchase_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Lost-Purchase View for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.lost_Purchase_value_view(dist, divcode, FMonth, FYear,subdivision);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                dsDoc = sf.lost_Purchase_date(drFF["Product_Detail_Code"].ToString(), FMonth, FYear,dist);
