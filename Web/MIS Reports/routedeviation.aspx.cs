...
public partial class MIS_Reports_routedeviation : System.Web.UI.Page
{
    ...
    private void FillManagers()
    {
        ...
        if (ddlFFType.SelectedValue.ToString() == "1")
        {
            ...
            {
                ddlAlpha.Visible = false;
                dsSalesForce = sf.SalesForceList(div_code, "admin");
            }
            else
            {
                dsSalesForce = sf.SalesForceList(div_code, sf_code);
    ...
    {
        string radiobuttonval = Convert.ToString(RadioButtonList1.SelectedIndex);
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
        ...
        string start = Convert.ToDateTime(Request.Form["txtFrom1"]).ToString("yyyy-MM-dd");
        ...
        if (RadioButtonList1.SelectedIndex == 0)
        {
            try
            {
                ...
                string sURL = "rptroutedeviation.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&startdate=" + start +"&enddate=" + enddate + "&cur_year=" + ddlYear.SelectedItem.Text +
                   "&Mode=" + RadioButtonList1.SelectedItem.Value + "&Sf_Name=" + ddlFieldForce.SelectedItem.Text + "&select=" + year;
            ...
            {
                ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>alert('Select Year!!!');</script>");
            }
        }
        else if (RadioButtonList1.SelectedIndex == 1)
        {
            try
            {
                ...
                //string sURL = "retailer_visit_status.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&startdate=" + start + "&enddate=" + enddate + "&cur_year=" + ddlYear.SelectedItem.Text +
                //   "&Mode=" + RadioButtonList1.SelectedItem.Value + "&Sf_Name=" + ddlFieldForce.SelectedItem.Text +  "&year=" + year;
				   
				string sURL = "retailer_visit_status.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&startdate=" + start + "&enddate=" + enddate + "&cur_year=" + ddlYear.SelectedItem.Text +
                   "&Mode=" + RadioButtonList1.SelectedItem.Value + "&Sf_Name=" + ddlFieldForce.SelectedItem.Text + "&year=" + year + "&select=" + start + "";
            ...
            {
                ClientScript.RegisterStartupScript(GetType(), "Message", "<SCRIPT LANGUAGE='javascript'>alert('Select Month!!!');</script>");
            }
        }
        else if (RadioButtonList1.SelectedIndex == 2)
        {
            try
            {
                ...
                //string sURL = "retailer_visit_status.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&startdate=" + start + "&enddate=" + enddate + "&cur_year=" + ddlYear.SelectedItem.Text +
                //  "&Mode=" + RadioButtonList1.SelectedItem.Value + "&Sf_Name=" + ddlFieldForce.SelectedItem.Text + "&select=" + StartDate;
				   
				   
				string sURL = "retailer_visit_status.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&startdate=" + StartDate + "&enddate=" + StartDate + "&cur_year=" + ddlYear.SelectedItem.Text +
                   "&Mode=" + RadioButtonList1.SelectedItem.Value + "&Sf_Name=" + ddlFieldForce.SelectedItem.Text + "&select=" + StartDate;
