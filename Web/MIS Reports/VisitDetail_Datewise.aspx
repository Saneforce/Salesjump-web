<%@ Page Title="Visit Detail - DateWise" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master_MR.master" CodeFile="VisitDetail_Datewise.aspx.cs" Inherits="MIS_Reports_VisitDetail_Datewise" %>
    ...
    <link type="text/css" rel="stylesheet" href="../css/style.css" />
      ...
      <script type="text/javascript">
          ...
          function showModalPopUp(sfcode, fmon, fyr, sf_name) {
              ...
              popUpObj = window.open("rptVisitDetail_Datewise.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&sf_name=" + sf_name,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#<%=btnGo.ClientID%>').click(function () {
                ...
                if (SName == "---Select Clear---") { alert("Select Field Force Name."); $('#<%=ddlFieldForce.ClientID%>').focus(); return false; }
                ...
                if (FYear == "---Select---") { alert("Select Year."); $('#<%=ddlYear.ClientID%>').focus(); return false; }
