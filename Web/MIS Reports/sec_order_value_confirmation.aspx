<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="sec_order_value_confirmation.aspx.cs" Inherits="MIS_Reports_sec_order_value_confirmation" %>
    ...
    <form runat="server" style="height:550px;">
        ...
        <div class="row">
            <div class="col-lg-12 sub-header">
               Secondary Order Value Confirmation
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnview').on('click', function () {
               ...
               if (sfcode == '') {
                ...
                url = "rpt_sec_order_value_confirmation.aspx?sf_code=" + sfcode + "&div_code=" + <%=Session["div_code"]%> + "&subdiv=" + subdiv +
        ...
        function loadDivision(ssdiv) {
            $.ajax({
                ...
                async: false,
                url: "sec_order_value_confirmation.aspx/getDivision",
        ...
        function loadFieldForce() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "sec_order_value_confirmation.aspx/getFieldForce",
