<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpt_secondary_sale_view_weekday.aspx.cs" Inherits="MIS_Reports_rpt_secondary_sale_view_weekday" %>
...
<center>
       <table  align="center">
                    <tr>
                         ...
                         <td width="500px">
                            <asp:Label ID="lblIDDist" Text="Distributor :" Font-Bold="True" runat="server" SkinID="lblMand"></asp:Label>
