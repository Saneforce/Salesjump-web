...
public partial class MIS_Reports_view_mgr_reporting : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Manager Working Report from " + d1.ToString("dd-MM-yyyy") + " to " + d2.ToString("dd-MM-yyyy");
		lblsf_name.Text = sfname;
    }
    [WebMethod(EnableSession = true)]
    public static string Filldtl()
    {
        mgrrpt sf = new mgrrpt();
        DataSet dsProd = sf.Get_mgr_report();
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        mgrrpt LstDoc = new mgrrpt();
        try
        {
            Response.ClearContent();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "MGR_Working_Rpt.xls"));
            Response.ContentType = "application/ms-excel";
            dsProd1 = LstDoc.Get_mgr_report_excl();
    ...
    public class mgrrpt { 
    public DataSet Get_mgr_report()
    {
        DB_EReporting db_ER = new DB_EReporting();

        DataSet dsDivision = null;
             string strQry = "exec manager_wrking_rpt '" + Sf_Code + "','" + div_code + "','" + FDate + "','" + TDate + "'";
    ...
    public DataTable Get_mgr_report_excl()
        {
            DB_EReporting db_ER = new DB_EReporting();
            string sub = "";
            DataTable dsStockist = null;

            string strQry = "exec manager_wrking_rpt_excl '" + Sf_Code + "','" + div_code + "','" + FDate + "','" + TDate + "'";
            try
            {
