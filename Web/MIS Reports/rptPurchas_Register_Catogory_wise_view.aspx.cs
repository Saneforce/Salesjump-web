...
public partial class MIS_Reports_rptPurchas_Register_Catogory_wise_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       stype = Request.QueryString["stype"];
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblProd.Text = "Purchase Register Catogory wise for the Period of " + strMonthName + " " + Year + " ";
...
protected void btnExport_Click(object sender, EventArgs e)
    ...
    private void CreateDynamicTable()
    {
        ...
        SalesForce dr = new SalesForce();
         ...
         if (stype == "1")
        {
            dsDr = dr.purchase_register_categorywisedetail_stockist(div_code, cat_code, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate, stockist);
        }

        if (stype == "2")
        {
            dsDr = dr.purchase_register_categorywisedetail_producttotal(div_code, cat_code, Convert.ToInt16(Year), Convert.ToInt16(Month),stockist); 
        }
