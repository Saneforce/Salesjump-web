...
public partial class MIS_Reports_rpt_retail_category_wise : System.Web.UI.Page
{
 ...
 stype = "1";
                            ...
                            stURL = "rpt_retail_categorywise_view.aspx?Stockist_Code=" + stockist_code + "&Stockist_name=" + Stock_name + " &cat_Code=" + drFF["Product_Cat_Code"] + " &cat_name=" + drFF["Product_Cat_Name"].ToString() + "&Year=" + cyear + "&Month=" + cmonth + " &stype=" + stype + "";
