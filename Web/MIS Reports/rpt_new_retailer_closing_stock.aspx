<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_new_retailer_closing_stock.aspx.cs" Inherits="MIS_Reports_rpt_new_retailer_closing_stock" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Retailer Closing Stock</title>    
    <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script><link href="../css/bootstrap-3.3.2.min.css" rel="stylesheet" />
 ...
 <script type="text/javascript">
     function exportexcel() {
         $("#pnlContents").table2excel({
             ...
             filename: "Retailer Closing Stock",
             fileext: ".xls"
         });
     };
</script>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <asp:Label ID="lblHead" Text="Closing Stock"   Font-Bold="true" STYLE="COLOR: #3F51B5;PADDING-RIGHT: 217PX;"  Font-Size="Large"  Font-Underline="true"
      ...
      <asp:Panel id="pnlContents"  EnableViewState="false" runat="server" Width="100%" style="margin-left:35px">
          ...
          <tr align="left"><td align="left" style="font-size: small; font-weight: bold;font-family: Andalus;Padding-left:180px;">Feildforce Name:
                   <asp:Label ID="Feild" runat="server" Text="" Font-Bold="true" style="font-family: Andalus; color:Blue;" ></asp:Label></td></tr>
                    ...
                    <tr> 
                        <td width="100%">
                            <asp:GridView ID="gdclstk" runat="server"      ShowHeader="false"
