<%@ Page Language="C#" title="Retailer Closing stock" AutoEventWireup="true" CodeFile="rpt_retailer_closing_stock.aspx.cs" Inherits="MIS_Reports_rpt_retailer_closing_stock" %>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <asp:Label ID="lblHead" Text="Retailerwise Closing Stock"   Font-Bold="true" STYLE="COLOR: #3F51B5;PADDING-RIGHT: 217PX;"  Font-Size="Large"  Font-Underline="true"
      ...
      <asp:Panel id="pnlContents"  runat="server" Width="100%" style="margin-left:35px">
          ...
          <tr align="left"><td align="left" style="font-size: small; font-weight: bold;font-family: Andalus;Padding-left:180px;">Feildforce Name:
                   <asp:Label ID="Feild" runat="server" Text="" Font-Bold="true" style="font-family: Andalus; color:Blue;" ></asp:Label></td></tr>
                    ...
                    <tr> 
                        <td width="100%">
                            <asp:GridView ID="gvclosingstockanalysis" runat="server"      ShowHeader="false"
