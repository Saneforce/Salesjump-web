...
public partial class MIS_Reports_rpt_SuperStockist_Order_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (sf_type == "4")
        {
            ...
            lblHead.Text = "Super Stockist Order View ";
        ...
        else
        {
            ...
            lblHead.Text = "Super Stockist Order View ";
            Label2.Text = " From Date : " + d2.ToString("dd-MM-yyyy");
            Label3.Text = "To Date : " + d3.ToString("dd-MM-yyyy");

            txtfromdate.Value = d2.ToString("yyyy-MM-dd");
            txttodate.Value = d3.ToString("yyyy-MM-dd");
    ...
    private void FillSF()
    {
        ...
        else
        {
            ...
            dsGV = dc.view_SS_order_view_sub(divcode, sfCode, Date, tDate, subdivision_code);
            if (dsGV.Tables[0].Rows.Count > 0)
            {
                gvtotalorder.DataSource = dsGV;
                gvtotalorder.DataBind();
    ...
    protected void catOnDataBound(object sender, EventArgs e)
    {
        for (int i = 0; i < GridViewcat.Rows.Count; i++)
        {
            ...
            catquan += int.Parse(((Label)GridViewcat.Rows[i].FindControl("stockist")).Text);
