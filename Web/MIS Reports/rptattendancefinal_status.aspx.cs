...
public partial class MIS_Reports_rptattendancefinal_status : System.Web.UI.Page
{
    ...
    string FDateWords = string.Empty;
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // imagepath = Request.QueryString["imgpath"].ToString();
        ...
        FDateWords = Request.QueryString["FDateWords"].ToString();
      ...
      lblHead.Text = "Attendance Status View for the Month of " + FDateWords + " - " + TDate;
    ...
    private void Fillstatusview()
    {
        ...
        dsGV = dc.attendance_view_status(sfCode, divcode, FDate, TDate, subdiv_code);
