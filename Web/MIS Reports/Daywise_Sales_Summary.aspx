<%@ Page Title="Daywise Sales Summary" Language="C#" MasterPageFile="~/Master.master"
    AutoEventWireup="true" CodeFile="Daywise_Sales_Summary.aspx.cs" Inherits="MIS_Reports_Daywise_Sales_Summary" %>
    ...
    <head>
        ...
        <script type="text/javascript">
            function NewWindow() {
                ...
                if (FMonth == "---Select---") { alert("Select FieldForce."); $('#<%=ddlFieldForce.ClientID%>').focus(); return false; }
                ...
                window.open("rptdaywisesummary.aspx?&Month=" + FMonth + "&Year=" + FYear + "&subdiv=" + subdiv + "&sf_code=" + ddlFF + "&Sf_Name=" + ddlFF_Name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
