...
public partial class MIS_Reports_rpt_retail_distributorwise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retail Register -Distributor Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
string stCrtDtaPnt = string.Empty;
        ...
        dsSalesForce = sf.GetStockName_Terrritoryy(divcode, territory_code,subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_retail_routewise.aspx?Stockist_Code=" + drFF["Stockist_Code"] + "&Stockist_name=" + drFF["Stockist_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.retail_Distributor_value(drFF["Stockist_Code"].ToString(), divcode, cmonth, cyear, subdivision);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            stURL = "rpt_retail_Distributor_wise_view.aspx?Stockist_Code=" + drFF["Stockist_Code"] + "&Stockist_name=" + drFF["Stockist_Name"].ToString() + " &Year=" + cyear + "&Month=" + cmonth + " &stype=" + stype + "";
...
protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        using (StringWriter sw = new StringWriter())
        {
          ...
          //   XMLWorkerHelper.GetInstance().ParseXHtml( new PdfWriter(writer), new Document(pdfDoc), new StringReader(sr));
                pdfDoc.Close();
