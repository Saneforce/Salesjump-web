    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (FYear <= TYear)
            {
                ...
                sURL = "rpt_primary_vs_secondary.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + " &TYear=" + ddlTYear.SelectedValue.ToString() + "&scode= " + Distributor.SelectedValue.ToString() + "&subdivision=" + subdiv.SelectedValue.ToString() + "&stockist_name=" + Distributor.SelectedItem.Text;
