<%@ Page Title="Order Booking Analysis" Language="C#" MasterPageFile="~/Master.master"
    AutoEventWireup="true" CodeFile="Order_Booking.aspx.cs" Inherits="MIS_Reports_Order_Booking" %>
    ...
    "top=0"
        ...
        <script type="text/javascript">
            function NewWindow() {
                ...
                window.open("Order_Booking_Analysis_month.aspx?&FYear=" + FYear + "&SF_Code=" + sfcode + "&subdiv=" + subdiv + "&sfname=" + FO + "&imgpath=" + imgpth, 'orderBooking', 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
                                ...
                                <div class="col-sm-6 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <asp:DropDownList ID="subdiv" runat="server" SkinID="ddlRequired" OnSelectedIndexChanged="subdiv_SelectedIndexChanged"
                                            CssClass="form-control" Style="min-width: 100px" Width="150" AutoPostBack="true">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
