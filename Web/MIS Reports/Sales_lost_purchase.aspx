<%@ Page Title="Lost-Products Details" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="Sales_lost_purchase.aspx.cs" Inherits="MIS_Reports_Sales_lost_purchase" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var subdivision = $('#<%=subdiv.ClientID%> :selected').text();
              ...
              window.open("rpt_sale_lost_purchase_sel_month.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdivision=" + subdiv + "&TMonth=" + TMonth + "&TYear=" + TYear, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
          }
</script>
<style type="text/css">
