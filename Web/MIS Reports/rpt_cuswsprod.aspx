<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_cuswsprod.aspx.cs" Inherits="MIS_Reports_rpt_cuswsprod" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Customerwise Product Details</title>
 ...
 <script type="text/javascript">
     function exportexcel() {
         $("#pnlContents").table2excel({
             ...
             filename: "Customerwise Product Details",
             fileext: ".xls"
         });
     };
</script>
