<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation = "false" CodeFile="samtotalorderview.aspx.cs" Inherits="MIS_Reports_samtotalorderview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Today Order View</title>
...
<body>
 ...
 ShowHeader="false" Font-Size=8pt     HorizontalAlign="Center" OnDataBound = "OnDataBound" OnRowCreated = "OnRowCreated"   OnRowDataBound="GridView1_RowDataBound"
                    ...
                    </table><table id='2' style="width: 90%;margin: auto;" >
                    <tr><td>                            </td></tr>
                    <tr>
                            ...
                            <table id="Rtsummary">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <label id="ordret" style="font-weight: 100;">Ordered Retailers ( EC ): </label></td>
                                    </tr>
                                    <tr>
                                        <td>
