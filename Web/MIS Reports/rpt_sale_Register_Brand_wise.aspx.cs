...
stCrtDtaPnt+="{label:\""+ drFF["Product_Brd_Name"].ToString()+"\",y:";
   ...
   dsDoc = sf.sale_Brand_value_categorywise(brandcode: drFF["Product_Brd_Code"].ToString(), div_code: divcode, cmonth: cmonth, cyear: cyear, catcod:  cat_code, stockistcode: stockist_code, sf_code:sfCode);
