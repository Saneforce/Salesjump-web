<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="rpt_lost_purchase_view.aspx.cs" Inherits="MIS_Reports_rpt_lost_purchase_view" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Lost Purchase Details</title>
        ...
        <div>
                <table width="100%" align="center">
                    ...
                    <td width="2.5%"></td>
                        ...
                        <td align="left">
                            <asp:Label ID="lblIDMonth" Text="Distributor" runat="server" SkinID="lblMand" 
