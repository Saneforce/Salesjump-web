<%@ Page Title="Secondary Sales-View" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master"
    CodeFile="Secondary_Sales_View.aspx.cs" Inherits="MIS_Reports_Secondary_Sales_View" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function NewWindow() {
            ...
            window.open("rpt_Secondary_Sales_View.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&Dist_Name=" + Dist_Name + "&fldforcename=" + ffd_Name + "&subdivision=" + subdiv + "&Distributor=" + Dist_Val, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
    </script>
    <style type="text/css">
