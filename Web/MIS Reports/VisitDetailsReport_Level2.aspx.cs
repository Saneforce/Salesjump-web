...
public partial class MIS_Reports_VisitDetailsReport_Level2 : System.Web.UI.Page
{
    ...
    private void FillCatg()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            if (months >= 0)
            {
                ...
                tr_lst_det.Attributes.Add("Class", "rptCellBorder");
            ...
            if (months >= 0)
            {
                ...
                tr_catg.Attributes.Add("Class", "rptCellBorder");
