...
public partial class MIS_Reports_rptattendancefinal1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Attendance Status View for the Month of " + strFMonthName + " " + FYear;
    ...
    private void Fillstatusview()
    {
        ...
        dsGV = dc.attendance_view_status(sfCode, divcode, FMonth, FYear, subdiv_code);
        ...
        {			
            if (divcode == "107")
            {
                ...
                dsGV.Tables[0].Columns.RemoveAt(5);
                dsGV.Tables[0].Columns.RemoveAt(5);
				dsGV.Tables[0].Columns.Add("Leave", typeof(string));
            }
            else
            {
                dsGV.Tables[0].Columns.RemoveAt(4);
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        string attachment = "attachment; filename=Attendance Status View.xls";
