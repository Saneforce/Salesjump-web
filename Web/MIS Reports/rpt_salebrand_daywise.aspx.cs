...
public partial class MIS_Reports_rpt_salebrand_daywise : System.Web.UI.Page
{
...
sf_code = Session["sf_code"].ToString();
        ...
        lblHead.Text = "Sale Register BrandWise Product Daywise Details for the Month of " + strFMonthName + " " + FYear;
...
tc_det_SNo.HorizontalAlign = HorizontalAlign.Right;
                ...
                if (getweekdays.Tables[0].Rows.Count > 0)
                {
                    ...
                    //    dsDrr = sd.sale_register_Branddetail_stockistwise_caterywise_daywise(div_code, FMonth, FYear, jj, drdoctor["Product_Detail_Code"].ToString(), distributor, cat_code, brand_code);
   dsDrr = sd.sale_Brand_value_categorywise(div_code: div_code,cmonth: FMonth,cyear: FYear, day: jj, product_code: drdoctor["Product_Detail_Code"].ToString(), stockistcode: distributor, catcod: cat_code, brandcode: brand_code , sf_code:sf_code);
