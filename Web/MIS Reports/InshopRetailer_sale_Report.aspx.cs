...
public partial class MIS_Reports_InshopRetailer_Sale_Report : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string GetDetails(string SF, string Sl_No)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("EXEC getInshopRetSales '" + SF + "','" + Sl_No + "'", con);
