...
public partial class rptroutedeviationnonretview_mon : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Non Available Retailer View for  " + FDate + "-" + TDate + "";
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.View_Non_Retailer_view_mon(divcode, sf_code, FDate, TDate);
