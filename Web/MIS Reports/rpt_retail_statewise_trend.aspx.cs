...
public partial class MIS_Reports_rpt_retail_statewise_trend : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = " Order Statewise Trend Analysis Details from  " + strFMonthName + " " + FYear;
        if (viewby == "Statewise")
        {
 ...
 private void FillFO()
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.Order_statewise_Trend_analysis_Distributor_descending(divcode, fromdate, todate, subdivision, state_cd);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                sURL = "rpt_order_areawise_trend.aspx?State_Code=" + drFF["State_Code"] + "&State_Name=" + drFF["statename"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&Subdivision=" + subdivision + "";
                ...
                viewby = "Statewise";
                sURL = "rpt_Ordertrend_month.aspx?State_name=" + drFF["statename"] + "&State_code=" + drFF["state_code"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                ...
                dsDoc = sf.Order_statewise_Trend_analysis_totalvalue(divcode, fromdate, todate, subdivision);
