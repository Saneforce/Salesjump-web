...
public partial class MIS_Reports_Distribution_Width : System.Web.UI.Page
{
    ...
    private void fillproduct()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            product.DataTextField = "Product_Detail_Name";
            product.DataValueField = "Product_Detail_Code";
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (FYear <= TYear)
            {
                ...
                sURL = "rpt_Distribution_Width.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + " &TYear=" + ddlTYear.SelectedValue.ToString() + "&product_code=" + product.SelectedValue.ToString() + "&product_name=" + product.SelectedItem.Text + "&stockist_code= " + Distributor.SelectedValue.ToString() + "&stockist_name=" + Distributor.SelectedItem.Text;
