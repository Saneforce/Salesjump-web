...
public partial class MIS_Reports_Rpt_Primary_Stock_Return : System.Web.UI.Page
{
    ...
    private void FillSF()
    {
        ...
        ss = new DataSet();
        dsGV = dc.primaryReturnHead(divcode, Sf_Code, FDate, TDate, subdiv_code);
    ...
    {
        string attachment = "attachment; filename=Return_Primary_Stock_Report.xls";
