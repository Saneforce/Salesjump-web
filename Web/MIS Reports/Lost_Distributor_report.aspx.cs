...
public partial class MIS_Reports_Lost_Distributor_report : System.Web.UI.Page
{
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (FYear <= TYear)
            {
                ...
                //  sURL = "rpt_lost_purchase_prac.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString()+"&Subdivision="+ subdiv.SelectedValue.ToString();
            sURL = "rpt_lost_distributor_reportpurchase.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&Subdivision=" + subdiv.SelectedValue.ToString()+"&Fieldforce="+ ddlFieldForce.SelectedValue.ToString();
