<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_Secondary_Stock_Return.aspx.cs" Inherits="MIS_Reports_Rpt_Secondary_Stock_Return" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Secondary Stock Return</title>
    ...
    <script language="Javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', ".retpro", function () {
                ...
                strOpen = "Return_Retailer_Details.aspx?FDate=" + fromdt + "&Pcode=" + ProdCode + "&TDate=" + todt + "&SF=" + sfc + "&PName=" + Prodname
