...
public partial class MIS_Reports_rptroutedeviationEffretview_mon : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       //date = Request.QueryString["date"].ToString();
        ...
        lblHead.Text = "Effective Retailer View for  " + FDate + " to "+ TDate + " ";
    ...
    private void FillSF()
    {
        ...
        Order sf = new Order();
        dsSalesForce = sf.View_Retailerdetailview_eff_Mon(divcode, sf_code, FDate, TDate);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                lit_det_usr.Text = "&nbsp;" + drFF["Trans_Detail_Name"].ToString();
                ...
                codee.Text = "&nbsp;" + drFF["SDP_Name"].ToString();
