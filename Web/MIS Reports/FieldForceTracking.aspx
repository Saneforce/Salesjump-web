<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="FieldForceTracking.aspx.cs" Inherits="MIS_Reports_FieldForceTracking" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '.btnview', function (e) {
                ...
                var Tdt = $("#<%=txtTo.ClientID%>").val();
                var SubDivCode = $("#<%=subdiv.ClientID%>").val();
                var SFName = $("#<%=ddlFieldForce.ClientID%>  option:selected").text();

                var str = 'rptFieldForceTracking.aspx?&SFCode=' + sf_code + '&FDate=' + Fdt + '&TDate=' + Tdt + '&SFName=' + SFName + '&SubDiv=' + SubDivCode;
