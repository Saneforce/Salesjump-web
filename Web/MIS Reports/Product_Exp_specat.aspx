<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Product_Exp_specat.aspx.cs" Inherits="MIS_Reports_Product_Exp_specat" %>
...
<link type="text/css" rel="Stylesheet" href="../css/rptMissCall.css" />
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, prod) {
            ...
            popUpObj = window.open("rptProduct_Exp_Detail.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&Prod=" + prod,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                if (SName == "---Select Clear---") { alert("Select Fieldforce Name."); $('#ddlFieldForce').focus(); return false; }
                var SName = $('#<%=ddlprod.ClientID%> :selected').text();
                if (SName == "---Select the Product---") { alert("Select the Product."); $('#ddlprod').focus(); return false; }
                ...
                var SName = $('#<%=rdoType.ClientID%> :selected').text();
                if (SName == "--Select--") { alert("Select Mode."); $('#rdoType').focus(); return false; }
    ...
    <%--      <asp:UpdatePanel ID="updatepanel4" runat="server">
           ...
           <br />
             <table >
               ...
               <tr>
                   <td align="left" class="stylespc" width="120px">
                        <asp:Label ID="lblprod" runat="server" SkinID="lblMand" Text="Product Name"></asp:Label>
                    </td>
                    <td align="left">
                     <asp:DropDownList ID="ddlprod" runat="server" AutoPostBack="true" SkinID="ddlRequired" 
               ...
               <tr>
                ...
                <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="lblType" runat="server" Text="Select Mode" SkinID="lblMand"></asp:Label>
                    </td>
                    <td align="left" class="stylespc">
                        <asp:DropDownList ID="rdoType" runat="server" SkinID="ddlRequired" AutoPostBack="true"  
                            onselectedindexchanged="rdoType_SelectedIndexChanged">
                            <asp:ListItem Value="-1" Text="--Select--" Selected="True"></asp:ListItem>
                            <asp:ListItem Value="0" Text="Speciality"></asp:ListItem>
                ...
                <td></td>
                    <td colspan="2" align="left">
                        <asp:CheckBoxList ID="chkspec" CssClass="chkboxLocation" CellPadding="10" RepeatColumns="3" Font-Bold="true" Font-Names="Verdana" Font-Size="11px"  RepeatDirection="vertical"  Width="300px" runat="server">
                        </asp:CheckBoxList>
                    </td>
                </tr>
                <tr class="padding" >
                <td></td>
                    <td colspan="2" align="left">
                        <asp:CheckBoxList ID="chkcat" CssClass="chkboxLocation" CellPadding="10" RepeatColumns="3" Font-Bold="true" Font-Names="Verdana" Font-Size="11px"  RepeatDirection="vertical"  Width="300px" runat="server">
                        </asp:CheckBoxList>
                    </td>
                </tr>
