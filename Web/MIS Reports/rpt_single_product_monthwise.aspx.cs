...
public partial class MIS_Reports_rpt_single_product_monthwise : System.Web.UI.Page
{
...
tc_det_SNo.Style.Add("text-align","right");
   ...
   Monthsub = sf.getMonthName(cmonth.ToString()) + "-" + cyear;
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Purchasee_Trend_analysis_Productwise_monthwise(product_code, divcode, cmonth, cyear);
