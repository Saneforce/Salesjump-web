...
public partial class MIS_Reports_InshopActivity_Orders_Report : System.Web.UI.Page
{
    ...
    public static string sfo = string.Empty;
	public static string RetNm = string.Empty;
    ...
    protected override void OnPreInit(EventArgs e)
    {
		...
		sfo = Request.QueryString["sf"];  
		RetNm = Request.QueryString["ret"];  
    ...
    [WebMethod]
    public static string GetDetails(string SF, string Ret, string dt)
    {
        ...
        {*/
            ds = SFD.getInshopActivityReports(SF, Ret, dt);
        //}
