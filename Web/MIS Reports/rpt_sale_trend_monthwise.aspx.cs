...
public partial class MIS_Reports_rpt_sale_trend_monthwise : System.Web.UI.Page
{
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Sale_Trend_analysis_stockisttotal_monthwise_distribution(drFF["Stockist_Code"].ToString(), divcode, cmonth, cyear);
                        ...
                        dsDoc = sf.sale_Trend_analysis_stockisttotal_monthwise_distribution_total(divcode, cmonth, cyear, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Sale_Trend_analysis_categorywisevalue_monthwise(drFF["Product_Cat_Code"].ToString(), divcode, cmonth, cyear);
                        ...
                        dsDoc = sf.sale_Trend_analysis_categorywisetotal_monthwise_total(divcode, cmonth, cyear, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.sale_Trend_analysis_Brandwisevalue_monthwise(drFF["Product_Brd_Code"].ToString(), divcode, cmonth, cyear);
                        ...
                        dsDoc = sf.sale_Trend_analysis_Brandwisetotal_monthwise_total(divcode, cmonth, cyear, subdivision);
