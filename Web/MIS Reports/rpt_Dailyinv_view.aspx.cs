...
public partial class MIS_Reports_rpt_Dailyinv_view : System.Web.UI.Page
{
    ...
    private void AddTotalRoww(string labelText, string ttvalue, string dispric, string ntvalue, string value, string b_inv_Total1, string s_Case_Total1, string s_string_Total1, string s_amount_Total1, string E_Case_Total1, string E_string_Total1, string E_amount_Total1, string TL_Case_Total, string TL_String_Total, string TL_Amount_Total, string IM_Case_Total, string IM_String_Total, string IN_BAL,string opcc,string opp)
    {
        GridViewRow row = new GridViewRow(0, 0, DataControlRowType.DataRow, DataControlRowState.Normal);
        ...
        row.Cells.AddRange(new TableCell[21] { new TableCell (), //Empty Cell
                                        ...
                                        new TableCell { Text = ntvalue, HorizontalAlign = HorizontalAlign.Right } ,
                                         ...
                                         new TableCell { Text = s_Case_Total1, HorizontalAlign = HorizontalAlign.Right } ,
                                         ...
                                         new TableCell { Text = E_Case_Total1, HorizontalAlign = HorizontalAlign.Right } ,
                                        ...
                                        new TableCell { Text = E_amount_Total1, HorizontalAlign = HorizontalAlign.Right },
                                         new TableCell { Text = TL_Case_Total, HorizontalAlign = HorizontalAlign.Right },
                                          new TableCell { Text = TL_String_Total, HorizontalAlign = HorizontalAlign.Right },
                                           new TableCell { Text = TL_Amount_Total, HorizontalAlign = HorizontalAlign.Right },
                                           new TableCell { Text = IM_Case_Total, HorizontalAlign = HorizontalAlign.Right },
                                           new TableCell { Text = IM_String_Total, HorizontalAlign = HorizontalAlign.Right },
                                           new TableCell { Text = IN_BAL, HorizontalAlign = HorizontalAlign.Right }
        });
    ...
    protected void OnDataBound(object sender, EventArgs e)
    {
        ...
        //this.AddTotalRow("Total",ovtotal.ToString("N2"),disctprice.ToString("N2"), nettotal.ToString("N2"), subTotal.ToString("N2"));
        this.AddTotalRoww("Total", subTotal.ToString("N2"), nettotal.ToString("N2"), ovtotal.ToString("N2"), disctprice.ToString("N2"), b_inv_Total.ToString("N2"), s_Case_Total.ToString("N2"), s_string_Total.ToString("N2"), s_amount_Total.ToString("N2"), E_Case_Total.ToString("N2"), E_string_Total.ToString("N2"), E_amount_Total.ToString("N2"), TL_Case_Total.ToString("N2"), TL_string_Total.ToString("N2"), TL_amount_Total.ToString("N2"), IM_Case_Total.ToString("N2"), IM_string_Total.ToString("N2"), IN_BAL_Total.ToString("N2"),opcase.ToString("N2"),oppiece.ToString("N2"));
    ...
    protected void gvtotalorder_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        for (int i = 0; i <= gvtotalorder.Rows.Count - 1; i++)
        {
            ...
            else
            {
                ...
                //gvtotalorder.Rows[i].Cells[6].BackColor = Color.Green;
