<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpt_retail_zonewise_report.aspx.cs" Inherits="MIS_Reports_rpt_retail_zonewise_report" %>
...
<td>
 ...
 <div id="chartContainer" style="text-align:center;height: 300px; width: 95%;"></div>
            ...
            <table width="100%" align="center">
                <tbody>
                  <tr><td align="left" >
               <asp:Label ID="lblfieldname" runat="server"  style="padding: 0px 3%;" Font-Size="14px" Text="Area:" Font-Bold="true" ></asp:Label>
