<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Rpt_Secondary_SuprStk_OrdScheme.aspx.cs" Inherits="MIS_Reports_Rpt_Secondary_SuprStk_OrdScheme" %>
    ...
    <form id="Form1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-12 sub-header">
                Secondary Retailer Scheme<span style="float: right; margin-right: 15px;">
                    ...
                    <asp:ImageButton ID="ImageButton1" runat="server" align="right" ImageUrl="~/img/Excel-icon.png"
                            Height="40px" Width="40px" OnClick="lnkDownload_Click" />
                    <%--<img style="cursor: pointer; width: 40px; height: 40px; float: right;" alt="" onclick="exportToExcel()" src="../img/Excel-icon.png" />--%>
                   </span>
            </div>
            <div class="col-lg-12">
                ...
                <table class="table table-hover" id="OrderList" style="font-size: 12px">
                    <thead class="text-warning">
                        <tr>
							...
							<th id="sfnm" style="text-align: left">Field Force</th>
                            <th id="Date" style="text-align: left">Date</th>
                            <th id="Ret_Nm" style="text-align: left">Retailer Name</th>
                            <th id="Ord_No" style="text-align: left">Order No.</th>
                            <th id="Prd" style="text-align: left">Product</th>
							<th id="schm_nm" style="text-align: left">Scheme Name</th>
        ...
        <script type="text/javascript">
            var AllOrders = []; var Orders = []; var FDT = ''; var TDT = '';
            var pgNo = 1; PgRecords = 10; TotalPg = 0;searchKeys = 'Order_Date,Order_No,Product_Name,Offer_ProductNm,ListedDr_Name,';
            ...
            function loadData() {
                $.ajax({
                    ...
                    url: "Rpt_Secondary_SuprStk_OrdScheme.aspx/GetSprStk_Schm",
                    dataType: "json",
            ...
            function exportToExcel() {
                ...
                var tets = 'Report_Secondary_Super_Stockist_Scheme' + '.xls';   //create fname
            ...
            function ReloadTable() {
                ...
                for ($i = st; $i < st + PgRecords; $i++) {
                    if ($i < Orders.length) {
                        tr = $("<tr></tr>");
                        $(tr).html("<td>" + ($i + 1) + "</td><td>"+Orders[$i].SF_Name+"</td><td>" + Orders[$i].Order_Date + "</td><td>" + Orders[$i].ListedDr_Name + "</td><td>" + Orders[$i].Order_No + "</td><td>" + Orders[$i].Product_Name + "</td><td>"+Orders[$i].Scheme_Name+"</td><td>" + Orders[$i].Offer_ProductNm + "</td><td>" + Orders[$i].Quantity + "</td><td>" + Orders[$i].free + "</td><td>" + Orders[$i].discount + "</td>");
            ...
            function fillsf() {
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "Rpt_Secondary_SuprStk_OrdScheme.aspx/GetSF",
