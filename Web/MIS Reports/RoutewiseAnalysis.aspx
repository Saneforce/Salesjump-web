<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="RoutewiseAnalysis.aspx.cs" Inherits="MIS_Reports_RoutewiseAnalysis" %>
...
<form id="form1" runat="server">
    ...
    <script type="text/javascript">
        function NewWindow() {
            ...
            window.open("RptRoutewiseAnalysis.aspx?&Fdate=" + fdate + "&Tdate=" + tdate + "&SF_code=" + ddlfo_Code + "&SF_Name=" + ddlfo_Name + "&Sub_Div=" + sub_div_code, 'SummRpt', 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');
        }
    </script>
</asp:Content>