...
public partial class MIS_Reports_Dailyinv_view: System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
         try
        {
            ...
            {*/
            string sURL = "rpt_Dailyinv_view.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&cur_month=" + ddlMonth.SelectedValue + "&cur_year=" + ddlYear.SelectedItem.Text +
