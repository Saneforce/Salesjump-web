<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptPro_val_sum.aspx.cs" Inherits="MIS_Reports_rptPro_val_sum" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Incentives Summary</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            genReport = function () {
                if (dSF.length > 0 && dProd.length > 0 && dPQV.length > 0) {
                    for (var i = 0; i < dSF.length; i++) {
                        //str = '<td><p name="sfcode" style="margin: 0 0 0px;">' + dSF[i].sfCode + '</p> </td><td><p name="sfname" style="margin: 0 0 0px;">' + dSF[i].sfName + '</p> </td><td><p name="sfhq" style="margin: 0 0 0px;">' + dSF[i].sfCode + '</p> </td>';
            ...
            $.ajax({
                ...
                async: false,
                url: "rptPro_val_sum.aspx/getdata",
                dataType: "json",
                success: function (data) {
                    ...
                    if (data.d.length > 0) {
                        ...
                        for (var i = 0; i < data.d.length; i++) {
                            ...
                            str1 += '<th>PromoValue</th><th>OrderValue</th>';
                        ...
                        $('#Product_Table thead').append('<tr class="secondhead">' + str1 + '<th>PromoValues</th><th>TC</th><th>EC</th></tr>');
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptPro_val_sum.aspx/getIssuDataTcEc",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptPro_val_sum.aspx/getSalesforce",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptPro_val_sum.aspx/getIssuData",
                data: "{'SF_Code':'" + sf_code + "', 'FYera':'" + Fyear + "', 'FMonth':'" + FMonth + "', 'SubDiv':'" + subDiv + "'}",
                dataType: "json",
                success: function (data) {
            ...
            $('#Product_Table tbody tr').each(function () {
                ...
                if ($(tds[0]).text() != "TOTAL") {
                    ...
                    if ($(tds[1]).text() != "0") {
                        $(tds[0]).html('<a class="AAA" href="rptPro_val_sum_re.aspx?&SFCode=' + $(tds[1]).text() + '&SFName=' + $(tds[0]).text() + '&FYear=' + Fyear + '&FMonth=' + FMonth + '&SubDiv=' + subDiv + '">' + $(tds[0]).text() + '</a>')
...
<body>
    ...
    <div class="row">
        <div class="col-sm-8" style="padding-left: 5px;">
            <asp:Label ID="Label2" runat="server" Text="Incentives Summary" Style="font-weight: bold;
