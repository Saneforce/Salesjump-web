...
public partial class MIS_Reports_rptEmployeewisePrimaryCategoryDetails : System.Web.UI.Page
{
    #region "Declaration"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label2.Text = "Employeewise PrimaryOrder Category Details From : " + FYear + " To " + FMonth;
    ...
    public static IssueDetails[] getcetegoryorderData(string SF_Code, string FYera, string FMonth, string SubDiv)
    {
        ...
        DataSet dsPro = exp.getPrimaryCategorywiseorderDetails(div_code, SF_Code, FYera, FMonth, SubDiv);
