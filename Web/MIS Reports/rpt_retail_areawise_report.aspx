<%@ Page Language="C#"  AutoEventWireup="true" EnableEventValidation="false" CodeFile="rpt_retail_areawise_report.aspx.cs" Inherits="MIS_Reports_rpt_retail_areawise_report" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Retail Register- AreaWise</title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>                
                    ...
                    <asp:Label ID="lblHead" Text="Retail Register-AreaWise" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
...
<td>
 ...
 <div id="chartContainer" style="text-align:center;height: 300px; width: 95%;"></div>
            ...
            <table width="100%" align="center">
               ...
               <asp:Label ID="lblfieldname" runat="server" style="padding: 0px 3%;" Font-Size="14px" Text="State:" Font-Bold="true" ></asp:Label>
