...
using System.IO;
using System.Data;
public partial class MIS_Reports_rpt_Catagory_Wise_Order : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // sfname = Request.QueryString["Sf_Name"].ToString();
        ...
        lblHead.Text = "SKU detail of " + Pdtcatname;
    ...
    private void FillSF()
    {
        ...
        dsGc = dc.categorywise_Order(divcode, sfCode, Date, subdivision_code, Pdtcatcode);                    
