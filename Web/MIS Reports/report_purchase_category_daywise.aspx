<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation="false"  CodeFile="report_purchase_category_daywise.aspx.cs" Inherits="MIS_Reports_report_purchase_category_daywise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>CategoryWise Details</title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <asp:Label ID="lblHead" Text="Category Daywise Details" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
