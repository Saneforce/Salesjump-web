...
<body>
    ...
    <script type="text/javascript">
        ...
        function ReloadTable() {
            ...
            sth += "<th rowspan = '2' > STATE</th ><th rowspan='2'>REPORTING MGR</th><th rowspan='2'>WORKING WITH</th>";
            ...
            //     const val = mymap.get(el.Sf_Code + '_' + el.DCR_Date, el.DCR_Date);
            //    if (val) {
            //        return false;
            //    }
            ...
            for (var j = 0; j < sfusers.length; j++) {
                ...
                str += '<tr><td>' + (j + 1) + '</td><td>' + sfusers[j].DCR_Date + '</td><td>' + sfusers[j].Sf_Name + '</td>';
                str += ' <td>' + sfusers[j].StateName + '</td><td>' + sfusers[j].mgr + '</td>';
                str += ' <td>' + sfusers[j].jointwrk + '</td><td>' + sfusers[j].rmrks + '</td><td>' + sfusers[j].dist_name + '</td>';
                str += ' <td>' + sfusers[j].ClstrName + '</td><td>' + sfusers[j].ST + '</td> ';
                str += '<td class="loginaddr" lat="' + sfusers[j].Start_Lat + '" long="' + sfusers[j].Start_Long + '"></td>';
                str += '<td>' + sfusers[j].ET + '</td><td class="logoutaddr" lat="' + sfusers[j].End_Lat + '" long="' + sfusers[j].End_Long + '"></td>';
