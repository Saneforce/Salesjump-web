...
public partial class MIS_Reports_rpt_sales_register_distributorwise_view : System.Web.UI.Page
{
 ...
 string stype = string.Empty;
   ...
   stype = Request.QueryString["stype"];
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblProd.Text = "Sales Register Distributor wise for the Period of " + strMonthName + " " + Year + " ";
   ...
   if (stype == "1")
        {
            ...
            dsDr = dr.sales_register_productdetail(div_code, stockist, Convert.ToInt16(Year), Convert.ToInt16(Month));
        }
        if (stype == "2")
        {
            dsDr = dr.sales_register_productdetail_total(div_code,Convert.ToInt16(Year), Convert.ToInt16(Month));
        }
