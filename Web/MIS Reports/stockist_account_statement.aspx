<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="stockist_account_statement.aspx.cs" Inherits="MIS_Reports_stockist_account_statement" %>
...
.button:hover span:after {
  ...
  <script type="text/javascript">
      function NewWindow() {
          ...
          window.open("rpt_stockist_accountstatement.aspx?&DATE=" + date + "&TODATE=" + date1 + " &subdivision=" + subdiv + "&stockist_code=" + Dist_Val + "&stockist_name=" + Dist_Name + "&product="+Product+"&productval="+productval+"&Feildforce=" + fieldforce, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
