...
public partial class MIS_Reports_rptretaileraccountstatement : System.Web.UI.Page
{
 ...
 string hdate1 = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dist_name = Request.QueryString["Retailer_name"].ToString();
    ...
    protected void BindGridd()
    {
        ...
        gg1 = gg.Getretaileraccount_statement_outstanding_value(retailer_code, hdate, tdate);
        if (gg1.Tables.Count > 0  )
        {
            if (gg1.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    fdatebal.Text = gg1.Tables[0].Rows[0][0].ToString();
                }
            }
        ...
        ff = gg.Getretaileraccount_statement(retailer_code, hdate, tdate);
