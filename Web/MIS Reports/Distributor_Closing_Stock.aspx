<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Distributor_Closing_Stock.aspx.cs" Inherits="MIS_Reports_Distributor_Closing_Stock" %>
...
<head id="Head1">
    <title>Distributor_Closing_Stock</title>
    ...
    <script type="text/javascript">
        function NewWindow() {
            ...
            window.open("Rpt_Distributor_Closing_Stock.aspx?fdate=" + FDT + "&tdate=" + TDT + "&subdiv=" + subdiv + "&dist_code=" + Dist_Val + "&Distri_name=" + distri + "&fieldforce_name=" + fieldforce + "&SFCode=" + sfCode, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
    </script>
    <style type="text/css">
...
<body>
    ...
    <div>
        ...
        <asp:UpdatePanel ID="Updatepanel1" runat="server">
            ...
            Distributor Closing Stock <span style="float: right; margin-top: -20px;">               
                        </span>                   
                   </div>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-5">
                                <button id="Button1" runat="server" onclick="NewWindow().this" class="btn btn-primary"
                                    style="width: 100px">
