<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master"  CodeFile="retail_distributorwise.aspx.cs" Inherits="MIS_Reports_retail_distributorwise" %>
...
<head id="Head1">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, prod) {
            ...
            popUpObj = window.open("rpt_retail_distributorwise.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&Prod=" + prod,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
    ...
    <div>
         <%-- <ucl:menu ID="menu1" runat="server" />--%>
           ...
           <br />
             ...
             <br />
             <br />
             <%-- <asp:Button ID="btnGo" runat="server" Width="45px" Height="29px" Text="View"  BackColor="	#6495ED"  CssClass="buttn" OnClick="btnGo_Click"
                 ForeColor="White" ><span>View</span></asp:button>--%>
