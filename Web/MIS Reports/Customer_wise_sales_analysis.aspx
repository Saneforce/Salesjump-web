...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function NewWindow() {
            ...
            if (<%=Session["div_code"]%>== "20") {
                window.open("rpt_Customer_sales_analysis_inv.aspx?SF_Code=" + str + "&FYear=" + year + "&SF_Name=" + MR_name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');
            }
            else {
