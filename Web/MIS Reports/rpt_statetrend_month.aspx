<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="rpt_statetrend_month.aspx.cs" Inherits="MIS_Reports_rpt_statetrend_month" %>
        ...
        <div>
                <table width="100%" align="center">
                    ...
                    <td width="2.5%"></td>
                        ...
                        <td align="left">
                            <asp:Label ID="lblIDhdr"  runat="server" SkinID="lblMand" FONT-FAMILY=" -webkit-pictograph" Font-Bold="true"  Font-Underline="true"></asp:Label>
                            <asp:Label ID="lblhd" runat="server" SkinID="lblMand"></asp:Label>
                        </td>
                       <td align="Center">
                            <asp:Label ID="lblIDhdr1"  runat="server" SkinID="lblMand" FONT-FAMILY=" -webkit-pictograph" Font-Bold="true"  Font-Underline="true"></asp:Label>
                            <asp:Label ID="lblhd1" runat="server" SkinID="lblMand"></asp:Label>
                        </td>
