...
public partial class MIS_Reports_rpt_retail_routewise_product_detail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        route = Request.QueryString["Route_code"];
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblProd.Text = "Retail Routewise Product Details for the Period of " + strMonthName + " " + Year + " ";
    ...
    private void CreateDynamicTable()
    {
        ...
        if (stype == "1")
        {
            ...
            dsDr = dr.retail_register_productdetail_routewise(div_code, stockist, Convert.ToInt16(Year), Convert.ToInt16(Month),route);
        }
        if (stype == "2")
        {
            dsDr = dr.retail_register_productdetail_routewise_total(div_code, Convert.ToInt16(Year), Convert.ToInt16(Month),stockist);
        }
        ...
        if (dsDr.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drdoctor in dsDr.Tables[0].Rows)
            {
                ...
                tc_det_usr.HorizontalAlign = HorizontalAlign.Left;
                ...
                lit_det_dr_name.Text =drdoctor["Quantity"]==DBNull.Value ? drdoctor["Quantity"].ToString() : Convert.ToDecimal(drdoctor["Quantity"]).ToString("0.00");// drdoctor["Quantity"].ToString("0.00");
