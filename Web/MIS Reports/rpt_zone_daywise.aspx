<%@ Page Language="C#"   EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpt_zone_daywise.aspx.cs" Inherits="MIS_Reports_rpt_zone_daywise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Zonewise Product Detail Daywise</title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <asp:Label ID="lblHead" Text="Zonewise Product Detail Daywise" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
