...
public partial class MIS_Reports_tsr_TsrSchemeRptanalysis : System.Web.UI.Page
{
    ...
    //[WebMethod]
    //public static string getArea(string divcode, string ZoneCode)
    //{
    //    DataTable dt = new DataTable();
    //    SalesForce Ad = new SalesForce();
    //    dt = Ad.GetTsrSchemeAreaList(divcode, ZoneCode);
    //    return JsonConvert.SerializeObject(dt);
    //}

    //[WebMethod]
    //public static string getZone(string AreaCode)
    //{
    //    DataTable dt = new DataTable();
    //    SalesForce Ad = new SalesForce();
    //    dt = Ad.GetTsrSchemeZoneList(AreaCode);
    //    return JsonConvert.SerializeObject(dt);
    //}

    //[WebMethod]
    //public static string getUser(string AreaCode, string ZoneCode)
    //{
    //    DataTable dt = new DataTable();
    //    SalesForce Ad = new SalesForce();
    //    dt = Ad.GetTsrSchemeUserList(AreaCode, ZoneCode);
    //    return JsonConvert.SerializeObject(dt);
    //}
}