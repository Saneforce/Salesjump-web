...
public partial class MIS_Reports_rpt_retail_territorywise_product_detail : System.Web.UI.Page
{
    DataSet dsDr = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblProd.Text = "Retail Register Territorywise Product Detail  for the Period of " + strMonthName + " " + Year + " ";
...
if (stype == "1")
        {
dsDr = dr.retail_Territorywise_purchase_productdetail(div_code, territorycode, Convert.ToInt16(Year), Convert.ToInt16(Month),subdivision);
        }

        if (stype == "2")
        {
dsDr = dr.retail_Territorywise_purchase_productdetail_total(div_code,Convert.ToInt16(Year), Convert.ToInt16(Month),subdivision);
        }
