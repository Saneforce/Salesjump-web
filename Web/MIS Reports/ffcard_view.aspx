<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="ffcard_view.aspx.cs"  Inherits="MIS_Reports_ffcard_view" %>
    ...
    <head>
        ...
        <script type="text/javascript">
            function NewWindow() {
                ...
                window.open("fieldforcecard.aspx?&Month=" + FMonth + "&Year=" + FYear + "&subdiv=" + subdiv + "&sf_code=" + ddlFF + "&Sf_Name=" + ddlFF_Name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
