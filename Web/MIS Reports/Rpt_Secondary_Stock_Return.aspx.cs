...
public partial class MIS_Reports_Rpt_Secondary_Stock_Return : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Return for Secondary Sales " + FDate +" to "+ TDate;
        FillSF();
    }
    ...
    private void FillSF()
    {
        ...
        ss = new DataSet();
        dsGV = dc.secondaryReturnHead(divcode, Sf_Code, FDate, TDate, subdiv_code);


        ss = dc.secondaryReturnDetail(divcode, Sf_Code, FDate, TDate, subdiv_code);
    ...
    protected void OnRowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            foreach (DataRow drdoctor in ff.Tables[0].Rows)
            {
                ...
                HeaderGridRow0.Cells.AddAt(HeaderGridRow0.Cells.Count - 1, HeaderCell);
            }
    ...
    {
        string attachment = "attachment; filename=Return_Secondary_Stock_Report.xls";
