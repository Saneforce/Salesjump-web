<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_lost_distributo_view.aspx.cs" Inherits="Rpt_lost_distributo_view" %>
        ...
        <div>
                <table width="100%" align="center">
                    ...
                    <td width="2.5%"></td>
                        ...
                        <td align="Center">
                            <asp:Label ID="lblIDMonth" Text="Fieldforce Name" runat="server" SkinID="lblMand" 
            ...
            <table width="100%" align="center">
                <tbody>
                    <tr>
                        <td align="center">
                            <asp:Table ID="tbl"  runat="server" class="newStly"  GridLines="Both" Width="88%">
                            </asp:Table>
                        </td>
