...
public partial class MIS_Reports_rpt_sale_Register_Brandwise_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //FillProd();
            lblProd.Text = "Sale Register Brand wise for the Period of " + strMonthName + " " + Year + " ";
...
protected void btnExport_Click(object sender, EventArgs e)
    ...
    private void CreateDynamicTable()
    {
        ...
        if (stype == "1")
        {
            dsDr = dr.sale_register_Branddetail_stockistwise_caterywise(div_code, Brand, Convert.ToInt16(Year), Convert.ToInt16(Month), catcode, stockist_code);
        }

        if (stype == "2")
        {
            dsDr = dr.sale_register_brandwisedetail_categorywise_total(div_code, Convert.ToInt16(Year), Convert.ToInt16(Month), catcode, stockist_code);
        }
