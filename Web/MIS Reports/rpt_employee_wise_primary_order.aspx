<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_employee_wise_primary_order.aspx.cs" Inherits="MIS_Reports_rpt_employee_wise_primary_order" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Employeewise Primary Order Details</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            genReport = function () {
                if (dSF.length > 0 && dProd.length > 0 && dPQV.length > 0) {
                    ...
                    for (var i = 0; i < dSF.length; i++) {
                        str = '<td><input type="hidden" name="sfcode" value="' + dSF[i].sfCode + '"/> ' + dSF[i].sfName + ' </td>'; //<p name="sfname" style="margin: 0 0 0px;">'</p>
                        var tc = 0, ec = 0;
                      ...
                      //  console.log(dSF[i].sfCode);
                        ...
                        str += '<td>' + parseFloat(TotQty).toFixed(0) + '</td><td>' + parseFloat(TotNetW).toFixed(2) + '</td><td>' + parseFloat(TotVal).toFixed(2) + '</td><td>' + tc + '</td><td>' + ec + '</td>';
            ...
            $.ajax({
                ...
                async: false,
                url: "rpt_employee_wise_primary_order.aspx/getdata",
                dataType: "json",
                success: function (data) {
                    ...
                    if (data.d.length > 0) {
                        ...
                        $('#Product_Table thead').append('<tr class="secondhead">' + str1 + '<th>QTY</th><th>Net Weight</th><th>Values</th><th>TC</th><th>EC</th></tr>');
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rpt_employee_wise_primary_order.aspx/getIssuDataTcEc",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rpt_employee_wise_primary_order.aspx/getSalesforce",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rpt_employee_wise_primary_order.aspx/getIssuData",
                data: "{'SF_Code':'" + sf_code + "', 'FYera':'" + Fyear + "', 'FMonth':'" + FMonth + "', 'SubDiv':'" + subDiv + "'}",
                dataType: "json",
                success: function (data) {
            ...
            $(document).on('click', "#btnExcel", function (e) {
                ...
                a.download = 'Employee_wise_Primary_Order_Details_' + postfix + '.xls';
