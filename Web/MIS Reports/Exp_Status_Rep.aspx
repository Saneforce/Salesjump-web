<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
    CodeFile="Exp_Status_Rep.aspx.cs" Inherits="MIS_Reports_Exp_Status_Rep" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $(document).on('click', '.btnview', function () {
                ...
                var str = 'rptExp_Status_RepView.aspx?&SFCode=' + sf_code + '&FYear=' + Fyear + '&FMonth=' + FMonth + '&SFName=' + SFName + '&SubDiv=' + SubDivCode;
                window.open(str, "Exp_Status", 'resizable=yes,toolbar=no,scrollbars=1,menubar=no,status=no,width=1100,height=700,left=0,top=0');
            });
