<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detailed_Primary_Order.aspx.cs" Inherits="MIS_Reports_Detailed_Primary_Order" %>
...
<head id="Head1" runat="server">
    <title>Detailed Primary Order View</title>
...
<body>
    ...
    <div>
      <asp:Panel ID="pnlbutton" runat="server">
		 ...
		 onclick="tablesToExcel(array1, 'myfile.xls')"">   
 ...
 ShowHeader="false" Font-Size=8pt     HorizontalAlign="Center" OnRowCreated = "OnRowCreated" OnDataBound = "OnDataBound"  OnRowDataBound="GridView1_RowDataBound"
    ...
    function generate() {
       ...
       // var doc = new jsPDF('l', 'pt');
        ...
        var header = function (data) {
            ...
            doc.text("PrimaryOrderView", data.settings.margin.top, 30);
        };
        var options = {
