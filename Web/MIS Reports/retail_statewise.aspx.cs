...
public partial class MIS_Reports_retail_statewise : System.Web.UI.Page
{
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (FYear <= TYear)
            {
                ...
                sURL = "rpt_retail_statewise_report.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&subdivision=" + subdiv.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString();
