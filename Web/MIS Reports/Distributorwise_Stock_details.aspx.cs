...
public partial class MIS_Reports_Distributorwise_Stock_details : System.Web.UI.Page
{
    ...
    public static DataSet get_Product_stock(string Date, string div_code, string stk_Code)
    {
        ...
        DataSet ds = null;
        strQry = "Exec getDistStockLedgeradmin '" + stk_Code + "','" + Date + "','" + Date + "','"+ div_code + "'";
        try
        {
    ...
    public static DataSet getDistributordetails(string sf_code, string Div_Code)
    {
        ...
        strQry = "select Stockist_Code,Stockist_Name,ERP_Code from mas_stockist ms  where Division_Code = '" + Div_Code + "' and Stockist_Active_Flag=0 order by Stockist_Name";
        try
        {
            ds = db_ER.Exec_DataSet(strQry);
        }
