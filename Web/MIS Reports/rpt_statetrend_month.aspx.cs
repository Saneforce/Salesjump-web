...
public partial class MIS_Reports_rpt_statetrend_month : System.Web.UI.Page
{
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        Purchase pf = new Purchase();
                        dsDoc = pf.statewise_Trend_analysis_value_singleProduct(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear,subdivision,State_Code);
                        ...
                        if (tot_dr != "")
                        {
                            ...
                            {
                                lit_det_sum.Text = tot_dr=="" ? tot_dr : Convert.ToDecimal(tot_dr).ToString("0.00");
                            }
                        ...
                        dsDoc = pf.statewise_Trend_analysis_value_singleProduct_total(divcode, cmonth, cyear, subdivision,State_Code);
            ...
            if (months >= 0)
            {
                ...
                for (int j = 1; j <= months + 1; j++)
                {
                    ...
                    foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
                    {
                        ...
                        Purchase gg = new Purchase();
                        dsDoc = gg.statewise_Trend_analysis_value_singleProduct(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear,subdivision,State_Code);
                        if (dsDoc.Tables[0].Rows.Count > 0)
                            tot_dr = dsDoc.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        tc_det_last6monthsum.Controls.Add(lit_det_sum);
                        tr_det.Cells.Add(tc_det_last6monthsum);
                        Purchase dff = new Purchase();
                        dsDoc = dff.areawise_Trend_analysis_singleproduct(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear, subdivision, State_Code, Areacode);
                        ...
                        dsDoc = dff.areawise_Trend_analysis_singleproduct_total(divcode, cmonth, cyear, subdivision, State_Code, Areacode);
            ...
            if (months >= 0)
            {
                ...
                for (int j = 1; j <= months + 1; j++)
                {
                    ...
                    foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
                    {
                        ...
                        Purchase pf = new Purchase();
                        dsDoc = pf.areawise_Trend_analysis_singleproduct(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear, subdivision,State_Code, Areacode);
                        if (dsDoc.Tables[0].Rows.Count > 0)
                            tot_dr = dsDoc.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
...
tc_DR_Codee.Style.Add("text-align","center");
                    Literal lit_DR_Codee = new Literal();
                    lit_DR_Codee.Text = "<center>Value</center>";
                    tc_DR_Codee.Controls.Add(lit_DR_Codee);
                    tc_DR_Codee.Attributes.Add("Class", "rptCellBorder");
                    tc_DR_Codee.BorderColor = System.Drawing.Color.Black;
                    //tc_DR_Code.Visible = false;
...
tc_det_SNo.Style.Add("text-align","center");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = df.Zonewise_Trend_analysis_totalvalue_singleprdt(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear,subdivision,State_Code,Areacode,ZoneCode);
                        ...
                        tc_det_currentmonth.Controls.Add(lit_det_mon);
                        tr_det.Cells.Add(tc_det_currentmonth);
                        Purchase jj = new Purchase();
                        dsDoc = jj.Zonewise_Trend_analysis_totalvalue_singleprdt_total(divcode, cmonth, cyear,subdivision, State_Code, Areacode, ZoneCode);
            ...
            if (months >= 0)
            {
                ...
                for (int j = 1; j <= months + 1; j++)
                {
                    ...
                    foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
                    {
                        Purchase ff = new Purchase();
                        dsDoc = ff.Zonewise_Trend_analysis_totalvalue_singleprdt(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear, subdivision,State_Code, Areacode, ZoneCode);
                        if (dsDoc.Tables[0].Rows.Count > 0)
                            tot_dr = dsDoc.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = ss.Territorywise_Trend_analysis_totalvalue_singleprt(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear, subdivision,State_Code,Areacode,ZoneCode,Territory_Code);
                        ...
                        Purchase ff = new Purchase();
                        dsDoc = ff.Territorywise_Trend_analysis_totalvalue_singleprt_total(divcode, cmonth, cyear,subdivision, State_Code, Areacode, ZoneCode, Territory_Code);
