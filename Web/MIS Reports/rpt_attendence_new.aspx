                        ...
                        if (urwt.length > 0) {
                            ...
                            for (var k = 0; k < urwt.length; k++) { //looping throw worktypes
                                while (h <= nmdys) { //whole days of an month
                                    ...
                                    var cF = urwt.filter(function (obj) {
                                        return obj.ddt1 == h;
                                    });
                                    //else {
                                        if (cF.length>0 && h == cF[0].ddt1) { //change from urwt[k].ddt1 to cF
                                            if ('<%=FMonth%>' == parseInt(mm) && '<%=FYear%>' == parseInt(yyyy) && h > parseInt(dd)) {
                                                ...
                                                var mdclr = misdt.filter(function (e) {
                                                    return ((e.Sf_Code == dUsr[j].SF_Code) && e.md == cF[0].ddt1) //change from urwt[k].ddt1 to cF
                                                });
                                                if (mdclr.length > 0) {
                                                    strr += '<td><span style="Background-color:orange;display:inline-block;width:20px;font-size:10px;">' + cF[0].WT + '</span></td>'; //change from urwt[k].ddt1 to cF

                                                }
                                                else {
                                                    strr += '<td><span style="' + ((cF[0].WT).includes('L') ? 'Background-color: yellow; ' : ((((cF[0].WT) == 'WO') || (cF[0].WT) == 'H') ? 'Background-color : lightgreen;' : 'Background-color : none;')) + 'display:inline-block;width:20px;font-size:10px;">' + cF[0].WT + '</span></td>'; //change from urwt[k].ddt1 to cF

                                                }
                                                h++;
                                                if ((cF[0].WT).includes('L')) { //change from urwt[k].ddt1 to cF
                                                    lv++;
                                                }
                                                else if (cF[0].WT == 'WO') { //change from urwt[k].ddt1 to cF
                                                    wkof++;
                                                }
                                                else if (cF[0].WT == 'H') { //change from urwt[k].ddt1 to cF
                                                    hldy++;
                                                }
                                                else if (cF[0].WT == 'FW') { //change from urwt[k].ddt1 to cF
                                                    wtyp++; 
                                                }
                                                else {
                                                    otwrk++;
