<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="rpt_sale_zonewise_product_detail.aspx.cs" Inherits="MIS_Reports_rpt_sale_zonewise_product_detail" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Sale Register Zonewise View</title>
   ...
   <asp:Panel ID="pnlbutton" runat="server">
        <table width="100%">
            ...
            <td width="20%"></td><td></td>
                ...
                <asp:Label ID="lblProd" runat="server" Text="Sale Register -ZoneWise" SkinID="lblMand" ></asp:Label>
                </td>
                <td align="right">
                    <table>
                        <tr>
