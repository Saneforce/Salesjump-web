<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeFile="Sec_od_retailerweekwise.aspx.cs" Inherits="MIS_Reports_Sec_od_retailerweekwise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Secondary Order Retailerwise Details </title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <asp:Label ID="lblHead" Text="Secondary Order Retailerwise Weekwise" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
        ...
        <div>
                <table width="100%" align="center">
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="lblIDdist" Text="Distributor :" runat="server"  Font-Bold="True" Font-Names="andalus"   SkinID="lblMand"></asp:Label>
                            <asp:Label ID="lbldist" runat="server" SkinID="lblMand"></asp:Label></td>
                       <td>&nbsp;&nbsp;   &nbsp;&nbsp;<td>
                        <td align="center">
                            <asp:Label ID="lblIDretl" Text="Retailer :" runat="server"  Font-Bold="True" Font-Names="andalus"   SkinID="lblMand"></asp:Label>
                            <asp:Label ID="lblret" runat="server" SkinID="lblMand"></asp:Label>
                        </td>
