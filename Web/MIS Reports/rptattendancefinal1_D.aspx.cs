...
public partial class MIS_Reports_rptattendancefinal1_D : System.Web.UI.Page
{
    ...
    private void Fillstatusview()
    {
        ...
        dsGV = dc.attendance_view_status_D(sfCode, divcode, FMonth, FYear, subdiv_code);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            ...
            {
                for (int colIndex = 3; colIndex < e.Row.Cells.Count; colIndex++)
                {
