<%@ Page Title="Today Primary Order View" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Today_PriOrder_view.aspx.cs" Inherits="MIS_Reports_Today_PriOrder_view" %>
            ...
            <form id="form1" runat="server">
                <div>
                    ...
                    <center>
                        <table cellpadding="0" cellspacing="5">
                            <tr>
                                <td align="left" class="stylespc">
                                    <asp:Label ID="Label3"  runat="server" SkinID="lblMand" Text=" Select Division "></asp:Label>
                                </td>
                                <td align="left">
                            ...
                            <tr>
                                <td align="left" class="stylespc">
                                    <asp:Label ID="Label1" runat="server" SkinID="lblMand" Text="From Date" Visible="true"></asp:Label>
                                </td>
                                <td align="left">
                            ...
                            <tr>
                                <td align="left" class="stylespc">
                                    <asp:Label ID="Label4" runat="server" SkinID="lblMand" Text="To Date" Visible="true"></asp:Label>
                                </td>
                                <td align="left">
                                    <input id="txtTDate" name="txtTo" type="date" CssClass="TEXTAREA" MaxLength="5"  
                                        onfocus="this.style.backgroundColor='#E0EE9D'" onblur="this.style.backgroundColor='White'" 
                                        onkeypress="AlphaNumeric_NoSpecialChars(event);" TabIndex="1" SkinID="MandTxtBox" />
                                    <asp:DropDownList ID="ddlTdt" runat="server" SkinID="ddlRequired" Width="100" Visible="false">
                                        <asp:ListItem Value="0" Text="---Select---"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="Jan"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="Feb"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="Mar"></asp:ListItem>
                        ...
                        <asp:Table ID="tbl" runat="server" BorderStyle="Solid" BorderWidth="1" GridLines="Both" Width="60%"></asp:Table>
                    </center>
