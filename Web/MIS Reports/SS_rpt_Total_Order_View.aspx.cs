...
public partial class MIS_Reports_SS_rpt_Total_Order_View : System.Web.UI.Page
{
    ...
    private void FillSF()
    {
        ...
        {
            dsGV = view_total_order_view(divcode, sfCode, Date, subdivision_code);
            if (dsGV.Tables[0].Rows.Count > 0)
            {
                gvtotalorder.DataSource = dsGV;
                gvtotalorder.DataBind();
            ...
            dsGc = view_total_order_view_categorywise(divcode, sfCode, Date, subdivision_code);
    ...
    protected void OnRowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            total += Convert.ToDecimal(dt.Rows[e.Row.RowIndex]["Sub_Total"]);
    ...
    public DataSet view_total_order_view(string div_code, string sf_code, string date, string subdiv = "0")
    {
        ...
        //string strQry = "exec [TODAY_ORDER_VIEW_DISCOUNT_FREEVAL] '" + sf_code + "','" + div_code + "','" + date + "','" + subdiv + "'";
        try
        {
    ...
    public DataSet view_total_order_view_categorywise(string div_code, string sf_code, string date, string subdivcode)
    {
        ...
        string strQry = "exec [SS_TODAY_ORDER_CATEGORY_VIEW] '" + sf_code + "','" + div_code + "','" + date + "','" + subdivcode + "'";
        try
        {
            dsAdmin = db_ER.Exec_DataSet(strQry);
        }
