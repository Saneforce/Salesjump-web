...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function NewWindow() {
            ...
            if (str == 0) {
                window.open("rptsalesmandailycallreportfl.aspx?SF_Code=" + st + "&date=" + date + "&tdate=" + tdate + "&subdiv=" + subdiv + "&SF_Name=" + sf_name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');
            }
            if (str != 0) {
                window.open("rptsalesmandailycallreportfl.aspx?SF_Code=" + str + "&date=" + date + "&tdate=" + tdate + "&subdiv=" + subdiv + "&SF_Name=" + MR_name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');
            }
    ...
    <div class="row">
        <asp:Label ID="lblFF" runat="server" SkinID="lblMand" Text="FieldForce Name" Style="text-align: right;
