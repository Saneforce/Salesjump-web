<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="rpt_sale_territorywise_purchase_report.aspx.cs" Inherits="MIS_Reports_rpt_sale_territorywise_purchase_report" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Sale Register- TerritoryWise</title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                    ...
                    <asp:Label ID="lblHead" Text="Sale Register-TerritoryWise" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
                ...
                <table  align="center">
                    <tr>                   
                        ...
                        <td width="200px">
                            ...
                            <asp:Label ID="lblIDzone" Text="Zone:"  Font-Bold="True" runat="server" SkinID="lblMand"></asp:Label>
                            <asp:Label ID="lblZone" runat="server" SkinID="lblMand"></asp:Label>
                        </td>
