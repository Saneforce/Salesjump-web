<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptattendancefinal2_D.aspx.cs" Inherits="MIS_Reports_rptattendancefinal2_D" %>
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
  ...
  <script type="text/javascript">
        ...
        $(document).ready(function () {            $('#gvtotalorder th').each(function (i) {
                ...
                if (remove == ($('#gvtotalorder tr').length - 1)) {
                    $(this).hide();
                    tds.hide();
                }
            });
...
<tr>&nbsp</tr>
       ...
       <asp:Panel ID="pnlContents" runat="server" Width="100%">
        ...
        <div align="center">
                        ...
                        <asp:GridView ID="gvtotalorder" runat="server" Width="95%"    Font-Size=9pt OnPreRender="gridView_PreRender"  CssClass="ttable"
