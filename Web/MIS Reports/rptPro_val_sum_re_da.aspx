<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptPro_val_sum_re_da.aspx.cs"
    Inherits="MIS_Reports_rptPro_val_sum_re_da" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>incentives in Reatailer Daywise</title>
   <link href="../css/bootstrap-3.3.2.min.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var cuscode = $("#<%=CusCode.ClientID%>").val();
            ...
            genReport = function () {
                if (dSF.length > 0 && dProd.length > 0 && dPQV.length > 0) {
                    ...
                    for (var i = 0; i < dSF.length; i++) {
                        ...
                        fP = dPQV.filter(function (a) { return (a.sfCode == dSF[i].sfCode); });
                        var TotVal = 0;
                        for (var j = 0; j < dProd.length; j++) {
                            console.log(dProd.length);
                            var q = "", v = "";
                            ...
                            str += '<td>' + q + '</td><td>' +v +'</td>'; //((v != "") ? parseFloat(v).toFixed(2) : "")
                            console.log(str);
                        }
                        console.log(parseFloat(TotVal).toFixed(2));
                        str += '<td>' + parseFloat(TotVal).toFixed(2) + '</td>';
            ...
            $.ajax({
                ...
                async: false,
                url: "rptPro_val_sum_re_da.aspx/getdata",
                ...
                success: function (data) {
                    ...
                    genReport();
                    if (data.d.length > 0) {
                        str = '<th  style="min-width:250px;" rowspan="2"> <p style="margin: 0 0 0px;">Retailer Name</p> </th>';
                        str1 = '';
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptPro_val_sum_re_da.aspx/getIssuData_dis",
                data: "{'SF_Code':'" + sf_code + "','cus':'" + cuscode + "', 'FYera':'" + Fyear + "', 'FMonth':'" + FMonth + "', 'SubDiv':'" + subDiv + "'}",
                dataType: "json",
                success: function (data) {
                    dSF = data.d;
                    // console.log(data.d);
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptPro_val_sum_re_da.aspx/getIssuData",
                data: "{'SF_Code':'" + sf_code + "','cus':'" + cuscode + "', 'FYera':'" + Fyear + "', 'FMonth':'" + FMonth + "', 'SubDiv':'" + subDiv + "'}",
                dataType: "json",
                success: function (data) {
...
<body>
    ...
    <asp:HiddenField ID="CusCode" runat="server" />
    <div class="row">
        <div class="col-sm-8" style="padding-left: 5px;">
            <asp:Label ID="Label2" runat="server" Text="Incentives Retailer Day wise" Style="font-weight: bold;
