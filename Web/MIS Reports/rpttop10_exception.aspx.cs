...
public partial class MIS_Reports_rpttop10_exception : System.Web.UI.Page
{
    ...
    private void FillSF_MR()
    {
        ...
        SalesForce sf = new SalesForce();
         ...
         if (sf_type == "1")
        {
            dsSalesForce = sf.Gettop10value_stockist_MR(divcode, FYear, sfCode);
        }
        else
        {
            dsSalesForce = sf.Gettop10value_stockist_MGR(divcode, FYear, sfCode);
        }
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                try
                {
                    decimal value = Math.Round(Convert.ToDecimal(drFF["value"].ToString()), 2);
                    hyp_lst_month.Text = value.ToString("0.00");
                }
                catch
                {
    ...
    private void FillSF()
    {
        ...
        SalesForce sf = new SalesForce();
        dsSalesForce = sf.Gettop10value_stockist(divcode, FYear);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                tr_det.Cells.Add(tc_det_FF);
                        ...
                        dsDoc = sf.Gettop10value_stockist_total(divcode, FYear);
...
//        dsSalesForce = sf.Gettop10value_category(divcode, FYear);
dsSalesForce = sf.Gettop10value_category(divcode, FYear,sfCode);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
             ...
             //   dsDoc = sf.Gettop10value_category_total(divcode, FYear);
...
tc_det_currentmonth.BackColor = System.Drawing.ColorTranslator.FromHtml("#cffabd");
    ...
    private void FillBrandwise()
    {
        ...
        SalesForce sf = new SalesForce();
      //  dsSalesForce = sf.Gettop10value_Brand(divcode,FYear);
dsSalesForce = sf.Gettop10value_Brand(divcode, FYear,sfCode);
...
decimal tot = 0m;
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
              ...
              //  dsDoc = sf.Gettop10value_Brand_total(divcode, FYear);
...
tc_det_currentmonth.BackColor = System.Drawing.ColorTranslator.FromHtml("#cffabd");
    ...
    private void FillProductwise()
    {
        ...
        SalesForce sf = new SalesForce();
    //    dsSalesForce = sf.Gettop10value_Product(divcode, FYear);
  dsSalesForce = sf.Gettop10value_Product(divcode, FYear,sfCode);
...
decimal tot = 0m;
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
              ...
              //  dsDoc = sf.Gettop10value_Product_total(divcode, FYear);
...
tc_det_currentmonth.BackColor = System.Drawing.ColorTranslator.FromHtml("#cffabd");
    ...
    private void Fillstatewise()
    {
       ...
       // dsSalesForce = sf.Gettopexception_statewise(divcode, FYear, state_cd);
   dsSalesForce = sf.Gettopexception_statewise(divcode, FYear, state_cd,sfCode);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                Purchase HH = new Purchase();
               // dsDoc = HH.Gettopexception_statewise_total(divcode, FYear,state_cd);
...
tc_det_currentmonth.BackColor = System.Drawing.ColorTranslator.FromHtml("#cffabd");
    ...
    private void Fillareawise()
    {
        ...
        Purchase sf = new Purchase();
      //  dsSalesForce = sf.Gettopexception_areawise(divcode, FYear, state_cd);
  dsSalesForce = sf.Gettopexception_areawise(divcode, FYear, state_cd,sfCode);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                Purchase HH = new Purchase();
                //dsDoc = HH.Gettopexception_areawise_total(divcode, FYear, state_cd);
...
tc_det_currentmonth.BackColor = System.Drawing.ColorTranslator.FromHtml("#cffabd");
    ...
    private void Fillzonewise()
    {
        ...
        Purchase sf = new Purchase();
    //    dsSalesForce = sf.Gettopexception_zonewise(divcode, FYear, state_cd);
  dsSalesForce = sf.Gettopexception_zonewise(divcode, FYear, state_cd,sfCode);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                Purchase HH = new Purchase();
              //  dsDoc = HH.Gettopexception_zonewise_total(divcode, FYear, state_cd);
...
tc_det_currentmonth.BackColor = System.Drawing.ColorTranslator.FromHtml("#cffabd");
    ...
    private void Fillterritorywise()
    {
        ...
        Purchase sf = new Purchase();
    //		    dsSalesForce = sf.Gettopexception_territorywise(divcode, FYear, state_cd);
  dsSalesForce = sf.Gettopexception_territorywise(divcode, FYear, state_cd,sfCode);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                Purchase HH = new Purchase();
             //   dsDoc = HH.Gettopexception_territorywise_total(divcode, FYear, state_cd);
