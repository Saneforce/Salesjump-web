<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_Primary_Stock_Return.aspx.cs" Inherits="MIS_Reports_Rpt_Primary_Stock_Return" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Primary Return Stock Details</title>
    ...
    <script language="Javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', ".retpro", function () {
                var ProdCode = $(this).attr('PCode');
                var Prodname = $(this).attr('Pname');
                var fromdt = $(this).attr('Fdt');
                var todt = $(this).attr('tdt');
                var sfc = $(this).attr('SF');
                //var Order_date = document.getElementById("Label2").innerHTML.split(':')[1].trim().split('-').reverse().join('-');

                strOpen = "Return_Stockist_Details.aspx?FDate=" + fromdt + "&Pcode=" + ProdCode + "&TDate=" + todt + "&SF=" + sfc + "&PName=" + Prodname
