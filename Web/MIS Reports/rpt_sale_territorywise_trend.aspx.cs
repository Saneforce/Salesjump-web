...
public partial class MIS_Reports_rpt_sale_territorywise_trend : System.Web.UI.Page
{
...
Area_name = Request.QueryString["Area_name"].ToString();
        ...
        Zone_name = Request.QueryString["Zone_name"].ToString();
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.Sales_Territorywise_Trend_analysis_Distributor_descending(divcode, fromdate, todate, subdivision, state_code, Area_code, Zone_code);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                viewby = "Territorywise";
                sURL = "rpt_salestrend_month.aspx?Territory_code=" + drFF["Territory_code"] + "&Territory_name=" + drFF["Territory_name"].ToString() + "&State_code=" + state_code + "&state_name="+ state_name +"&Area_name="+Area_name+"&Area_code=" + Area_code + "&Zone_code=" + Zone_code + "&Zone_name=" + Zone_name + "&FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                ...
                dsDoc = sf.Sales_Territorywise_Trend_analysis_totalvalue(divcode, fromdate, todate, subdivision, state_code, Area_code, Zone_code);
