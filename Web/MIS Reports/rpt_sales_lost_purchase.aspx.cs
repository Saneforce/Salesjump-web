...
public partial class MIS_Reports_rpt_sales_lost_purchase : System.Web.UI.Page
{
...
Subdivision = Request.QueryString["Subdivision"].ToString();
        ...
        lblHead.Text = "Sales Lost-Purchase Details for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
