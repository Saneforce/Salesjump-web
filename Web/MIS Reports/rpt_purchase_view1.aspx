<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="rpt_purchase_view1.aspx.cs" Inherits="MIS_Reports_rpt_purchase_view1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Distributor Wise View</title>
        ...
        <div>
                <table width="100%" align="center">
                    ...
                    <td width="2.5%"></td>
                        ...
                        <td align="Center">
                            <asp:Label ID="lblIDDistributor"  Font-Bold="True" Font-Names="Times New Roman"  Text="Distributor :" runat="server" SkinID="lblMand"></asp:Label>
                            <asp:Label ID="lbldistri" runat="server" SkinID="lblMand"></asp:Label>
                        </td>
