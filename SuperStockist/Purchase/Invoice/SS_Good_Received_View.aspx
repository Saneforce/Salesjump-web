<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Good_Received_View.aspx.cs" Inherits="SuperStockist_Purchase_Invoice_SS_Good_Received_View" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                async: false,
                url: "SS_Good_Received_View.aspx/GetPriOrderDetails",
                data: "{'Order_No':'" + ss + "'}",
                dataType: "json",
