<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Goods_Received_List.aspx.cs" Inherits="SuperStockist_Purchase_Invoice_SS_Goods_Received_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="row">
            <div class="col-lg-12 sub-header">
                Purchase GRN<span style="float: right;"><a href="../Invoice/SS_Goods_Received_Note.aspx" class="btn btn-primary btn" id="newsf">Add New</a></span><span style="float: right; margin-right: 15px;"><div id="reportrange" class="form-control mt-5 mb-5" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc;">
                    ...
                    <thead class="text-warning">
                        <tr>
                            ...
                            <th style="text-align: left">Print</th>
                             <th style="text-align: left;display:none;">DO</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
    ...
    <script language="javascript" type="text/javascript">
            ...
            for ($i = st; $i < st + PgRecords; $i++) {
                ...
                if ($i < Orders.length) {
                    ...
                    $(tr).html("<td>" + slno + "</td><td>" + Orders[$i].GRN_No + "</td><td>" + Orders[$i].GRN_Date +
                        ...
                        "</td><td>" + parseFloat(Orders[$i].Net_Tot_Goods).toFixed(2) + "</td><td>" + parseFloat(Orders[$i].Net_Tot_Tax).toFixed(2) + "</td><td>" + parseFloat(Orders[$i].Net_Tot_Value).toFixed(2) + "</td><td><a href='SS_Good_Received_View.aspx?Trans_Sl_No=" + Orders[$i].Trans_Sl_No + "&Stockist_Code=" + Orders[$i].S_No + "&Div_Code=" + Div_Code + "'><span class='glyphicon glyphicon-eye-open'></span></a></td><td><a href='SS_Grn_Print.aspx?Trans_Sl_No="+Orders[$i].Po_No+"&Div_Code=" + Div_Code + "'><span class='glyphicon glyphicon-print'></span></a></td>");
					//<td><a href='SS_Delivery_Order.aspx?Trans_Sl_No="+Orders[$i].Po_No+"&Div_Code=" + Div_Code + "'><span class='glyphicon glyphicon-print'></span></a></td>
        ...
        function loadData(tdt,fdt) {
            $.ajax({
                ...
                async: false,
                url: "SS_Goods_Received_List.aspx/GetgrnDetails",
