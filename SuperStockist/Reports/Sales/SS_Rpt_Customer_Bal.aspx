<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Rpt_Customer_Bal.aspx.cs" Inherits="SuperStockist_Reports_Sales_SS_Rpt_Customer_Bal" %>
        ...
        <script type="text/javascript">
            ...
            function get_Years(from_mnth, to_mnth, type) {
                ...
                $.ajax({
                    ...
                    url: "SS_Rpt_Customer_Bal.aspx/Get_Year_Data",
                    dataType: "json",
                    success: function (data) {
            ...
            function loadData(splited_form_year, splited_to_year, From_month, To_month, access_type) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Rpt_Customer_Bal.aspx/Get_Cust_bal",
