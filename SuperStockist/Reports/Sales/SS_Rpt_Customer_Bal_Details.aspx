<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Rpt_Customer_Bal_Details.aspx.cs" Inherits="SuperStockist_Reports_Sales_SS_Rpt_Customer_Bal_Details" %>
        ...
        $(document).ready(function () {
            ...
            function loadData() {
                $.ajax({
                    ...
                    async: false,
                    url: "SS_Rpt_Customer_Bal_Details.aspx/Get_cust_bal_details",
                    dataType: "json",
