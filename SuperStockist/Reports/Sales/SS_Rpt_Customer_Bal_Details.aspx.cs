...
public partial class SuperStockist_Reports_Sales_SS_Rpt_Customer_Bal_Details : System.Web.UI.Page
{
    ...
    public static DataSet Bind_Cust_Bal_details(string Cust_Code, string Div_Code, string From_Year, string To_Year, string From_Month, string To_Month, string Typee)
    {
        ...
        string strQry = "EXEC sp_SS_cust_bal_details '" + Cust_Code + "','" + Div_Code + "','" + From_Year + "','" + To_Year + "','" + From_Month + "','" + To_Month + "','" + Typee + "'";
    ...
    public static DataSet getretailerdetails(string scode, string divcode, string Sf_Type)
    {
        ...
        try
        {
            ...
            string strQry = "EXEC Bind_SS_sales_details '" + Sf_Type + "','" + divcode + "','" + scode + "'";
