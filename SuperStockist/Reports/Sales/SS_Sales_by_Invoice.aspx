<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Sales_by_Invoice.aspx.cs" Inherits="SuperStockist_Reports_Sales_SS_Sales_by_Invoice" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function NewWindow() {
            ...
            window.open("SS_Sales_by_Invoice_Report.aspx?&Fdate=" + fdate + "&Tdate=" + Tdate + "&stk=" + sf_code + "&retailer=" + retailer_code, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
        ...
        function retrieveRetailer() {
            ...
            $.ajax({
                ...
                async: false,
                url: "SS_Sales_by_Invoice.aspx/getRetailer",
    ...
    <form id="target_form" runat="server">
        <div class="container" style="width: 100%">
            <div class="row" style="font-size: 22px; text-align: left; font-weight: bolder; color: steelblue;">Sales By Distributor Invoice</div>
