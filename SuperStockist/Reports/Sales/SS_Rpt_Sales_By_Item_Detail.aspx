<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Rpt_Sales_By_Item_Detail.aspx.cs" Inherits="SuperStockist_Reports_Sales_SS_Rpt_Sales_By_Item_Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <form id="form1" runat="server">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <a href="#" onclick="goBack()" style="font-size: 17px;">Sale by Item</a>
                </div>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            async: false,
            url: "SS_Rpt_Sales_By_Item_Detail.aspx/Get_salebyitem_details",
            dataType: "json",
   ...
   var urlParams = new URLSearchParams(currentURL);
    var fdate = urlParams.get("FDate");
    var tdate = urlParams.get("TDate");

    var redirectURL = "SS_Rpt_Sale_By_Item.aspx?FDate=" + fdate + "&TDate=" + tdate;
        ...
        function Bind_Details() {
            ...
            for ($i = 0; Item_details.length > $i; $i++) {
                ...
                if ($i < Item_details.length) {
                    ...
                    tr = $("<tr></tr>");
                    $(tr).html("<td style='display:none';>" + Item_details[$i].Cus_Code + "</td><td>" + Item_details[$i].Cus_Name + "</td><td text-align:'right'>" + /*Item_details[$i].Qty*/ Item_details[$i].Qty + "</td><td style='text-align: right;'>" + Item_details[$i].Amt.toFixed(2) + "</td>");
                    $("#Item_Details TBODY").append(tr);
                    // <td><a id='clc' href='#' onclick= \" inv_count_click(" + Item_details[$i].no + ") \" >" + Item_details[$i].no + "</td>mm

                    qty1 = parseFloat(Item_details[$i].Qty || 0) + parseFloat(qty1);
