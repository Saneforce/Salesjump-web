<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Purchase_by_Vendor.aspx.cs" Inherits="SuperStockist_Reports_Purchase_SS_Purchase_by_Vendor" %>
        ...
        <script type="text/javascript">
            ...
            function ReloadTable() {
                ...
                for ($i = 0; Orders.length > $i; $i++) {
                    if ($i < Orders.length) {
                        tr = $("<tr></tr>");
                        $(tr).html("<td style='display:none';>" + Orders[$i].Sup_No + "</td><td>" + Orders[$i].Sup_Name + "</td><td><a id='clc' href='SS_Purchase_by_Vendor_details.aspx?Vendor_Name=" + Orders[$i].Sup_Name + "&FDate=" + fdt + "&TDate=" + tdt + "&Vendor_Id=" + Orders[$i].Sup_No + "'>" + Orders[$i].Order_count + "</td><td align=\"right\">" + Orders[$i].Total_value.toFixed(2) + "</td>");
            ...
            function loadData() {
                $.ajax({
                    ...
                    async: false,
                    url: "SS_Purchase_by_Vendor.aspx/Get_Purchase_vendor_count",
