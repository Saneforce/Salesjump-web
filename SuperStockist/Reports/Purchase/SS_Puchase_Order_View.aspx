<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Puchase_Order_View.aspx.cs" Inherits="SuperStockist_Reports_Purchase_SS_Puchase_Order_View" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            function ReloadTable() {
                ...
                $("#OrderList").append('<tfoot><tr><th colspan="4"></th><th style="text-align: right;">Total</th><th style="text-align: right;">' + qty_total + '</th><th style="text-align: right;">' + free_total + '</th><th style="text-align: right;">' + dis_tot + '</th><th style="text-align: right;">' + dis_val_tot.toFixed(2) + '</th><th id="ttt" style="text-align: right">' + tot.toFixed(2) + '</th><th id="tax_tot" style="text-align: right">' + tax_t.toFixed(2) + '</th><th id="gross_tot" style="text-align: right">' + gross_t.toFixed(2) + '</th></tr></tfoot>');
            }
        });
