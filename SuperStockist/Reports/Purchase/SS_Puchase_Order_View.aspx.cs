...
public partial class SuperStockist_Reports_Purchase_SS_Puchase_Order_View : System.Web.UI.Page
{
	 ...
	 public static DataSet getallorderbystockist(string Stockist_Code, string Div_Code, string Order_No)
        {
            ...
            //strQry = "SS_sp_get_orderby_ordno '" + Order_No + "','" + Stockist_Code + "','" + Div_Code + "'";
            string strQry = "SS_sp_get_orderby_ordno '" + Order_No + "','" + Stockist_Code + "','" + Div_Code + "'";
           // string strQry = "sp_get_orderby_ordno '" + Order_No + "','" + Stockist_Code + "','" + Div_Code + "'";
