<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Credit_Note.aspx.cs" Inherits="SuperStockist_Sales_CreditNote_SS_Credit_Note" %>
            ...
            $(document).ready(function () {
                ...
                function loadfunction() {
                    $.ajax({
                        ...
                        async: false,
                        url: "SS_Credit_Note.aspx/GetProductDetails",
                        dataType: "json",
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SS_Credit_Note.aspx/Get_SalesMan",
                        dataType: "json",
                        success: function (data) {
                    ...
                    $.ajax({
                        ...
                        url: "SS_Credit_Note.aspx/getreate",
                        dataType: "json",
                        success: function (data) {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "SS_Credit_Note.aspx/Get_Inv_customer",
                        dataType: "json",
                        success: function (data) {
                ...
                $('#Cust_id').change(function () {
                    ...
                    $.ajax({
                        ...
                        url: "SS_Credit_Note.aspx/Get_cust_inv_no",
                        dataType: "json",
                        success: function (data) {
                            $('.spinnner_div').show();
                    ...
                    $.ajax({
                        ...
                        url: "SS_Credit_Note.aspx/Get_Pre_credit_details",
                        dataType: "json",
                        success: function (data) {
                            $('.spinnner_div').show();
                ...
                $(document).on('click', '.Click_view', function () {
                    ...
                    $.ajax({
                        ...
                        url: "SS_Credit_Note.aspx/View_credit_details",
                        dataType: "json",
                        success: function (data) {
                            $('.spinnner_div').show();
                ...
                $('#Inv_no').change(function () {
                    ...
                    $.ajax({
                        ...
                        url: "SS_Credit_Note.aspx/Get_invoice_pro_details",
                        dataType: "json",
                        success: function (data) {
                            $('.spinnner_div').show();
                ...
                $(document).on('change', '.unit', function () {
                    ...
                    if (Selected_Unit == '0') {
                         toastr.info('Attention', 'select Unit');
                        //alert('select Unit');
                ...
                $(document).on('keyup paste', '[id*=Ret_qty]', function (e) {
                    ...
                    if (parseFloat(cal_val) > parseFloat(order_qty)) {
                        ...
                        all()
                           toastr.warning('Caution', 'Please Check the Quantity');
                ...
                $(document).on('click', '.btnsave', function (e) {
                    ...
                    if (credit_no == "" || credit_no == null) {
                        buttoncount = 0;
                         toastr.error('Error', 'Enter Credit Num.');
                        //alert("Enter Credit Num.");
                        $('.spinnner_div').hide();
                        return false;
                    }

                    var Credit_date = $('#datepick').val();
                    if (Credit_date.length <= 0) {
                        buttoncount = 0;
                        approve = 0;
                        toastr.error('Error', 'Select Credit_date.!!.');
                    ...
                    if (Inv_num == "0") {
                        buttoncount = 0;
                        toastr.info('Alert', 'Please Select Invoice Number.');
                    ...
                    if (Sales_man == "0") {
                        buttoncount = 0;
                         toastr.info('Alert', 'Please Select Sales Man.');
                    ...
                    if (fff.length < 1) {
                        toastr.warning('Alert', 'Please Enter Damage Quantity');
                    ...
                    var sf = ("<%=Session["Sf_Code"].ToString()%>");
                    mainarr.push({
                        Inv_no: Inv_num,
                        Date: Credit_date,
                    ...
                    $.ajax({
                        ...
                        url: "SS_Credit_Note.aspx/Save_Credit",
                        dataType: "json",
                        success: function (data) {
                            ...
                            if (data.d = "success") {
                                toastr.options = {
                                "positionClass": "toast-bottom-right",
                                "onHidden": function () { window.location.href = "../Stockist/Credit_Note_List.aspx"; }
                            }

                            toastr.success('Success', 'Credit Note Added Successfully');
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="datepick" data-validation="required" type="date" autocomplete="off" />
                            </div>
                        </div>
                    </div>
