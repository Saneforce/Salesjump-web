<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Myorderview.aspx.cs" Inherits="SuperStockist_Sales_Orders_SS_Myorderview" %>
                ...
                <table class="table table-hover" id="OrderList">
                    <thead class="text-warning">
                        <tr>
                            ...
                            <th style="text-align: Right; width: 8%;display:none;">Amount</th>
        ...
        $(document).ready(function () {
          ...
          //  window.history.go(1);
            ...
            $.ajax({
                ...
                async: false,
                url: "SS_Myorderview.aspx/GetSecOrderDetails",
                data: "{'Order_No':'" + ss + "'}",
                dataType: "json",
            ...
            function ReloadTable() {
                ...
                for ($i = 0; $i < Orders.length; $i++) {
                    ...
                    $(tr).html("<td>" + slno + "</td><td>" + Orders[$i].Sale_Erp_Code + "</td>" +
                        ...
                        //<td align='right'>" + Orders[$i].value.toFixed(2) + "</td>
						"<td align='right'>" + Orders[$i].Tax_value.toFixed(2) + "</td><td align='right'>" + parseFloat(gross).toFixed(2) + "</td>");
                ...
                $("#OrderList").append('<tfoot><tr><th colspan="4"></th><th style="text-align: right">Total</th><th style="text-align: right">' + q_tot + '</th><th style="text-align: right">' + f_tot + '</th><th style="text-align: right">' + d_tot + '</th><th id="ttt" style="text-align: right;display:none;">' + tot.toFixed(2) + '</th><th id="tax_tot" style="text-align: right">' + tax_t.toFixed(2) + '</th><th id="gross_tot" style="text-align: right">' + gross_t.toFixed(2) + '</th></tr></tfoot>');
