...
public partial class SuperStockist_Sales_Orders_SS_Myorder_Edit : System.Web.UI.Page
{
    ...
    public static string Get_Product_unit()
    {
        ...
        ds = gets_Product_unit_details(div_code, stk);
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }
    ...
    public static string GetCustWise_price()
    {
        ...
        div_code = div_code.TrimEnd(',');
		 string state_code = HttpContext.Current.Session["State"].ToString();
        string strQry = "EXEC sp_get_SSPrice_Details '" + Div + "','" + stk + "','"+state_code+"','" + Cust_Code + "'";
        ...
        if (sf_type == "5")
        {
            ...
            using (var scope = new TransactionScope())
            {
                try
                {
                    ...
                    string strQry = "exec sp_SS_Sec_Order_Edit_Save  '" + Stockist_Code + "','" + RetCode + "','" + Stockist_Code + "','" + routc + "','" + routar + "','" + RecDate + "','" + Ordrval + "','" + CollAmt + "','" + Ntwt + "','" + Remark + "','" + Disc + "','" + DisAmt + "','" + RateMode + "','" + ARC + "'," + Div_Code + ",'" + sxml + "','" + Type + "','" + ref_order + "','" + sub_total + "','" + dis_total + "','" + tax_total + "','" + Ord_id + "'";
                    int result = 0;
