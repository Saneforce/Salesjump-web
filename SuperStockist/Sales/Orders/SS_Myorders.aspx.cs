...
public partial class SuperStockist_Sales_Orders_SS_Myorders : System.Web.UI.Page
{
    #region "Declaration"
    ...
    public static DataSet getRetailOrdersByDist(string Stk, string FDate, string TDate, string type, string div)
    {
        ...
        string strQry = "exec getSS_RetailOrderByStk '" + Stk + "','" + FDate + "','" + TDate + "','" + type + "','" + div + "'";
        try
        {
    ...
    public static DataSet getProdall(string divcode, string state_code, string stk)
    {
        ...
        string strQry = "EXEC get_SSproduct_details_view '" + divcode + "','" + state_code + "','" + stk + "'";
    ...
    public static string saveorders(string NewOrd, string NewOrd_Tax_Details, string Remark, string Ordrval, string RetCode, string RecDate, string Ntwt, string retnm, string Type, string ref_order, string sub_total, string dis_total, string tax_total,
        string Extra_Tax_type, string Extra_Tax_value,string routename)
    {
        ...
        if (sf_type == "5")
        {
            ...
            using (var scope = new TransactionScope())
            {
                ...
                try
                {
                    ...
                    //da1.Fill(ds1);
                    strQry = "EXEC sv_ss_SecOrder '" + Stockist_Code + "','" + RetCode + "','" + Stockist_Code + "','" + routc + "','" + routar + "','" + RecDate + "','" + Ordrval + "','" + CollAmt + "','" + Ntwt + "','" + Remark + "','" + Disc + "','" + DisAmt + "','" + RateMode + "','" + ARC + "'," + Div_Code + ",'" + sxml + "','" + Type + "','" + ref_order + "','" + sub_total + "','" + dis_total + "','" + tax_total + "','" + sxml1 + "','"+ routecode + "'";
    ...
    public static DataSet get_rate_new_bystk(string Div_Code, string Stockist_Code, string State)
    {
        ...
        string strQry = "Exec getrateSS_new '" + Div_Code + "','" + Stockist_Code + "','" + State + "'";
    ...
    public static string Get_Route()
    {
        ...
        // DataSet ds = getDataSet("SELECT a.Territory_Code,a.Route_Code,a.Territory_Name,a.Dist_Name FROM  Mas_Territory_Creation a with (nolock) where  a.Territory_Active_Flag = 0 and a.Division_Code = '" + div_code + "' order by Territory_SNo");
    ...
    public static string GetProductdetails(string Order_Id)
    {
       // DataSet ds = getDataSet("exec Sp_Get_Sec_Print_Prd '" + Order_Id + "'");
        DataSet ds = getDataSet("exec Sp_GetSS_Sec_Print_Prd '" + Order_Id + "'");
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }
    ...
    {
        DataSet ds = getDataSet("exec [Sp_GetSS_Sec_Print_DIs] '" + Division + "','" + Stockist + "','" + Cust_code + "','" + Order_Id + "'");
