<%@ Page Title="" Language="C#" MasterPageFile="~/Master_SS.master" AutoEventWireup="true" CodeFile="SS_Invoice_Entry.aspx.cs" Inherits="SuperStockist_Sales_Invoice_SS_Invoice_Entry" %>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function ($) {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: "SS_Invoice_Entry.aspx/GetProductDetails",
                    dataType: "json",
                ...
                $.ajax({
                    type: "Post",
                    contentType: "application/json; charset=utf-8",
                    url: "SS_Invoice_Entry.aspx/bindretailer",
                    dataType: "json",
                    async: false,
                    success: function (data) {
                        ...
                        if (retailer_details.length > 0) {
                            for (var f = 0; f < retailer_details.length; f++) {
                                $('#recipient-name').append($('<option style ="' + ((retailer_details[f].Order_Flag == 0) ? 'background: #5cb85c; color: #fff;' : "") + '" value="' + retailer_details[f].Stockist_Code + '">' + retailer_details[f].Stockist_Name1 + '</option>'));
                            }
                        }
                    },
                    error: function (result) {
                ...
                $.ajax({
                    ...
                    url: "SS_Invoice_Entry.aspx/getratenew",
                    dataType: "json",
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Invoice_Entry.aspx/Get_Product_unit",
                    dataType: "json",
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    async: false,
                    data: "{'Div_Code':'" + div_code + "','Stockist_Code':'" + stockistcode + "'}",
                    url: "SS_Invoice_Entry.aspx/Get_All_Stock",
                    dataType: "json",
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Invoice_Entry.aspx/GetTransType",
                    dataType: "json",
                    success: function (data) {
                        if (data.d.length > 0) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Invoice_Entry.aspx/Get_Product_Cat_Details",
                    dataType: "json",
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Invoice_Entry.aspx/Get_Route",
                    dataType: "json",
                    success: function (data) {
                        All_Route = JSON.parse(data.d) || [];
                        $('#route-name').append("<option value='0'>---Select Territary Name---</option>");
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Invoice_Entry.aspx/GetCustWise_price",
                    dataType: "json",
                    success: function (data) {
                ...
                $('#route-name').on('change', function () {
                    ...
                    $('#recipient-name').append("<option value='0'>---Select Distributor Name---</option>");
                    ...
                    for (var f = 0; f < filtered_retailer.length; f++) {
                        ...
                        $('#recipient-name').append('<option value="' + filtered_retailer[f].Stockist_Code + '">' + filtered_retailer[f].Stockist_Name1 + '</option>');
                ...
                $('#recipient-name').change(function () {
                    ...
                    $.ajax({
                        ...
                        url: "SS_Invoice_Entry.aspx/GetWise_price",
                        dataType: "json",
                        success: function (data) {
                            Cust_Price = JSON.parse(data.d) || [];
                        },
                    ...
                    async: false,
					data: "{'retailercode':'" + retailer_ID + "'}",
                    url: "SS_Invoice_Entry.aspx/Get_Product_Tax",
                    dataType: "json",
                    success: function (data) {
                        All_Tax = JSON.parse(data.d) || [];
                    },
                    ...
                    setTimeout(function () {
                        $.ajax({
                            type: "Post",
                            contentType: "application/json; charset=utf-8",
                            url: "SS_Invoice_Entry.aspx/GetPendingOrder",
                    ...
                    $.ajax({
                        type: "Post",
                        contentType: "application/json; charset=utf-8",
                        url: "SS_Invoice_Entry.aspx/GetPendingOrder_details",
                        data: "{'Retailer_ID':'" + retailer_ID + "'}",
                        dataType: "json",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "Post",
                        contentType: "application/json; charset=utf-8",
                        url: "SS_Invoice_Entry.aspx/Get_Adv_Credit_amt_details",
                        data: "{'Retailer_ID':'" + retailer_ID + "'}",
                        dataType: "json",
                        success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Invoice_Entry.aspx/GetPayType",
                    dataType: "json",
                    success: function (data) {
                        if (data.d.length > 0) {
                        ...
                        for (var i = 0; i < multivalue.length; i++) {
                            ...
                            if (multivalue[i].Product_Code != null && multivalue[i].Unit != null) {
                                ...
                                if (multivalue[i].Type == "Order") {
                                    ...
                                    str += "<td><input class='form-control' type='text' id='Price_' name='price[]' data-cell='C1' data-format='0.00' data-validation='required' readonly=''  value=" + parseFloat(multivalue[i].Rate).toFixed(2) + " /><input type='hidden' name='stkval' stkgood='0' stkdamage='0' /></td>";
                ...
                $(document).on("focus", "#Free", function () {
                    ...
                    if (qua.length <= 0) {
                        toastr.warning('Caution', 'Enter Quantity!');
                ...
                function calc_stock(n, flag) {
                    ...
                    $(document).find('.' + pduct_code).each(function () {
                        ...
                        if (sto_filter[0].Total_Stock > 0 && sto_filter[0].Total_Stock >= ad_qty) {
                            ...
                            if (flag != 1) {
                                toastr.warning('Caution', 'Stock is not Available for the product!..');
                ...
                $(document).on('keyup', '[id*=english]', function (e) {
                    ...
                    if (row.find('.autoc').attr('t') == "") {
                        toastr.warning('Caution', 'Select Product!..');
                    ...
                    if (parseFloat(qqty) > parseFloat(row.find('#Order_qty').val())) {
                        toastr.warning('Caution', 'To increase please create a new order..');
                    ...
                    if (parseFloat($(this).val()) < parseFloat(row.find('#Order_qty').val())) {
                        ...
                        toastr.info('<div><a href="" target="">Do you want to Add the balance quantity to pending order</a></div><div><button type="button" id="okBtn" class="btn btn-primary">OK</button><button type="button" id="surpriseBtn" class="btn" style="margin: 0 8px 0 8px">Cancel</button></div>', "Attention", {
                            timeOut: "5000",
                            extendedTimeOut: "1000",
                            closeButton: true,
                            tapToDismiss: false,
                            ...
                            onShown: function (toast) {
                                $("#okBtn").click(function () {
                                    ...
                                    toastr.success('Success', 'Pending Order Saved Successfully');
                                    if (qqty == '0') {
                                        autodelalert(row);
                                    }
                                ...
                                $("#surpriseBtn").click(function () {
                                    ...
                                    toastr.info('Attention', 'Quantity Will not added to the pending order', {
                                        closeButton: true,
                                        debug: false,
                                        newestOnTop: true,
                                        progressBar: true,
                ...
                function AddRow() {
                    ...
                    data.html("<td><input type='checkbox' class='case'/></td><td>" + co + "</td> " +
                        ...
                        "<td><input class='form-control' data-validation='required' autocomplete='off' type='text' id='Price_' readonly='' name='price[]' data-format='0.00' /></td> " +
                    ...
                    $('#tblCustomers tbody tr:last').find(".item").trigger('select2:open');
                ...
                $(document).on("change", ".item", function (e) {
                    ...
                    if (selected_route_code == '' || selected_route_code == 0) {
                        toastr.info('Attention', 'Select Territary.');
                    ...
                    if (selected_cust_Code == '' || selected_cust_Code == 0) {
                        toastr.info('Attention', 'Please select Customer..');
                   ...
                   // })
                    ...
                    if (filter_unit.length > 0) {
                        ...
                        if (Pro_filter.length > 0) {
                            var unitrate = 0;
                            for (var z = 0; z < filter_unit.length; z++) {
                                if (filter_unit[z].Move_MailFolder_Id == Pro_filter[0].UnitCode) {
                    ...
                    if (Pro_filter.length > 0) {
                        ...
                        $(document).find('.' + product_code).each(function () {
                            ...
                            if (Unit_length >= row_length) {
                                ...
                                get();
                                toastr.error('Error!', 'Product Units Already Selected..');
                ...
                $(document).on('change', '.unit', function () {
                    ...
                    if (Selected_Unit_Code == '0' || Selected_Unit_Code == "") {
                        toastr.error('Error!', 'select Unit..');
                    ...
                    if (pro_filter.length > 0) {
                        toastr.error('Error!', 'Product Unit Already Selected..');
                ...
                $("#datepicker1").on('change', function () {
                    ...
                    if (selectedDate < todaysDate) {
                        toastr.warning('Caution!', 'Selected date must be greater than today date..');
                ...
                $("#datepicker").on('change', function () {
                    ...
                    var todaysDate = new Date().ddmmyyyy();
                    if (selectedDate < todaysDate) {
                        toastr.error('Error!', 'Selected date must be greater than today date..');
                        //rjalert('Error!', 'Selected date must be greater than today date..', 'error');
                        //alert('Selected date must be greater than today date');
                        $(this).val('');
                    }
                ...
                $(document).on('click', '.btnsave', function (e) {
                    ...
                    if (approve == "1") {
                        ...
                        if (Customer_Code == "0") {
                            approve = 0;
                            toastr.warning('Caution!', 'Please Select Customer..');
                            //rjalert('Error!', 'Please Select Customer..', 'error');
                            //alert("Please Select Customer.");
                            return false;
                        }
                        ...
                        $('#tblCustomers > tbody > tr').each(function () {
                            ...
                            if (un == "0") {
                                approve = 0;
                                chck = false;
                                toastr.error('Error!', 'Please Select UOM!!');
                            ...
                            if (parseInt(qt) <= 0 && $(this).find('#type').val() != 'remove') {
                                approve = 0;
                                chck = false;
                                toastr.error('Error!', 'Enter Quantity OR Remove Product!');
                        ...
                        if (stock_chck == 0) {
                            ...
                            $('#tblCustomers > tbody > tr').each(function () {
                                ...
                                if (res.length > 0) {
                                    ...
                                    else if (sales_qty == "0" || $(this).find('#type').val() == 'remove') {
                                        $(this).css('background-color', '');
                                        $(this).find('.txtQty').removeClass('focus');
                                    }
                                    else {
                            ...
                            if (flagstk > 0) {
                                toastr.error('Error!', 'Stock is not available!!.');
								approve = 0
                            ...
                            if (orderid != "" && orderid != "Direct") {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (data) {
                                                ...
                                                if (add_order_orderno.length > 0) {
                                                    ...
                                                    toastr.error('Error!', 'Order Not Saved!!');
                                ...
                                if (Pen_order_ids.length > 0) {
                                    if (chck == true) {
                                        ...
                                        $.ajax({
                                            ...
                                            contentType: "application/json; charset=utf-8",
                                            async: false,
                                            url: "SS_MyOrders.aspx/PendingOrders",
                                ...
                                if (chck == true) {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        contentType: "application/json; charset=utf-8",
                                        url: "SS_Invoice_Entry.aspx/SaveInvoice",
                                        ...
                                        success: function (data) {
                                            ...
                                            toastr.options = {
                                                ...
                                                progressBar: true,
                                                "onHidden": function () {
                                                    var url ="../Invoice/SS_Invoice_Order_List.aspx"
                                ...
                                toastr.error('Error!', 'Please Select Order Id!');
                                //rjalert('Error!', 'Please Select Order Id!..', 'error');
                                //alert("Please Select Order Id ");
                                $("#example-multiple-selected").trigger('select2:open');
                                return false;
                            }
                            ...
                            approve = 0;
                            toastr.error('Error!', 'Please Correct the Stock and Save..');
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "SS_Invoice_Entry.aspx/GetCurrStock",
                    dataType: "json",
                    success: function (data) {
                        StkDetail = data.d;
                        $('#tblCustomers  >tbody > tr').each(function () {
                ...
                $.ajax({
                    type: "Post",
                    contentType: "application/json; charset=utf-8",
                    url: "SS_Invoice_Entry.aspx/getscheme",
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea style="width: 330px;" rows="2" class="form-control txtblue" id=" txt_Ship_add"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
