...
public partial class SuperStockist_Sales_Invoice_SS_Invoice_Entry : System.Web.UI.Page
{
    ...
    public static DataSet getretailerdetailsmyorder(string scode, string divcode)
    {
        ...
        try
        {
            string strQry = "EXEC spGetdistributorName '" + scode + "','" + divcode + "'";
    ...
    {
        ds = Getpendingorder(Retailer_ID, Stockist_Code, Div_Code, Sf_Type);
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }
    public static DataSet Getpendingorder(string Retailer_ID, string Stockist_Code, string Div_code, string Sf_Type)
    {
        DB_EReporting db_ER = new DB_EReporting();
        DataSet ds = null;

        string strQry = "EXEC bindSS_pending_order '" + Sf_Type + "','" + Div_code + "','" + Stockist_Code + "','" + Retailer_ID + "'";
        //string strQry = "EXEC bind_pending_order '" + Sf_Type + "','" + Div_code + "','" + Stockist_Code + "','" + Retailer_ID + "'";
        try
        {
            ds = db_ER.Exec_DataSet(strQry);
        }
    ...
    public static  DataSet getprodDet(string Div_Code, string Stockist_Code)
    {
       ...
       string  strQry = "exec sp_SSGetProductTaxDetails '" + Div_Code + "','" + Stockist_Code + "'";
	...
	[WebMethod(EnableSession = true)]
    public static string Get_Product_Tax(string retailercode)
    {
        string Stockist_Code = retailercode;
        string div_code = HttpContext.Current.Session["div_code"].ToString();
        string state_code = HttpContext.Current.Session["State"].ToString();
        div_code = div_code.TrimEnd(',');
        DataSet ds = new DataSet();
    ...
    public static string GetCustWise_price()
    {
        ...
        //strQry = "EXEC sp_get_SSPrice_Details '" + div_code + "','" + Stockist_Code + "','" + state_code + "'";
        strQry = "EXEC sp_getSS_CustWise_Price_Details '" + div_code + "','" + Stockist_Code + "','" + state_code + "'";
    ...
    public static string Get_Route()
    {
        ...
        //ds = getDataSet("SELECT a.Territory_Code,a.Route_Code,a.Territory_Name,a.Dist_Name FROM  Mas_Territory_Creation a with (nolock) where  a.Territory_Active_Flag = 0 and a.Division_Code = '" + div_code + "' order by Territory_SNo");
        string strQry = "EXEC SS_territory '" + div_code + "','" + Stockist_Code + "'";	
    ...
    public static string GetWise_price(string retailercode)
    {
        ...
        strQry = "EXEC sp_get_SSPrice_Details '" + div_code + "','" + Stockist_Code + "','" + state_code + "','" + retailercode + "'";
        try
        {
            ds = db_ER.Exec_DataSet(strQry);
        }
