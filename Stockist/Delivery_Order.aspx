<%@ Page Title="" Language="C#" MasterPageFile="~/Master_DIS.master" AutoEventWireup="true" CodeFile="Delivery_Order.aspx.cs" Inherits="Stockist_Delivery_Order" %>
...
textarea { border: 0; font: 14px Georgia, Serif; overflow: hidden; resize: none; }
    ...
    .auto-style2 {
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    url: "Delivery_Order.aspx/BindgrnOrderDetails",
                    dataType: "json",
                    async: false,
            ...
            $("#btn_back").on('click', function (e) {
						   ...
						   window.location.href = 'Goods_Received_List.aspx'; // navigate to the specified URL
				});
                ...
                function loadData() {
                    ...
                    $.ajax({
                        type: "Post",
                        contentType: "application/json; charset=utf-8",
                        url: "Delivery_Order.aspx/BindgrnProductdetails",
                        data: "{'Order_ID':'" + sl_no + "'}",
                        dataType: "json",
                        async: false,
                        success: function (data) {
        ...
        <asp:HiddenField ID="hid_cust" runat="server" />
                        ...
                        <button id="btn_back" class="btn btn primary" style="background-color: #ffffff;"> Back</button>
                        </div>
