    ...
    fmcgAPI.addMAData = function(method, url, choice, data) {
        ...
        switch (choice) {
            ...
            case "2":
                ...
                resultData.push({
                    'unlisted_doctor_master': unlisted_doctor_master
                });
            ...
            case "8":
                ...
                if (data.photosList != undefined) {
                    for (var i = 0, len = data['photosList'].length; i < len; i++) {
                        ...
                        if(data['photosList'][i]['Type']==1){
                        tempOb['imgurl'] = addQuotes(imgUrl.substr(imgUrl.lastIndexOf('/') + 1));
                        }else{
                            tempOb['imgurl'] = addQuotes(imgUrl.substr(imgUrl.lastIndexOf('?') + 1)+'.jpg');
                        }
            ...
            case "28":
                ...
                resultData.push({
                    "ActivityCaptures": Activity_Event_Captures
                });
                resultData.push({
                    'Expense_New': data.Expens_Save
                });
                break;
            case "30":
                resultData.push({
            ...
            case "31":
                ...
                resultData.push({
                    "No0fcoupen": data['Coupons']
                });
                resultData.push({
                    "Retailer": data['Retailername']
                });
                resultData.push({
                    'Distributors': data['inshopDisti']
                });
                resultData.push({
                    'Route': data['inshopRoute']
                });
                resultData.push({
                    "ActivityCaptures": Activity_Event_Captures
                });
            ...
            case "32":
                ...
                resultData.push({
                    'Inshop_Activity': DoortoDoorserver
                });
                resultData.push({
                    "Remarks": data['Remarks']
                });
                ...
                resultData.push({
                    'Inshop_Activity_Orders': activity_sample_reports
                });
                resultData.push({
            ...
            case "46":
                ...
                resultData.push({
                    'Supplier_Master': data['Remarks']
                });
                resultData.push({
                    "Remarks": data['Remarks']
                });
                resultData.push({
                    'Supplier_Master_Orders': activity_sample_reports
                });
                resultData.push({
                    'SupplierName': data['doctor']['name']
                });
                resultData.push({
                    'Route': data['SupplierRoute']
                });
                break;
            case "33":
                var TP_Attendance = {}
            ...
            case "34":
                ...
                resultData.push({
                    'Product_Display_Activity': DisplayActivity
                });
                resultData.push({
                    "Remarks": data['Remarks']
                });
                ...
                resultData.push({
                    'Retailer': data['doctor']['id']
                });
                resultData.push({
                    'Distributors': data['stockist']['selected']['id']
                });
                resultData.push({
                    'Route': data['cluster']['selected']['id']
                });
                resultData.push({
                    'FieldForceName': data['FieldForceName']
                });
                resultData.push({
                    'HQSfCode': data['HQSfCode']
                });
            ...
            case "37":
                ...
                resultData.push({
                    'FieldDemo_Activity_Orders': activity_sample_reports
                });
                resultData.push({
                    'FormarName': data['FormarName']
                });
                resultData.push({
            ...
            case "40":
                ...
                resultData.push({
                    'Inshop_Activity_CheckIn': InshopCheckinserver
                });
                resultData.push({
                    "Remarks": data['Remarks']
                });
            ...
            case "45":
                ...
                resultData.push({
                    'NewContact': activity_sample_reports
                });
                resultData.push({
                    'NewContactOrder': FieldDemo
                });
            ...
            case "53":
                ...
                resultData.push({
                    'unlisted_Expense_start': unlisted_doctor_master
                });
...
Multidistiname = '', MultidistiCode = '';
                if (data.MultiDistributor != undefined) {
                    for (var t = 0, jwlen = data.MultiDistributor.length; t < jwlen; t++) {
                        if (t != 0)
                            Multidistiname += ",";
                        MultidistiCode += ",";
                        Multidistiname += data.MultiDistributor[t].name;
                        MultidistiCode += data.MultiDistributor[t].jointwork;

                    }
                }
                Tour_Plan.RouteName = addQuotes(data.Route_Name);
                Tour_Plan.POB = addQuotes(data.POB);
                Tour_Plan.SOB = addQuotes(data.SOB);
                Tour_Plan.RouteCode = addQuotes(data.Route_id);
                Tour_Plan.Multiretailername = addQuotes(Multiretailername);
                Tour_Plan.MultiretailerCode = addQuotes(MultiretailerCode);
                Tour_Plan.Multidistiname = addQuotes(Multidistiname);
                Tour_Plan.MultidistiCode = addQuotes(MultidistiCode);
                Tour_Plan.worked_with = addQuotes(jointWorkString);
                if (data.SF_type == 2) {
                    Tour_Plan.HQ_Code = addQuotes(data.HQ_Code);
                    Tour_Plan.HQ_Name = addQuotes(data.HQ_Name);
                ...
                //  Tour_Plan.Market = addQuotes(data.market);
                resultData.push({
                    'Tour_Plannew': Tour_Plan
                });
                break;
            case "62":
                var Vansalesreject = {};
                Vansalesreject.Sf_Code = data.Sf_code;
                Vansalesreject.Reason = data.reason;
                resultData.push({
                    'Vansalesreject': Vansalesreject
                });
                break;
        }
    ...
    fmcgAPI.saveDCRData = function(method, url, data, update) {
        ...
        activity_report_APP['RateEditable']=addQuotes(((data['RateEditable']!=undefined && data['RateEditable']!=null)?data['RateEditable']:0));
            ...
            case "1":
                ...
                if (data.productSelectedList != undefined) {
                    for (var i = 0, len = data['productSelectedList'].length; i < len; i++) {
                        ...
                        UnitName = data['productSelectedList'][i]['UnitName'];
                        tempOb['UnitName'] = (UnitName == null) ? '' : UnitName;
                ...
                if (data.productSelectedList != undefined) {
                    for (var i = 0, len = data['productSelectedList'].length; i < len; i++) {
                        if (data['productSelectedList'][i]['rx_qty'] > 0 || data['productSelectedList'][i]['Prx_qty'] > 0 || data['productSelectedList'][i]['cb_qty'] > 0) {
                            ...
                            Rate = data['productSelectedList'][i]['Rate'];
                            tempOb['Rate'] = (Rate == null) ? 0 : Rate;
                            PieseRate = data['productSelectedList'][i]['PieseRate'];
                            tempOb['PieseRate'] = (PieseRate == null) ? 0 : PieseRate;
                            Qty = data['productSelectedList'][i]['discount'];
                            tempOb['discount'] = (Qty == null) ? 0 : Qty;
                            Qty = data['productSelectedList'][i]['FreeP_Code'];
                            tempOb['FreeP_Code'] = (Qty == null) ? 0 : Qty;
