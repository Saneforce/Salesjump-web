...
function addEntry() {
 ...
 case "doortodoor":
   ...
   $ARCd = "0";
			...
			$ww=$vals["worked_with"];
$sql = "{call  svDoorToDoor('" . $sfCode . "'," . $vals["sf_member_code"] . ",'" . date('Y-m-d H:i:s') . "'," . $vals["cluster"] . "," . $vals["remarks"] . ",'" . $Owndiv . "'," . $vals["ClstrName"] . "," . $vals["stockist"].",$ww,".$vals['numberofcoupens'].",".$vals['imagString'].",".$vals['retailorcode'].", ".$vals['retailorname'].")}";
