...
$sql = "{call  svDoorToDoor('" . $sfCode . "'," . $vals["DataSF"] . ",'" . date('Y-m-d H:i:s') . "'," . $tableData['DoorToDoor']["Town_code"] . "," . $vals["Daywise_Remarks"] . ",'" . $Owndiv . "'," . $tableData['DoorToDoor']["Town_name"] . "," . $tableData['DoorToDoor']["stockist"].",".$tableData['DoorToDoor']["Worked_With"].",".$tableData['DoorToDoor']['numberofcoupens'].",".$tableData['DoorToDoor']['imagString'].",".$tableData['DoorToDoor']['doctor_code'].", ".$tableData['DoorToDoor']['doctor_name'].")}";
