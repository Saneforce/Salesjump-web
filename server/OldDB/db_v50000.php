...
$sql = "SELECT activity.trans_slno FROM vwActivity_Report activity
inner join vwactivity_msl_details msl on msl.trans_slno=activity.trans_slno
where activity.SF_Code='" . $sfCode . "' and cast(activity.activity_date as datetime)=cast('$today' as datetime) and sdp=$townCode";
