...
public partial class MIS_Reports_rpt_territory_trend : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Territorywise Trend Analysis Details from  " + strFMonthName + " " + FYear;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.Territorywise_Trend_analysis_Distributor_descending(divcode, fromdate, todate, subdivision, state_code, Area_code,Zone_code);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_statetrend_month.aspx?Territory_code=" + drFF["Territory_code"] + "&Territory_name=" + drFF["Territory_name"].ToString() + "&State_code=" + state_code + "&Area_code=" + Area_code + "&Zone_code="+Zone_code+"&FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                ...
                dsDoc = sf.Territorywise_Trend_analysis_totalvalue(divcode, fromdate, todate, subdivision, state_code, Area_code, Zone_code);
