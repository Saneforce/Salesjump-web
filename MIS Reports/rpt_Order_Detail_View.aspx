<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="rpt_Order_Detail_View.aspx.cs" Inherits="MIS_Reports_rpt_Order_Detail_View" %>
    ...
    <div>
       ...
       <div>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:Label ID="Lbl_Ex_Name" runat="server" Font-Bold="true" SkinID="lblMand" 
                            Text=""></asp:Label>
                        <br />
                        <asp:Label ID="Lbl_Retailer" runat="server" Font-Bold="true" SkinID="lblMand" 
                            Text=""></asp:Label>
                    </td>
                    <td align="left">
                        <asp:Label ID="Lbl_Fo" runat="server" Font-Bold="true" SkinID="lblMand" 
                            Text=""></asp:Label>
                        <br />
