<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Primary_Order_View.aspx.cs" Inherits="MIS_Reports_Primary_Order_View" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Primary_Order_View</title>
    <style type="text/css">
        #tblDocRpt
        {
            margin-left: 300px;
