<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mgr_rptNew_Outlet_List.aspx.cs" Inherits="MIS_Reports_mgr_rptNew_Outlet_List" %>
    ...
    <script type="text/javascript">
        ...
        function getSFName() {
            return $.ajax({
                ...
                async: true,
                url: "mgr_rptNew_Outlet_List.aspx/getSalesforce",
                dataType: "json",
        ...
        function getStockistName() {
            return $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: true,
                url: "mgr_rptNew_Outlet_List.aspx/getStockist",
                dataType: "json",
                success: function (data) {
        ...
        function loadData() {
            return $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: true,
                url: "mgr_rptNew_Outlet_List.aspx/GetData",
