...
public partial class rpt_non_retailer_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Non-Available Retailers View for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.retail_routewise_non_available_retailer_name(dist, divcode, Territory_Code, product_code, FMonth, FYear);
