...
public partial class MIS_Reports_Trend_Analysis : System.Web.UI.Page
{
 ...
 subdiv.Items.Insert(0, new ListItem("--Select--", "0"));
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        if (viewdrop.SelectedItem.Text == "Statewise")
        {
            ...
            sURL = "rpt_statewise_trend.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&Subdivision=" + subdiv.SelectedValue.ToString() + "&viewby=" + viewdrop.SelectedItem.Text + "&FYear=" + ddlFYear.SelectedValue.ToString();
        }
        else
        {
            ...
            sURL = "rpt_distributor_trend.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&Subdivision=" + subdiv.SelectedValue.ToString() + "&viewby=" + viewdrop.SelectedItem.Text + "&FYear=" + ddlFYear.SelectedValue.ToString();
        }
