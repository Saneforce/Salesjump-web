...
public partial class Salesmandailycallreportfl : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            fillsubdivision();
            sub_division = subdiv.SelectedValue.ToString();
            FillManagers();
    ...
    private void FillManagers()
    {
        ...
        if(subdiv.SelectedValue.ToString() == "0")
        {
			if(div_code=="219")
			{
				dsSalesForce = sf.UserList_HQ1(div_code, "admin", "0");
			}
		else{
			dsSalesForce = sf.UserList_HQ(div_code, "admin");
		}
        ...
        {
            dsSalesForce = sf.UserList_HQ1(div_code, "admin", subdiv.SelectedValue.ToString());
            ddlFieldForce.Items.Clear();
            ddlFieldForce.DataTextField = "sf_name";
            ddlFieldForce.DataValueField = "sf_code";
            ddlFieldForce.DataSource = dsSalesForce;
    ...
    private void FillMRManagers_MR()
    {
        ...
        dsSalesForce = sf.SalesForceListMgrGet1(div_code, ddlFieldForce.SelectedValue.ToString(), subdiv.SelectedValue.ToString());
    ...
    //    dsSalesForce = sf.UserList_AlphaAll(div_code, "admin", "1");
