<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Customer_wise_target_VS_sales_analysis.aspx.cs" Inherits="MIS_Reports_Customer_wise_target_VS_sales_analysis" %>
    ...
    <script type="text/javascript">
        ...
        function NewWindow() {
            ...
            if (monthDiff(dt1, dt2) > 0 || (FMonth == TMonth && FYear <= TYear)) {
                ...
                if (type == 1) {
                    window.open("rptProductwiseTargetvsSales.aspx?SF_Code=" + str + "&FYear=" + FYear + "&SF_Name=" + MR_name
                    + "&FMonth=" + FMonth
                    + "&TYear=" + TYear
                    + "&TMonth=" + TMonth
                    + "&subDiv=" + subDiv
                    ...
                    window.open("rpt_Customer_target_VS_sales_analysis.aspx?SF_Code=" + str + "&FYear=" + FYear + "&SF_Name=" + MR_name
                    + "&FMonth=" + FMonth
                    + "&TYear=" + TYear
                    + "&TMonth=" + TMonth
                    + "&subDiv=" + subDiv
                   ...
                   window.open("rpt_PriFieldforce_target_VS_sale_analysis.aspx?SF_Code=" + st + "&FYear=" + FYear + "&SF_Name=" + sf_name
                        + "&FMonth=" + FMonth
                        + "&TYear=" + TYear
                        + "&TMonth=" + TMonth
                        + "&subDiv=" + subDiv
                    ...
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="ddlType" runat="server" SkinID="ddlRequired" CssClass="form-control"
                            ...
                            <asp:ListItem Value="1" Text="Product"></asp:ListItem>  						
 							<asp:ListItem Value="4" Text="FieldForce"></asp:ListItem>                          
                        </asp:DropDownList>                       
                    </div>
                </div>
            </div>
