<%@ Page Title="Monthly Attendance" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Attendance_view_D.aspx.cs" Inherits="MIS_Reports_Attendace_view_D" %>
...
<script type="text/javascript">
 ...
 if (type == 'Status') {
     ...
     window.open("rptattendancefinal1_D.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdiv=" + subdiv + "&sfCode=" + sfcode + "&sfname=" + FO + "&type=" + type + "&imgpath=" + imgpth, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
 else if (type=='Typewise') {
     window.open("rptattendancefinal2_D.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdiv=" + subdiv + "&sfCode=" + sfcode + "&sfname=" + FO + "&type=" + type + "&imgpath=" + imgpth, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
        else {
            window.open("rptattendancefinal_D.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdiv=" + subdiv + "&sfCode=" + sfcode + "&sfname=" + FO + "&type=" + type + "&imgpath=" + imgpth, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
    }
</script>
...
<div class="col-md-2 inputGroupContainer">
                ...
                <asp:Label ID="Label2" runat="server" SkinID="lblMand" Text="Select Sales Executive Officer" Visible="false"></asp:Label></td><td align="left">
                   <asp:DropDownList ID="ddlFieldForce" Visible="true" runat="server" SkinID="ddlRequired" AutoPostBack="true"
                        CssClass="ddl" Width="210px" style="display:none;" > 
                       <asp:ListItem Value="admin">Admin</asp:ListItem>
                   </asp:DropDownList>
             

                   <asp:DropDownList ID="view" runat="server" CssClass="form-control"  Visible="true"  Width="150">
