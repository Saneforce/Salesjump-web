...
<link rel="Stylesheet" href="../css/kendo.common.min.css" />
                ...
                <thead class="text-warning">
                   <tr>                          
                       ...
                       <!-- <th id="TotHrs" style="text-align:left">Working Hours</th>-->
                        ...
                        <th id="OrderValue" style="text-align:left">Order Value</th>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var sortid = '';
        var asc=true;//
        var Orders = []; pgNo = 1; PgRecords = 10; TotalPg = 0; searchKeys = "SF_Name,WrkDate,DistName,Rut_Name,Ret_Name,Promotor,Start_Time,End_Time,Value,OrderValue,Rmks";
