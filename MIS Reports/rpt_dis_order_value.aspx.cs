...
public partial class MIS_Reports_rpt_dis_order_value : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //years = Convert.ToInt32(Request.QueryString["Year"].ToString());
       ...
       // Stockist_Code = Request.QueryString["Stockist_Code"].ToString();
        ...
        lblhead1.Text = "Distributer Wise Secondary Orders Summary  - <b>" + Year + "</b>";
        //lblsf.Text = "Distributer Wise";
        FillSF();
    ...
    private void FillSF()
    {
        ...
        Target_Dt.Columns.Add("Territory", typeof(string));
        ...
        DataSet dsTO = null;
            ...
            dsTO = od.get_dis_order_value(div_code, Year, sf_code);
        ...
        foreach (DataRow dr in dsTO.Tables[0].Rows)
        {
            ...
            Target_Dt.Rows.Add(dr["Stockist_Code"].ToString(), dr["Stockist_Name"].ToString(), dr["Territory"].ToString(), jano, febo, maro, apro, mayo, juno, julo, augo, sepo, octo, novo, deco, TOT_Ot);
