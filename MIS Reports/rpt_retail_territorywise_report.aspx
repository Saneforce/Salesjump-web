<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpt_retail_territorywise_report.aspx.cs" Inherits="MIS_Reports_rpt_retail_territorywise_report" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Retail Register- TerritoryWise</title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <asp:Label ID="lblHead" Text="Retail Register-TerritoryWise" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
...
<div id="chartContainer" style="text-align:center;height: 300px; width: 95%;"></div>
            ...
            <table width="100%" align="center">
                <tbody>
                 <tr><td align="left" ></td><td>&nbsp</td>
               <asp:Label ID="lblfieldname" runat="server" style="padding: 0px 3%;" Font-Size="14px" Text="Zone:" Font-Bold="true" ></asp:Label>
