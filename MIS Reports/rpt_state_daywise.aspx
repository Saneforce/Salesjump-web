<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation="false" CodeFile="rpt_state_daywise.aspx.cs" Inherits="MIS_Reports_rpt_state_daywise" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Statewise Product Detail Daywise</title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <td width="80%" align="center"   style="padding-left:20px;">
                    <asp:Label ID="lblHead" Text="Statewise Product Detail Daywise" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
