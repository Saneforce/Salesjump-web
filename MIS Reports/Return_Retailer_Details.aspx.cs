...
public partial class MIS_Reports_Return_Retailer_Details : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retailer Details For " + Pname;
        FillSF();
    }
    private void FillSF()
    {
        ...
        dsGV = dc.getproductwisecus(Fdate, Pcode,Tdate,Sf_Code);
    ...
    {
        string attachment = "attachment; filename=Productwise_Retailer_Details.xls";
