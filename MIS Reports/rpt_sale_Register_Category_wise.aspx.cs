...
public partial class MIS_Reports_rpt_sale_Register_Category_wise : System.Web.UI.Page
{
...
subdivision = Request.QueryString["subdivision"].ToString();
        ...
        lblHead.Text = "Sale Register-Category Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
stCrtDtaPnt+="{label:\""+ drFF["Product_Cat_Name"].ToString()+"\",y:";
                ...
                stURL = "rpt_sale_Register_Brand_wise.aspx?Stockist_Code=" + stockist_code + "&Stockist_name=" + Stock_name + " &cat_Code=" + drFF["Product_Cat_Code"] + " &cat_name=" + drFF["Product_Cat_Name"].ToString() + "&FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + " &sCurrentDate=" + sCurrentDate + "&subdivision=" + subdivision + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                     ...
                     //   dsDoc = sf.sale_catogory_wise_sale_value_stockist(drFF["Product_Cat_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate, stockist_code);
  dsDoc = sf.sale_catogory_wise_sale_value_stockist(productcatname: drFF["Product_Cat_Code"].ToString(), divcode: divcode, cmonth: cmonth, cyear: cyear, stockistcode: stockist_code,sf_code:sfCode);
  ...
  stype = "1";
                            ...
                            stURL = "rpt_sale_category_weekwise.aspx?Stockist_Code=" + stockist_code + "&Stockist_name=" + Stock_name + " &cat_Code=" + drFF["Product_Cat_Code"] + " &cat_name=" + drFF["Product_Cat_Name"].ToString() + "&Year=" + cyear + "&Month=" + cmonth + " &stype=" + stype + "&subdivision=" + subdivision + "";
