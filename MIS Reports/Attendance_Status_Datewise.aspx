<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Attendance_Status_Datewise.aspx.cs" Inherits="MIS_Reports_Attendance_Status_Datewise" %>
     ...
     <script type="text/javascript">
         ...
         $(document).ready(function () {
             ...
             $('#btnview').on('click', function () {
                ...
                if (sfcode == '') {
                 ...
                 url = "rptattendancefinal_daywise.aspx?sf_code=" + sfcode + "&div_code=" + <%=Session["div_code"]%> + "&subdiv=" + subdiv +
                        "&Sf_Name=" + sfname + "&FromDate=" + fdate + "&FDateWords=&ToDate=" + tdate;
         ...
         function loadDivision(ssdiv) {
             $.ajax({
                 ...
                 async: false,
                 url: "Attendance_Status_Datewise.aspx/getDivision",
        ...
        liveSearch: true
         ...
         function loadFieldForce() {
             ...
             $.ajax({
                 ...
                 contentType: "application/json; charset=utf-8",
                 async: false,
                 url: "Attendance_Status_Datewise.aspx/getFieldForce",
