...
public partial class MIS_Reports_rpt_dis_orderRUT_value : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblhead1.Text = "Route Wise Secondary Orders Summary- <b>" + Year + "</b>";
        //lblsf.Text = "Route Wise";
        FillSF();
    ...
    private void FillSF()
    {
        ...
        DataTable Target_Dt = new DataTable();
          Target_Dt.Columns.Add("Territory_Code", typeof(string));
        Target_Dt.Columns.Add("Territory_Name", typeof(string));
        ...
        dsTO = od.get_dis_orderRUT_value(div_code, Year, Stockist_Code);
        ...
        foreach (DataRow dr in dsTO.Tables[0].Rows)
        {
            ...
            Target_Dt.Rows.Add(dr["Territory_Code"].ToString(), dr["Territory_Name"].ToString(), jano, febo, maro, apro, mayo, juno, julo, augo, sepo, octo, novo, deco, TOT_Ot);
