<%@ Page Title="Daily Inventory ImBalance view" Language="C#" MasterPageFile="~/Master.master"
    AutoEventWireup="true" CodeFile="Dailyinv_view.aspx.cs" Inherits="MIS_Reports_Dailyinv_view" %>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#<%=btnSubmit.ClientID%>').click(function () {
                    ...
                    //                    var FieldForce = $('#<%=subdiv.ClientID%> :selected').text();
                    //                    if (FieldForce == "--Select--") { alert("Select Sub Division Name."); $('#<%=subdiv.ClientID%>').focus(); return false; }
