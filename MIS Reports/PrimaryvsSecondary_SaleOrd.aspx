...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $("#savBtn").on('click', function () {
            ...
            var stateNm = $("#ddlst option:selected").text()
            var state = $("#ddlst").val();
            var MGR = $("#ddlmgr").val();
            var SF = $("#ddlso").val();
            ...
            var SubdivNm = $("#ddlsubdiv option:selected").text() == 'Nothing Select' ? '' : $("#ddlsubdiv option:selected").text();
            var SFnm = $("#ddlso option:selected").text() == 'Nothing Select' ? '' : $("#ddlso option:selected").text();
            var MGRNm = $("#ddlmgr option:selected").text() == 'Nothing Select' ? '' : $("#ddlmgr option:selected").text();
            var URL = "rpt_pri_VS_sec_saleorder.aspx?sfcode=" + SF + "&stateNm=" + stateNm + "&RSf=" + MGR + "&state=" + state + "&Subdiv=" + Subdiv + "&PrdNm=" + Prd_Nm + "&PrdGrp=" + Prd_Grp + "&PrdCat=" + Prd_Cat + "&Frm_Dt=" + FDT + "&To_Dt=" + TDT + "&RSfNm=" + MGRNm + "&sfNm=" + SFnm + "&Divnm=" + SubdivNm + "";
        ...
        $("#ddlst").on('change', function () {
            ...
            if (Mgrfilter.length > 0) {
                ...
                for (var i = 0; i < Mgrfilter.length; i++) {
                    str += "<option value=" + Mgrfilter[i].Sf_Code + ">" + Mgrfilter[i].Sf_Name + "</option>";
                }
                $("#ddlmgr").append(str);
