<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Retailer_Offtake.aspx.cs" Inherits="MIS_Reports_Retailer_Offtake" %>
...
.button:hover span:after {
  ...
  <script type="text/javascript">
      function NewWindow() {
          ...
          window.open("rpt_retailer_offtake.aspx?&subdivision=" + subdiv + "&Route_code=" + Route_code + "&Route_name=" + Route_name + "&Retailer_code=" + Retailer_code + "&Retailer_name=" + Retailer_name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
               ...
               <tr><td> <asp:Label ID="Label2" runat="server" SkinID="lblMand" Text="Select Division"></asp:Label></td><td align="left">
                ...
                <tr><td> <asp:Label ID="Label5" runat="server" SkinID="lblMand" Text="Select Fieldforce"></asp:Label></td><td align="left">
                   <asp:DropDownList ID="ddlFieldForce" runat="server"  SkinID="ddlRequired"   AutoPostBack="true"   CssClass="ddl" Width="210px"
                    ...
                    <tr><td> <asp:Label ID="Label1" runat="server" SkinID="lblMand" Text="Select Distributor"></asp:Label></td><td align="left">
                   <asp:DropDownList ID="Distributor" runat="server" SkinID="ddlRequired" 
                            CssClass="ddl" Width="210px"   AutoPostBack="true"
                            onselectedindexchanged="Distributor_SelectedIndexChanged">
                   </asp:DropDownList>
               </td></tr>
                     <tr><td> <asp:Label ID="Label3" runat="server" SkinID="lblMand" Text="Select Route"></asp:Label></td><td align="left">
                   <asp:DropDownList ID="product" runat="server" SkinID="ddlRequired" CssClass="ddl" Width="210px" onselectedindexchanged="route_SelectedIndexChanged" AutoPostBack="true">
                   </asp:DropDownList>
               </td></tr> 
                 
                <tr><td> <asp:Label ID="Label6" runat="server" SkinID="lblMand" Text="Select Retailer"></asp:Label></td><td align="left">
                   <asp:DropDownList ID="ddretailer" runat="server" SkinID="ddlRequired" CssClass="ddl" Width="210px">
                   </asp:DropDownList>
               </td></tr> 
