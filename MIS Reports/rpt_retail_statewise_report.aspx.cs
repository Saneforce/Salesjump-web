...
public partial class MIS_Reports_rpt_retail_statewise_report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retail Register-State Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
stCrtDtaPnt+="{label:\""+ drFF["statename"].ToString()+"\",y:";
                ...
                sURL = "rpt_retail_areawise_report.aspx?State_Code=" + drFF["State_Code"] + "&State_name=" + drFF["statename"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "&subdivision=" + subdivision + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        {
                            dsDoc = sf.retail_Statewise_value(drFF["State_Code"].ToString(), divcode, cmonth, cyear, subdivision,sfCode);
                        }
                        else
                        {
                            dsDoc = sf.retail_Statewise_value(drFF["State_Code"].ToString(), divcode, cmonth, cyear, subdivision);
                        }
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            if (tot_dr != "")
                            {
							 ...
							 sURL = "rpt_retail_statewise_product_detail.aspx?State_Code=" + drFF["State_Code"] + "&State_name=" + drFF["statename"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + "&stype=" + stype + "&subdivision=" + subdivision + "";
