<%@ Page Title="Sales Register-StateWise" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master"
    CodeFile="sales_statewise.aspx.cs" Inherits="MIS_Reports_sales_statewise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, subdiv, tmon, tyr, prod) {
            ...
            popUpObj = window.open("rpt_sale_statewise_report.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&subdivision=" + subdiv + "&TMonth=" + tmon + "&TYear=" + tyr + "&Prod=" + prod,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
    ...
    <script type="text/javascript">
        function NewWindow() {
            ...
            window.open("rpt_sale_statewise_report.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdivision=" + subdiv + "&TMonth=" + TMonth + "&TYear=" + TYear, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
    </script>
    <style type="text/css">
