...
public partial class MIS_Reports_rptPurchas_Register_Brandwise_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblProd.Text = "Purchase Register Brand wise for the Period of " + strMonthName + " " + Year + " ";
...
protected void btnExport_Click(object sender, EventArgs e)
    ...
    private void CreateDynamicTable()
    {
        ...
        if (stype == "1")
        {
            dsDr = dr.purchase_register_Branddetail_stockistwise_caterywise(div_code, Brand, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate,catcode,stockist_code);
        }

        if (stype == "2")
        {
            dsDr = dr.purchase_register_brandwisedetail_categorywise(div_code, Brand, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate,catcode,stockist_code);
        }
