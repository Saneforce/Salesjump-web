<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptEmployeewiseorderDetails.aspx.cs"
    Inherits="MIS_Reports_rptEmployeewiseorderDetails" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
                    ...
                    for (var i = 0; i < dSF.length; i++) {
                      ...
                      //  console.log(dSF[i].sfCode);
                        ...
                        //str += '<td>' + parseFloat(TotQty).toFixed(0) + '</td><td>' + parseFloat(pclen).toFixed(0) + '</td><td>' + parseFloat(TotNetW).toFixed(2) + '</td><td>' + parseFloat(TotVal).toFixed(2) + '</td><td>' + tc + '</td><td>' + ec + '</td>';
						 str += '<td>' + parseFloat(TotQty).toFixed(2) + '</td><td>' + parseFloat(pclen).toFixed(2) + '</td><td>' + parseFloat(TotNetW).toFixed(2) + '</td><td>' + parseFloat(TotVal).toFixed(2) + '</td><td>' + tc + '</td><td>' + ec + '</td>';
            ...
            $.ajax({
                ...
                async: false,
                url: "rptEmployeewiseorderDetails.aspx/getdata",
                dataType: "json",
                success: function (data) {
                    ...
                    if (data.d.length > 0) {
                        ...
                        $('#Product_Table thead').append('<tr class="mainhead">' + str + '<th colspan="6">Total</th></tr>');
                        $('#Product_Table thead').append('<tr class="secondhead">' + str1 + '<th>QTY</th><th>SKU Count</th><th>Net Weight</th><th>Values</th><th>TC</th><th>EC</th></tr>');
                        $('#Product_Table tfoot').append('<tr class="trfoot">' + strff + '<th></th><th><th></th></th><th></th><th></th><th></th></tr>');
                    }
                },
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptEmployeewiseorderDetails.aspx/getSalesforce",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptEmployeewiseorderDetails.aspx/getIssuData",
                data: "{'SF_Code':'" + sf_code + "', 'FYera':'" + Fyear + "', 'FMonth':'" + FMonth + "', 'SubDiv':'" + subDiv + "'}",
                dataType: "json",
                success: function (data) {
                        ...
                        if (leng - 3 == i) {
                            ...
                            if (Number(leng) - 4 == Number(i)) {
                                ...
                                //$(this).text(isNaN((parseFloat(arr[i - 1]))) ? "" : parseFloat(arr[i - 1]));
								  ...
								  $(this).text(isNaN((parseFloat(arr[i - 1]).toFixed(2))) ? "" : parseFloat(arr[i - 1]).toFixed(2));
