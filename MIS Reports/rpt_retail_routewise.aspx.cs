...
public partial class MIS_Reports_rpt_retail_routewise : System.Web.UI.Page
{
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        //dsDoc = sf.retail_Distributor_value(drFF["Territory_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            stURL = "rpt_retail_routewise_product_detail.aspx?Stockist_Code=" + Stockist_Code + "&Stockist_name=" + Stockist_Name + " &Year=" + cyear + "&Month=" + cmonth + " &stype=" + stype + "&Route_code=" + drFF["Territory_Code"].ToString() + "";
