<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Fieldforce_wise_sales_analysis.aspx.cs" Inherits="MIS_Reports_Fieldforce_wise_sales_analysis" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function NewWindow() {
            ...
            var subdivtext = $('#<%=subdiv.ClientID%> :selected').text();
            let menuType = ("<%=Session["Menu_type"].ToString()%>");

            if (menuType == "h" && subdivcode == "0") { alert("Select Division."); $('#<%=subdiv.ClientID%>').focus(); return false; }
            ...
            var str = $('#<%=ddlFieldForce.ClientID%> :selected').val();
			...
			window.open("rpt_Fieldforce_sales_analysis.aspx?SF_Code=" + str + "&FYear=" + year + "&SF_Name=" + MR_name+ "&subdiv=" + subdivcode, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');
            //window.open("rpt_Fieldforce_sales_analysis.aspx?SF_Code=" + str + "&FYear=" + year + "&SF_Name=" + MR_name, null,'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');
