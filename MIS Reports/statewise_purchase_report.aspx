<%@ Page Title="Purchase Register-StateWise" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="statewise_purchase_report.aspx.cs" Inherits="MIS_Reports_statewise_purchase_report" %>
...
<head>
    <title>Purchase Register-StateWise</title>
  ...
  <link type="text/css" rel="stylesheet" href="../css/style1.css" />
    ...
    <script type="text/javascript">
        var popUpObj;
        function showModalPopUp(sfcode, fmon, fyr,subdiv,tmon, tyr, prod) {
            
            popUpObj = window.open("rpt_statewise_purchase_report.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&subdivision="+subdiv+"&TMonth=" + tmon + "&TYear=" + tyr + "&Prod=" + prod,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
 ...
 var FMonth = $('#<%=ddlFMonth.ClientID%> :selected').text();
   ...
   var subdivision = $('#<%=subdiv.ClientID%> :selected').text();
              ...
              window.open("rpt_statewise_purchase_report.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdivision=" + subdiv + "&TMonth=" + TMonth + "&TYear=" + TYear, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
          }
 </script>
</head>
<body>
  ...
  <div class="col-sm-6 inputGroupContainer">
                   ...
                   <asp:DropDownList ID="subdiv" runat="server" SkinID="ddlRequired"  AutoPostBack="true" CssClass="form-control"  Style="min-width: 100px" Width="150" >
                   </asp:DropDownList>
              </div>
                            </div>
