...
public partial class MIS_Reports_rpt_retailtrend_monthwise : System.Web.UI.Page
{
    ...
    sec_value = dsDoc.Tables[0].Rows[0].ItemArray.GetValue(1).ToString();
        ...
        TableCell tc_lst_month1 = new TableCell();
                ...
                tr_det.Cells.Add(tc_lst_month1);
                        ...
                        dsDoc = sf.Retail_Trend_analysis_stockist_monthwise_distribution_total(divcode, cmonth, cyear, Stockist_Code);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Retail_Trend_analysis_categorywise_monthwise(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear, Product_Cat_Code);
 ...
 sec_value = dsDoc.Tables[0].Rows[0].ItemArray.GetValue(1).ToString();
           ...
           TableCell tc_lst_month1 = new TableCell();
                ...
                tr_det.Cells.Add(tc_lst_month1);
                        ...
                        tc_det_currentmonth.Controls.Add(lit_det_mon);
                        tr_det.Cells.Add(tc_det_currentmonth);
                        dsDoc = sf.Retail_Trend_analysis_categorywise_monthwise_total(divcode, cmonth, cyear, Product_Cat_Code);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Retail_Trend_analysis_Brandwise_monthwise(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear, Product_Brd_Code);
...
TableCell tc_lst_month1 = new TableCell();
                ...
                tr_det.Cells.Add(tc_lst_month1);
                        ...
                        dsDoc = sf.Retail_Trend_analysis_Brandwise_monthwise_total(divcode, cmonth, cyear, Product_Brd_Code);
