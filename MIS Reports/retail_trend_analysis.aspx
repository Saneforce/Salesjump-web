<%@ Page Title="Retail Trend Analysis" Language="C#" AutoEventWireup="true"  MasterPageFile="~/Master.master" CodeFile="retail_trend_analysis.aspx.cs" Inherits="MIS_Reports_retail_trend_analysis" %>
...
<head id="Head1">
    <title>Retail Trend Analysis</title>
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(fmon, subdiv, viewby, fyr) {
            ...
            popUpObj = window.open("retail_trend_analysis_routewise.aspx?FMonth=" + fmon + "&Subdivision=" + subdiv + "&viewby=" + viewby + "&FYear=" + fyr,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
                            ...
                            <asp:ListItem Value="3" Text="BrandWise" ></asp:ListItem>
                              <asp:ListItem Value="4" Text="CategoryWise" ></asp:ListItem>
                                <asp:ListItem Value="5" Text="ProductWise" ></asp:ListItem>
								 <asp:ListItem Value="6" Text="ChannelWise"></asp:ListItem>
                        </asp:DropDownList>
</div>
</div>
</div>
