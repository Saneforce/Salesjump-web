...
public partial class MIS_Reports_view_sec_salesreturn : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Sales Return Entry Secondary Order From " + d1.ToString("dd-MM-yyyy") + " to " + d2.ToString("dd-MM-yyyy");
    ...
    {
        salsec SFD = new salsec();
        DataSet ds = SFD.getsalesseidtl(sfcode, Div, FDT, TDT, subdiv);
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }

    public class salsec
    {
        public DataSet getsalesseidtl(string sfcode, string DivCode, string fdt, string tdt, string subdiv)
        {
            DB_EReporting db_ER = new DB_EReporting();

            DataSet dsAdmin = null;

            string strQry = "exec [salesreturn_secorder_dtls] '" + sfcode + "'," + DivCode.TrimEnd(',') + ",'" + fdt + "','" + tdt + "','" + subdiv + "'";
