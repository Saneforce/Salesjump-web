<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="mgr_working_report.aspx.cs" Inherits="MIS_Reports_mgr_working_report" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <form id="form1" runat="server">
     ...
     $('#btnview').on('click', function () {
         ...
         url = "view_mgr_reporting.aspx?divcode=" + div + "&mgrval=" + mgrv + "&mgrnm=" + mgrn + "&fdt=" + fdate + "&tdt=" + tdate;
