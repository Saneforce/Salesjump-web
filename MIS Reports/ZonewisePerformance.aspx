<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Zonewiseperformance.aspx.cs" Inherits="MIS_Reports_Zonewiseperformance" %>
...
<script type="text/javascript">
    function NewWindow() {
        ...
        var designation_name = $('#<%=Dropdesignation.ClientID%> :selected').text();
        if (designation_name == "--Select--") { alert("Select designation"); $('#Dropdesignation').focus(); return false; }




        var designation_code = $('#<%=Dropdesignation.ClientID%> :selected').val();
        ...
        window.open("rptzonewiseperformance.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&designation_code=" + designation_code + "&designation_name=" + designation_name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
