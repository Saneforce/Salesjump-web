<%@ Page Title="Lost-Distributor" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Lost_Distributor_report.aspx.cs" Inherits="MIS_Reports_Lost_Distributor_report" %>
...
<head>
    <title>Lost-Distributor Details</title>
   ...
   <script type="text/javascript">
       function NewWindow() {
           ...
           var ffd = $('#<%=ddlFieldForce.ClientID%> :selected').val();

           window.open("rpt_lost_distributor_reportpurchase.aspx?&FMonth=" + FMonth + "&FYear=" + FYear +  "&TMonth=" + TMonth + "&TYear=" + TYear+" &subdivision=" + subdiv + "&feildforce= "+ ffd, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
       }
</script>
</head>
<body>
         ...
         <%-- <ucl:menu ID="menu1" runat="server" />--%>
          ...
          <div class="container" style="width: 100%">
                    ...
                    <div class="row">
                                ...
                                <label id="lblTMonth" class="col-md-2 col-md-offset-3  control-label">
                                    To</label>
                     <div class="col-sm-6 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
               ...
               <div class="row">
                   ...
                   <asp:DropDownList ID="ddlFieldForce" runat="server"  SkinID="ddlRequired"   AutoPostBack="true"   CssClass="form-control"
                                            Style="min-width: 100px" Width="210" 
                        >
                        </asp:DropDownList>
