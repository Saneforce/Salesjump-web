<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="rptterritorywise_purchase_report.aspx.cs" Inherits="MIS_Reports_rptterritorywise_purchase_report" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Purchase Register- TerritoryWise</title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <asp:Label ID="lblHead" Text="Purchase Register-TerritoryWise" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
