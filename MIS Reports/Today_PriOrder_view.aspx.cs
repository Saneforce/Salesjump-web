...
public partial class MIS_Reports_Today_PriOrder_view : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            {*/
            string sURL = "rpt_Pri_Order_View.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&cur_month=" + ddlMonth.SelectedValue + "&cur_year=" + ddlYear.SelectedItem.Text +
               "&subdiv=" + subdiv.SelectedItem.Value + "&Sf_Name=" + ddlFieldForce.SelectedItem.Text + "&Date=" + StartDate + "&ToDate=" + EndDate + "&Type=" + sf_type;
            string newWin = "window.open('" + sURL + "',null,'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');";
            ClientScript.RegisterStartupScript(this.GetType(), "pop", newWin, true);
