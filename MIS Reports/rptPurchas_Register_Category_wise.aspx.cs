...
public partial class MIS_Reports_rptPurchas_Register_Category_wise : System.Web.UI.Page
{
...
string subdivision=string.Empty;
 ...
 subdivision = Request.QueryString["subdivision"].ToString();
        ...
        lblHead.Text = "Purchase Register-Category Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
tc_det_SNo.HorizontalAlign = HorizontalAlign.Right;
              ...
              stCrtDtaPnt+="{label:\""+ drFF["Product_Cat_Name"].ToString()+"\",y:";
                ...
                stURL = "rptPurchas_Register_Brand_wise.aspx?Stockist_Code=" + stockist_code + "&Stockist_name=" + Stock_name + " &cat_Code=" + drFF["Product_Cat_Code"] + " &cat_name=" + drFF["Product_Cat_Name"].ToString() + "&FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + " &sCurrentDate=" + sCurrentDate + "&subdivision=" + subdivision + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        //dsDoc = sf.catogory_wise_sale_value_stockist(drFF["Product_Cat_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate, stockist_code);
						dsDoc = sf.catogory_wise_sale_value_stockist(divcode: divcode, sf_code: sfCode, cyear: cyear, cmonth: cmonth, cat_code: drFF["Product_Cat_Code"].ToString(), stockistcode: stockist_code);
                        ...
                        if (tot_dr != "0")
                        {
                         ...
                         stype = "1";
                             ...
                             stURL = "rpt_purchase_category_view_weekwise.aspx?Stockist_Code=" + stockist_code + "&Stockist_name=" + Stock_name + " &cat_Code=" + drFF["Product_Cat_Code"] + " &cat_name=" + drFF["Product_Cat_Name"].ToString() + "&Year=" + cyear + "&Month=" + cmonth + "&stype=" + stype + "&subdivision=" + subdivision + "";
                ...
                for (int j = 1; j <= months + 1; j++)
                {
                    ...
                    foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
                    {
                      ...
                      //  dsDoc = sf.catogory_wise_sale_value_stockist(drFF["Product_Cat_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate, stockist_code);
                        ...
                        if (tot_Drr != "")
                        {
                            iTotLstCount += (Decimal.Parse(tot_Drr));
