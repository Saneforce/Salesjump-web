<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpt_order_areawise_trend.aspx.cs" Inherits="MIS_Reports_rpt_order_areawise_trend" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Retail Areawise Trend Analysis</title>
      ...
      <center>
                <table  align="center">
                    <tr>                   
                        ...
                        <td width="200px">
            <asp:Label ID="stateName" runat="server" Text="State Name"  
                Font-Bold="True" Font-Names="Andalus"></asp:Label>
                <asp:Label ID="lblstate" runat="server" Font-Size="12px" Font-Underline="True"></asp:Label></td>
