...
public partial class rpt_retail_routemonth : System.Web.UI.Page
{
...
string sec_total = string.Empty;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retail Trend Analysis Route Details  for  " + strFMonthName + " " + FYear + "To" + " " + strTMonthName + " " + TYear;
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "RPT_RETAIL_RETAILER.aspx?Stockist_Code=" + Stockist_Code + "&Stockist_Name=" + Stockist_Name + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&Territory_code=" + drFF["Territory_Code"].ToString() + "&Territory_Name=" + drFF["Territory_Name"].ToString() + "";
...
dsDoc = sf.Retail_Trend_analysis_stockist_monthwise_distribution_routee(drFF["Territory_Code"].ToString(), divcode, cmonth, cyear, Stockist_Code);
                ...
                tr_det.Cells.Add(tc_lst_month1);
                       ...
                       if (tot_dr != "")
                        ...
                        dsDoc = sf.Retail_Trend_analysis_stockist_monthwise_distribution_routee_total(divcode, cmonth, cyear, Stockist_Code);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Retail_Trend_analysis_stockist_monthwise_distribution_finaltotalj(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear);
 ...
 TableCell tc_lst_month1 = new TableCell();
                        ...
                        dsDoc = sf.Retail_Trend_analysis_stockist_monthwise_distribution_finaltotal(divcode, cmonth, cyear);
