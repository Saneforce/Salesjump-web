<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptEmployeewisePrimaryCategoryDetails.aspx.cs" Inherits="MIS_Reports_rptEmployeewisePrimaryCategoryDetails" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                async: false,
                url: "rptEmployeewisePrimaryCategoryDetails.aspx/getcategorys",
                dataType: "json",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptEmployeewisePrimaryCategoryDetails.aspx/getSalesforce",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptEmployeewisePrimaryCategoryDetails.aspx/getcetegoryorderData",
                data: "{'SF_Code':'" + sf_code + "', 'FYera':'" + Fyear + "', 'FMonth':'" + FMonth + "', 'SubDiv':'" + subDiv + "'}",
                dataType: "json",
                success: function (data) {
            ...
            $(document).on('click', "#btnExcel", function (e) {
                ...
                a.download = 'Employee_wise_Primary_category_Details_' + postfix + '.xls';
