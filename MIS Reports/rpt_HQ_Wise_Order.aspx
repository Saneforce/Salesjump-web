<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_HQ_Wise_Order.aspx.cs" Inherits="MIS_Reports_rpt_HQ_Wise_Order" %>
         ...
         <tr><td>
              <asp:GridView ID="GridViewcat" runat="server" Width="100%" CssClass="newStly"  OnDataBound="catOnDataBound"
                                ...
                                <asp:TemplateField HeaderText="S.No" ItemStyle-Width="50" HeaderStyle-BorderWidth="1"
                                     ...
                                     <asp:TemplateField HeaderText="HQ" ItemStyle-Width="50" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="10pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:Label ID="SF_Name" runat="server" Font-Size="9pt" Text='<%#Eval("Sf_HQ")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Product Category" ItemStyle-Width="50" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="10pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:Label ID="product_Detail_Name" runat="server" Font-Size="9pt" Text='<%#Eval("Product_Cat_Name")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
