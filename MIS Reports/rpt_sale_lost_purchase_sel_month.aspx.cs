...
public partial class MIS_Reports_rpt_sale_lost_purchase_sel_month : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Sales Lost-Product Details for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Sales_lost_Purchase_value_stockist(drFF["Stockist_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate, Subdivision);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            sURL = "rpt_sale_lostproduct_view.aspx?Stockist_Code=" + drFF["Stockist_Code"] + "&Stockist_name=" + drFF["Stockist_Name"].ToString() + " &FYear=" + cyear + "&FMonth=" + cmonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&subdivision=" + Subdivision + "&sCurrentDate=" + sCurrentDate + "";
    ...
    private void FillSF()
    {
      ...
      //  {
       //     dsSalesForce = sf.GetStockist_subdivisionwise(divcode,Subdivision, sfCode);
      //  }
       // else
      //  {
      //      dsSalesForce = sf.GetStockist_subdivisionwise(divcode,Subdivision);
      //  }
    dsSalesForce = sf.GetStockist_subdivisionwise(divcode, Subdivision,sfCode);
...
tc_det_SNo.Style.Add("text-align","right");
               ...
               // dsDoc = sf.Sales_lost_Purchase_value_stockist_sel_month(drFF["Stockist_Code"].ToString(), divcode, st, tom, Subdivision);
				  dsDoc = sf.Sales_lost_Purchase_value_stockist_sel_month(drFF["Stockist_Code"].ToString(), divcode, st, tom, Subdivision,sfCode);
                        ...
                        {
                            hyp_lst_month.Text = tot_dr;
                            sURL = "rpt_sale_lost_selmonth_view.aspx?Stockist_Code=" + drFF["Stockist_Code"] + "&Stockist_name=" + drFF["Stockist_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&subdivision=" + Subdivision + "&tdate=" + tom + "&fdate=" + st + "";
                            hyp_lst_month.Attributes["onclick"] = "javascript:window.open('" + sURL + "' ,'','resizable=yes,toolbar=no,menubar=no,scrollbars=1,status=no,width=500,height=600,left=0,top=0,zoom=50%');";
                            hyp_lst_month.NavigateUrl = "#";
