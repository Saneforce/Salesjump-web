<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new_primaryord_view.aspx.cs" Inherits="MIS_Reports_new_primaryord_view" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.btnPrint', function () {
            ...
            var printReport = document.querySelector("body ")
