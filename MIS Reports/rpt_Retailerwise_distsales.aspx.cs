...
public partial class MIS_Reports_rpt_Retailerwise_distsales : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retailerwise Distributor sales View from " + month + " to " + year;
        Feild.Text = sfname;
        FillSF();
    }
    private void FillSF()
    ...
    public class loc
    {
        public DataSet get_details(string divcode, string month, string year, string Sf_Code)
        {
            ...
            string strQry = "exec sp_retwise_distsales '" + Sf_Code + "','" + month + "','" + year + "','" + divcode + "'";
