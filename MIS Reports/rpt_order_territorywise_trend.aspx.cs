...
public partial class MIS_Reports_rpt_order_territorywise_trend : System.Web.UI.Page
{
decimal netsumtotal = 0;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.Order_Territorywise_Trend_analysis_Distributor_descending(divcode, fromdate, todate, subdivision, state_code, Area_code, Zone_code);
...
TableCell tc_lst_month1 = new TableCell();
 ...
 viewby = "Territorywise";
                sURL = "rpt_Ordertrend_month.aspx?Territory_code=" + drFF["Territory_code"] + "&Territory_name=" + drFF["Territory_name"].ToString() + "&State_code=" + state_code + "&Area_code=" + Area_code + "&Zone_code=" + Zone_code + "&FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                ...
                dsDoc = sf.Order_Territorywise_Trend_analysis_totalvalue(divcode, fromdate, todate, subdivision, state_code, Area_code, Zone_code);
