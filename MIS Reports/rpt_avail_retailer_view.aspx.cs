...
public partial class MIS_Reports_rpt_avail_retailer_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dist = Request.QueryString["distributor_code"].ToString();
        dist_name = Request.QueryString["distri_name"].ToString();
        ...
        lblHead.Text = "Available Retailers View for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;


        lblMonth.Text = territory_name;
        lblYear.Text = dist_name;
        FillSF();
    }
    private void FillSF()
    {
        ...
        dsSalesForce = sf.retail_routewise_available_retailer_name(dist, divcode, Territory_Code, product_code, FMonth, FYear);
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                tc_det_usrr.HorizontalAlign = HorizontalAlign.Left;
                Literal lit_det_usrr = new Literal();
                lit_det_usrr.Text = "&nbsp;" + drFF["ListedDr_Name"].ToString();
