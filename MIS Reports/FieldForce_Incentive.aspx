<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="FieldForce_Incentive.aspx.cs" Inherits="MIS_Reports_FieldForce_Incentive" %>
    ...
    <script type="text/javascript">
        ...
        function NewWindow() {
            ...
            if (ddlMR != -1 && ddlMR != 0 && MR_name != '') {
                window.open("rpt_fieldforce_incentive.aspx?SF_Code=" + ddlMR + "&date=" + date + "&tdate=" + tdate + "&SF_Name=" + MR_name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');
                
            }
            else {
                window.open("rpt_fieldforce_incentive.aspx?SF_Code=" + st + "&date=" + date + "&tdate=" + tdate + "&SF_Name=" + sf_name, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=950,height=650,left=0,top=0');
...
.col-sm-6
     ...
     <form id="form1" runat="server">
    		...
    		<div class="row">
                    <asp:Label ID="lblFF" runat="server" SkinID="lblMand" Text="Select Manager" Style="text-align: right; padding: 8px 4px;"
		...
		<div class="row">
                        <asp:Label ID="lblMR" runat="server" Text="Select Fieldforce" SkinID="lblMand" Visible="false" Style="text-align: right; padding: 8px 4px;"
                CssClass="col-md-4 control-label"></asp:Label>
                  	<div class="col-sm-6 inputGroupContainer">
