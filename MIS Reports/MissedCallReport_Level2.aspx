<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MissedCallReport_Level2.aspx.cs" Inherits="MIS_Reports_MissedCallReport_Level2" %>
...
<script type = "text/javascript">
    ...
    function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, cmode) {
        popUpObj = window.open("MissedCallReport_Level3.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&cMode=" + cmode,
    "ModalPopUp_Level1",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
...
<body>
    ...
    <div>
        ...
        <asp:Table ID="tbl" runat="server" BorderStyle="Solid" BorderWidth="1" Style="border-collapse: collapse; border: solid 1px Black;" GridLines="Both" Width ="95%">
        </asp:Table>
        </center> 
    </div>
    </form>
