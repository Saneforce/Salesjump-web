<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Sec_od_distweekwise.aspx.cs" Inherits="MIS_Reports_Sec_od_distweekwise" %>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <asp:Label ID="lblHead" Text="Secondary Order Distributorwise Weekwise" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
