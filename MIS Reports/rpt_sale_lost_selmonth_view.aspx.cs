...
public partial class MIS_Reports_rpt_sale_lost_selmonth_view : System.Web.UI.Page
{
...
sf_code = Session["sf_code"].ToString();
        ...
        lblHead.Text = "Sale Lost-Products View for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
//        dsSalesForce = sf.Sales_lost_Purchase_value_view_sel_month(dist, divcode, frmdate, todate, subdivision);
  dsSalesForce = sf.Sales_lost_Purchase_value_stockist_sel_month(dist, divcode, frmdate, todate, subdivision,sf_code);
...
tc_DR_Name.HorizontalAlign = HorizontalAlign.Center;
            ...
            dsSalesForce = (DataSet)
//if (tot_value != "" && tot_value!="0")
             ViewState["dsSalesForce"];
...
//  dsDoc = sf.lost_sale_date_sel_month(drFF["Product_Detail_Code"].ToString(), FMonth, FYear, dist);
   dsDoc = sf.lost_sale_date_sel_month(drFF["Product_Detail_Code"].ToString(), FMonth, FYear, dist,divcode,sf_code);
