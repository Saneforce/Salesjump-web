<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="TsrLeaveFormAll.aspx.cs" Inherits="MIS_Reports_tsr_TsrLeaveFormAll" %>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            $(document).on('click', '.btnview', function () {
                ...
                str = 'TsrrptLeaveFormAll.aspx?SFCode=' + sf_code + '&FYear=' + Fyear + '&SubDiv=' + SubDivCode + '&SFName=' + SFName;
