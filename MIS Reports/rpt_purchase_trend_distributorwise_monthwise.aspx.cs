...
public partial class MIS_Reports_rpt_purchase_trend_distributorwise_monthwise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (viewby == "DistributorTotal")
        {

            FillSF();
        }
        else if (viewby == "CategoryTotal")
        {

            FillCategorywise();
        }
        else if (viewby == "BrandTotal")
        {

            FillBrandwise();

        }
        else if (viewby == "ProductWiseTotal")
        {
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Purchase_Trend_analysis_stockisttotal_monthwise_distribution(drFF["Stockist_Code"].ToString(), divcode, cmonth, cyear);
                        ...
                        dsDoc = sf.Purchase_Trend_analysis_stockisttotal_monthwise_distribution_total(divcode, cmonth, cyear,subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Purchase_Trend_analysis_categorywisevalue_monthwise(drFF["Product_Cat_Code"].ToString(), divcode, cmonth, cyear);
                      ...
                      if (tot_dr != "" && tot_dr !="0")
                        ...
                        dsDoc = sf.Purchase_Trend_analysis_categorywisetotal_monthwise_total(divcode, cmonth, cyear, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Purchase_Trend_analysis_Brandwisevalue_monthwise(drFF["Product_Brd_Code"].ToString(), divcode, cmonth, cyear);
                        ...
                        dsDoc = sf.Purchase_Trend_analysis_Brandwisetotal_monthwise_total(divcode, cmonth, cyear, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Purchasee_Trend_analysis_Productwise_monthwise(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear);
                       ...
                       if (tot_dr != "" && tot_dr !="0")
                        ...
                        dsDoc = sf.Purchasee_Trend_analysis_Productwise_monthwise_total(subdivision, divcode, cmonth, cyear);
