...
public partial class MIS_Reports_Product_Sale : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            {*/
            string sURL = "Product_wise_salesanalysis.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&cur_year=" + ddlYear.SelectedItem.Text +
