<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptDistwiseCalls.aspx.cs" Inherits="MIS_Reports_RptDistwiseCalls" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="row" style="margin: 0px 0px 0px 5px;">
            <div class="row">
                <div class="col-sm-8">
                    <asp:Label ID="Label1" runat="server" Text="Wholeseller Productivity Report" Style="margin-left: 10px; font-size: x-large"></asp:Label>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function getSKU() {
            $.ajax({
                ...
                async: false,
                url: "RptDistwiseCalls.aspx/getDetails",
        ...
        function ReloadData() {
            ...
            for (let i = 0; i < jsonData.length; i++) {
                let str = `<tr><td align="right">${i + 1}</td><td>${jsonData[i]["Activity_Date"]}</td><td>${jsonData[i]["Fieldforce"]}</td><td>${jsonData[i]["Distributor"]}</td><td>${jsonData[i]["RetailerCnt"]}</td><td>${jsonData[i]["Total_Calls"]}</td><td>${jsonData[i]["Productive_calls"]}</td><td>${jsonData[i]["Order_Value"]}</td></tr>`;
                strArr[i] = str;
            }
        ...
        $(document).ready(function () {
            ...
            $('#btnExport').click(function () {
                ...
                var tets = 'Productivity Report' + '.xls';   //create fname
