...
public partial class MIS_Reports_rpt_sale_lostproduct_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Lost-Sale View for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.Sales_lost_Purchase_value_view(dist, divcode, FMonth, FYear);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                dsDoc = sf.lost_sale_date(drFF["Product_Detail_Code"].ToString(), FMonth, FYear, dist);
