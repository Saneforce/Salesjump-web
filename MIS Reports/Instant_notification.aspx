<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Instant_notification.aspx.cs" Inherits="MIS_Reports_Instant_notification" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  	...
  	.textarea{
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                <%--$("#<%=txtstartdate.ClientID%>").datepicker({ minDate: 0 });
                ...
                function filldata() {
                    $.ajax({
                        ...
                        async: false,
                        url: "Instant_notification.aspx/fillData",
                        dataType: "json",
                ...
                function fillfield() {
                    ...
                    $('#<%=hdnslno.ClientID%>').val('');
                }
            });
            function Confirm() {
                //geturl();
                alert('Submitted Successfully');
                window.location.href = 'Instant_Notification_list.aspx';
            }
            function geturl() {
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "Instant_notification.aspx/geturldata",
                    dataType: "json",
                    success: function (data) {
                        urlname = data.d;
                        alert('"' + urlname + '"');
  ...
  <asp:HiddenField ID="hdnslno" runat="server" /> <asp:HiddenField ID="msgbox" runat="server" /> 
          <table width="50%" class="Hprint" align="center">
           ...
           <table width="50%" align="center" style="width: 50%; height: 350px; margin-top: 5px" cellpadding="0"
               ...
               <%-- <tr>
                   <td>
                       <span> <asp:Label ID="lblEndDate" runat="server" Text=" Notification End  Date  : "></asp:Label></span>
                   <asp:TextBox ID="txtEndDate" runat="server" DataFormatString="{dd/MM/yyyy}"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="txtmsg" runat="server" TextMode="MultiLine" class="textarea"></asp:TextBox>
                    </td>
                    </tr>
                </table>
             </contenttemplate>
                    ...
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="BUTTON" PostBackUrl="Instant_Notification_list.aspx" />
                </center>
