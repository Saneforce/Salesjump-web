...
public partial class MIS_Reports_mgr_rptNew_Outlet_List : System.Web.UI.Page
{
    #region "Declaration"      
    ...
    public class outlt
    {
        public DataSet getNew_outlet_List(string DivCode, string SFCode, string FYear, string FMonth, string SubDivCode, string modedt)
        {
          ...
          string  strQry = "EXEC mgr_GET_New_Retailer_List_Today '" + DivCode + "','" + SubDivCode + "','" + SFCode + "','" + modedt + "'";
