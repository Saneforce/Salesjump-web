...
<script type="text/javascript">
    ...
    function ReloadTable() {
        ...
        if (fmonth < tmonth) {
            for (var i = 0; i < parseInt(tmonth); i++) {
                strhead += "<td colspan='" + prdcat.length + "'>" + monthNames[parseInt(i, 10)] + "</td><td rowspan='2'>Fous products Value</td><td rowspan='2'>Total Value</td>";
            }
        ...
        for (var i = 0; i < AnalysisSales.length; i++) {
            ...
            strbody += "<tr>";
            strbody += "<td>" + AnalysisSales[i].RptNm + "</td><td>" + AnalysisSales[i].Sf_Name + "</td><td>" + AnalysisSales[i].Territory_Name + "</td><td>" + AnalysisSales[i].Cust_Code + "</td><td>" + AnalysisSales[i].ListedDr_Name + "</td>";
            if (fmonth < tmonth) {
                Ovrlltot = 0;
                Otot = 0;
                tot = 0;
                totval = 0;
                for (var l = 1; l <= parseInt(tmonth); l++) {
                    for (var j = 0; j < prdcat.length; j++) {
                        ...
                        strbody += "<td>" + tot + "</td><td>" + Otot.toFixed(2) + "</td>";
                    }
                    strbody += "<td>" + totval + "</td><td>" + Otot.toFixed(2) + "</td><td>" + (Otot - totval).toFixed(2) + "</td>";
                    Ovrlltot += totval;
                }
            }
            else {
        ...
        <div>
            <div>
                <div class="row m-0" style="padding: 30px">
                    ...
                    <div class="table table-responsive col-10" style="overflow-x: scroll; height: 530px;">
                        <table id="cnt_retailerdet" style="border: 1px solid gray !important; min-width: 100%;" class="table table-bordered table-hover grids">
                            <thead style="position: sticky;top: 0;z-index: 20;background-color: white;">
                            </thead>
                            <tbody>
                            </tbody>
                            <tfoot></tfoot>
