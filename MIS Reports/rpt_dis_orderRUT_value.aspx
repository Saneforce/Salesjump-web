<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_dis_orderRUT_value.aspx.cs" Inherits="MIS_Reports_rpt_dis_orderRUT_value" %>
...
<link href="../css/bootstrap-3.3.2.min.css" rel="stylesheet" />
 ...
 function popUp(Sf_Code, Stockist_Code, Year, Sf_name,Territory_Code) {
            
           
            strOpen = "rpt_dis_orderCUS_value.aspx?SF_Code=" + Sf_Code + "&Year=" + Year + "&Stockist_Code=" + Stockist_Code + "&Sf_name=" + Sf_name + "&Territory_Code=" + Territory_Code
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                ...
                                <td style="text-align: left;">
                                   <a href="javascript:popUp('<%=sf_code %>',<%=Stockist_Code%>,'<%=Year%>','<%=SF_Name%>','<%#Eval("Territory_Code")%>')">
                                        <%# Eval("Territory_Name") %>
