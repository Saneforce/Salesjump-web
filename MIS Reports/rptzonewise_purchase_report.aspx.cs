...
public partial class MIS_Reports_rptzonewise_purchase_report : System.Web.UI.Page
{
...
subdivision= Request.QueryString["subdivision"].ToString();
        ...
        lblHead.Text = "Purchase Register -Zone Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
string stCrtDtaPnt = string.Empty;
        ...
        State st = new State();
        dsSalesForce = st.get_area_Details_Zonewise(areacode, divcode);
...
stCrtDtaPnt+="{label:\""+ drFF["Zone_Name"].ToString()+"\",y:";
                ...
                //hq
                sURL = "rptterritorywise_purchase_report.aspx?Zone_Code=" + drFF["Zone_code"] + "&Zone_name=" + drFF["Zone_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "&subdivision=" + subdivision + "";
                ...
                if (months >= 0)
                {
                    ...
                    //    dsDoc = sf.Zonewise_purchase_value(drFF["Zone_code"].ToString(), divcode, cmonth, cyear, subdivision);
  					  dsDoc = sf.Zonewise_purchase_value(zonecode: drFF["Zone_code"].ToString(), div_code: divcode, cmonth: cmonth, cyear: cyear, subdivision: subdivision, sf_code: sfCode);
         ...
         stype = "1";
                            ...
                            sURL = "rpt_zonewise_product_detail.aspx?Zone_code=" + drFF["Zone_code"] + "&Zone_Name=" + drFF["Zone_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + " &stype=" + stype + "&subdivision=" + subdivision + "";
