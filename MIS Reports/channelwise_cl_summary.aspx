<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="channelwise_cl_summary.aspx.cs" Inherits="MIS_Reports_channelwise_cl_summary" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnview').on('click', function () {
               ...
               var fdate = $('#fdate').val();
                ...
                url = "Rpt_channelwise_cl_summary.aspx?sf_code=" + sfcode + "&div_code=" + <%=Session["div_code"]%> + "&subdiv=" + subdiv +
        ...
        function loadDivision(ssdiv) {
            $.ajax({
                ...
                async: false,
                url: "channelwise_cl_summary.aspx/getDivision",
        ...
        function loadFieldForce() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "channelwise_cl_summary.aspx/getFieldForce",
