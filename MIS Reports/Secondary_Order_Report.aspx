<%@ Page Title="Secondary Order-Distributor Wise" Language="C#" AutoEventWireup="true"  MasterPageFile="~/Master.master" CodeFile="Secondary_Order_Report.aspx.cs" Inherits="MIS_Reports_Secondary_Order_Report" %>
...
<script type="text/javascript">
        ...
        if (subdivision == "--Select--") { alert("Select subdivision"); $('#subdiv').focus(); return false; }
              ...
              window.open("Secondary_Order_Distributor_wise.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdivision=" + subdiv + "&TMonth=" + TMonth + "&TYear=" + TYear, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
          }
</script>
</head>
<body>
