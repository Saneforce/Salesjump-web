<%@ Page Language="C#"  EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpt_purchase_view_daywise.aspx.cs" Inherits="MIS_Reports_rpt_purchase_view_daywise" %>
        ...
        <div>
                <table width="100%" align="center">
                    ...
                    <td width="2.5%"></td>
                        ...
                        <td align="Center">
                            <asp:Label ID="lblIDDistributor" Text="Distributor :"  Font-Bold="True" Font-Names="Times New Roman" runat="server" SkinID="lblMand"></asp:Label>
