            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    ...
                    $('#btnview').on('click', function () {
                        ...
                        if ("<%=sf_type%>" == "2" && subdiv == "0" && div_code == "98") {
                ...
                function loadFieldForce() {
                    ...
                    if (divcode == "98") {
                        ...
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            async: false,
                            url: "dcrcalls.aspx/getFieldForce1",
                            data: '{"divcode":"<%=Session["div_code"]%>","sfcode":"<%=Session["Sf_Code"]%>","subdivision": "' + subdiv + '","Alpha": "' + 1 + '","StateCode": "' + state + '"}',
                            dataType: "json",
                            success: function (data) {
                                console.log(data);
                                AllFF = JSON.parse(data.d) || [];
                                ...
                                if (data.length > 0) {
                                    //var dept = $("#ddlff");
                                    //dept.empty().append('<option selected="selected" value="">Select FieldForce</option>');
                                    $("#ddlff").append('<option selected="selected" value="">Select FieldForce</option>');

                                    for (var i = 0; i < data.length; i++) {
                                        dept.append($('<option value="' + data[i].Sf_Code + '">' + data[i].Sf_Name + '</option>'))
                                    }
                                }
                            }
                        });
