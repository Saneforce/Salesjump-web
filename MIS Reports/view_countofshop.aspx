<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master"  CodeFile="view_countofshop.aspx.cs"  EnableEventValidation="false" Inherits="MIS_Reports_view_countofshop" %>
    ...
    <script type="text/javascript">
        ...
        function FillList() {
                ...
                $.ajax({
                    ...
                    url: "view_countofshop.aspx/getdatanshp",
                    dataType: "json",
        ...
        $('#btnpdf').click(function () {
            ...
            html2canvas($(".grids")[0], { allowTaint: true }).then(function (canvas) {
                ...
                pdf.save("billedoutlet_details.pdf");
            });
        });
        $('#btnExport').click(function () {
            ...
            var tets = 'billedoutlet_details' + '.xls';   //create fname
