<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_Retailerwise_distsales.aspx.cs" Inherits="MIS_Reports_rpt_Retailerwise_distsales" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Retailerwise Distrbutor sales</title>
    ...
    <link href="../css/style.css" rel="stylesheet" />
     ...
     <script type="text/javascript">
         $(document).on('click', "#btnExcel", function (e) {
             ...
             a.download = 'RetailerwiseSales.xls';
             a.click();
             e.preventDefault();
         });
    </script>
...
<body>
 ...
 ShowHeader="true" Font-Size=8pt  HorizontalAlign="Center" 
                                ...
                                <asp:TemplateField HeaderText="RetailerName" ItemStyle-Width="50" HeaderStyle-BorderWidth="1"
                                ItemStyle-Font-Bold="true" ItemStyle-Font-Names="Rockwell" HeaderStyle-Font-Size="12pt"
                                ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="retailer" Style="white-space: nowrap" runat="server" Font-Size="10pt"
                                        Text='<%#Eval("ListedDr_Name")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Category" ItemStyle-Width="50" HeaderStyle-BorderWidth="1"
                                ItemStyle-Font-Bold="true" ItemStyle-Font-Names="Rockwell" HeaderStyle-Font-Size="12pt"
                                ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="class" Style="white-space: nowrap" runat="server" Font-Size="10pt"
                                        Text='<%#Eval("Doc_Spec_ShortName")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Area Worked" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="tc_name" runat="server" Font-Size="10pt" Text='<%#Eval("Territory_Name")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Mobile" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                ...
                                ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="phone" runat="server" Font-Size="10pt" Text='<%#Eval("ListedDr_Phone")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Sales" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                ...
                                ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="Sales" runat="server" Font-Size="10pt" Text='<%#Eval("order_value")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                                </Columns>
