...
public partial class MIS_Reports_rpt_sale_statewise_report : System.Web.UI.Page
{
...
string subdivision=string.Empty;
    ...
    subdivision = Request.QueryString["Subdivision"].ToString();
        ...
        lblHead.Text = "Sales Register -State Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_sale_areawise_report.aspx?State_Code=" + drFF["State_Code"] + "&State_name=" + drFF["statename"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "&subdivision=" + subdivision + "";
                ...
                if (months >= 0)
                {
                 ...
                 //       dsDoc = sf.Sale_Statewise_value(drFF["State_Code"].ToString(), divcode, cmonth, cyear, subdivision );
  dsDoc = sf.Sale_Statewise_value(  statecode: drFF["State_Code"].ToString(), div_code:  divcode, cmonth: cmonth, cyear: cyear, subdivision: subdivision, sf_code: sfCode);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            sURL = "rpt_sales_statewise_product_detail.aspx?State_Code=" + drFF["State_Code"] + "&State_name=" + drFF["statename"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + "&stype=" + stype + "&subdivision=" + subdivision + "";
                    ...
                    if (iTotLstCount1 != 0)
                    {
                        ...
                        Literal hyp_lst_month12 = new Literal();
  ...
  dsDoc = sf.Sale_Statewise_value(  statecode: drFF["State_Code"].ToString(), div_code:  divcode, cmonth: cmonth, cyear: cyear, subdivision: subdivision, sf_code: sfCode);
                        ...
                        if (tot_dr != "")
                        {
                            ...
                            hyp_month.Text = iTotLstCount2.ToString("0.00");
                          stype = "2";
