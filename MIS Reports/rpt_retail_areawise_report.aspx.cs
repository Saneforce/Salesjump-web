...
tc_det_SNo.Style.Add("text-align","right");
                ...
                //hq
                sURL = "rpt_retail_zonewise_report.aspx?Area_Code=" + drFF["Area_code"] + "&Area_name=" + drFF["Area_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "&subdivision="+subdivision+"";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.retail_areawise_purchase_value(drFF["Area_code"].ToString(), divcode, cmonth, cyear, subdivision);
 ...
 sURL = "rpt_retail_areawise_product_detail.aspx?Area_Code=" + drFF["Area_Code"] + "&Area_name=" + drFF["Area_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + "&stype=" + stype + "&subdivision=" + subdivision + "";
