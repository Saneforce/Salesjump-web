<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_monthly_summary.aspx.cs" Inherits="MIS_Reports_rpt_monthly_summary" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Secondary Sales Summary</title>
    ...
    <link href="../css/style.css" rel="stylesheet" />
     ...
     <script type="text/javascript">
         $(document).on('click', "#btnExcel", function (e) {
             ...
             a.download = 'MonthlySecondarySales.xls';
             a.click();
             e.preventDefault();
         });
    </script>
 ...
 ShowHeader="true" Font-Size=8pt  HorizontalAlign="Center" 
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="stockist" Style="white-space: nowrap" runat="server" Font-Size="10pt"
                                        Text='<%#Eval("Order_Date","{0: dd/MM/yyyy}")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Day" ItemStyle-Width="50" HeaderStyle-BorderWidth="1"
                                ItemStyle-Font-Bold="true" ItemStyle-Font-Names="Rockwell" HeaderStyle-Font-Size="12pt"
                                ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="stockist" Style="white-space: nowrap" runat="server" Font-Size="10pt"
                                        Text='<%#Eval("Dayy")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Distributor Name" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                HeaderStyle-Font-Size="12pt" ItemStyle-BorderWidth="1" ItemStyle-Font-Bold="true"
                                ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="SF_name" runat="server" Font-Size="10pt" Text='<%#Eval("Stockist_Name")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Area Worked" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                ItemStyle-Font-Bold="true" HeaderStyle-Font-Size="12pt" ItemStyle-BorderWidth="1"
                                ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="Route_name" runat="server" Font-Size="10pt" Text='<%#Eval("territory_name")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="TC" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                ItemStyle-Font-Bold="true" HeaderStyle-Font-Size="12pt" ItemStyle-BorderWidth="1"
                                ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:Label ID="Retailer_name" runat="server" Font-Size="10pt" Text='<%#Eval("TCall")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="PC" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                ItemStyle-Font-Bold="true" HeaderStyle-Font-Size="12pt" ItemStyle-BorderWidth="1"
                                ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <asp:Label ID="netval" runat="server" Font-Size="10pt" Text='<%#Eval("PC")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Sales" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                ...
                                ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <asp:Label ID="freept" runat="server" Font-Size="10pt" Text='<%#Eval("order_value")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
