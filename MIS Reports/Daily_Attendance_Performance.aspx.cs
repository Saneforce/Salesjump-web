...
public partial class MIS_Reports_Daily_Attendance_Performance : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string GetAttendancePerformance(string SF, string Div, string Mn, string Yr)
    {
        SalesForce SFD = new SalesForce();
    ...
    protected void lnkDownload_Click(object sender, EventArgs e)
    {
        ...
        {
            wb.Worksheets.Add(dtfilter, "Attendance Performance");
            Response.Clear();
            Response.Buffer = true;
            Response.Charset = "";
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
            Response.AddHeader("content-disposition", "attachment;filename=Attendance Performance_" + fdt + "_to_" + tdt + ".xlsx");
