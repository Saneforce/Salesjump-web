<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="rptSales_Top10_Exception.aspx.cs" Inherits="MIS_Reports_rptSales_Top10_Exception" %>
...
<head id="Head1" runat="server">
    <title>Sales- ExceptionTop10</title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                    ...
                    <asp:Label ID="lblHead" Text="Purchase Register-Exception Top 10" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:Table ID="tbl"  runat="server" Style="border-collapse: collapse;  border: solid 1px Black;
                                 font-family: Calibri" Font-Size="8pt" GridLines="Both" Width="65%">
                            </asp:Table>
                        </td>
