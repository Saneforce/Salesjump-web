...
public partial class MIS_Reports_rpt_Primary_Order_View_CLB : System.Web.UI.Page
{
        ...
        /*    if (sfID != currentsfid)
            {
                if (e.Row.RowIndex > 0)
                {
                    ...
                    {
                        //var chk = gdprimary.Rows[i].Cells[gridcnt].Text;
                        gridcnt = gdprimary.Rows[i].Cells.Count-1;
                        subTotal1 += Convert.ToDecimal(gdprimary.Rows[i].Cells[gridcnt].Text);
 ...
 public static DataTable LINQResultToDataTable<T>(IEnumerable<T> Linqlist)
    ...
    protected void OnDataBound(object sender, EventArgs e)
    {
        ...
        if (gdprimary.Rows.Count > 0)
        {
            ...
            {
		gridcnt = gdprimary.Rows[i].Cells.Count-1;
                subTotal += Convert.ToDecimal(gdprimary.Rows[i].Cells[gridcnt-1].Text);
