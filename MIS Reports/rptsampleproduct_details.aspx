<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptsampleproduct_details.aspx.cs" Inherits="MIS_Reports_rptsampleproduct_details" %>
...
<link type="text/css" rel="stylesheet" href="../../css/repstyle.css" />
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, sf_name, cyear, cmonth, sCurrentDate) {
            popUpObj = window.open("rptsampleproduct_details1.aspx?sf_code=" + sfcode + "&sf_name=" + sf_name + "&Year=" + cyear + "&Month=" + cmonth + "&sCurrentDate=" + sCurrentDate ,
     "_blank",
    "ModalPopUp," +
    "toolbar=no," +
    "scrollbars=yes," +
