                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            string stype = "1";
                            stURL = "rpt_retail_brandwise_view.aspx?Stockist_Code=" + stockist_code + "&Stockist_name=" + Stock_name + "&Brand_Code=" + drFF["Product_Brd_Code"] + "&Brand_name=" + drFF["Product_Brd_Name"].ToString() + " &cat_Code=" + cat_code + " &cat_name=" + cat_name + "&Year=" + cyear + "&Month=" + cmonth + " &sCurrentDate=" + sCurrentDate + "&stype=" + stype + "";
