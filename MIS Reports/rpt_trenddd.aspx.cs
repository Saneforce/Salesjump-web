...
public partial class MIS_Reports_rpt_trenddd : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Sales Trend Analysis Details for  " + strFMonthName + " " + FYear;
    ...
    private void FillSF_MR()
    {
        ...
        if (sf_type == "1")
        {
            dsSalesForce = sf.Sales_Trend_analysis_Distributor_descending_MR(divcode, fromdate, todate, subdivision, sfCode);
        }
        else
        {
            dsSalesForce = sf.Sales_Trend_analysis_Distributor_descending_MGR(divcode, fromdate, todate, subdivision, sfCode);
        }
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_saletrend_monthwise.aspx?Stockist_Code=" + drFF["Stockist_Code"] + "&Stockist_Name=" + drFF["Stockist_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                ...
                dsDoc = sf.Sales_Trend_analysis_totalvalue(divcode, fromdate, todate, subdivision);
            ...
            sURL = "rpt_sale_trend_monthwise.aspx?FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + total + "";
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.Sales_Trend_analysis_Distributor_descending(divcode,fromdate,todate, subdivision);
...
stCrtDtaPnt+="{label:\""+ drFF["Stockist_Name"].ToString()+"\",y:";
 ...
 sURL = "rpt_saletrend_monthwise.aspx?Stockist_Code=" + drFF["Stockist_Code"] + "&Stockist_Name=" + drFF["Stockist_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
    ...
    private void FillCategorywise()
    {
        ...
        SalesForce sf = new SalesForce();
        //dsSalesForce = sf.Getcategorysudivision_wise(divcode, subdivision);
        dsSalesForce = sf.Sales_Trend_analysis_categorywise_descending(divcode,fromdate,todate, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                lit_det_usr.Text = "&nbsp;" + drFF["cat_code"].ToString();
                tc_det_usr.BorderStyle = BorderStyle.Solid;
                tc_det_usr.BorderWidth = 1;
                tc_det_usr.Visible = false;
                tc_det_usr.Attributes.Add("Class", "rptCellBorder");
               ...
               stCrtDtaPnt+="{label:\""+ drFF["Product_Cat_Name"].ToString()+"\",y:";
                ...
                sURL = "rpt_saletrend_monthwise.aspx?Product_Cat_Code=" + drFF["cat_code"] + "&Product_Cat_Name=" + drFF["Product_Cat_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                    lit_det_sum.Attributes["onclick"] = "javascript:window.open('" + sURL + "' ,'','resizable=yes,toolbar=no,menubar=no,scrollbars=1,status=no,width=500,height=600,left=0,top=0,zoom=50%');";
                ...
                tc_det_currentmonth.Controls.Add(lit_det_mon);
                tr_det.Cells.Add(tc_det_currentmonth);
                dsDoc = sf.Sales_Trend_analysis_categorywise_total_value(divcode, fromdate, todate, subdivision);
                if (dsDoc.Tables[0].Rows.Count > 0)
                    tot_value = dsDoc.Tables[0].Rows[0].ItemArray.GetValue(0).ToString();
                if (tot_value != "" && tot_value != "0")
                {
    ...
    private void FillBrandwise()
    {
       ...
       string stCrtDtaPnt = string.Empty;
        ...
        SalesForce sf = new SalesForce();
        //dsSalesForce = sf.GetBrandsudivision_wise(divcode, subdivision);
        dsSalesForce = sf.Sales_Trend_analysis_Brandwise_descending(divcode, fromdate, todate, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                lit_det_usr.Text = "&nbsp;" + drFF["Brand_code"].ToString();
                tc_det_usr.BorderStyle = BorderStyle.Solid;
                tc_det_usr.BorderWidth = 1;
                tc_det_usr.Visible = false;
                tc_det_usr.Attributes.Add("Class", "rptCellBorder");
...
stCrtDtaPnt+="{label:\""+ drFF["Product_Brd_Name"].ToString()+"\",y:";
                ...
                tr_det.Cells.Add(tc_det_last6monthsum);                
				  ...
				  sURL = "rpt_saletrend_monthwise.aspx?Product_Brd_Code=" + drFF["Product_Brd_Code"] + "&Product_Brd_Name=" + drFF["Product_Brd_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                    lit_det_sum.Attributes["onclick"] = "javascript:window.open('" + sURL + "' ,'','resizable=yes,toolbar=no,menubar=no,scrollbars=1,status=no,width=500,height=600,left=0,top=0,zoom=50%');";
                ...
                dsDoc = sf.Sales_Trend_analysis_brandwise_total_value(divcode, fromdate, todate, subdivision);
...
string stCrtDtaPnt = string.Empty;
        ...
        dsSalesForce = sf.Sales_Trend_analysis_Productwise_descending(divcode, fromdate, todate, subdivision);
...
tc_det_SNo.Style.Add("text-align","right");
				...
				sURL = "rpt_single_sale_product_monthwise.aspx?FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&subdivision=" + subdivision + "&product_name=" + drFF["Product_Detail_Name"].ToString() + "&product_code=" + drFF["Product_Detail_Code"].ToString() + "";
                ...
                dsDoc = sf.Sales_Trend_analysis_Productwise(drFF["Product_Detail_Code"].ToString(), divcode, fromdate, todate);               
                ...
                dsDoc = sf.Sales_Trend_analysis_productwise_total_value(divcode, fromdate, todate, subdivision);
            ...
            sURL = "rpt_saletrend_monthwise.aspx?FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
            hyp_month.Attributes["onclick"] = "javascript:window.open('" + sURL + "' ,'','resizable=yes,toolbar=no,menubar=no,scrollbars=1,status=no,width=500,height=600,left=0,top=0,zoom=50%');";
