...
<td> <asp:Button ID="btnExport" runat="server" Text="PDF"  Font-Names="Verdana" Font-Size="10px"  BorderWidth="1" Height="25px" Width="60px"
    ...
    <div>
        ...
        <div>
             ...
             <table align="center"><tr><td width="200px">
            <asp:Label ID="DistributorName" runat="server" Text="Distributor Name" 
                Font-Bold="True" Font-Names="Andalus"></asp:Label>
                <asp:Label ID="dist" runat="server" Font-Size="12px" Font-Underline="True" ></asp:Label></td> <td> &nbsp;&nbsp;</td><td align="left">
                            <asp:Label ID="lblIDYear" Text="Category :" Font-Bold="True" Font-Names="Andalus" runat="server" SkinID="lblMand"></asp:Label>
                            <asp:Label ID="lblcatgory"   runat="server" SkinID="lblMand"></asp:Label>
                        </td></tr></table>
            <br />
