<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="vantoursale.aspx.cs" Inherits="MIS_Reports_vantoursale" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnview').on('click', function () {
                ...
                url = "rpt_vantoursale.aspx?sf_code=" + sfcode + "&div_code=" + <%=Session["div_code"]%> + "&subdiv=" + subdiv +
        ...
        function loadStates() {
            $.ajax({
                ...
                async: false,
                url: "vantoursale.aspx/getStates",
        ...
        function loadDivision(ssdiv) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "vantoursale.aspx/getDivision",
                data: '{"divcode":"<%=Session["div_code"]%>"}',
                dataType: "json",
                success: function (data) {
        ...
        function loadFieldForce() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "vantoursale.aspx/getFieldForce",
