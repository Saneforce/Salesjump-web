<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptLeaveFormAll.aspx.cs"
    Inherits="MIS_Reports_rptLeaveFormAll" %>
        ...
        jQuery(document).ready(function ($) {
            ...
            genRepot = function () {
                if (CDtls.length > 0 && lDtls.length > 0) {
                    var tbl = $('#tblFF');
                    str = '<th rowspan="2" >SlNo.</th><th rowspan="2">Name</th>';
                    stk = '';
                    ...
                    for (var i = 0; i < fil.length; i++) {
                        str = '<td style="text-align: right;">' + (i + 1) + '</td><td>' + fil[i].sfName + '</td>';
                        sf = fil[i].sfCode;
            ...
            $.ajax({
                ...
                async: false,
                url: "rptLeaveFormAll.aspx/getLeaveCode",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rptLeaveFormAll.aspx/GetLeaveSF",
