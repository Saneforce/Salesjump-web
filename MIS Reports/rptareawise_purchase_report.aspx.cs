...
public partial class MIS_Reports_rptareawise_purchase_report : System.Web.UI.Page
{
...
statename = Request.QueryString["State_name"].ToString();
        ...
        lblHead.Text = "Purchase Register -Area Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
    ...
    private void FillSF()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                //hq
                sURL = "rptzonewise_purchase_report.aspx?Area_Code=" + drFF["Area_code"] + "&Area_name=" + drFF["Area_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "&subdivision=" + subdivision + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                     ...
                     //   dsDoc = sf.areawise_purchase_value(drFF["Area_code"].ToString(), divcode, cmonth, cyear, subdivision);
						  dsDoc = sf.areawise_purchase_value(areacode: drFF["Area_code"].ToString(), div_code: divcode, cmonth: cmonth, cyear: cyear, subdivision: subdivision, sf_code:sfCode);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            sURL = "rpt_areawise_product_detail.aspx?Area_Code=" + drFF["Area_Code"] + "&Area_name=" + drFF["Area_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + "&subdivision=" + subdivision + "&stype=" + stype + "";
  ...
  dsDoc = sf.areawise_purchase_value(areacode: drFF["Area_code"].ToString(), div_code: divcode, cmonth: cmonth, cyear: cyear, subdivision: subdivision, sf_code: sfCode);
               ...
               // hyp_monthq.Text = iTotLstCount.ToString("0.00");
