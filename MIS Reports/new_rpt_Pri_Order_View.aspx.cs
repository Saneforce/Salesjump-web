...
public partial class MIS_Reports_rpt_Pri_Order_View : System.Web.UI.Page
{
    ...
    static string subdivision_code = "0";
    decimal catnwgt = 0;
    decimal catval = 0;
    decimal catquan = 0;
    ...
    public static string Getnewtable()
    {
        ...
        DCR dc = new DCR();
        ds = dc.view_pri_order_view_sub(divcode, sfCode, Date, subdivision_code);
    ...
    private void AddTotalRoww(string labelText, string value)
    {
        ...
        row.Cells.AddRange(new TableCell[3] { new TableCell (), //Empty Cell
                                        new TableCell { Text = labelText, HorizontalAlign = HorizontalAlign.Right,ColumnSpan=((divcode == "107") ? 5 : 5)},
