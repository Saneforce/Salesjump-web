...
public partial class MIS_Reports_rpt_sale_areawise_trend : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Sales Areawise Trend Analysis Details from  " + strFMonthName + " " + FYear;
 ...
 lblstate.Text =state_name;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.Sales_areawise_Trend_analysis_Distributor_descending(divcode, fromdate, todate, subdivision, state_code);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_sales_zonewise_trend.aspx?Area_code=" + drFF["Area_code"] + "&Area_name=" + drFF["Area_name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&state_name=" + state_name + "&state_code=" + state_code + "&Subdivision=" + subdivision + "";
                ...
                viewby = "Areawise";
                sURL = "rpt_salestrend_month.aspx?Area_code=" + drFF["Area_code"] + "&Area_name=" + drFF["Area_name"].ToString() + "&state_name=" + state_name + "&state_code=" + state_code + "  &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                ...
                dsDoc = sf.Sales_areawise_Trend_analysis_totalvalue(divcode, fromdate, todate, subdivision, state_code);
