<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="distbeatwise_card.aspx.cs" Inherits="MIS_Reports_distbeatwise_card" %>
    ...
    <form runat="server" style="height:550px;">
        <div class="row">
            <div class="col-lg-12 sub-header">
                Distributor/Beat Wise Score Card 			
          </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnview').on('click', function () {
                ...
                url = "Rpt_distbeatwise_card.aspx?sf_code=" + sfcode + "&div_code=" + <%=Session["div_code"]%> + "&subdiv=" + subdiv +
        ...
        function loadDivision(ssdiv) {
            $.ajax({
                ...
                async: false,
                url: "distbeatwise_card.aspx/getDivision",
        ...
        function loadFieldForce() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "distbeatwise_card.aspx/getFieldForce",
