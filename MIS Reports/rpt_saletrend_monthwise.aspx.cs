...
public partial class MIS_Reports_rpt_saletrend_monthwise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (viewby == "CategoryWise")
        {
           ...
           headerName.Text="CategoryWise";
          dist.Text=Product_Cat_Name;
        }
     ...
     headerName.Text="BrandWise";
          dist.Text=Product_Brd_Name;
        }
        ...
        if (viewby == "DistributorWise")
        {
            ...
            FillSF();
         headerName.Text="Distributorwise";
          dist.Text=Stockist_Name;
        }
        else if (viewby == "CategoryWise")
        {
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Sales_Trend_analysis_stockist_monthwise_distribution(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear, Stockist_Code);
                        ...
                        dsDoc = sf.Sales_Trend_analysis_stockist_monthwise_distribution_total(divcode, cmonth, cyear, Stockist_Code);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Sales_Trend_analysis_categorywise_monthwise(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear,Product_Cat_Code);
                        ...
                        dsDoc = sf.Sales_Trend_analysis_categorywise_monthwise_total(divcode, cmonth, cyear, Product_Cat_Code);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Sales_Trend_analysis_Brandwise_monthwise(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear,Product_Brd_Code);
                        ...
                        dsDoc = sf.Sales_Trend_analysis_Brandwise_monthwise_total(divcode, cmonth, cyear, Product_Brd_Code);
                ...
                for (int j = 1; j <= months + 1; j++)
                {
                    ...
                    foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
                    {
                        ...
                        if (tot_dr != "" && tot_dr != "0")
                        {
                            ...
                            try
                            {
                                Decimal per = Math.Round(Convert.ToDecimal(iTotLstCount.ToString()), 2);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        tc_det_last6monthsum.Controls.Add(lit_det_sum);
                        tr_det.Cells.Add(tc_det_last6monthsum);
                        dsDoc = sf.Sales_Trend_analysis_Productwise_monthwise(drFF["Product_Detail_Code"].ToString(), divcode, cmonth, cyear);
