...
public partial class MIS_Reports_Secondary_Return_Stock : System.Web.UI.Page
{
    ...
    protected void btnview_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string sURL = "Rpt_Secondary_Stock_Return.aspx?SF_code=" + ddldist.SelectedValue + "&div_code=" + divCode +
