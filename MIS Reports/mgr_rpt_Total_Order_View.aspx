<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mgr_rpt_Total_Order_View.aspx.cs" Inherits="MIS_Reports_mgr_rpt_Total_Order_View" %>
...
<a href="javascript:popUp123('<%=sfcode%>','<%=year%>','<%=sfname%>','<%=date%>','<%=month%>')">
                            RPT View</a>
                    ...
                    <tr> 
                        <td width="100%">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="S.No" ItemStyle-Width="50" HeaderStyle-BorderWidth="1"
									 ...
									 <asp:TemplateField HeaderText="State" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                        ...
                                        <ItemTemplate>
					                  <asp:Label ID="statcodes" style="white-space:nowrap" runat="server" Font-Size="9pt" Text='<%#Eval("StateName")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                      <asp:TemplateField HeaderText="Reporting Manager" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="10pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
					                      <asp:Label ID="rsfc" style="white-space:nowrap" runat="server" Font-Size="9pt" Text='<%#Eval("rsf")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Manager Des" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="10pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
					                      <asp:Label ID="rsfcdes" style="white-space:nowrap" runat="server" Font-Size="9pt" Text='<%#Eval("rsfdes")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
					     ...
					     <asp:HiddenField ID="stkcode" runat="server" Value='<%#Eval("Stockist_Code")%>'></asp:HiddenField>
									 ...
									 <asp:TemplateField HeaderText="SO Emp Id" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="10pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
					                      <asp:Label ID="empid" style="white-space:nowrap" runat="server" Font-Size="9pt" Text='<%#Eval("sf_emp_id")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="SO Name" ItemStyle-Width="270" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="10pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                       ...
                                       <asp:TemplateField HeaderText="HQ" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                        HeaderStyle-Font-Size="10pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
					                      <asp:Label ID="sfhq" style="white-space:nowrap" runat="server" Font-Size="9pt" Text='<%#Eval("sf_hq")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
