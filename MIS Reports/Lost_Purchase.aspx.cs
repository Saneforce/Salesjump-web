...
public partial class MIS_Reports_Lost_Purchase : System.Web.UI.Page
{
...
private void fillsubdivision()
 ...
 subdiv.Items.Insert(0, new ListItem("--Select--", "0"));
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
       ...
       sURL = "rpt_purchase_lost_selmonth.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString()+"&Subdivision="+ subdiv.SelectedValue.ToString();
