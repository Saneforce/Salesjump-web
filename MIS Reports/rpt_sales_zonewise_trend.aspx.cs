...
public partial class MIS_Reports_rpt_sales_zonewise_trend : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Sales Zonewise Trend Analysis Details from  " + strFMonthName + " " + FYear;
...
lblarea.Text=Area_name;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.Sales_Zonewise_Trend_analysis_Distributor_descending(divcode, fromdate, todate, subdivision, state_code, Area_code);
...
tc_det_SNo.Style.Add("text-align","right");
                ...
                sURL = "rpt_sale_territorywise_trend.aspx?Zone_code=" + drFF["Zone_code"] + "&Zone_name=" + drFF["Zone_name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&Area_code=" + Area_code + "&Area_name="+Area_name+"&State_code=" + state_code + "&state_name="+state_name+"&Subdivision=" + subdivision + "";
                ...
                viewby = "Zonewise";
                sURL = "rpt_salestrend_month.aspx?State_Code=" + state_code + "&state_name="+state_name+"&Area_code=" + Area_code + "&Area_name="+Area_name+"&Zone_code=" + drFF["Zone_code"] + "&Zone_name=" + drFF["Zone_name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                ...
                dsDoc = sf.Sales_Zonewise_Trend_analysis_totalvalue(divcode, fromdate, todate, subdivision, state_code, Area_code);
