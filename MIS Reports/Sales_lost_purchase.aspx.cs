...
public partial class MIS_Reports_Sales_lost_purchase : System.Web.UI.Page
{
        ...
        else
        {
            ...
            if (FYear <= TYear)
            {
               ...
               // sURL = "rpt_sales_lost_purchase.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString()+"&Subdivision="+ subdiv.SelectedValue.ToString();
                ...
                sURL = "rpt_sale_lost_purchase_sel_month.aspx?&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString()+"&Subdivision="+ subdiv.SelectedValue.ToString();
