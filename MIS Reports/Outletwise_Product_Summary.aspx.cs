...
public partial class MIS_Reports_Outletwise_Product_Summary : System.Web.UI.Page
{
    ...
    protected void btnview_Click(object sender, EventArgs e)
    {
        try
        {
            string sURL = "Rpt_Outletwise_Analysis.aspx?SF_code=" + ddldist.SelectedValue + "&div_code=" + divCode +
