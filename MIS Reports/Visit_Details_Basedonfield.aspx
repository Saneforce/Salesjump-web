<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Basedonfield.aspx.cs" Inherits="MIS_Reports_Visit_Details_Basedonfield" %>
...
<head runat="server">
     <title>Visit Details (Based on Field)</title>
...
<script type = "text/javascript">
    ...
    function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, cmode) {
        ...
        popUpObj = window.open("Visit_Details_Basedonfield_Level1.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&cMode=" + cmode,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
