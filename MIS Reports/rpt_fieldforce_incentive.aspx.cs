...
public partial class MIS_Reports_rpt_fieldforce_incentive : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "FieldForce Incentive from  " + date + " to  " + todate + "";
        Feild.Text = sfname;
        FillSF();
    ...
    private void FillSF()
    {
        ...
        ff = new DataSet();
        ff = SF.GetTarget(Sf_Code, date, todate);

        ss = new DataSet();
        ss = SF.GetQuantity(divcode, Sf_Code, date, todate);
    ...
    protected void OnRowCreated(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            foreach (DataRow drdoctor in ff.Tables[0].Rows)
            {
                ...
                HeaderCell.Text = drdoctor["UOM_Weight"].ToString()+" (" + drdoctor["TAR"].ToString() +")";
            ...
            for (int i = 0; i < ff.Tables[0].Rows.Count; i++)
            {
                ...
                gvincentive.Controls[0].Controls.AddAt(1, HeaderGridRow1);
                HeaderCell = new TableCell();
            ...
            foreach (DataRow drdoctor in ff.Tables[0].Rows)
            {
                try
                {
                    ...
                    if (drp.Length > 0)
                    {
                        ...
                        tableCellBal.Text = (Convert.ToInt64(drdoctor["TAR"]) - TQty[jk]).ToString();// +" ( " + drdoctor["Product_Detail_Code"] + ")";
    ...
    protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=FieldForceIncentive.xls");
        Response.Charset = "";
