<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Attendance_Rpt.aspx.cs" Inherits="MIS_Reports_Attendance_Rpt" %>
...
<script type="text/javascript">
    function NewWindow() {
        ...
        var imgpth = $('#ctl00_ContentPlaceHolder1_lblpath').text();
            ...
            window.open("rptattendancewrktype.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdiv=" + subdiv + "&sfCode=" + sfcode + "&sfname=" + FO + "&stcode=" + statc + "&stval=" + statv + "&type=" + type + "&imgpath=" + imgpth, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
