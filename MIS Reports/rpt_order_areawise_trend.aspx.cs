...
public partial class MIS_Reports_rpt_order_areawise_trend : System.Web.UI.Page
{
  ...
  lblstate.Text=state_name;
        ...
        lblHead.Text = "Order Areawise Trend Analysis Details from  " + strFMonthName + " " + FYear;
    ...
    private void FillSF()
    {
        ...
        dsSalesForce = sf.Order_areawise_Trend_analysis_Distributor_descending(divcode, fromdate, todate, subdivision, state_code);
...
tc_DR_Code.Style.Add("text-align","center");
	...
	tc_DR_Code_month.Style.Add("text-align","center");
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                sURL = "rpt_order_Zonewise_Trend.aspx?Area_code=" + drFF["Area_code"] + "&Area_name=" + drFF["Area_name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + "&state_name=" + state_name + "&state_code=" + state_code + "&Subdivision=" + subdivision + "";
...
TableCell tc_lst_month1 = new TableCell();
                ...
                viewby = "Areawise";
                sURL = "rpt_Ordertrend_month.aspx?Area_code=" + drFF["Area_code"] + "&Area_name=" + drFF["Area_name"].ToString() + "&state_name=" + state_name + "&state_code=" + state_code + "  &FYear=" + FYear + "&FMonth=" + FMonth + "&TMonth=" + TMonth + "&TYear=" + TYear + "&Subdivision=" + subdivision + "&viewby=" + viewby + "";
                ...
                {
                    lit_det_sum.Text = drFF["value"].ToString();
                }
                ...
                dsDoc = sf.Order_areawise_Trend_analysis_totalvalue(divcode, fromdate, todate, subdivision, state_code);
