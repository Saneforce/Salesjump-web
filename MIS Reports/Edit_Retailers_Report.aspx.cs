...
public partial class MIS_Reports_Edit_Retailers_Report : System.Web.UI.Page
{
    ...
    public static string GetDetails(string SF, string Div, string Mn, string Yr)
    {
        ...
        ds = SFD.getEdit_Retailers(SF, Div, Mn, Yr);
    ...
    {
        ListedDR SFD = new ListedDR();
        ds = SFD.getEdit_Retailers_Excel(sfcode, divcode, fdt, tdt);
        using (XLWorkbook wb = new XLWorkbook())
        {
            wb.Worksheets.Add(ds.Tables[0], "Edit Retailer Report");
            Response.Clear();
            Response.Buffer = true;
            Response.Charset = "";
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
            Response.AddHeader("content-disposition", "attachment;filename=Edit Retailers Report" + fdt + "_to_" + tdt + ".xlsx");
