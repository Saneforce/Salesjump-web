<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_lost_distributor_reportpurchase.aspx.cs" Inherits="MIS_Reports_rpt_lost_distributor_reportpurchase" %>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                <tr>
                    ...
                    <asp:Label ID="lblHead" Text="Lost Distributor Details" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
