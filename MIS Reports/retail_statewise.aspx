<%@ Page  Title="Retail Register-StateWise" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="retail_statewise.aspx.cs" Inherits="MIS_Reports_retail_statewise" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<%--<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>--%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<title>Retail Register-StateWise</title>
...
<script type="text/javascript">
    ...
    function showModalPopUp(sfcode, fmon, fyr, subdiv, tmon, tyr, prod) {
        ...
        popUpObj = window.open("rpt_retail_statewise_report.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&subdivision=" + subdiv + "&TMonth=" + tmon + "&TYear=" + tyr + "&Prod=" + prod,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
...
<script type="text/javascript">
    function NewWindow() {
        ...
        window.open("rpt_retail_statewise_report.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdivision=" + subdiv + "&TMonth=" + TMonth + "&TYear=" + TYear, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
    }
</script>
           ...
           <br />
             ...
             <div class="row">
                            <div class="col-md-6 col-md-offset-5">                              
                                         ...
                                         <button  ID="btnGo" class="btn btn-primary" style="width: 100px" runat="server"   onclick="NewWindow().this" ><span>View</span></button>
                            </div>
                        </div>
                        </div>
                        </div>
