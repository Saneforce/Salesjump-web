<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_pri_salesreturn.aspx.cs" Inherits="MIS_Reports_view_pri_salesreturn" %>
    ...
    <script type="text/javascript">
        ...
        function getUsers() {
            $.ajax({
                ...
                async: false,
                url: "view_pri_salesreturn.aspx/getSFdets",
        ...
        function ReloadTable() {
            ...
            for (var j = 0; j < sfusers.length; j++) {
                str += '<tr><td>' + (j + 1) + '</td><td>' + sfusers[j].SF_Name + '</td><td>' + sfusers[j].sf_hq + '</td><td>' + sfusers[j].Stockist_Name + '</td> '+
                ...
                '<td>' + sfusers[j].Ret_Qty + '</td><td>' + sfusers[j].RetValue + '</td>'; 
            ...
            $('#OrderList tfoot').html("<tr><td colspan=9 style='text-align: center;font-weight: bold'>Total  Value</td><td>" + qtytot.toFixed(2) + "</td><td>" + valtot.toFixed(2) + "</td></tr>");

        }
      
        $(document).ready(function () {
            $('#btnExportrpt').click(function () {
                doit('biff8', 'SalesReturnEntry_Primaryorder.xls');
            });
