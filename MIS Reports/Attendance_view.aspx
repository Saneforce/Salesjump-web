<%@ Page Title="Monthly Attendance" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Attendance_view.aspx.cs" Inherits="MIS_Reports_Attendace_view" %>
...
<script type="text/javascript">
    function NewWindow() {
        ...
        if (type == "--Select--") { alert("Select View"); $('#view').focus(); return false; }
 ...
 if (type == 'Status') {
     ...
     window.open("rptattendancefinal1.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdiv=" + subdiv + "&sfCode=" + sfcode + "&sfname=" + FO + "&type=" + type + "&imgpath=" + imgpth, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
 else if (type=='Typewise') {
     window.open("rptattendancefinal2.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdiv=" + subdiv + "&sfCode=" + sfcode + "&sfname=" + FO + "&type=" + type + "&imgpath=" + imgpth, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
 else if (type == 'WorkTypewise') {
     //window.open("rptattendancewrktype.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdiv=" + subdiv + "&sfCode=" + sfcode + "&sfname=" + FO + "&type=" + type + "&imgpath=" + imgpth, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
	 window.open("rpt_attendence_new.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdiv=" + subdiv + "&sfCode=" + sfcode + "&sfname=" + FO + "&type=" + type + "&imgpath=" + imgpth, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
		else if (type == 'Maximised') {
     window.open("monthlymaxattndce.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdiv=" + subdiv + "&sfCode=" + sfcode + "&sfname=" + FO + "&type=" + type + "&imgpath=" + imgpth, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
        else {
            window.open("rptattendancefinal.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdiv=" + subdiv + "&sfCode=" + sfcode + "&sfname=" + FO + "&type=" + type + "&imgpath=" + imgpth, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
    }
</script>
