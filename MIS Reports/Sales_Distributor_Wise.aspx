<%@ Page Title="Sale Register-Distributor Wise" Language="C#" AutoEventWireup="true"
    MasterPageFile="~/Master.master" CodeFile="Sales_Distributor_Wise.aspx.cs" Inherits="MIS_Reports_Sales_Distributor_Wise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function NewWindow() {
            ...
            window.open("rpt_sales_register_distributor_wise.aspx?&FMonth=" + FMonth + "&FYear=" + FYear + "&subdivision=" + subdiv + "&TMonth=" + TMonth + "&TYear=" + TYear, null, 'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');
        }
    </script>
