<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Visit_Details_Basedonfield_Level2.aspx.cs" Inherits="MIS_Reports_Visit_Details_Field2" %>
     ...
     <link type="text/css" rel="stylesheet" href="../css/repstyle.css" />
      ...
      <script type = "text/javascript">
          ...
          function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, cmode, Type) {
              popUpObj = window.open("Visit_Details_Basedonfield_Level3.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&cMode=" + cmode + "&Type=" + Type,
                "_blank",
        "ModalPopUp_Level1," +
         "0," +   
         "resizable=yes,"  +   
