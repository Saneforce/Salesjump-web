<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptvanstockledger.aspx.cs" Inherits="MIS_Reports_rptvanstockledger" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head>
<title>Van stock Ledger Statement</title>
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          ...
          var bal1 = parseInt(document.getElementById('fdatebal').innerText);
          $('[id*=GridView1]').find('tr:has(td)').each(function () {

              var sf_name = $(this).find("td:eq(1)").text();
              var sf_code = $(this).find("td:eq(0) :input").val();
              var credit = parseInt($(this).find("td :eq(5)").text());
              var debit = parseInt($(this).find("td:eq(6)").text());
...
<%--    <link href="../assets/css/style-responsive.css" rel="stylesheet">--%>
  ...
  <div class="container" style="padding-bottom:990px;">
		       ...
		       <h3 align="center"  style="text-decoration: underline">Vanstock Account Statement  for the period of 
                ...
                <table align="center"><tr><td> <asp:Label ID="lblretailer" runat="server" Text="Feildforce: "  Font-Bold="true" Font-Names="Andalus"></asp:Label><asp:Label ID="lblretailerval" Font-Names="Andalus"
                        runat="server" Text="Label">  </asp:Label></td><td>&nbsp;&nbsp;</td><td>  <asp:Label ID="lblroute" Font-Names="Andalus"  Font-Bold="true" runat="server" Text="Product:"></asp:Label></td><td> <asp:Label ID="lblrouteval" Font-Names="Andalus"
                        runat="server" Text=""></asp:Label></td><td></td></tr></table>
		          ...
		          <h3 align="Center" style="color:#2196F3;text-decoration: underline " >Stock as on   &nbsp;
                    ...
                    <Columns>
                     ...
                     <asp:TemplateField HeaderText="S.No" ItemStyle-Width="50"  HeaderStyle-HorizontalAlign="Center"
                        ...
                        <asp:TemplateField HeaderText="Distributor" ItemStyle-Width="270" HeaderStyle-HorizontalAlign="Center"
                                        HeaderStyle-Font-Size="10pt"  ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="stokist" runat="server" Font-Size="9pt" Text='<%#Eval("Fnm")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                         <asp:TemplateField HeaderText="Retailer" ItemStyle-Width="270" HeaderStyle-HorizontalAlign="Center"
                                        HeaderStyle-Font-Size="10pt"  ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="listeddr" runat="server" Font-Size="9pt" Text='<%#Eval("Tnm")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
