<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptretaileraccountstatement.aspx.cs" Inherits="MIS_Reports_rptretaileraccountstatement" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<title>Retailer Account Statement</title>
<head  >
    <meta charset="utf-8">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('[id*=GridView1]').find('tr:has(td)').each(function () {
                ...
                var credit = parseFloat($(this).find("td :eq(3)").text());
                var debit = parseFloat($(this).find("td:eq(4)").text());          
                ...
                $(this).find("td:eq(5)").text(bal.toFixed(2));
 ...
 var sum = 0;
            ...
            for (var i = 0; i < tds1.length; i++) {
                debitsum += isNaN(tds1[i].innerText) ? 0 : parseFloat(tds1[i].innerText);
            }
            ...
            var balsum = document.createTextNode(balncesum.toFixed(2));
            ...
            var debitsum = document.createTextNode(debitsum.toFixed(2));
            ...
            var creditsum = document.createTextNode(sum.toFixed(2));
            ...
            if (balncesum > 0) {
                lbloutputdisplay.innerText = " Payable Amount:";
                balvalue.innerText = balncesum.toFixed(2);
            }
            else {

                balncesum = Math.abs(balncesum);
                balvalue.innerText = balncesum.toFixed(2);
                lbloutputdisplay.innerText = "Outstanding Amount :";
            }
        });
</script>
...
<%--    <link href="../assets/css/style-responsive.css" rel="stylesheet">--%>
  ...
  <div class="container" style="padding-bottom:990px;">
		       ...
		       <h3 align="center"  style="text-decoration: underline">Retailer Account Statement  for the period of 
                ...
                <table align="center"><tr><td> <asp:Label ID="lblretailer" runat="server" Text="Retailer: "  Font-Bold="true" Font-Names="Andalus"></asp:Label><asp:Label ID="lblretailerval" Font-Names="Andalus"
                        runat="server" Text="Label">  </asp:Label></td><td>&nbsp;&nbsp;</td><td>  <asp:Label ID="lblroute" Font-Names="Andalus"  Font-Bold="true" runat="server" Text="Route :"></asp:Label></td><td> <asp:Label ID="lblrouteval" Font-Names="Andalus"
                        runat="server" Text="Label"></asp:Label></td><td></td></tr></table>
                
		          <h3 align="Center" style="color:#2196F3;text-decoration: underline " >Balance as on   &nbsp;
                    ...
                    <Columns>
                     ...
                     <asp:TemplateField HeaderText="S.No" ItemStyle-Width="50"  HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <asp:TemplateField HeaderText="Date" ItemStyle-Height="34" ItemStyle-Width="70"   HeaderStyle-HorizontalAlign="Center"
                                        HeaderStyle-Font-Size="10pt"  ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="stockist" style="white-space:nowrap" runat="server" Font-Size="9pt" Text='<%#Eval("Edate")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Transaction" ItemStyle-Width="270"   HeaderStyle-HorizontalAlign="Center"
                                        HeaderStyle-Font-Size="10pt"  ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="SF_name" runat="server" Font-Size="9pt" Text='<%#Eval("EntryFrom")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Credit" ItemStyle-Width="270"  HeaderStyle-HorizontalAlign="Center"
                                        HeaderStyle-Font-Size="10pt"  ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
    
 <asp:Label ID="credit" runat="server" Font-Size="9pt" class="credit" Text='<%#Eval("Credit")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Debit" ItemStyle-Width="270"  HeaderStyle-HorizontalAlign="Center"
                                        HeaderStyle-Font-Size="10pt"  ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                          <asp:Label ID="debit" runat="server" class="debit" Font-Size="9pt" Text='<%#Eval("Debit")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
