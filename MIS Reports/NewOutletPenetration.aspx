<%@ Page Title="NEW OUTLET PENETRATION" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="NewOutletPenetration.aspx.cs" Inherits="MIS_Reports_NewOutletPenetration" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $(document).on('click', '.btnview', function () {
                ...
                var str = 'rptNewOutletPenetration.aspx?&SFCode=' + sf_code + '&FYear=' + FYear + '&FMonth=' + FMonth + '&MnthName=' + monthName + '&SFName=' + SFName;
