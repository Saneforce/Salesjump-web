<%@ Page Language="C#"   EnableEventValidation="false" AutoEventWireup="true" CodeFile="rpt_non_retailer_view.aspx.cs" Inherits="rpt_non_retailer_view" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Lost Retailer Details</title>
      ...
      <asp:Panel ID="pnlbutton" runat="server">
            <table width="100%">
                ...
                <td width="20%"></td>
                    ...
                    <asp:Label ID="lblHead" Text="Lost Purchase Details" SkinID="lblMand" Font-Bold="true"  Font-Underline="true"
        ...
        <div>
                <table width="100%" align="center">
                    ...
                    <td width="2.5%"></td>
                        ...
                        <td align="left">
                            <asp:Label ID="lblIDMonth" Text="Route:" runat="server" SkinID="lblMand" 
                                Font-Bold="True" Font-Names="Andalus"></asp:Label>
                            <asp:Label ID="lblMonth" runat="server" SkinID="lblMand"></asp:Label>
                        </td>
                        <td align="left">
                            <asp:Label ID="lblIDYear" Text="Distributor :" runat="server" SkinID="lblMand"  Font-Bold="True" Font-Names="Andalus"></asp:Label>
