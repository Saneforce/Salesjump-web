<%@ Page Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="mgr_outlet_review.aspx.cs" Inherits="MIS_Reports_mgr_outlet_review" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <form id="form1" runat="server">
     ...
     $('#btnview').on('click', function () {
         ...
         url = "view_mgr_outlet_review.aspx?divcode=" + div + "&mgrval=" + mgrv + "&mgrnm=" + mgrn + "&fdt=" + fdate + "&tdt=" + tdate;
