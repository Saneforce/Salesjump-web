<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Rpt_SecondaryOrderSale.aspx.cs" Inherits="MIS_Reports_Rpt_SecondaryOrderSale" %>
...
<head >
    <title>Secondary Order Vs Sale</title>
    ...
    <script type="text/javascript">
        ...
        var    month = $('#<%=ddlmonth.ClientID%> :selected').val();
            ...
            window.open("Rpt_SecondaryOrderVsSale.aspx?SF_Code=" + st + "&year=" + year + "&month=" + month + "&Mgr_name=" + mgr_name + "&Mgr_code=" + str + "&mr_name=" + mr_name, null,
