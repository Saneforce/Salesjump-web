...
public partial class MIS_Reports_rptterritorywise_purchase_report : System.Web.UI.Page
{
...
subdivision = Request.QueryString["subdivision"].ToString();
        ...
        lblHead.Text = "Purchase Register -Territory Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;


        lblzones.Text=Zone_name;
...
string stCrtDtaPnt = string.Empty;
        ...
        State st = new State();
        dsSalesForce = st.get_area_Details_Territorywise(Zonecode, divcode);
...
stCrtDtaPnt+="{label:\""+ drFF["Territory_Name"].ToString()+"\",y:";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                     ...
                     //   dsDoc = sf.Territorywise_purchase_value(drFF["Territory_code"].ToString(), divcode, cmonth, cyear, subdivision);
  dsDoc = sf.Territorywise_purchase_value( territorycode:  drFF["Territory_code"].ToString(), div_code: divcode, cmonth: cmonth, cyear: cyear, subdivision: subdivision, sf_code:sfCode );
 ...
 stype = "1";
                            ...
                            sURL = "rpt_territorywise_product_detail.aspx?Territory_code=" + drFF["Territory_code"] + "&Territory_Name=" + drFF["Territory_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + "&stype=" + stype + "&subdivision=" + subdivision + "";
