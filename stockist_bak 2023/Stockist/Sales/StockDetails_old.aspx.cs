...
public partial class Stockist_Sales_StockDetails : System.Web.UI.Page
{
    ...
    public static string Get_Stock(string dist_code, string splited_form_year, string splited_to_year, string From_month, string To_month)
    {
       ...
       //ds = sm.get_Product_stock(Date, div_code, stk_Code);
        ds = get_Product_stock( div_code, dist_code, splited_form_year, splited_to_year, From_month, To_month);
        return JsonConvert.SerializeObject(ds.Tables[0]);
    }

    public  static DataSet get_Product_stock( string div_code, string stk_Code, string splited_form_year, string splited_to_year, string From_month, string To_month)
    {
        ...
        strQry = "Exec [get_stock_details_new] '" + div_code + "','" + stk_Code  + "','" + splited_form_year + "','" + splited_to_year + "','" + From_month + "','" + To_month + "'";
