<%@ Page Title="" Language="C#" MasterPageFile="~/Master_DIS.master" AutoEventWireup="true" CodeFile="Rpt_Sale_By_Item.aspx.cs" Inherits="Stockist_Sales_Rpt_Sale_By_Item" %>
        ...
        <script type="text/javascript">
            ...
            function ReloadTable() {
                ...
                for ($i = 0; Orders.length > $i; $i++) {
                    if ($i < Orders.length) {
                        ...
                        $(tr).html("<td >" + Orders[$i].Product_Code + "</td><td>" + Orders[$i].Product_Name + "</td><td><a id='clc' href='Rpt_Sales_By_Item_Detail.aspx?Pro_Code=" + Orders[$i].Product_Code + "&FDate=" + fdt + "&TDate=" + tdt + "&Pro_Name=" + Orders[$i].Product_Name + "'>" + Orders[$i].Qty + "</td><td align=\"right\">" + Orders[$i].Amt.toFixed() + "</td>");
            ...
            function loadData() {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: "Rpt_Sale_By_Item.aspx/Get_salebyitem_Count",
