<%@ Page Title="Route Add" Language="C#" AutoEventWireup="true" CodeFile="Territory_Detail.aspx.cs" MasterPageFile="~/Master_DIS.master"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            $(document).ready(function () {
               ...
               <%-- if ($('#<%=chkboxLocation.ClientID%> input:checked').length > 0) { return true; } else { alert(' Distributor Name '); return false; }--%>
				 ...
				 $('#bac').on('click', function () {
                    window.location.href = "../Stockist/Territory.aspx";
                });
                 $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Territory_Detail.aspx/DisplayRouteCode",
                dataType: "json",
                success: function (data) {
                    var RouteCode = data.d;
                    $("input[id$='txtRoutecode']").val(RouteCode);
                 },
    ...
    <body>
        <form id="form1" runat="server">
            <div>
                <input id="bac" type="button" class="btn btn-primary" style="margin-left: 90%; margin-top: -1%;" value="Back" />
          ...
          <tr>
            ...
            <table border="0" cellpadding="3" cellspacing="3" id="tblDocCatDtls">
                <tr>
                    ...
                    <td align="left" class="stylespc">
                        <asp:TextBox ID="txtRoutecode" TabIndex="1" ReadOnly="true" SkinID="MandTxtBox" onfocus="this.style.backgroundColor='#E0EE9D'"
                ...
                <asp:Panel ID="Panel2" runat="server">
                    ...
                    <center>
        <table border="0" cellpadding="0" cellspacing="0" id="Table1" align="center" style="width: 70%;display:none;">
                <tr>
            ...
            <table align="center" border="1" cellpadding="0" cellspacing="0" style="width: 70%;
                margin-bottom: 0px; margin-right: 0px; margin-top: 15px;display:none;">
                <tr>
                    ...
                    <center>
        <table border="0" cellpadding="0" cellspacing="0" id="Table2" align="center" style="width: 70%;display:none;">
                <tr>
                    <td rowspan="" class="style65" align="left" style="background-color: #A6A6D2; color: white; padding: 6px;">
                        &nbsp;Field Force&nbsp;
                    </td>
