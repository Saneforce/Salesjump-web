...
public partial class MasterFiles_Notification_Message : System.Web.UI.Page
{
 ...
 public static string trans_sl_no = string.Empty;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            iReturn = sf.AddNotification(div_code, SF_Code, SF_Name, txtmsg.Text, stdate, Edate);
        }
        else
        {
            iReturn=sf.Notification_update( SF_Code, SF_Name, txtmsg.Text, stdate, Edate, trans_sl_no,div_code);
        }
        if (iReturn > 0)
        {
