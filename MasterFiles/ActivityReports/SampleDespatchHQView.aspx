<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeFile="SampleDespatchHQView.aspx.cs" Inherits="SampleDespatchHQView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <table>
            <tr>
                <td align="center" style="color: #8A2EE6; font-family: Verdana; font-weight: bold;
                    ...
                    <asp:Label ID="lblHead" runat="server" Text="Sample Despatch from HQ View" Font-Underline="True"
    ...
    <center>
        <table >
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:GridView ID="gvSampleDespatch" runat="server" AutoGenerateColumns="false" 
                        CssClass="mGrid" Width="65%">
                        <Columns>
                            <asp:TemplateField HeaderText="Products" HeaderStyle-ForeColor="White" ItemStyle-Wrap="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblProduct" runat="server" Text='<%# Eval("ProductName") %>'></asp:Label>
                                    <asp:HiddenField ID="hdnProdCode" runat="server" Value='<%# Eval("Product_Detail_Code") %>'></asp:HiddenField>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="Pack" HeaderText="Pack" HeaderStyle-ForeColor="White" ItemStyle-Wrap="false"/>
                            <asp:BoundField DataField="Despatch_Qty" HeaderText="Pre Despatch Qty" HeaderStyle-ForeColor="White" />
