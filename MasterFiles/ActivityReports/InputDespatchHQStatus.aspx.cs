...
public partial class InputDespatchHQStatus : System.Web.UI.Page
{
    ...
    {
        DataSet dsInputDespatch = null;

        dsInputDespatch = objInput.GetInputDespatchStatus(sfCode, strMonth, strYear);
        if (dsInputDespatch.Tables[0].Rows.Count > 0)
        {
            gvInputDespatch.Visible = true;

            gvInputDespatch.DataSource = dsInputDespatch;
