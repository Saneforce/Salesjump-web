<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HO_ID_View.aspx.cs" Inherits="MasterFiles_HO_ID_View" %>
     ...
     <tbody>
        <tr>            
            <td colspan="2" align="center">
               <asp:GridView ID="grdHoID" runat="server" Width="85%" HorizontalAlign="Center" 
                     AutoGenerateColumns="false" EmptyDataText ="No Records Found" 
                     onrowcommand="grdHoID_RowCommand"                 
                     ...
                     <Columns>                
                      ...
                      <%--   <asp:TemplateField  HeaderStyle-ForeColor="white" HeaderText="Reporting To" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:Label ID="lbl_RptTo" runat="server" Text='<%# Bind("Reporting_To_Name") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                        <asp:HyperLinkField HeaderText="Edit" Text="Edit" HeaderStyle-ForeColor="White" DataNavigateUrlFormatString="HO_ID_Creation.aspx?HO_ID={0}"
