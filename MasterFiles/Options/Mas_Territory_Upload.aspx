<%@ Page Title="Route Upload" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="Mas_Territory_Upload.aspx.cs"
    Inherits="MasterFiles_Options_Mas_Territory_Upload" %>
                    ...
                    <table width="95%" cellpadding="5px" cellspacing="5px" style="border: 1px solid Black; background-color:White">
                       ...
                       <td align="right" style="padding-right:4px;">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <asp:ImageButton ID="Button1" runat="server"  Width="160px" Height="30px" ImageUrl="~/Images/routeuplaod.png" Text="Upload" ValidationGroup="Val" OnClick="btnUpload_Click" />
