...
public partial class MasterFiles_Options_Mail_Folder_Creation : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void grdmail_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Deactivate")
        {
            ...
            int iReturn = adm.DeActMail_Id(Mail_Id);
    ...
    {
        AdminSetup adm = new AdminSetup();
        dsMail = adm.getMailFolderName(div_code);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gridRow in grdmail.Rows)
        {
            ...
            {
                 iReturn = adm.RecordAdd(Name, div_code);
            ...
            //Update 
            iReturn = adm.MailUpdate(Convert.ToInt16(MailFolder_Id), MailFolder_Name, div_code);
    ...
    protected void grdmail_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        {
            int iReturn = adm.RecordAdd(txtname.Text, div_code);
    ...
    protected void btnTransfer_mail_Click(object sender, EventArgs e)
    {
        System.Threading.Thread.Sleep(time);
        Response.Redirect("Mail_Folder_Trans.aspx");
    }
    ...
    protected void btnaddnew_Click(object sender, EventArgs e)
    {
        ...
        if (MailFolder_Id == "")
        {
            ...
            int iReturn = adm.MailAdd(MailFolder_Name, div_code);
