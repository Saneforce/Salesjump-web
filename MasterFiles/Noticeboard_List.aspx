<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Noticeboard_List.aspx.cs" Inherits="MasterFiles_Noticeboard_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        var AllOrders = [];
        var divcode;
        var Orders = []; pgNo = 1; PgRecords = 10; TotalPg = 0; searchKeys = "Comment,Comment_Type";
	 ...
	 if (confirm("Do you want Delete the Message?")) {
            $.ajax({
                ...
                async: false,
                url: "Noticeboard_List.aspx/notifyDelete",
  ...
  alert(JSON.stringify(result));
        ...
        function ReloadTable() {
            ...
            for ($i = st; $i < st + PgRecords; $i++) {
                ...
                if ($i < Orders.length) {
                    ...
                    $(tr).html('<td>' + slno + '</td><td>' + Orders[$i].Comment + '</td><td>' + Orders[$i].Comment_Type + '</td><td>' + Orders[$i].Created_Date + '</td><td id=' + Orders[$i].Sl_No + ' class="sfedit" align="center"><a href="#">Edit</a></td><td align="center" onclick="sfdeact(' + Orders[$i].Sl_No + ')"><a href="#">Delete</a></td>');
        ...
        function loadData() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Noticeboard_List.aspx/getnotice_board",               
                dataType: "json",
                success: function (data) {
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#newsf', function () {
                y =0;
                window.location.href = "../MIS Reports/Notification_inpu.aspx";
            });

            $(document).on('click', '.sfedit', function () {
                x = this.id;
                window.location.href = "../MIS Reports/Notification_inpu.aspx?Sl_No=" + x;
            });
