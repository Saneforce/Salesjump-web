...
public partial class MasterFiles_DocCamp_SlNo_Gen : System.Web.UI.Page
{
    #region "Declaration"
    ...
    private DataTable BindGridView()
    {
        ...
        dtGrid = dv.getDocSubCatlist_DataTable(div_code);
    ...
    {
        Doctor dv = new Doctor();
        dsDocCat = dv.getDocSubCat(div_code);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            foreach (GridViewRow gridRow in grdDocCat.Rows)
            {
                ...
                // Update Division
                Doctor dv = new Doctor();
                //int iReturn = dv.Update_DocCatSno(Doc_Cat_Code, txtSlNo);
                int iReturn = dv.Update_DocCampSno(Doc_Cat_Code, txtSlNo);
                if (iReturn > 0)
                {
