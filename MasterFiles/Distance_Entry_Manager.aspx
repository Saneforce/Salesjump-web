<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="Distance_Entry_Manager.aspx.cs" Inherits="MasterFiles_Distance_Entry_Manager" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).on("click", ".btn-save", function () {
            ...
            $.ajax({
                ...
                //   async: false,
                url: "Distance_Entry_Manager.aspx/SaveDistance",
                data: "{'SF':'" + SF + "','xml':'" + sXMl + "'}",
                dataType: "json",
        ...
        function loadData(SF) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                //   async: false,
                url: "Distance_Entry_Manager.aspx/GetRoutes",
                data: "{'SF':'"+SF+"'}",
                dataType: "json",
                success: function (data) {
