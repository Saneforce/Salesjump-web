<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Zone_Salesforcewise.aspx.cs"
    Inherits="MasterFiles_Zone_Salesforcewise" %>

<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Zone - FieldForcewise View</title>
            ...
            <table>
                <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="lblSubdiv" runat="server" SkinID="lblMand" Text="Zone Name"></asp:Label>
                    </td>
                    <td align="left" class="stylespc">
