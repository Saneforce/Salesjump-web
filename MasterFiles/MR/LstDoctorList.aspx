...
<head runat="server">
    <title>Listed Customer Details</title>
        ...
        <center>
            <table width="91%">
                <tr>
                    <td style="width: 3.2%" />
                    <td>
                        <asp:Button ID="btnQAdd" runat="server" CssClass="BUTTON" Text="Add Listed Customer" ForeColor="White" BackColor="HotPink" 
                        ...
                        &nbsp;
                         <asp:Button ID="btnDAdd" runat="server" CssClass="BUTTON" Text="Detail Add Listed Customer"
                        ...
                        &nbsp;
                        <asp:Button ID="btnReAc" runat="server" CssClass="BUTTON" Text="Reactivate Listed Customer"
                            Width="160px" OnClick="btnReAc_Click" Height="26px" />
                        &nbsp;
                        ...
                        <asp:GridView ID="grdDoctor" runat="server" Width="85%" HorizontalAlign="Center"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField HeaderText="Add/Deactivate" ItemStyle-HorizontalAlign="Center"
                                    ...
                                    DataNavigateUrlFields="ListedDrCode">
                                    <ControlStyle ForeColor="DarkBlue" Font-Size="XX-Small" Font-Names="Verdana" Font-Bold="True">
                                    </ControlStyle>
                                    <ItemStyle ForeColor="DarkBlue" Font-Bold="False"></ItemStyle>
                                </asp:HyperLinkField>
