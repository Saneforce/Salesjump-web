...
public partial class MasterFiles_MR_ListedDoctor_LstDoctorView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Session["sf_type"].ToString() == "2" || Session["sf_type"].ToString() == "" || Session["sf_type"].ToString() == "3")
            {
                FillMR();
            }
        }
    ...
    private void FillMR()
    {
        ...
        // Added by Sridevi - to Check for Audit Manager
           ...
           // dsDoctor = (DataSet)ViewState["dsDoctor"];
            ...
            {           
                ...
                foreach (DataRow dataRow in dsDoctor.Tables[0].Rows)
                {
                    ...
                    if (rdoType.SelectedValue.ToString().Trim() == "0")
                    {
                        iDRCatg = dr_cat.getTerr_Cat_Count(drFF["Territory_Code"].ToString(), dataRow["Doc_Cat_Code"].ToString(),sf_code);
                    }
                    else if (rdoType.SelectedValue.ToString().Trim() == "1")
                    {
                        iDRCatg = dr_cat.getTerr_Spec_Count(drFF["Territory_Code"].ToString(), dataRow["Doc_Cat_Code"].ToString(),sf_code);
                    }
                    else if (rdoType.SelectedValue.ToString().Trim() == "2")
                    {
                        iDRCatg = dr_cat.getTerr_Cls_Count(drFF["Territory_Code"].ToString(), dataRow["Doc_Cat_Code"].ToString(),sf_code);
                    }
                    else if (rdoType.SelectedValue.ToString().Trim() == "3")
                    {
                        iDRCatg = dr_cat.getTerr_Qua_Count(drFF["Territory_Code"].ToString(), dataRow["Doc_Cat_Code"].ToString(), sf_code);
                    }
                    if (Session["sf_type"].ToString() == "1")
                    {
                        sf_code = Session["sf_code"].ToString();
                    ...
                    else
                    {
                        ...
                        sURL = "rptListedDr_View.aspx?sf_code=" + sf_code + "&terr_code=" + drFF["Territory_Code"].ToString() + " &terr_Name=" + drFF["Territory_Name"].ToString() + "&cat_code=" + dataRow["Doc_Cat_Code"].ToString() + "&cat_name=" + dataRow["Doc_Cat_name"].ToString() + "&type=" + rdoType.SelectedValue.ToString() + "&div=" + div_code;
                ...
                //if (iTotal_FF > 0)
                    ...
                    {
                        sURL = "rptListedDr_View.aspx?sf_code=" + sf_code + "&terr_code=" + drFF["Territory_Code"].ToString() + " &terr_Name=" + drFF["Territory_Name"].ToString() + "&type=" + rdoType.SelectedValue.ToString() + "&div=" + div_code;
            ...
            if (tot_catg > 0)
                ...
                sURL = "rptListedDr_View.aspx?mgr_code=" + sf_code  +"&type=" + rdoType.SelectedValue.ToString() +  "&div=" + div_code;
