...
<head runat="server">
   <title>UnListed Customer Deactivation</title>
...
<body>
       ...
       <table width="100%">
        <tr>
            ...
            <td>
                    ...
                    <asp:TextBox id="txtsearch" runat="server" CssClass="TEXTAREA" Visible= "false" SkinID="MandTxtBox" widht="100px" ></asp:TextBox> 
                ...
                <td colspan="2" align="center">
                    <asp:GridView ID="grdDoctor" runat="server" Width="85%" HorizontalAlign="Center" OnRowDataBound="grdDoctor_RowDataBound" 
                        ...
                        <Columns>                
                            ...
                            <asp:TemplateField HeaderText="Channal" ItemStyle-HorizontalAlign="Left" SortExpression="Doc_Special_Name" HeaderStyle-ForeColor="White">
                                <ItemTemplate>
    ...
    <div class="div_fixed">
         <asp:Button ID="btnSave" CssClass="BUTTON" Width="90px" Height="25px" runat="server" Text="De-Activate" Visible="false" 
