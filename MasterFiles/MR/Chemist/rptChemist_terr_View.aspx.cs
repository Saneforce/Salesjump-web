...
public partial class MasterFiles_MR_Chemist_rptChemist_terr_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["mgr_code"] != null)
        {
            ...
            dsDoctor = chem.getChemistsDetails_terr(Request.QueryString["mgr_code"].ToString());

            if (dsDoctor.Tables[0].Rows.Count > 0)
            {
                grdChemist.Visible = true;
                grdChemist.DataSource = dsDoctor;
                grdChemist.DataBind();
            }
        ...
        {
            Chemist chem = new Chemist();
            dsDoctor = chem.getChemist_terr(sf_code, terr_code);
