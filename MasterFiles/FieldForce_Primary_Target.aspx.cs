...
public partial class MasterFiles_FieldForce_Primary_Target : System.Web.UI.Page
{
    #region "declaration"
    ...
    public static string inserttarget(string target, string div, string Sf_code, string year, string subdiv)
    {
        ...
        try
        {
            ...
            xml += "</root>";
            rr = st.inserttargetFF_Primary(xml, year, Sf_code, div, subdiv);
        }
        catch (Exception ex)
        {
            return "update fail...";
    ...
    public static ItemRates[] getqnty(string div, string sfcode, string year)
    {
        ...
        DataSet dsAccessmas = pro.get_Target_QntyFF_Primary(div, sfcode, year);
