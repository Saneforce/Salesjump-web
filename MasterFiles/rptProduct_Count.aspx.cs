...
public partial class MasterFiles_rptProduct_Count : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
         ...
         {
             FillProd();
             lblProd.Text = "Product Details " + "<span style='color:Red'> " + "(Division: " + ProdName + ")" + "</span";
         }
    }
    private void FillProd()
    {
        Product dv = new Product();
        dsProd = dv.getProdforDiv(div_code, ProdCatCode);      
