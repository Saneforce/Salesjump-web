...
public partial class MasterFiles_rptField_Count : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
         ...
         {
             FillProd();
             lblProd.Text = "FieldForce Details " + "<span style='color:Red'> " + "(Division: " + ProdName + ")" + "</span";
         }
    }
    private void FillProd()
    {
        Product dv = new Product();
        dsProd = dv.getFieldforcou(div_code, ProdCatCode);      
