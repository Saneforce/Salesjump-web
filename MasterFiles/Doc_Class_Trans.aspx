...
<head runat="server">
    <title>Transfer Customer Class</title>
...
<body>
    ...
    <div>
        ...
        <br />
        <center>
            <table border="0" cellpadding="5" cellspacing="5" id="tblClasstransfer" align="center">
                <tr>
                    <td align="left">
                        <asp:Label ID="lblTrans_From" runat="server" SkinID="lblMand" 
                            Height="18px" ><span style="Color:Red">*</span>Transfer From</asp:Label>
                    </td>
                    <td align="left">
                ...
                <tr>
                    <td align="left">
                        <asp:Label ID="lblTrans_To" runat="server" SkinID="lblMand" Height="19px"
        ...
        <br />
           ...
           <center>
            ...
            <asp:Button ID="btnTransfer" runat="server" CssClass="BUTTON" Text="Transfer - Speciality" OnClick="btnTransfer_Click" />
        </center>
        <br />
        <center>
