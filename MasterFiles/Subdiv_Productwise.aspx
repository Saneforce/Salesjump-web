<%@ Page Language="C#" Title="Division - Productwise View" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="Subdiv_Productwise.aspx.cs" Inherits="MasterFiles_Subdiv_Productwise" %>
...
<head>
    <title>division - Productwise View</title>
 ...
 <script type="text/javascript" src="../JsFiles/CommonValidation.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#<%=btnProduct.ClientID%>').click(function () {
                var Prod = $('#<%=ddlProduct.ClientID%> :selected').text();
                if (Prod == "---Select---") { alert("Select Division Name."); $('#ddlProduct').focus(); return false; }
            });
        });
    </script>
</head>
<body>
    ...
    <asp:Label ID="lblProduct" runat="server" SkinID="lblMand" Text="Division Name"></asp:Label></td>
    <td align="left" class="stylespc">
                              ...
                              <asp:TemplateField HeaderText="Category" ItemStyle-HorizontalAlign="Left">                              
                                <ItemTemplate>
                                    <asp:Label ID="lblCat" runat="server" Text='<%# Bind("Product_Cat_Name") %>'></asp:Label>
                                     ...
                                     <asp:TemplateField HeaderText="Group" ItemStyle-HorizontalAlign="Left" Visible="false">                              
                                <ItemTemplate>
