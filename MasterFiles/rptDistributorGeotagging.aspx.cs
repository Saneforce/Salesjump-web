...
public partial class MasterFiles_rptDistributorGeotagging : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static List<distributor> GetGEODistributorsOnly(string SF_Code)
    {
        ...
        dsAlowtype = stk.GetGEODistributor(divcode, SF_Code, "", "", "");
    ...
    public static string untagDistributor(string custCode)
    {
        string err = "";
        int iReturn = -1;
        Stockist ldr = new Stockist();
        try
        {
