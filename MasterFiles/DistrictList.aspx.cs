...
public partial class MasterFiles_DistrictList : System.Web.UI.Page
{
    #region "Declaration"
...
string sf_type = string.Empty;
    ...
    private void FillSubdiv()
    {
        ...
        dsSubDiv = dv.DistgetSubDiv(divcode);
    ...
    private DataTable BindGridView()
    {
        ...
        District dv = new District();
        dtGrid = dv.DistgetSubDivisionlist_DataTable(divcode);
        return dtGrid;
    }
    ...
    protected void btnNew_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("DistrictCreation.aspx");
    }
    ...
    protected void grdSubDiv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deactivate")
        {
            ...
            //Deactivate
            District dv = new District();
            int iReturn = dv.DistDeActivate(subdivision_code);
            if (iReturn > 0)
            {
    ...
    protected void grdSubDiv_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        state_code =(grdSubDiv.Rows[e.RowIndex].FindControl("ddlState") as DropDownList).SelectedValue.ToString();
        Update(iIndex);
        FillSubdiv();
    }
    ...
    private void Update(int eIndex)
    {
        ...
        else
        {
            // Update Sub Division
            District dv = new District();
            int iReturn = dv.DistRecordUpdate(subdivcode, subdiv_sname, subdiv_name, state_name, divcode,state_code);
            if (iReturn == 0)
            {
  ...
  protected void ExportToExcel(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=DistrictList.xls");
        Response.Charset = "";
