<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master"  CodeFile="Route_Master_New.aspx.cs" Inherits="MasterFiles_Route_Master_New" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="col-md-6"  style="float: right">                               
                            ...
                            <div class="col-md-3 sub-header" style="float: right;width:10%;">                                  
                                <span style="float: right;border-width: 0px; position: absolute; top: 5px;height: 40px; width: 40px;">
                                    <a href="New_Territory_CustomDetail.aspx" class="btn btn-primary btn-update" id="newsf">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var filtrkey = '0'; var MasFrms = []; var ARoute = []; var CustItems = [];
        ...
        function ReloadTable() {
            ...
            for ($i = st; $i < st + Number(PgRecords); $i++) {
                if ($i < Orders.length) {
                    ...
                    let CustItem = ARoute.filter(function (a) { return Orders[$i].Territory_Code == a.RouteID })
                                                    ...
                                                    if ($(this).is(":checked")) {
                                                        ...
                                                        if ((cbval == ortblhn)) {
                                                            ...
                                                            if ($val == "") {
                                                                ...
                                                                $(tr).html("<td>" + ($i + 1) + "</td><td>" + Orders[$i].Territory_Code + "</td><td>" + Orders[$i].Territory_Name + "</td><td>" + stknm + "</td><td>" + sfname + "</td><td class='rocount' tcode='" + Orders[$i].Territory_SName + "'><a href='#'>" + Orders[$i].Reatailer_Count + "</a></td><td>" + Orders[$i].Target + "</td><td class='roedit'><a href='#'>Edit</a></td><td class='rodeact'><a href='#'>" + Orders[$i].Status + "</a></td>" + $td + "");
                                                            }
                                                            else {
                                                                $td += "<td>" + $val + "</td>";
                                                                tr = $("<tr rname='" + Orders[$i].Territory_Name + "' rocode='" + Orders[$i].Territory_Code + "'></tr>");
                                                                $(tr).html("<td>" + ($i + 1) + "</td><td>" + Orders[$i].Territory_Code + "</td><td>" + Orders[$i].Territory_Name + "</td><td class='fieldforce-name'>" + stknm + "</td><td class='fieldforce-name'>" + sfname + "</td><td class='rocount' tcode='" + Orders[$i].Territory_SName + "'><a href='#'>" + Orders[$i].Reatailer_Count + "</a></td><td>" + Orders[$i].Target + "</td><td class='roedit'><a href='#'>Edit</a></td><td class='rodeact'><a href='#'>" + Orders[$i].Status + "</a></td>" + $td + "");
                                                            }
        ...
        function fillAdditionalRoute() {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Route_Master_New.aspx/GetAdditionalRoute",
                data: "{'divcode':'<%=Session["div_code"]%>','ModuleId':'4'}",
                dataType: "json",
                success: function (data) {
                    ARoute = JSON.parse(data.d) || [];
        ...
        function fillstate() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Route_Master_New.aspx/getStates",
        ...
        function getSalesforce() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Route_Master_New.aspx/getSalesforce",
                dataType: "json",
                success: function (data) {
        ...
        function getStockistDetails() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Route_Master_New.aspx/getStockist",
                dataType: "json",
                success: function (data) {
        ...
        function fillHQ(sst) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Route_Master_New.aspx/getHQ",
        ...
        function fillSF(shq) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Route_Master_New.aspx/getSF",
        ...
        function fillRoutes(sfs) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: true,
                url: "Route_Master_New.aspx/getRoutes",
        ...
        function fillRetailers(sfs) {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Route_Master_New.aspx/getRoute_Retailers",
        ...
        function deactRoute($routeCode,$deactFlag,$indx) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Route_Master_New.aspx/deactivateRoutes",
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.roedit', function () {
                ...
                window.location.href = "New_Territory_CustomDetail.aspx?&Territory_Code=" + route_C + "";
            });
        ...
        function loadCustomFields() {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Route_Master_New.aspx/GetCustomFormsFieldsColumns",
        ...
        //                    $fldnm = MasFrms[$k].Field_Name;
        //                    $fldnc = MasFrms[$k].Field_Col;
        //                    if ((MasFrms[$k].Field_Type == "C")) {
        //                        if (($fldnm == ortblhn)) {
        //                            $('#CustoFielddets').find('input[type="checkbox"]').each(function () {
        //                                var cbval = $(this).val();
        //                                if (($fldnm == cbval)) {
        //                                    if ($(this).prop('checked') == false) {
        //                                        $(this).prop('checked', true);
        ...
        //                        }
        //                        else {
        //                            $('#CustoFielddets').find('input[type="checkbox"]:checked').each(function () {
        //                                var cbval = $(this).val();
        //                                if (($fldnm != cbval)) {

        //                                    $td += "<th style='text-align:left; color: #fff'>" + $fldnm + "</th>";
        //                                }
        //                                //else { $td += "<th style='text-align:left; color: #fff'>" + $fldnm + "</th>"; }
        //                            });
        //                            //
        //                        }
