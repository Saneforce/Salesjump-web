           ...
           <tbody >
              <tr>
                 <td colspan="2" align="center"> 
                         ...
                         <asp:GridView ID="grdProdBrd" runat="server" Width="30%" HorizontalAlign="Center" EmptyDataText="No Records Found"  
                            ...
                            <Columns>                
                                ...
                                <asp:TemplateField HeaderText="Brand Code" ItemStyle-HorizontalAlign="Left">
                                     <ItemTemplate> 
                                        <asp:TextBox ID="txtProductBrdSName" Width="80px" MaxLength="12" onkeypress="AlphaNumeric_NoSpecialChars(event);" runat="server" SkinID="TxtBxAllowSymb"  Text='<%# Bind("Product_Brd_SName") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Brand Name">
                                     <ItemTemplate>
                                        <asp:TextBox ID="txtProductBrdName" Width="120px"  MaxLength="120"  SkinID="TxtBxAllowSymb" onkeypress="AlphaNumeric_NoSpecialChars(event);"  runat="server" Text='<%# Bind("Product_Brd_Name") %>'></asp:TextBox>
                                     </ItemTemplate>
                                </asp:TemplateField>   
