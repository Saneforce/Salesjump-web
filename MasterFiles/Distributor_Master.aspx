<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Distributor_Master.aspx.cs" Inherits="MasterFiles_Distributor_Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<form runat="server">
        ...
        <div class="row" style="margin-bottom: 1rem;">
            ...
            <div class="col-lg-12 sub-header">Distributor Master<span style="float: right"><a href="Distributor_Creation.aspx" class="btn btn-primary btn-update" id="newsf">Add Distributor</a></span></div>
        </div>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.roedit', function () {
                ...
                window.location.href = "Distributor_Creation.aspx?stockist_code=" + route_C + "";
            });
