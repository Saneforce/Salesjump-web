<%@ Page Title="Issue Slip List" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master"
    CodeFile="Issue_Slip_List.aspx.cs" Inherits="MasterFiles_Issue_Slip_List" %>
...
function (event) {
    ...
    <body>
                                            ...
                                            <asp:GridView ID="GrdDoctor" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="120px" HeaderText="Rate" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                                        <ItemTemplate>
                                                            <asp:Label ID="LabDP" Width="60px" Style="text-align: right;" MaxLength="8" CssClass="TEXTAREA"
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="120px" HeaderText="Qty" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                                        <ItemTemplate>
                                                            <asp:Label ID="Labqty" Width="60px" Style="text-align: right;" MaxLength="8" CssClass="TEXTAREA"
                                                                runat="server" Text='<%# Bind("Qty") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-Width="140px" HeaderText="Value" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                                        <ItemTemplate>
                                                            <asp:Label ID="LabVal" Width="60px" Style="text-align: right;" MaxLength="8" CssClass="TEXTAREA"
                                                                runat="server" Text='<%# Bind("Value") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-Width="140px" HeaderText="Reason" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" BorderColor="Black"></HeaderStyle>
                                                        <ItemTemplate>
                                                            <asp:Label ID="LabRea" Width="60px" Style="text-align: right;" MaxLength="8" CssClass="TEXTAREA"
                                                                runat="server" Text='<%# Bind("Reason") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
        ...
        <%--<table>
            <tr>
                <td>
                    <asp:Button ID="btnSubmit" class="btn btn-secondary" runat="server" Text="Save" Visible="false"
