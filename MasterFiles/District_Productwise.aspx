<%@ Page Language="C#" AutoEventWireup="true" CodeFile="District_Productwise.aspx.cs" Inherits="MasterFiles_District_Productwise" %>
<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>District - Productwise View</title>
...
<body>
    ...
    <asp:Label ID="lblProduct" runat="server" SkinID="lblMand" Text="District Name"></asp:Label></td>
    <td align="left" class="stylespc">
