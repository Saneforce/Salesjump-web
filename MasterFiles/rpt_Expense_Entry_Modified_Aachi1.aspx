 ...
 <div class="overlay" id="loadover" style="display: none;">
    ...
    <form id="form1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            var prvsTot = 0, prvsOTot = 0, DedAmnt = '';
            var ExpApprovedBy = '';
			...
			$('#loadover').show();
               ...
               // if (ExpItem.ADate != NAdt) {
                ...
                $(".E_Mot_typ").on('change', function () {
                    ...
                    var oldcdist = $($(this)).closest('tr').find('.E_Dis>span').text();
            ...
            function distchange($chdist, $Fulchrg) {
                ...
                var chfare = cdist * ($($chdist).closest('tr').find(".E_Mot_typ").val() != -1) ? $($chdist).closest('tr').find(".E_Mot_typ").val() : 0;//$Fulchrg;
            ...
            function svExpense() {
                ...
                for ($i = 0; $i < $trdy.length; $i++) {
                    ...
                    dy = {};
                    if ($($trdy[$i]).find('.E_Mot_typ option:selected').text() == 'SELECT' || $($trdy[$i]).find('.E_Mot_typ option:selected').attr("id")==-1) {
