...
public partial class MasterFiles_DSMList : System.Web.UI.Page
{
#region "Declaration"
...
int time;
    ...
    {
        DSM dv = new DSM();
        dsSubDiv = dv.ZonegetSubDiv(divcode);
    ...
    protected void btnNew_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("DSMCreation.aspx");
    }
    ...
    protected void grdSubDiv_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Deactivate")
        {
          ...
          //  subdivision_code = Convert.ToInt16(e.CommandArgument);
            ...
            //Deactivate
            DSM dv = new DSM();
            int iReturn = dv.DSMDeActivate(subdivision_codee);
            if (iReturn > 0)
            {                
    ...
    protected void grdSubDiv_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        Area_code = (grdSubDiv.Rows[e.RowIndex].FindControl("ddlState") as DropDownList).SelectedValue.ToString();
        Update(iIndex);
        FillSubdiv();
    }
             ...
             if (ddlQual != null)
             {
                 ...
                 if (e.Row.RowType == DataControlRowType.DataRow)
                 {
                     ...
                     if (State_Type != null)
                     {
                         ...
                         State_Type.SelectedIndex = State_Type.Items.IndexOf(State_Type.Items.FindByText(row["Distributor_Name"].ToString()));
