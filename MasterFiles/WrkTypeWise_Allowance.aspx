<%@ Page Title="Expense Entry" Language="C#" MasterPageFile="~/Master_MR.master" AutoEventWireup="true" CodeFile="WrkTypeWise_Allowance.aspx.cs"
            ...
            <table width="100%">
                <tr>
                    <td align="center" colspan="2">
                        <asp:GridView ID="grdWTAllowance" Width="80%" runat="server" AutoGenerateColumns="False"
                            ...
                            Style="border-collapse: collapse;" FooterStyle-HorizontalAlign="Right">
                                ...
                                <asp:TemplateField HeaderText="Total">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtTotal" Style="text-align: right;" MaxLength="8" runat="server"
                                            Text='<%#(Eval("Expense_Total"))%>' Enabled="true"></asp:TextBox>
                                    </ItemTemplate>
                                    <FooterTemplate>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:Button ID="btnSave" Text="Save" Width="50px" CssClass="BUTTON" runat="server"
        ...
        <center>
            <table width="10%" align="right" style="margin-right: 10%">
                <tr>
                    <td style="width: 150px">
                        Grand Total:<br />
                        <asp:TextBox ID="Txt_OverallTotal" runat="server" Width="140" Enabled="false" />
                    </td>
                </tr>
            </table>
        </center>
