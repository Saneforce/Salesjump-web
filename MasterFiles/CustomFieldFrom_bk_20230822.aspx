<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="CustomFieldFrom_bk_20230822.aspx.cs" Inherits="MasterFiles_CustomFieldFrom_bk_20230822" %>
        ...
        <body>
                ...
                <div class="card" style="padding:10px !important; margin-top:0px !important; " id="AddModuleFields">
                    ...
                    <div class="row" style="margin-bottom: 1rem!important;">
                        <div class="col-lg-12 sub-header">
                            Custom Field Forms
                            <button type="button" class="btn btn-demo btnadd" data-toggle="modal" data-target="#myModal2" style="float: right; background-color: #16aac9; color: white;" id="btnAdd" >
                                Add Fields
                            </button>
                    ...
                    <div class="row">
                        <div class="row" style="margin-bottom: 1rem!important;">
                            <div class="col-xs-6 col-center-block " style="margin-right:10%">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content" style="margin-top:50px !important;padding:16px !important">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel3">New Custom Form </h4>
                                </div>
            ...
            <script type="text/javascript">
                        ...
                        success: function (data) {
                            ...
                            if (CTCList.length > 0) {
                                ...
                                for (var i = 0; i < CTCList.length; i++) {
                                    valtbl.append($('<option value="' + CTCList[i].Cols + '">' + CTCList[i].Cols + '</option>'));
                                    texttbl.append($('<option value="' + CTCList[i].Cols + '">' + CTCList[i].Cols + '</option>'));
                                }
                            }
                        }
                    });
                    ...
                    for ($i = st; $i < st + PgRecords; $i++) {
                        if ($i < Orders.length) {
                            ...
                            $(tr).html('<td>' + slno + '</td><td>' + Orders[$i].ModuleName +
                                ...
                                '</td><td><a href="#" onclick="deactfrmfld(' + Orders[$i].Field_Id + ')">' + Orders[$i].Status +
                ...
                $(document).ready(function () {
                    ...
                    FiledTypeOnChange();
                    $('#Filter').hide(); loadMasterTablelist();
                    //var TableName = $("#mtables").val();
                    //alert(TableName);
