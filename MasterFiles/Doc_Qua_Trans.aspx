...
<head runat="server">
    <title>Transfer Customer Qualification</title>
...
<body>
    ...
    <div>
        ...
        <br />
        <center>
            <table border="0" cellpadding="5" cellspacing="5" id="tblQuatransfer" align="center">
                <tr>
                    <td align="left">
                        <asp:Label ID="lblTrans_From" runat="server" SkinID="lblMand" 
                           ><span style="Color:Red">*</span>Transfer From</asp:Label>
                    </td>
                    <td align="left">
                ...
                <tr>
                    <td align="left">
                        <asp:Label ID="lblTrans_To" runat="server" SkinID="lblMand" 
                            ><span style="Color:Red">*</span>Transfer To</asp:Label>
                    </td>
                    <td align="left">
        ...
        <center>
            ...
            <asp:Button ID="btnTransfer" runat="server" CssClass="BUTTON" Text="Transfer - Qualification" OnClick="btnTransfer_Click" />
        </center>
        <br />
        <center>
            <asp:Panel ID="pnlCount" runat="server" Visible="false">
                ...
                <br />
                <asp:Button ID="btnConfirm" runat="server" Text="Confirm to Transfer" CssClass="BUTTON" OnClientClick="return confirm('Do you want to Transfer Qualification?') &&  confirm('Are you sure want to Transfer?');" 
