<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="StarViewMail.aspx.cs" Inherits="MasterFiles_StarViewMail" %>
                  ...
                  <%--<span class="label label-primary pull-right">12</span></a></li>--%>
                        ...
                        <div class="col-md-9">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><i class='fa fa-star-o text-black'></i> Starred</h3>
            ...
            $(function () {
                ...
                $(document).ready(function () {
                    <%-- $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "StarViewMail.aspx/GetStarData",
