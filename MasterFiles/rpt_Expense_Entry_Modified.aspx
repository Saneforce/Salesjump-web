<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="rpt_Expense_Entry_Modified.aspx.cs" Inherits="MasterFiles_rpt_Expense_Entry_Modified" %>
...
<body style="margin: 15px; margin-top: 50px">
    ...
    <form id="form1" runat="server">
                                ...
                                <table class="table table-hover" id="Tptbl">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: left;">Devation Reason</th>
                                            <th style="text-align: left;">TP Area</th>
                                            <th style="text-align: left;">TP Date</th>
                                            <th style="text-align: left;">Tp Approved By</th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                </table>
        ...
        <script language="javascript" type="text/javascript">
            ...
            var Type = 0; let dailyAdd_Amt = 0; let dailyD_Amt = 0, click_key = 0,HotelBill =[];
			var AccessDets=[], Url='';
            ...
            function AddDRow() {
                ...
                for (var i = 0; i < $UsrDAdd.length; i++) {
                    ...
                    //if($Daily.AltAmnt!='')
                    //dailyAdd_D+=parseInt($Daily.AltAmnt);
                    ...
                    if ($ArApp[0].EnDis == 'Disable'  && '<%=Exp_Proc%>' == 1) {
            ...
            function rejectexpense1($rdt) {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/rejectExpense_Condition",
            ...
            function rejectexpense($rdt) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/rejectExpense",
            ...
            function CalcDAddDed($k) {
                ...
                if (vty == '1') {
                    ...
                    if (otmant >= cval) {
                        otmant -= cval
                    } else { rjalert('Alert!!','Cannot Exceed the Expense Amount','error'); $($k).closest('tr').find('.tamnt').text(parseFloat(otmant).toFixed(2)); return false; }
                }
                $(".dtxAddDed").each(function () {
			...
			function CalcMAddDed(x) {
                var $cVal = 0; $taddv = 0; $tdedv = 0; $deamnt = 0; $OvrAll_deamnt = 0;
                $(".txAddDed").each(function () {
                    $xv = parseFloat($(this).val());
                    if (isNaN($xv)) $xv = 0;
                    vty = $(this).closest('tr').find('.cbAlwTyp').val()
                ...
                if ($NTot == -1) {
                    ...
                    $("#tfAddDedAmt").text($OvrAll_deamnt - $OvrAll_deamnt);
                    $NTot = $pNTVal;
                    //alert('Cannot Exceed the Expense Amount');                    
                    rjalert('Alert!!', 'Cannot Exceed the Expense Amount', 'error');                                        
                    $("#tDedAmt").html(parseFloat($deamnt).toFixed(2));                    
				}
                    ...
                    if (ExpItem.ADate != NAdt) {
                        if ((ExpItem.ADate != frecord) && (ExpItem.ADate != lrecord)) {
                            ...
                            for ($j = 0; $j < AllowanceMx.length; $j++) {
                                ...
                                $s += "<td class='E_DyExp' Decd='" + AllowanceMx[$j].AlwCd + "' Dedt='" + ExpItem.ExpDt + "'  align=\"right\">" + ((ExpItem.WType == 'No Claim' || ExpItem.WType == 'Not Claimed') ? "" : ($adAlw).toFixed(2)) + "</td>";
...
//                            //$s += "</table></td>";
        			var Htlnum = (isNaN(Number(ExpItem.Hotel_Bill_Amt)) ? 0 : Number(ExpItem.Hotel_Bill_Amt));
                            if (ExpItem.WType != 'No Claim' && ExpItem.WType != 'Not Claimed' && Htlnum != 0 ) {
					...
					for (var i = 0; i < htl_img.length; i++)
                	        ...
                	        $s += "<tr><td expdt='" + ExpItem.ExpDt + "'>Hotel Bill<div>"+img+"</div></td><td>" + (Number(ExpItem.Hotel_Bill_Amt)).toFixed(2) + "</td></tr></table></td>";
                        	
                                //$s += "<tr><td><a  class='htlbill' expdt='" + ExpItem.ExpDt + "'>Hotel Bill</a></td><td>" + (Number(ExpItem.Hotel_Bill_Amt)).toFixed(2) + "</td></tr></table></td>";
                            }
			else{
				$s += "</table></td>";
			}
                            ...
                            $s += "<td class='tamnt'  orval='" + $cTAmt + "' align=\"right\">" + ((ExpItem.WType != 'No Claim' && ExpItem.WType != 'Not Claimed') ? ($cTAmt).toFixed(2) : "") + "</td>" + tdAdd + tdreject + "";
                            $(tr).html($s);
                            $("#tBdyExp").append(tr);
                            //if (ExpItem.WType != 'N/A') {
                ...
                $('.htlbill').on('click', function () {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        //   async: false,
                        url: "rpt_Expense_Entry_Modified.aspx/Get_HotelBillExpense",
                ...
                if (($ArApp[0].EnDis == 'Disable'  && '<%=Exp_Proc%>' == 1) || '<%=Session["sf_code"]%>' == '<%=SF_Code%>') {
            ...
            function loadData() {
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    //   async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/GetExpense",
                ...
                success: function (data) {
                    ...
                    if ('<%=Session["div_code"]%>' == '109' || '<%=Session["div_code"]%>' == '29'|| '<%=Session["div_code"]%>' == '4') {
                        $('.phsfields').show();
                    }
                    else {
                        $('.phsfields').hide();
            ...
            function distchange($chdist, $Fulchrg) {
                ...
                var chfare = cdist * ( ('<%=Session["div_code"]%>'=='100') ? ($($chdist).closest('tr').find(".Atyp").val() == 'HQ') ? 0 : $($chdist).closest('tr').find(".E_Mot_typ").val() : parseFloat(((FareDet.length > 0) ? FareDet[0].Fare : 0)));
                ...
                $($chdist).closest('tr').find('.E_Dis>span').text(($($chdist).closest('tr').find(".Atyp").val() == 'HQ' && '<%=Session["div_code"]%>'=='100') ? 0 : cdist);
                ...
                if ($($chdist).closest('tr').find(".Atyp").val() == 'HQ' && '<%=Session["div_code"]%>'=='100') {
                    $($chdist).closest('tr').find(".eddist").val('0');
                    $($chdist).closest('tr').find(".E_Fare").text(0);
                }
                $($chdist).hide();
            }
            function Atypchange($typch, AllCd, Dt) {
                ...
                $($typch).closest('tr').find(".E_Mot_typ").empty().append(Motstr);
                ...
                if (chdatyp == 'HQ' && '<%=Session["div_code"]%>'=='100') { 
                    $($typch).closest('tr').find(".eddist").val(0);
                    distchange($($typch).closest('tr').find(".eddist"), 0);
                    $($typch).closest('tr').find(".E_Fare").val(0);
                }
                ...
                $ChAlwAmt = (AllowanceMx.length > 0) ? isNaN(parseFloat(AllowanceMx[0].AlwAmt)) ? 0 : parseFloat(AllowanceMx[0].AlwAmt) : 0;
		...
		console.log(location.href)
                    ...
                    console.log(Url)
                    Url = Url.replace('/MasterFiles/rpt_Expense_Entry_Modified', '');
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/GetSFDetails",
                    data: "{'SF':'<%=SF_Code%>'}",
                    dataType: "json",
                    success: function (data) {
				...
				if(localStorage.getItem('Access_Details')){
					AccessDets=JSON.parse(localStorage.getItem('Access_Details'));
				}
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/GetDistanceDetails",
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/GetfAREDetails",
                    data: "{'sf_code':'<%=SF_Code%>'}",
                    dataType: "json",
                    success: function (data) {
                        FareDet = data.d;
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/GetAllowanceDetails",
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/GetUserExpense",
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/UserDailyAdditional",
                    data: "{'SF':'<%=SF_Code%>','Mn':'<%=Mn %>','Yr':'<%=Yr%>'}",
                    dataType: "json",
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/UserExpAdditional",
                    data: "{'SF':'<%=SF_Code%>','Mn':'<%=Mn %>','Yr':'<%=Yr%>'}",
                    dataType: "json",
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/getTPDetails",
                    data: "{'SF':'<%=SF_Code%>','Mn':'<%=Mn %>','Yr':'<%=Yr%>'}",
                    dataType: "json",
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/getApproval",
                    data: "{'SF':'<%=SF_Code%>','Mn':'<%=Mn %>','Yr':'<%=Yr%>'}",
                dataType: "json",
                success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/AutoExpense",
                    data: "{'SF':'<%=SF_Code%>','Mn':'<%=Mn %>','Yr':'<%=Yr%>'}",
                    dataType: "json",
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/ManualSfExpense",
                    data: "{'SF':'<%=SF_Code%>','Mn':'<%=Mn %>','Yr':'<%=Yr%>'}",
                    dataType: "json",
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/getTransMonthExp",
                    data: "{'SF':'<%=SF_Code%>','Mn':'<%=Mn %>','Yr':'<%=Yr%>'}",
                    dataType: "json",
                    success: function (data) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/GetExpenseKm",
                    data: "{'SF':'<%=SF_Code%>','Mn':'<%=Mn %>','Yr':'<%=Yr%>'}",
                    dataType: "json",
                    success: function (data) {
                        transExpStEndKm = JSON.parse(data.d) || [];
                    },
                    error: function (jqXHR, exception) { $('#loadover').hide(); showERROR(jqXHR, exception); }
                });
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    async: false,
                    url: "rpt_Expense_Entry_Modified.aspx/GetExpenseModeoftravel",
                    dataType: "json",
                    success: function (data) {
				...
				$.ajax({
					...
					contentType: "application/json; charset=utf-8",
					async: false,
					url: "rpt_Expense_Entry_Modified.aspx/getTPDeVation",
					data: "{'SF':'<%=SF_Code%>','Mn':'<%=Mn %>','Yr':'<%=Yr%>'}",
					dataType: "json",
					success: function (data) {
		    ...
		    var dt=transTpDevation[i].Activity_Date.split('T')	
                    str += "<tr><td>" + (i + 1) + "</td><td>" + transTpDevation[i].Deviation_Reason + "</td><td>" + transTpDevation[i].TP_Area + "</td><td>" + dt[0] + "</td><td>" + transTpDevation[i].Approval_MGR_Name + "</td></tr>";
                }
            ...
            function svExpense() {
                ...
                if (click_key == 1) {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json; charset=utf-8",
                        async: false,
                        url: "rpt_Expense_Entry_Modified.aspx/ApprHyr_Vacant_Chk",
                        data: "{'SfCode':'<%=SF_Code%>','MAuto':'" + $MAuto + "'}",
                        dataType: "json",
                        success: function (data) {
                            Appr_SF_sts = JSON.parse(data.d) || [];
                            if (Appr_SF_sts != '' && Appr_SF_sts != 'N/A') {
                                //alert(data.d);
                                $('#loadover').hide();
                                rjalert('Alert', Appr_SF_sts, 'error');
                                return false;
                            }
                            else {
                                chk();
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "rpt_Expense_Entry_Modified.aspx/saveExpense",
