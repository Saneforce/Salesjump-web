<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_Retailer_Tag_Status.aspx.cs" Inherits="MasterFiles_Reports_Rpt_Retailer_Tag_Status" %>
...
<head runat="server">
    ...
    <script language="Javascript">
        ...
        function openmodal($x,$typ) {
		   ...
		   strOpen = "Rpt_Retailer_Tag_Breakup.aspx?SF_Code=" + sf + "&SF_Name=" + $sfname + "&subDiv=&TagType=" + $typ+"&FDate=" + fdt + "&TDate=" + tdt;
        ...
        $(document).ready(function () {
            ...
            $("#btnExcel").click(function () {
                $("#gvMyDayPlan").table2excel({
                    filename: "Retailer Tag Status.xls"
                });
            });
        });
    </script>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div class="row">
                <div class="col-sm-8">
                    <asp:Label ID="lblhead1" runat="server" Style="font-weight: bold; font-size: 12pt; padding: 0px 20px;">Retailer Tag List</asp:Label>
                </div>
                ...
                <asp:GridView ID="gvMyDayPlan" runat="server" Width="100%" HorizontalAlign="Center"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Mapped Retialers" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                 <a href="#" sfc="<%#Eval("Sf_Code")%>" ttyp="Retailer_Count" onclick="openmodal('<%#Eval("Sf_Code")%>','Retailer_Count')" ><%#Eval("Retailer_Count")%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Tagged Retialers" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                 <a href="#" sfc="<%#Eval("Sf_Code")%>" ttyp="Tagged" onclick="openmodal('<%#Eval("Sf_Code")%>','Tagged')" ><%#Eval("Tagged")%></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Untagged Retialers" ItemStyle-Width="70" HeaderStyle-BorderWidth="1"
                                            HeaderStyle-Font-Size="8pt" ItemStyle-BorderWidth="1" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
