...
public partial class MasterFiles_Reports_Secondary_Order_View : System.Web.UI.Page
{
    ...
    public void filldist()
    {
        SalesForce sd = new SalesForce();
        DataSet ds = new DataSet();
        ds = sd.SalesForceList(divCode, Session["Sf_Code"].ToString(), ddldiv.SelectedValue);
        if (ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void btnview_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string sURL = "New_Rpt_Secondary_Order.aspx?SF_code=" + ddldist.SelectedValue + "&div_code=" + divCode +
