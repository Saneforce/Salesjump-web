...
public partial class Reports_Rpt_My_Day_Plan_View : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        desig_code = Request.QueryString["Designation_code"].ToString();
        ...
        {
            lblTitle.Text = "My Day Plan Detail";
            DateTime d1 = Convert.ToDateTime(Date);
            lblHead.Text ="Date : " + d1.ToString("dd/MM/yyyy");
            Label1.Text = "<span style='color:blue'>Team :  </span> " + Sf_Name;
            //lblFieldForceName.Text = Sf_Name;
            DataSet dsGV = new DataSet();
            DCR dc = new DCR();
            if (desig_code != "All" && desig_code != "")
            {

                dsGV = dc.GetTPDayPlan_designationwise(div_code, sf_code, Date, desig_code, Sub_Div_code);
            ...
            else
            {
                ...
                {
                    dsGV = dc.GetTPDayPlan_MR(div_code, sf_code, Date, Sub_Div_code);
                    if (dsGV.Tables[0].Rows.Count > 0)
                    {
                        gvMyDayPlan.DataSource = dsGV;
                        gvMyDayPlan.DataBind();
                ...
                {
                    dsGV = dc.GetTPDayPlan_MGR(div_code, sf_code, Date, Sub_Div_code);
                    if (dsGV.Tables[0].Rows.Count > 0)
                    {
                        gvMyDayPlan.DataSource = dsGV;
                        gvMyDayPlan.DataBind();
    ...
    [WebMethod]
    public static string getTBPlan(string divcode, string sfcode, string Dt)
    {
        TourPlan sf = new TourPlan();
        dstp = sf.get_SFDayPlan(sfcode, divcode, Dt);
    ...
    {
        TourPlan sf = new TourPlan();
        dstp = sf.get_TPPlanWorktypes(sfcode, divcode);
        return JsonConvert.SerializeObject(dstp.Tables[0]);
    }
    [WebMethod]
    ...
    {
        TourPlan sf = new TourPlan();
        dstp = sf.get_TPPlanDist(sfcode, divcode);
        return JsonConvert.SerializeObject(dstp.Tables[0]);
    }
    [WebMethod]
    ...
    {
        TourPlan sf = new TourPlan();
        dstp = sf.get_TPPlanRoute(sfcode, divcode);
        return JsonConvert.SerializeObject(dstp.Tables[0]);
    }
    [WebMethod]
    ...
    {
        TourPlan sf = new TourPlan();
        dstp = sf.get_DayPlanWorkedWith(sfcode);
        return JsonConvert.SerializeObject(dstp.Tables[0]);
    }
    [WebMethod(EnableSession = true)]
    public static string getRepHQs(string repsf)
    {
        string strQry = string.Empty;
        DataSet dsTerritory = new DataSet();
        SqlConnection con = new SqlConnection(Globals.ConnString);
        con.Open();
        SqlCommand cmd = new SqlCommand("select Sf_Code,Sf_HQ +' ( ' + Sf_Name +' ) ' HqName from Mas_Salesforce where Reporting_To_SF='"+ repsf + "' and SF_Status<>'2' order by Sf_HQ", con);
    ...
    [WebMethod]
    public static string svDayplan(string sfcode, string PlnDate, string sxml)
    {
    ...
    {
        /*if (div_code.TrimEnd(',') != "4" && div_code.TrimEnd(',') != "107" && div_code.TrimEnd(',') != "69" && div_code.TrimEnd(',') != "86" && div_code.TrimEnd(',') != "55" && div_code.TrimEnd(',') != "98")
        {
            e.Row.Cells[28].Visible = false;
        }*/
       // if(div_code.TrimEnd(',') != "107")
       // {
            //e.Row.FindControl("Zone").Visible = false;
       ...
       // }
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label txtName = (e.Row.FindControl("Pln_Time") as Label);
            Label txtName1 = (e.Row.FindControl("txtWorkTypeName") as Label);
            string hh = txtName.Text;
            //System.Web.UI.WebControls.Image imgTickBox = (System.Web.UI.WebControls.Image)e.Row.FindControl("imgAgree");
            Label imgTickBox1 = (e.Row.FindControl("L1") as Label);
            Label imgTickBox2 = (e.Row.FindControl("L2") as Label);
            Label imgTickBox3 = (e.Row.FindControl("L3") as Label);
            Label imgTickBox4 = (e.Row.FindControl("L4") as Label);
            Label imgTickBox5 = (e.Row.FindControl("L5") as Label);
            Label imgTickBox6 = (e.Row.FindControl("L6") as Label);
            Label imgTickBox7 = (e.Row.FindControl("L7") as Label);
            Label imgTickBox8 = (e.Row.FindControl("L8") as Label);
            string tim = "9:30";
            DateTime ctim = Convert.ToDateTime(tim);
            DateTime cpln = (hh != "") ? Convert.ToDateTime(hh) : DateTime.Now;
            if (hh != "" && div_code!="55")
            {
                imgTickBox1.Visible = true;
            }
            else if((cpln > Convert.ToDateTime(tim)) &&  div_code == "55")
            {
                imgTickBox2.Visible = true;
            }
            else if ((cpln <= Convert.ToDateTime(tim)) && div_code == "55")
            {
                imgTickBox1.Visible = true;
            ...
            if (txtName1.Text == "Leave")
            {				
                e.Row.BackColor= System.Drawing.Color.Bisque;
                imgTickBox2.Visible = true;
                imgTickBox1.Visible = false;
            }


            HiddenField field = e.Row.FindControl("HiddenField1") as HiddenField;
            string hd1 = field.Value;
            //System.Web.UI.WebControls.Image imgTickBox1 = (System.Web.UI.WebControls.Image)e.Row.FindControl("imgInvent");

            if (hd1 != "")
            {
                imgTickBox3.Visible = true;
            }
            else
            {
                imgTickBox4.Visible = true;
            }

            HiddenField field2 = e.Row.FindControl("HiddenField2") as HiddenField;
            string hd2 = field2.Value;
            //System.Web.UI.WebControls.Image imgTickBox2 = (System.Web.UI.WebControls.Image)e.Row.FindControl("imgOrder");

            if (hd2 != "")
            {
                imgTickBox5.Visible = true;
            }
            else
            {
                imgTickBox6.Visible = true;
            }
            HiddenField field3 = e.Row.FindControl("HiddenField3") as HiddenField;
            string hd3 = field3.Value;
            //System.Web.UI.WebControls.Image imgTickBox3 = (System.Web.UI.WebControls.Image)e.Row.FindControl("imgend");

            if (hd3 != "")
            {
                imgTickBox7.Visible = true;
            }
            else
            {
                imgTickBox8.Visible = true;
            }
        }
            ...
            foreach (DataRow drdoc in dsDCR.Tables[0].Rows)
            {
                ...
                else
                {
                    ...
                    if (dsdoc.Tables[0].Rows.Count > 0)
                    {
                        ...
                        lit_det_head_gift.Text = "<b>POB</b>";
                        ...
                        foreach (DataRow drdoctor in dsdoc.Tables[0].Rows)
                        {
                            ...
                            {
                                sURL = "ShowMap.aspx?sf_Code=" + sf_code + " &strDate=" + drdoc["Activity_Date"].ToString() + " ";
    ...
    {
        string attachment = "attachment; filename=Daily_Attendance.xls";
