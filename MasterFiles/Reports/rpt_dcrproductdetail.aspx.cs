...
using System.Net;
using DBase_EReport;
public partial class MasterFiles_Reports_rpt_dcrproductdetail : System.Web.UI.Page
{
    string divcode = string.Empty;
  string retailer_code = string.Empty;
string retailer_name = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       Sf_Name = Request.QueryString["Sf_Name"].ToString();
        ...
        Sf_Code = Request.QueryString["Sf_Code"].ToString();
         ...
         retailer_code = Request.QueryString["retailer_code"].ToString();
retailer_name= Request.QueryString["retailer_name"].ToString();
       ...
       lblHead.Text = " DCR Product Detail View for  " + hdate + "";


         lblMonth.Text = Sf_Name;
         lblYear.Text = retailer_name;
          FillSF();
   ...
   private void FillSF()
    {
        ...
        DCR sf = new DCR();
		loc sf1 = new loc();
        dsDrr = sf1.dcr_Gettransno1(Sf_Code, divcode, hdate, retailer_code);
        foreach (DataRow d in dsDrr.Tables[0].Rows)
        {
            order_no = d["Trans_Sl_No"].ToString();
            dsSalesForce = sf1.dcr_product_detaill(order_no);
            ...
            if (dsSalesForce.Tables[0].Rows.Count > 0)
            {
                ...
                lit_det_head_min1.Text = "<b>Net Weight</b>";
                ...
                foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
                {
                    ...
                    lit_det_dr_min.Text = drFF["netvalue"].ToString();
                    iTotLstCountt += Decimal.Parse(drFF["netvalue"].ToString());
                ...
                lit_Count_Total.Text = "<center>Sub Total</center>";
                tc_Count_Total.Attributes.Add("style", "color:Green;font-weight:bold;");
...
TableCell tc_tot_free = new TableCell();
                ...
                lit_Count_Total1.Text = "<center>Total</center>";
                ...
                TableCell tc_tot_free1 = new TableCell();
                HyperLink hyp_free1 = new HyperLink();
                hyp_free1.Text = iTotLstfree.ToString();
                tc_tot_free1.BorderStyle = BorderStyle.Solid;
                tc_tot_free1.BorderWidth = 1;
                tc_tot_free1.BackColor = System.Drawing.Color.White;
                tc_tot_free1.Width = 200;
                tc_tot_free1.Style.Add("font-family", "Calibri");
                tc_tot_free1.Style.Add("font-size", "10pt");
                tc_tot_free1.HorizontalAlign = HorizontalAlign.Center;
                tc_tot_free1.VerticalAlign = VerticalAlign.Middle;
                tc_tot_free1.Controls.Add(hyp_free1);
                tc_tot_free1.Attributes.Add("style", "font-weight:bold;");
                tc_tot_free1.Attributes.Add("Class", "rptCellBorder");
                tr_total1.Cells.Add(tc_tot_free1);
                iTotLstfree = 0;
                TableCell tc_tot_discount1 = new TableCell();
                HyperLink hyp_discount1 = new HyperLink();
                hyp_discount1.Text = (Decimal.Parse(d["tlDisAmt"].ToString())).ToString();
                //hyp_discount1.Text = iTotLstdiscount.ToString();
                tc_tot_discount1.BorderStyle = BorderStyle.Solid;
                tc_tot_discount1.BorderWidth = 1;
                tc_tot_discount1.BackColor = System.Drawing.Color.White;
                tc_tot_discount1.Width = 200;
                tc_tot_discount1.Style.Add("font-family", "Calibri");
                tc_tot_discount1.Style.Add("font-size", "10pt");
                tc_tot_discount1.HorizontalAlign = HorizontalAlign.Center;
                tc_tot_discount1.VerticalAlign = VerticalAlign.Middle;
                tc_tot_discount1.Controls.Add(hyp_discount1);
                tc_tot_discount1.Attributes.Add("style", "font-weight:bold;");
                tc_tot_discount1.Attributes.Add("Class", "rptCellBorder");
                tr_total1.Cells.Add(tc_tot_discount1);
                iTotLstdiscount = 0;
                TableCell tc_tot_month1 = new TableCell();
                HyperLink hyp_month1 = new HyperLink();
                hyp_month1.Text = (iTotLstCount - Decimal.Parse(d["tlDisAmt"].ToString())).ToString();
                ...
                hyp_montht1.Text = iTotLstCountt.ToString();
	 ...
	 public class loc
    {
        public DataSet dcr_product_detaill(string Trans_Sl_no)
        {
            ...
            string strQry = " select d.Product_Code,d.Product_Name,d.Quantity,d.free,d.discount_price,d.Rate,d.value,(d.value-(d.discount_price+tlDisAmt))value1,(d.net_weight* d.Quantity)netvalue,d.MfgDt from Trans_Order_Head h  inner join Trans_Order_Details d on h.Trans_Sl_No=d.Trans_Sl_No where h.Trans_Sl_No='" + Trans_Sl_no + "'";
            try
            {
        ...
        public DataSet dcr_Gettransno1(string sfcode, string div_code, string activitydate, string retailer_code)
        {
            DB_EReporting db_ER = new DB_EReporting();
            DataSet dsSF = null;
            string strQry = "select Trans_Sl_No,case when tlDisAmt='' then '0' when tlDisAmt is null then '0' else tlDisAmt end as tlDisAmt from Trans_Order_Head  where Sf_code='" + sfcode + "' and  CONVERT(VARCHAR(25), Order_Date, 126)  like '" + activitydate + "%' and Cust_Code='" + retailer_code + "'";
