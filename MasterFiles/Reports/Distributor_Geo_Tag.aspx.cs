...
public partial class MasterFiles_Reports_Distributor_Geo_Tag : System.Web.UI.Page
{
    ...
    protected void btnview_Click(object sender, EventArgs e)
    {
        try
        {
            string sURL = "Rpt_Distributor_Tag.aspx?SF_code=" + ddldist.SelectedValue + "&div_code=" + divCode +
