<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Exp_Allowance.aspx.cs"
    Inherits="MasterFiles_Exp_Allowance" EnableEventValidation="true" %>
        ...
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                $.ajax({
                    ...
                    url: 'Exp_Allowance.aspx/SaveData', //Home.aspx is the page   
                    type: 'POST',
                    dataType: 'json',
