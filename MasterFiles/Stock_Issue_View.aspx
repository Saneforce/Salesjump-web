<%@ Page Title="Issue Slip View" Language="C#" MasterPageFile="~/Master.master"
    AutoEventWireup="true" CodeFile="Stock_Issue_View.aspx.cs" Inherits="MasterFiles_Stock_Issue_View" %>
        ...
        $(document).ready(function () {
            if ($('#<%=hdnmode.ClientID %>').val() == "1") {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: "Stock_Issue_View.aspx/Get_AllValues",
                    ...
                    success: function (data) {
                        ...
                        if (obj.TransH.length > 0) {
                            ...
                            $('#stockistTo').text(obj.TransH[0].stockistTo);
                        }

                        var str = "";
                        for (var i = 0; i < obj.TransD.length; i++) {
                            str = "<td>" + (i + 1) + "</td><td>" + obj.TransD[i].pName + "</td><td>" + obj.TransD[i].pType + "</td><td>" + obj.TransD[i].prate + "</td><td>" + obj.TransD[i].pqty + "</td><td>" + obj.TransD[i].pval + "</td><td>" + obj.TransD[i].preason + "</td>";
