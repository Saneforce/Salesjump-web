...
<head runat="server">
    <title>Bulk Edit - Customer Campaign</title>
      <style type="text/css">
            .modal
    {
        position: fixed;
                        ...
                        <asp:GridView ID="grdDocCat" runat="server" Width="30%" HorizontalAlign="Center" EmptyDataText="No Records Found" 
                            ...
                            <Columns>                
                                ...
                                <asp:TemplateField HeaderText="Short Name" ItemStyle-HorizontalAlign="Left">
                                     <ItemTemplate> 
                                        <asp:TextBox ID="txtDoc_Cat_SName" MaxLength="12" onkeypress="AlphaNumeric_NoSpecialChars(event);" runat="server" SkinID="TxtBxAllowSymb"  Text='<%# Bind("Doc_SubCatSName") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Category Name">
                                     <ItemTemplate>
                                        <asp:TextBox ID="txtDocCatName" Width="250px" onkeypress="AlphaNumeric_NoSpecialChars(event);" SkinID="TxtBxAllowSymb"  runat="server" MaxLength="100" Text='<%# Bind("Doc_SubCatName") %>'></asp:TextBox>
                                     </ItemTemplate>
                                </asp:TemplateField>                                       
                            </Columns>
