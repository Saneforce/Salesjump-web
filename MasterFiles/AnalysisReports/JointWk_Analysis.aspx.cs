...
public partial class MasterFiles_AnalysisReports_JointWk_Analysis : System.Web.UI.Page
{
    ...
    //{
    //    int strddlFYear = Convert.ToInt32(ddlFrmYear.SelectedValue);
    //    int strddlTYear = Convert.ToInt32(ddlToYear.SelectedValue);
    //    int fmonth = Convert.ToInt32(ddlFrmMonth.SelectedValue);
    //    int tmonth = Convert.ToInt32(ddlToMonth.SelectedValue);
    ...
    //            sURL = "rptJointWk_Analysis.aspx?sf_code=" + ddlFieldForce.SelectedValue.ToString() +
