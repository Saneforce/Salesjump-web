                    ...
                    <table width="95%" cellpadding="5px" cellspacing="5px" style="border: 1px solid Black;">
                        <tr>
                            <td style="padding-right: auto;">
                                <asp:Label ID="Label1" runat="server" Style="position: relative; color: #336277; font-family: Verdana; font-weight: bold; text-transform: capitalize; font-size: 14px; margin-top: 20px;">Excel file</asp:Label>
                                <br />
                                <div>
            ...
            for (var i = 0; i < excelRows.length; i++) { //excelRows.length
                ...
                try {
                    for (var j = 0; j < columnSet.length; j++) {
                        ...
                        if ((excelRows[i][columnSet[j]] != "" && ((excelRows[i][columnSet[j]]).toString()).indexOf("\'") > -1)) {
                            excelRows[i][columnSet[j]] = (excelRows[i][columnSet[j]]).replaceAll("\'", "u0027");
                        }

                        if ((excelRows[i][columnSet[j]] != "" && (columnSet[j]).toString().toLowerCase().indexOf("date") > -1)) {
        ...
        function BindTable(jsondata, tableid) {/*Function used to convert the JSON array to Html Table*/
            ...
            for ($i = st; $i < st + PgRecords; $i++) {
                if ($i < jsondata.length) {
                    ...
                    console.log(excelRows[0]["Success"]);
