<%@ Page Title="Tour Plan" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="TourPlan_Calen.aspx.cs" Inherits="MasterFiles_MGR_TourPlan_Calen" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%--<%@ Register Src="~/UserControl/MGR_Menu.ascx" TagName="Menu" TagPrefix="ucl" %>
<%@ Register Src="~/UserControl/MenuUserControl_TP.ascx" TagName="Menu2" TagPrefix="ucl" %>--%>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <asp:Panel ID="pnlCalendar" runat="server">
        ...
        <%--<ucl:Menu2 ID="menu2" runat="server" />--%>
        <table id="tblTitle" runat="server" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td align="center">
                    ...
                    <asp:HyperLink ID="hylEdit" runat="server" NavigateUrl="~/MasterFiles/MGR/TourPlan_Calen.aspx?Edit=E"
        ...
        <center>
            <table align="right" width="100%" style="margin-right: 165px;">
                ...
                <%--<cc1:BalloonPopupExtender ID="BalloonPopupExtender1" runat="server" TargetControlID="lblNote"
                    BalloonPopupControlID="Panel1" Position="TopLeft" DisplayOnMouseOver="true" BalloonSize="Small"></cc1:BalloonPopupExtender>--%>
            ...
            <asp:Calendar ID="Calendar1" runat="server" BackColor="#FFFFCC" ForeColor="White"
                ...
                ShowGridLines="True" ShowNextPrevMonth="False" Height="388px"  
                OnDayRender = "Calendar1_DayRender"  ToolTip ="Please Click on Date Link"
            ...
            <div align="center">
                       <asp:Button ID="btnApprove" CssClass="BUTTON" runat="server" Height="25px" Visible="false" Width="90px" Text="Approve TP" OnClick="btnApprove_Click"  OnClientClick="return progress();"
               />
            &nbsp
            
            <asp:Button ID="btnReject" CssClass="BUTTON" runat="server" Height="25px" Visible="false" Text="Reject TP" Width="90px" OnClick="btnReject_Click"/>
              
            &nbsp
            <asp:Label ID="lblRejectReason" Text="Reject Reason : " Visible="false" SkinID="lblMand" runat="server"  OnClientClick="return progress();"></asp:Label>
            &nbsp
            <asp:TextBox ID="txtReason" Width="400" Height="45" Visible="false" TextMode="MultiLine"
                runat="server"></asp:TextBox>
            &nbsp
            <asp:Button ID="btnSendBack" CssClass="BUTTON" Width="140px" Height="25px" runat="server" Visible="false"  OnClientClick="return progress();"
    ...
    <div>
        <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="269px" Width="800px"
            class="ontop" Style="left: 250px; top: 200px; position: absolute; display : none" >
                                            ...
                                            <asp:Panel ID="pnlFieldForce" runat="server" Height="116px" Width="300px" BorderStyle="Solid"
                                                ...
                                                <div style="height: 15px; position: relative; background-color: #4682B4; overflow-y: scroll;
                                                    ...
                                                    <asp:Button ID="Button2" BackColor ="Yellow"  Style="font-family: Verdana; height:15px; font-size: 5pt; width: 20px;
                                                        color:Black; margin-top: -1px;" Text="X" runat="server" OnClick="btnCloseFF_Click"
                                ...
                                <asp:Panel ID="pnlTerritory" runat="server" Height="116px" Width="300px" BorderStyle="Solid"
                                    ...
                                    <div style="height: 15px; position: relative; background-color: #4682B4; overflow-y: scroll;
                                        ...
                                        <asp:Button ID="Button1" BackColor ="Yellow" Style="font-family: Verdana; font-size: 5pt; width: 20px;
                                            color:Black; margin-top: -1px;" Text="X" runat="server"
                                            OnClientClick="return HidePopup();" /></div>
                                    <br />
                ...
                <tr>
                    <td colspan="2" align="center">
                        ...
                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" Width="70px" Height="25px"
                            OnClientClick="return HidePanel();" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
    ...
    <asp:Panel ID="pnlHidden" runat="server">
        ...
        <br />
        <center>
            <asp:Button ID="btnDraftSave" runat="server"  Text="Draft Save" Height="25px" Visible="false" Width="80px"  OnClientClick= "return progress();" OnClick="btnDraftSave_Click" />
            <asp:Button ID="btnSubmit" runat="server" Height="25px" Width="170px" Text="Send to Manager Approval" OnClientClick="return progress();"
                OnClick="btnSubmit_Click" />
            <asp:Button ID="btnClear" runat="server" Width="60px" Height="25px" Text="Clear" OnClientClick="return progress();"
