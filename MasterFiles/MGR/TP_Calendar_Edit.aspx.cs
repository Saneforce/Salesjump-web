...
public partial class MasterFiles_MGR_TP_Calendar_Edit : System.Web.UI.Page
{
    ...
    protected void GetTitle()
    {
        ...
        {
            //Label2.Text = "Month Tour Plan - Entry For " + "<span style='color:Green'>" + dsTP.Tables[0].Rows[0]["Sf_Name"] + "</span>" +
            //               " Month Of - " + "<span style='color:#FF3300'>" + dsTP.Tables[0].Rows[0]["Sf_Joining_Date"] + "</span>";
        }
    }
    ...
    private void Enable()
    {
        ...
        Server.Transfer("TP_Calendar_Edit.aspx");
    }
    private void FillTPDate()
    {
        ...
        if (dsTP.Tables[0].Rows.Count > 0)
        {
            ...
            dsTPC = tp.TPCalander_checkmonth(sf_code, Convert.ToString(dt_TP_Active_Date.Month));
    ...
    protected void ddlWorkType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (dsTP.Tables[0].Rows.Count > 0)
        {
            ...
            if (dsTP.Tables[0].Rows[0][0].ToString() == "N")
            {
                ...
                txtFieldForce.Text = "";
                txtTerritory.Text = "";
                txtFieldForce.BackColor = System.Drawing.Color.LightGray;
                txtTerritory.BackColor = System.Drawing.Color.LightGray;
            ...
            else
            {
                ...
                txtFieldForce.BackColor = System.Drawing.Color.White;
                txtTerritory.BackColor = System.Drawing.Color.White;
    ...
    private bool check_TP_Month(int sMonth, int sYear)
    {
        ...
        for (i = 1; i <= iLastDay; i++)
        {
            ...
            if (!bHoliday)
            {
                ...
                dsCount = tp.get_TP_Count_one(sf_code, cDate);
                if (iCount <= 0)
                {
                    bTourPlan = false;
                }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (bTourPlan)
            {
                ...
                TourPlan tp = new TourPlan();
                iReturn = tp.ReadyforCalanderEdit(sf_code, Calendar1.TodaysDate.Month.ToString(), Calendar1.TodaysDate.Year.ToString(), Session["sf_name"].ToString());
