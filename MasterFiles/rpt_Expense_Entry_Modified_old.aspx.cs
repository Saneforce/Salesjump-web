...
public partial class MasterFiles_rpt_Expense_Entry_Modified : System.Web.UI.Page
{
	  ...
	  public static DataSet GetAllowanceDets(string sf_code, string Mn, string Yr)
        {
            ...
            DataSet Alws = null;
            string strQry = "exec GetDesg_AllowanceDets '" + sf_code + "','" + Mn + "','" + Yr + "'";
            try
            {
	...
	dsDivision.Dispose();
      ...
      [WebMethod]
    public static string rejectExpense(string SF, string Mn, string Yr, string RejDt, string Rtype, string sEmpID,string RjectRm,string Type)
    {
        Expense Exp = new Expense();
        string msg = string.Empty;
        if (div_code == "107")
        ...
        {
            msg = RejectExpense(SF, Mn, Yr, RejDt, Rtype, sEmpID, RjectRm,Type,div_code);
        }
        return msg;
    }
    public static string RejectExpense(string SF, string Mn, string Yr, string rejdt, string Rtype, string EmpID, string Remarks,string Type,string div_code)
    {
        DB_EReporting db_ER = new DB_EReporting();
