<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MissedCallReport_Level3.aspx.cs" Inherits="MIS_Reports_MissedCallReport_Level3" %>
...
<script type = "text/javascript">
    ...
    function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, cmode) {
        popUpObj = window.open("MissedCallReport_Level4.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&cMode=" + cmode,
    "ModalPopUp_Level1",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
