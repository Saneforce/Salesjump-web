...
public partial class MIS_Reports_VisitDocList : System.Web.UI.Page
{
    ...
    private void FillDoctor()
    {
        ...
        if (vMode != "")
        {
            dsDoctor = dc.Visit_Doc(div_code, sf_code, Convert.ToInt16(FMonth), Convert.ToInt16(FYear), dtCurrent, sMode,vMode);
        }
    ...
    protected void BindChart()
    {
        ...
        ds = dr.getDoctorCategory(sf_code, sMode); 
