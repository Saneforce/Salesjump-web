<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTerritory_Format2.aspx.cs" Inherits="MIS_Reports_rptTerritory_Format2" %>
    ...
    <asp:Panel ID="pnlbutton" runat="server">
        <table width="100%">
            ...
            <td width="20%"></td><td></td>
                ...
                <asp:Label ID="lblProd" runat="server" Text="ListedCustomer - Product Visit" SkinID="lblMand" ></asp:Label>
                </td>
                <td align="right">
                    <table>
                        <tr>
                    ...
                    <td align="center">
                        <asp:GridView ID="grdDr" runat="server" Width="70%" HorizontalAlign="Center" EmptyDataText="No Records Found" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ListedCustomerCode" ItemStyle-HorizontalAlign="Left" Visible="false" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblDrCode" runat="server" Width="120px" Text='<%#Eval("Listeddr_Code")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                               <%-- <asp:TemplateField  HeaderText="Fieldforce Name" ItemStyle-HorizontalAlign="Left"  >
                                ...
                                <asp:TemplateField HeaderText="Product Visit" ItemStyle-HorizontalAlign="Left">
                                 <ControlStyle Width="80%"></ControlStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="lblprod_name" runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
