...
stCrtDtaPnt+="{label:\""+ drFF["Zone_Name"].ToString()+"\",y:";
                ...
                //hq
                sURL = "rptterritorywise_purchase_report.aspx?Zone_Code=" + drFF["Zone_code"] + "&Zone_name=" + drFF["Zone_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Zonewise_purchase_value(drFF["Zone_code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            sURL = "rpt_zonewise_product_detail.aspx?Zone_code=" + drFF["Zone_code"] + "&Zone_Name=" + drFF["Zone_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + " &sCurrentDate=" + sCurrentDate + "";
