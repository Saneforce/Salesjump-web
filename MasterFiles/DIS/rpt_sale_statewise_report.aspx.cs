...
string stCrtDtaPnt = string.Empty;
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
          ...
          stCrtDtaPnt+="{label:\""+ drFF["statename"].ToString()+"\",y:";
                ...
                sURL = "rpt_sale_areawise_report.aspx?State_Code=" + drFF["State_Code"] + "&State_name=" + drFF["statename"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.Sale_Statewise_value(drFF["State_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            sURL = "rpt_sales_statewise_product_detail.aspx?State_Code=" + drFF["State_Code"] + "&State_name=" + drFF["statename"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + " &sCurrentDate=" + sCurrentDate + "";
