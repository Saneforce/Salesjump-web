<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Trend_Analysis.aspx.cs" Inherits="MIS_Reports_Trend_Analysis" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(fmon, fyr) {
            ...
            popUpObj = window.open("rpt_trend_analysis.aspx?FMonth=" + fmon + "&FYear=" + fyr,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
