...
public partial class MIS_Reports_VisitDetailsReport_Level1 : System.Web.UI.Page
{
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            if (months >= 0)
            {
                ...
                for (int j = 1; j <= months + 1; j++)
                {
                    ...
                    tc_DR_Total_mon.Attributes.Add("Class", "Backcolor");
                    ...
                    tc_DR_Total_mon_tot.Attributes.Add("Class", "Backcolor");
                ...
                for (int j = 1; j <= (months + 1) * 2; j++)
                {
                    if (dsDoctor.Tables[0].Rows.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            tc_catg_tot_met.Attributes.Add("Class", "Backcolor");
                            ...
                            tc_catg_tot_miss.Attributes.Add("Class", "Backcolor");
                ...
                if (months >= 0)
                {
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        if (dsDoctor.Tables[0].Rows.Count > 0)
                        {
                            ...
                            tc_det_sf_tot.BackColor = System.Drawing.Color.White;
                        ...
                        if (dsDoctor.Tables[0].Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow dataRow in dsDoctor.Tables[0].Rows)
                            {
                                ...
                                dsDCR = dc.Catg_Visit_Report(drFF["sf_code"].ToString(), div_code, cmonth, cyear, Convert.ToInt32(dataRow["Doc_Cat_Code"].ToString()));
                        ...
                        tc_det_sf_tt.BackColor = System.Drawing.Color.White;
                        ...
                        tc_det_sf_tt_miss.BackColor = System.Drawing.Color.White;
    ...
    private void FillSpec()
    {
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            Literal lit_DR_Code = new Literal();
            lit_DR_Code.Text = "<center>SF Code</center>";
            tc_DR_Code.Attributes.Add("Class", "Backcolor");
            tc_DR_Code.Controls.Add(lit_DR_Code);
            tc_DR_Code.Visible = false;
            tr_header.Cells.Add(tc_DR_Code);
                ...
                for (int j = 1; j <= (months + 1) * 2; j++)
                {
                    if (dsDoctor.Tables[0].Rows.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            tc_catg_tot_miss.Width = 30;
                            Literal lit_catg_tot_miss = new Literal();
                            lit_catg_tot_miss.Text = "<center>Msd</center>";
                            tc_catg_tot_miss.Attributes.Add("Class", "Backcolor");
                            tc_catg_tot_miss.Controls.Add(lit_catg_tot_miss);
                            tr_catg.Cells.Add(tc_catg_tot_miss);
                        }
