    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#Btnsrc').click(function () {
                ...
                if ($("#txtsearch").val() == "") { alert("Enter Retailer Name."); $('#txtsearch').focus(); return false; }
            ...
            <tr>
                <td align="right" colspan="3">
                    ...
                    <div style="margin-left: 90%">
                        <asp:ImageButton ID="btnBack" ImageUrl="~/Images/back3.jpg" runat="server" OnClick="btnBack_Click" Visible="false" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:Panel ID="pnlAdmin" runat="server">
                        ...
                        <asp:DropDownList ID="Alpha" runat="server" AutoPostBack="true" SkinID="ddlRequired"
                            OnSelectedIndexChanged="Alpha_SelectedIndexChanged" Height="24px">
                        ...
                        <asp:DropDownList ID="ddlSFCode" runat="server" SkinID="ddlRequired" AutoPostBack="true" 
                            onselectedindexchanged="ddlSFCode_SelectedIndexChanged" Font-Bold="True" >
                        </asp:DropDownList>
                        <asp:DropDownList ID="ddlroutecode" runat="server" SkinID="ddlRequired" 
                            Font-Bold="True"> 
...
<%--                        <asp:Button ID="btnDeAc" runat="server" CssClass="BUTTON" ForeColor="White"  BackColor="Chocolate" Text="Deactivate Listed Customer"
                        ...
                        &nbsp;
                         <asp:Button ID="btnDAdd" runat="server" CssClass="BUTTON" Text="Bulk Add Listed Retailer"
                            Width="160px" OnClick="btnDAdd_Click" />
                        &nbsp;
            ...
            <tr>
                <td align="center"> 
                    <asp:Label ID="lblSelect" runat="server" Font-Size="Large" ForeColor="Red"  Visible="false"
                        Text="Select the Distributor & Route and Press the 'Go' Button"></asp:Label>
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:GridView ID="grdDoctor" runat="server" Width="85%" HorizontalAlign="Center"
                            ...
                            OnRowDataBound="grdDoctor_RowDataBound" GridLines="None" CssClass="mGridImg"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField SortExpression="Doc_Class_ShortName" ItemStyle-HorizontalAlign="Left"
                                    ...
                                    <EditItemTemplate>
                                        <asp:DropDownList ID="ddlDocClass" runat="server" SkinID="ddlRequired" DataSource="<%# Doc_Class() %>"
                              ...
                              <%--  <asp:HyperLinkField HeaderText="View" Text="View" DataNavigateUrlFormatString="ListedDr_DetailAdd.aspx?type=1&ListedDrCode={0}"
                                ...
                                <asp:HyperLinkField HeaderText="Edit" Text="Edit" DataNavigateUrlFormatString="ListedDr_DetailAdd.aspx?type=2&ListedDrCode={0}&lblterrCode={1}"
                                    DataNavigateUrlFields="ListedDrCode,lblterrCode"  ItemStyle-HorizontalAlign="Center">
                                    <ControlStyle ForeColor="DarkBlue" Font-Size="XX-Small" Font-Names="Verdana" Font-Bold="True">
                                    </ControlStyle>
                                    <ItemStyle ForeColor="DarkBlue" Font-Bold="False"></ItemStyle>
                                </asp:HyperLinkField>
                                <asp:HyperLinkField HeaderText="Add/Deactivate" ItemStyle-HorizontalAlign="Center"
                                    ...
                                    DataNavigateUrlFields="ListedDrCode" Visible="false">
                                    <ControlStyle ForeColor="DarkBlue" Font-Size="XX-Small" Font-Names="Verdana" Font-Bold="True">
                                    </ControlStyle>
                                    <ItemStyle ForeColor="DarkBlue" Font-Bold="False"></ItemStyle>
                                </asp:HyperLinkField>
