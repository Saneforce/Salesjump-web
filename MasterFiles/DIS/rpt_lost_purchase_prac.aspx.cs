...
public partial class MIS_Reports_rpt_lost_purchase_prac : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Lost-Purchase Details for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
