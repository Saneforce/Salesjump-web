...
using Bus_EReport;
using System.Net;
public partial class MIS_Reports_rpt_retail_Register_Brand_wise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retail Register -Brand Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
stCrtDtaPnt+="{label:\""+ drFF["Product_Brd_Name"].ToString()+"\",y:";
                ...
                //string type1 = "1";
                //stURL = "rpt_retail_brandwise_view.aspx?Stockist_Code=" + stockist_code + "&Stockist_name=" + Stock_name + "&Brand_Code=" + drFF["Product_Brd_Code"] + "&Stockist_name=" + drFF["Product_Brd_Name"].ToString() + " &cat_Code=" + cat_code + " &cat_name=" + cat_name + "&Year=" + cyear + "&Month=" + cmonth + " &sCurrentDate=" + sCurrentDate + "&Type=" + type1 + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.retail_Brand_value_categorywise(drFF["Product_Brd_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate, cat_code, stockist_code);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            string type2 = "2";
                            stURL = "rpt_retail_brandwise_view.aspx?Stockist_Code=" + stockist_code + "&Stockist_name=" + Stock_name + "&Brand_Code=" + drFF["Product_Brd_Code"] + "&Brand_name=" + drFF["Product_Brd_Name"].ToString() + " &cat_Code=" + cat_code + " &cat_name=" + cat_name + "&Year=" + cyear + "&Month=" + cmonth + " &sCurrentDate=" + sCurrentDate + "&Type=" + type2 + "";
