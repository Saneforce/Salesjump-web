<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DIS_Index.aspx.cs" Inherits="MasterFiles_DIS_Index" %>
            ...
            <table cellpadding="0" cellspacing="0" id="Table2" align="center" style="width: 100%;
                ...
                <tr>
                    <td align="center" width="90%">
                        <a href="../../DIS_Home.aspx" style="text-decoration: none; color: white">
                            <asp:Label ID="lblApproval" runat="server" Text=" " Font-Size="Medium"></asp:Label>
                        </a>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td align="center">
                        <asp:Label ID="lbldcr" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana"
                            ForeColor="Chocolate" Visible="false">DCR</asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:GridView ID="grdDCR" runat="server" Width="60%" HorizontalAlign="Center" AutoGenerateColumns="false"  Visible="false"
                ...
                <tr>
                    <td align="center">
                        <asp:Label ID="lbltp" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana"
                            ForeColor="Chocolate" Visible="false">Tour Plan</asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:GridView ID="grdTP" runat="server" Width="60%" HorizontalAlign="Center" AutoGenerateColumns="false"  Visible="false"
                            GridLines="None" CssClass="mGridImg"
                            PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
                            <HeaderStyle Font-Bold="False" />
                            <SelectedRowStyle BackColor="BurlyWood" />
                        ...
                        <asp:GridView ID="grdTP_Calander" runat="server" Width="60%" HorizontalAlign="Center" Visible="false"
                ...
                <tr>
                    <td align="center">
                        <asp:Label ID="lblcrm" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana"
                            ForeColor="Chocolate" Visible="false">Expense</asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="center">
        ...
        <center>
                ...
                <tbody>
                    <tr>
                        <td align="center">
                            <asp:Label ID="lblAdd" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana"
                                ForeColor="Chocolate" Visible="false">Listed Customer Addition</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr style="height: 25px">
                        <td colspan="2" align="center">
                            <asp:GridView ID="grdListedDR" runat="server" Width="60%" HorizontalAlign="Center" Visible="false"
            ...
            <table width="100%" align="center">
                <tbody>
                    <tr>
                        <td align="center">
                            <asp:Label ID="Label1" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana"
                                ForeColor="Chocolate" Visible="false">Listed Customer Deactivation</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr style="height: 25px">
                        <td colspan="2" align="center">
                            <asp:GridView ID="grdListedDR1" runat="server" Width="60%" HorizontalAlign="Center" Visible="false"
                ...
                <tr>
                    <td align="center">
                        <asp:Label ID="Lbladddeact" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana"
                            ForeColor="Chocolate" Visible="false">Add Against Deactivated Customer Approval</asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                        <asp:GridView ID="grdadddeactivate" runat="server" Width="60%" HorizontalAlign="Center" Visible="false" 
                            AutoGenerateColumns="false" EmptyDataText="No Data found for Approval's" GridLines="None"
                ...
                <tr>
                    <td align="center">
                        <asp:Label ID="lblleave" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana"
                            ForeColor="Chocolate" Visible="false">Leave</asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                        <asp:GridView ID="grdLeave" runat="server" Width="60%" HorizontalAlign="Center" AutoGenerateColumns="false"
                            EmptyDataText="No Data found for Approval's" GridLines="None" CssClass="mGridImg" Visible="false"
                            PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
                            <HeaderStyle Font-Bold="False" />
                            <SelectedRowStyle BackColor="BurlyWood" />
                            <AlternatingRowStyle CssClass="alt"></AlternatingRowStyle>
                ...
                <tr>
                    <td align="center">
                        <asp:Label ID="lblSecSales" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Verdana"
                            ForeColor="Chocolate" Visible="false">Secondary Sales</asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:GridView ID="grdSecSales" runat="server" Width="60%" HorizontalAlign="Center" Visible="false"
