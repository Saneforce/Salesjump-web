<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="rpt_retail_categorywise_view.aspx.cs" Inherits="MIS_Reports_rpt_retail_categorywise_view" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Retail Register - Category Wise View</title>
   ...
   <asp:Panel ID="pnlbutton" runat="server">
        <table width="100%">
            ...
            <td width="20%"></td><td></td>
                ...
                <asp:Label ID="lblProd" runat="server" Text="Retail Register -Category Wise" SkinID="lblMand" ></asp:Label>
                </td>
                <td align="right">
                    <table>
                        <tr>
