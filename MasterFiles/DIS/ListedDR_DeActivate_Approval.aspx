<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListedDR_DeActivate_Approval.aspx.cs" Inherits="MasterFiles_MGR_ListedDR_DeActivate_Approval" %>
...
<body>
  ...
  <br />
  <center>
        <asp:Button ID="btnApprove" runat="server" CssClass="BUTTON" Text="Approve - Deactivate Lst.Drs" Width="180px" OnClick="btnApprove_Click" Visible="false" />&nbsp;
        <asp:Button ID="btnReject" runat="server" CssClass="BUTTON" Text="Reject - Add Lst.Drs" Width="160px" OnClick="btnReject_Click" Visible="false" />
        </center>
