...
public partial class MIS_Reports_Visit_Details_Consolidated_Level1 : System.Web.UI.Page
{
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            if (months >= 0)
            {
                ...
                for (int j = 1; j <= months + 1; j++)
                {
                    ...
                    tc_Docs_call_seen.Width = 80;
                    Literal lit_Docs_calls_seen = new Literal();
                    lit_Docs_calls_seen.Text = "<center>Drs Calls<br> Seen</center>";
                    ...
                    TableCell tc_average_Missed = new TableCell();
                    tc_average_Missed.BorderStyle = BorderStyle.Solid;
                    tc_average_Missed.BorderWidth = 1;
                    tc_average_Missed.Width = 80;
                    Literal lit_average_Missed = new Literal();
                    lit_average_Missed.Text = "<center>Missed <br>Average </center>";
                    tc_average_Missed.Controls.Add(lit_average_Missed);
                    tr_lst_det.Cells.Add(tc_average_Missed);
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        RoundCoverage = Math.Round((decimal)dblCoverage, 2);
