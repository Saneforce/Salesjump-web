...
public partial class MIS_Reports_rpt_retail_areawise_report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblHead.Text = "Retail Register -Area Wise for  " + strFMonthName + " " + FYear + " " + "To" + " " + strTMonthName + " " + TYear;
...
string stCrtDtaPnt = string.Empty;
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            lit_DR_Name.Text = "<center>Area </center>";
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                //hq
                sURL = "rpt_retail_zonewise_report.aspx?Area_Code=" + drFF["Area_code"] + "&Area_name=" + drFF["Area_Name"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.retail_areawise_purchase_value(drFF["Area_code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            sURL = "rpt_retail_areawise_product_detail.aspx?Area_Code=" + drFF["Area_Code"] + "&Area_name=" + drFF["Area_Name"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + " &sCurrentDate=" + sCurrentDate + "";
            ...
            if (months >= 0)
            {
                ...
                for (int j = 1; j <= months + 1; j++)
                {
                    ...
                    foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
                    {
                        ...
                        if (tot_dr != "")
                        {
                            iTotLstCount += (Decimal.Parse(tot_dr)).ToString();
