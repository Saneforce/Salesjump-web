...
public partial class MIS_Reports_retail_top10_exception : System.Web.UI.Page
{
    ...
    private void fillroute()
    {
        ...
        dsSalesForce = sd.Getretail_customer(div_code);
    ...
    protected void btnGo_Click(object sender, EventArgs e)
    {
        ...
        sURL = "rpt_retail_top10_exception.aspx?FYear=" + ddlFYear.SelectedValue.ToString() + "&viewtop=" + topdrop.SelectedItem.Text+"&route="+route.SelectedValue.ToString();
