...
stCrtDtaPnt+="{label:\""+ drFF["statename"].ToString()+"\",y:";
                ...
                sURL = "rpt_retail_areawise_report.aspx?State_Code=" + drFF["State_Code"] + "&State_name=" + drFF["statename"].ToString() + " &FYear=" + FYear + "&FMonth=" + FMonth + " &TYear=" + TYear + "&TMonth=" + TMonth + "&sCurrentDate=" + sCurrentDate + "";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.retail_Statewise_value(drFF["State_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            sURL = "rpt_retail_statewise_product_detail.aspx?State_Code=" + drFF["State_Code"] + "&State_name=" + drFF["statename"].ToString() + " &CYear=" + cyear + "&CMonth=" + cmonth + " &sCurrentDate=" + sCurrentDate + "";
...
stCrtDtaPnt+= "0},";
            ...
            if (months >= 0)
            {
                ...
                hyp_monthq.Text = iTotLstCount.ToString();
