...
public partial class MIS_Reports_rpt_statewise_product_detail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblProd.Text = "Purchase Register statewise Product Detail for the Period of " + strMonthName + " " + Year + " ";
    ...
    {      
        ...
        dsDr = dr.Statewise_purchase_productdetail(div_code, statecode, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate);
