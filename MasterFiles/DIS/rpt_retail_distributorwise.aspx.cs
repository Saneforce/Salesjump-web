...
stCrtDtaPnt+="{label:\""+ drFF["Stockist_Name"].ToString()+"\",y:";
                ...
                if (months >= 0)
                {
                    ...
                    for (int j = 1; j <= months + 1; j++)
                    {
                        ...
                        dsDoc = sf.retail_Distributor_value(drFF["Stockist_Code"].ToString(), divcode, cmonth, cyear, sCurrentDate);
                        ...
                        if (tot_dr != "0")
                        {
                            ...
                            stURL = "rpt_retail_Distributor_wise_view.aspx?Stockist_Code=" + drFF["Stockist_Code"] + "&Stockist_name=" + drFF["Stockist_Name"].ToString() + " &Year=" + cyear + "&Month=" + cmonth + " &sCurrentDate=" + sCurrentDate + "";
