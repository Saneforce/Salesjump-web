<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TP_Calendar_Edit.aspx.cs"
    Inherits="MasterFiles_MGR_TP_Calendar_Edit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ValidateEmptyValue() {           
                ...
                if (confirm("Do you want to Saved Successfully ?")) {
  ...
  <script type="text/javascript">
    ...
    <asp:Panel ID="pnlCalendar" runat="server">
        ...
        <center>
            ...
            <br />
            <asp:Button ID="btnSave" CssClass="BUTTON" Width="170px" runat="server" Text="Send to Manager Approval" OnClientClick="return ValidateEmptyValue()"
                OnClick="btnSave_Click" />
        </center>
    </asp:Panel>
    <%--<asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="Calendar1" PopupControlID="pnlpopup"
                                        ...
                                        <td>
                                            ...
                                            <asp:Panel ID="pnlFieldForce" runat="server" Height="116px" Width="300px" BorderStyle="Solid"
                                                ...
                                                <div style="height: 15px; position: relative; background-color: #4682B4; overflow-y: scroll;
                                                    ...
                                                    <asp:Button ID="Button2" Style="font-family: Verdana; font-size: 5pt; width: 5px;
                        ...
                        <asp:UpdatePanel ID="updatepanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:Panel ID="pnlTerritory" runat="server" Height="116px" Width="300px" BorderStyle="Solid"
                                    ...
                                    <div style="height: 15px; position: relative; background-color: #4682B4; overflow-y: scroll;
                                        text-transform: capitalize; width: 100%; float: left" align="right">
                                        <asp:Button ID="Button1" Style="font-family: Verdana; font-size: 5pt; width: 5px;
                                            color: Black; margin-top: -1px;" Text="X" runat="server" OnClick="btnClose_Click"
                                            OnClientClick="HidePopup();" /></div>
                                    <br />
