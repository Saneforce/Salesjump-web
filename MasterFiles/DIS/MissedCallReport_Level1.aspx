<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MissedCallReport_Level1.aspx.cs" Inherits="MIS_Reports_MissedCallReport_Level1" %>
...
<body>
    ...
    <div>
        ...
        <asp:Table ID="tbl" runat="server" BorderStyle="Solid" Style="border-collapse: collapse; border: solid 1px Black;"
         BorderWidth="1" GridLines="Both" Width ="95%">
        </asp:Table>
        </center> 
    </div>
    </form>
