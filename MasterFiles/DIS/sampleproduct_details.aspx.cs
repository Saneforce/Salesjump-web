...
public partial class MIS_Reports_sampleproduct_details : System.Web.UI.Page
{
        ...
        else
        {
            ...
            if (FYear <= TYear)
            {
                ...
                if (ddlFieldForce.SelectedIndex > 0)
                {
                    ...
                    sURL = "rptsampleproduct_details.aspx?sfcode=" + ddlFieldForce.SelectedValue.ToString() + "&FMonth=" + ddlFMonth.SelectedValue.ToString() + "&FYear=" + ddlFYear.SelectedValue.ToString() + "&TMonth=" + ddlTMonth.SelectedValue.ToString() + "&TYear=" + ddlTYear.SelectedValue.ToString() + "&sf_name=" + ddlFieldForce.SelectedItem.Text.ToString();
