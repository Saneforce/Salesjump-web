...
public partial class MIS_Reports_Secondary_Order_Route_wise_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //FillProd();
            lblProd.Text = "Secondary_Order_Route_wise_view for the Period of " + strMonthName + " " + Year + " ";
    ...
    private void CreateDynamicTable()
    {
        ...
        //if (type == "1")
        //{
        //    dsDr = dr.purchase_register_catogorydetail_stockistwise(div_code, Brand, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate);
        //}

        //if (type == "2")
        //{
        dsDr = dr.Secondary_Order_Route_wise(div_code, cat_code, Convert.ToInt16(Year), Convert.ToInt16(Month), sCurrentDate, stockist);
        //}
