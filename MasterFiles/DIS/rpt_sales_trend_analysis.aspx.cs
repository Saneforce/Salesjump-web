...
public partial class MIS_Reports_rpt_sales_trend_analysis : System.Web.UI.Page
{
       ...
       string t = "1";
        ...
        if (dsSalesForce.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (DataRow drFF in dsSalesForce.Tables[0].Rows)
            {
                ...
                dsDoc = sf.Sales_Trend_analysis_stockist(drFF["Stockist_Code"].ToString(), divcode, st);
                ...
                dsDoc = sf.Sales_Trend_analysis_currentmonth(drFF["Stockist_Code"].ToString(), divcode, FYear, FMonth);
