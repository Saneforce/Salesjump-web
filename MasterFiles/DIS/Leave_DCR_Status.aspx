<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Leave_DCR_Status.aspx.cs" Inherits="MIS_Reports_Leave_DCR_Status" %>
    ...
    <link type="text/css" rel="stylesheet" href="../css/style.css" />
     <script type="text/javascript">
         ...
         function showModalPopUp(sfcode, fmon, fyr, tmon, tyear, sf_name, Detailed) {
             ...
             popUpObj = window.open("rptLeave_DCR_Status.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyear + "&sf_name=" + sf_name + "&Detailed=" + Detailed,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
