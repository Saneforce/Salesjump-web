<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lost_Purchase.aspx.cs" Inherits="MIS_Reports_Lost_Purchase" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, prod) {
            ...
            popUpObj = window.open("rpt_lost_purchase_prac.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&Prod=" + prod,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
