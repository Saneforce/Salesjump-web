<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Territory_Format.aspx.cs" Inherits="MIS_Reports_Territory_Format" %>
...
<head runat="server">
    <title>ListedCustomer - Product Visit</title>
<link type="text/css" rel="Stylesheet" href="../css/rptMissCall.css" />
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(sfcode, fmon, fyr, tmon, tyr, prod) {
            ...
            popUpObj = window.open("rptTerritory_Format.aspx?sfcode=" + sfcode + "&FMonth=" + fmon + "&FYear=" + fyr + "&TMonth=" + tmon + "&TYear=" + tyr + "&Prod=" + prod,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnGo').click(function () {
                ...
                var SNa = $('#<%=ddlMR.ClientID%> :selected').text();
                if (SNa == "---Select---") { alert("Select Base Level."); $('#ddlMR').focus(); return false; }
          ...
          <%--<asp:UpdatePanel ID="updatepanel4" runat="server">
           ...
           <br />
             <table >
              ...
              <%--  <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="lblterr" runat="server" Text="Territory" Visible="false"  SkinID="lblMand" ></asp:Label>
                    </td>
                    <td align="left">
                        <asp:DropDownList ID="ddlterr" runat="server" SkinID="ddlRequired" Visible="false">
                        </asp:DropDownList>
                    </td>
                </tr>--%>
