<%@ Page Language="C#" AutoEventWireup="true" CodeFile="retail_trend_analysis.aspx.cs" Inherits="MIS_Reports_retail_trend_analysis" %>
  ...
  right: 0;
    ...
    <script type="text/javascript">
        ...
        function showModalPopUp(fmon, fyr) {
            ...
            popUpObj = window.open("rpt_retail_trend_analysis.aspx?FMonth=" + fmon + "&FYear=" + fyr,
    "ModalPopUp",
    "toolbar=no," +
    "scrollbars=yes," +
    "location=no," +
