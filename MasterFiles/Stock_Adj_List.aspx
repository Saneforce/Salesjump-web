<%@ Page Title="Stock Adjustment" Language="C#" MasterPageFile="~/Master.master"
    AutoEventWireup="true" CodeFile="Stock_Adj_List.aspx.cs" Inherits="MasterFiles_Stock_Adj_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#btnGo', function () {
                ...
                $.ajax({
                    ...
                    async: false,
                    url: "Stock_Adj_List.aspx/Get_GoodsRecived",
                    ...
                    success: function (data) {
                        ...
                        if (data.d.length > 0) {
                            for (var i = 0; i < data.d.length; i++) {
                                var strFF = "<td>" + (i + 1) + "</td><td>" + data.d[i].Adj_No + "</td><td>" + data.d[i].Adj_Date + "</td><td><input type='hidden' name='stk_Code' value='" + data.d[i].Stk_Code + "'/>" + data.d[i].Stk_Name + "</td><td><a class='btn btn-primary btn-md' href='Stock_Adj_Entry.aspx?Mode=1&Adj_No=" + data.d[i].Adj_No + "&Adj_Date=" + data.d[i].Adj_Date + "&Stk_Code=" + data.d[i].Stk_Code + "'><span class='glyphicon glyphicon-edit'> Edit</span></a></td><td><a class='btn btn-primary btn-md' href='Stock_Adj_View.aspx?Mode=1&Adj_No=" + data.d[i].Adj_No + "&Adj_Date=" + data.d[i].Adj_Date + "&Stk_Code=" + data.d[i].Stk_Code + "'><span class='glyphicon glyphicon-edit'> View</span></a></td>";
    ...
    <div class="row">
            <div class="col-lg-12">
                <a class='btn btn-success btn-md' href='Stock_Adj_Entry.aspx?Mode=0'>
                    New Stock Adjustment</span></a>
            </div>
        </div>
        <br />
        <br />
