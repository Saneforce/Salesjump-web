...
public partial class MasterFiles_Reports_Rpt_Distributor_Tag_BreakUp : System.Web.UI.Page
{
    ...
    private void FillSF()
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("exec getDistributor_Tag_Status '" + Sf_Code + "','" + divcode + "','" + ttype + "'", con);
