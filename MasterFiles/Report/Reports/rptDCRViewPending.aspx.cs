...
public partial class Reports_rptDCRViewPending : System.Web.UI.Page
{
    ...
    private void dynamicCreateTable()
    {
        ...
        if (strType == "1")
        {
            ...
            if (dsdoc.Tables[0].Rows.Count > 0)
            {
                ...
                lit_det_head_Territory.Text = "<b>Territory</b>";
                ...
                foreach (DataRow drdoctor in dsdoc.Tables[0].Rows)
                {
                    ...
                    tc_det_dr_name.HorizontalAlign = HorizontalAlign.Left;
                    ...
                    lit_det_Territory.Text = drdoctor["Plan_Name"].ToString();
        ...
        else if (strType == "2")
        {
            ...
            if (dsdoc.Tables[0].Rows.Count > 0)
            {
                ...
                tc_det_head_Chem.HorizontalAlign = HorizontalAlign.Left;
                ...
                foreach (DataRow drdoctor in dsdoc.Tables[0].Rows)
                {
                    ...
                    TableCell tc_det_spec = new TableCell();
                    Literal lit_det_spec = new Literal();
                    lit_det_spec.Text = drdoctor["Plan_Name"].ToString();
                    tc_det_spec.Attributes.Add("Class", "tblRow");
                    tc_det_spec.BorderStyle = BorderStyle.Solid;
                    tc_det_spec.BorderWidth = 1;
                    tc_det_spec.Controls.Add(lit_det_spec);
        ...
        else if (strType == "3")
        {
            ...
            if (dsdoc.Tables[0].Rows.Count > 0)
            {
                ...
                tc_det_head_doc.Attributes.Add("Class", "tblHead");
                tc_det_head_doc.HorizontalAlign = HorizontalAlign.Left;
                tc_det_head_doc.Controls.Add(lit_det_head_doc);
        ...
        else if (strType == "4")
        {
            ...
            tc_UnLstDocdet.Style.Add("border-collapse", "collapse");
            tc_UnLstDocdet.Style.Add("border", "solid 1px Black");
            tc_UnLstDocdet.Width = 400;
            ...
            dsdoc = dc.get_Pending_unlst_doc_details(sf_code, StrDate, 4); //4-UnlistDoc
            if (dsdoc.Tables[0].Rows.Count > 0)
            {
                TableRow tr_det_head_SNo = new TableRow();
                TableCell tc_det_head_SNo = new TableCell();
                ...
                foreach (DataRow drdoctor in dsdoc.Tables[0].Rows)
                {
                    ...
                    lit_det_Plan.Text = drdoctor["Plan_Name"].ToString();
                    tc_det_dr_Category.Attributes.Add("Class", "tblRow");
                    ...
                    TableCell tc_det_WorkWith = new TableCell();
                    Literal lit_det_WorkWith = new Literal();
                    lit_det_Plan.Text = drdoctor["Plan_Name"].ToString();
                    tc_det_dr_Category.Attributes.Add("Class", "tblRow");
                    tc_det_Plan.BorderStyle = BorderStyle.Solid;
                    tc_det_Plan.BorderWidth = 1;
