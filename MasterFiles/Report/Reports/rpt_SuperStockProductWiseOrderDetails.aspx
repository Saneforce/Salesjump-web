<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_SuperStockProductWiseOrderDetails.aspx.cs" Inherits="MasterFiles_Reports_rpt_SuperStockProductWiseOrderDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        <title>SuperStock Product Details</title>
        ...
        <script type="text/javascript">
            ...
            function pdf() {
                ...
                doc.addHTML(document.body, function () {
                    doc.save('SuperStock_Order_Details.pdf');
                });
            }
            function webprint() {
            ...
            function popUp1(SF_Code, Order_date, Sf_Name, Stockist_Name, stockist_code) {
                ...
                strOpen = "../MasterFiles/Reports/rpt_SuperStockProductWiseOrderDetails.aspx?Sf_Code=" + SF_Code + "&Activity_date=" + Order_date + "&Sf_Name=" + Sf_Name + "&Stockist_Name=" + Stockist_Name + "&Stockist_Code=" + stockist_code;
   ...
   <body>
       <form id="form1" runat="server">
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <asp:Button ID="btnExport" runat="server" Text="PDF" Font-Names="Verdana" Font-Size="10px" BorderWidth="1" Height="25px" Width="60px"
                                                   BorderColor="Black" BorderStyle="Solid" OnClientClick="pdf()" />
                                           </td>
                                           <td>
           ...
           <asp:Panel ID="pnlContents" runat="server" Width="100%">
               <div>
                   <div align="center">
                       <asp:Label ID="lblHead1" SkinID="lblMand" Font-Bold="true" Width="290px" Font-Underline="true" Visible="true" runat="server"></asp:Label>
                   </div>
                   <div>
                       <table width="100%" align="center">
                           <tr>
                               ...
                               <td align="left">
                                   <asp:Label ID="lblIDYear" Text="Stokist Name:" runat="server" Font-Bold="True" Font-Names="Andalus" SkinID="lblMand"></asp:Label>
