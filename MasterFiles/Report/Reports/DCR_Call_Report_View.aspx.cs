...
public partial class DCR_Call_Report_View : System.Web.UI.Page
{
...
protected void Page_PreInit(object sender, EventArgs e)
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            {*/
            string sURL = "Rpt_DCR_Call_Reports_View.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&cur_month=" + ddlMonth.SelectedValue + "&cur_year=" + ddlYear.SelectedItem.Text +
                   "&Mode=" + rbnList.SelectedItem.Value + "&Sf_Name=" + ddlFieldForce.SelectedItem.Text + "&Date=" + StartDate;
                string newWin = "window.open('" + sURL + "',null,'resizable=yes,toolbar=no,scrollbars=yes,menubar=no,status=no,width=800,height=600,left=0,top=0');";
                ClientScript.RegisterStartupScript(this.GetType(), "pop", newWin, true);
