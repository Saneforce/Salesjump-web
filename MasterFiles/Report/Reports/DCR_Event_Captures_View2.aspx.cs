...
public partial class DCR_Event_Captures_View : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dsSf.Tables[0].Rows.Count > 0)
            {
                ...
                string sURL = "Rpt_DCR_Event_Captures_View.aspx?sf_code=" + ddlFieldForce.SelectedValue + "&div_code=" + div_code + "&cur_month=" + ddlMonth.SelectedValue + "&cur_year=" + ddlYear.SelectedItem.Text +
