<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Secondary_Order.aspx.cs" Inherits="MasterFiles_Reports_Secondary_Order" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnview').on('click', function () {
                ...
                var url = "New_Rpt_Secondary_Order.aspx?SF_code=" + sfcode + "&div_code=" + <%=Session["div_code"]%> +
               "&subdiv=" + subdiv + "&SF_Name=" + sfname + "&FromDate=" + fdate + "&ToDate=" + tdate + "&state=" + state;
        ...
        function loadStates() {
            $.ajax({
                ...
                async: false,
                url: "Secondary_Order.aspx/getStates",
        ...
        function loadDivision(ssdiv) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Secondary_Order.aspx/getDivision",
                data: '{"divcode":"<%=Session["div_code"]%>"}',
                dataType: "json",
                success: function (data) {
        ...
        function loadFieldForce() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Secondary_Order.aspx/getFieldForce",
                data: '{"divcode":"<%=Session["div_code"]%>"}',
                dataType: "json",
                success: function (data) {
