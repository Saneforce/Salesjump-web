<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockiestSalesReport.aspx.cs" Inherits="MasterFiles_Reports_StockiestSalesReport" %>
...
<head runat="server">
    <title>Stockiest Sale Entry Status</title>
    ...
    <div>
       <center>
        <br />
            ...
            <br />
            <asp:GridView ID="grdSecSales" runat="server" Width="40%" HorizontalAlign="Center" GridLines="None" OnRowDataBound="grdSecSales_RowDataBound" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Sale Entry" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="100">
                        <ItemTemplate>
