<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Area_Salesforcewise.aspx.cs"
    Inherits="MasterFiles_Area_Salesforcewise" %>

<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Area - FieldForcewise View</title>
            ...
            <table>
                <tr>
                    <td align="left" class="stylespc">
                        <asp:Label ID="lblSubdiv" runat="server" SkinID="lblMand" Text="Area Name"></asp:Label>
                    </td>
                    <td align="left" class="stylespc">
