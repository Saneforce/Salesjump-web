<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master.master" CodeFile="Admin_Menu_Permission.aspx.cs" Inherits="MasterFiles_Admin_Menu_Permission" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <script type="text/javascript">
      $(document).ready(function () {
          bindComdrop();
          $('#ddlcomname').val('<%=Session["div_code"]%>');
          ...
          function getmenuhoid() {
              var adname1 = $('#ddladmin :selected').val();
              ...
              $.ajax({
                  ...
                  async: false,
                  data: "{'adname':'" + adname1 + "'}",
                  url: "Admin_Menu_Permission.aspx/findhomenuids",
                  dataType: "json",
                  success: function (data) {
          ...
          function getdata() {
              ...
              $.ajax({
                  ...
                  contentType: "application/json; charset=utf-8",
                  async:false,
                  url: "Admin_Menu_Permission.aspx/Display",
                  data: "{'divcode':'<%=Session["div_code"]%>'}",
                  dataType: "json",
                  success: function (data) {
                      $('#d1').html('');
