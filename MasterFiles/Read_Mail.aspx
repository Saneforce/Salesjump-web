<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Read_Mail.aspx.cs" Inherits="MasterFiles_Read_Mail" %>
        ...
        <script type="text/javascript">
                ...
                for ($i = st; $i < bfarray.length ; $i++) {
                    ...
                    if ($i < dd) {
                        ...
                        if ((bfarray[$i].indexOf('.docx') > -1) || bfarray[$i].indexOf('.doc') > -1)
                            ...
                            //image = img.attr("src", 'http://localhost:14802/FileImage/txt.png');
                        ...
                        tb.append(tr);
                        cimg.append(tb);
                        //td1 = $("<td style='width: 150px;padding-left:40px'><a href='#' class='fileDownloadPromise'>" + bfarray[$i] + "</a></td>");
                        //td1 = $("<td style='width: 150px;padding-left:40px'><a href='FileDownload.ashx?Mail_Attachement="+bfarray[$i]+"'>" + bfarray[$i] + "</a></td>");
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    url: "Read_Mail.aspx/GetReadData",
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < Orders.length; i++) {                            
                            ...
                            //    + Orders[i].Mail_Content + "</div> <div id='showimage'></div> <br/><br/><br/><br/> <br/><br/><br/><br/> <br/><br/><br/><br/> <div class='box-footer'><div class='pull-right'><button type='button' class='btn btn-default'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "&From=" + Orders[i].Mail_SF_From + "'><i class='fa fa-reply'></i>Reply</a></button> <button type='button' class='btn btn-default'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "'><i class='fa fa-share'></i>Forward</a></button></div><button type='button' class='btn btn-default'><i class='fa fa-trash-o'></i>Delete</button><button type='button' class='btn btn-default' onclick='print()'><i class='fa fa-print'></i>Print</button></div>");
                            //filebind(Orders[i].Mail_Attachement)

                            //$("#ReadMail").append("<div class='mailbox-read-info'><h3>" + Orders[i].Mail_Subject + "</h3><h5>From:" + Orders[i].Mail_SF_From + "<span class='mailbox-read-time pull-right'>"
                            //   + Orders[i].Mail_Sent_Time + "</span></h5></div><div class='mailbox-controls with-border text-center'> <div class='btn-group'> <button type='button' class='btn btn-default btn-sm' data-toggle='tooltip' data-container='body' title='Reply'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "&From=" + Orders[i].Mail_SF_From + "'><i class='fa fa-reply'></i></a></button> <button type='button' class='btn btn-default btn-sm' data-toggle='tooltip' data-container='body' title='Forward'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "'><i class='fa fa-share'></i></a></button></div> <button type='button' class='btn btn-default btn-sm' data-toggle='tooltip' title='Print' onclick='print()'> <i class='fa fa-print'></i></button></div><div class='mailbox-read-message'>"
                            //   + Orders[i].Mail_Content + "</div> <div id='showimage'></div> <br/><br/><br/><br/> <br/><br/><br/><br/> <br/><br/><br/><br/> <div class='box-footer'><div class='pull-right'><button type='button' class='btn btn-default'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "&From=" + Orders[i].Mail_SF_From + "'><i class='fa fa-reply'></i>Reply</a></button> <button type='button' class='btn btn-default'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "'><i class='fa fa-share'></i>Forward</a></button></div><button type='button' class='btn btn-default' onclick='print()'><i class='fa fa-print'></i>Print</button></div>");
                            //filebind(Orders[i].Mail_Attachement)

                            $("#ReadMail").append("<div class='mailbox-read-info'><h3>" + Orders[i].Mail_Subject + "</h3><h5>From:" + Orders[i].Mail_SF_From + "<span class='mailbox-read-time pull-right'>"
                              + Orders[i].Mail_Sent_Time + "</span></h5></div><div class='mailbox-controls with-border text-center'> <div class='btn-group'> <button type='button' class='btn btn-default btn-sm' data-toggle='tooltip' data-container='body' title='Reply'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "&From=" + Orders[i].From_SF + "'><i class='fa fa-reply'></i></a></button> <button type='button' class='btn btn-default btn-sm' data-toggle='tooltip' data-container='body' title='Forward'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "'><i class='fa fa-share'></i></a></button></div> <button type='button' class='btn btn-default btn-sm' data-toggle='tooltip' title='Print' onclick='print()'> <i class='fa fa-print'></i></button></div><div class='mailbox-read-message'>"
                              + Orders[i].Mail_Content + "</div> <table><tbody><tr><td style='width: 100% !important;'><div id='showimage'></div></td></tr></tbody></table> <br/><br/><br/><br/> <br/><br/><br/><br/> <br/><br/><br/><br/> <div class='box-footer'><div class='pull-right'><button type='button' class='btn btn-default'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "&From=" + Orders[i].From_SF + "'><i class='fa fa-reply'></i>Reply</a></button> <button type='button' class='btn btn-default'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "'><i class='fa fa-share'></i>Forward</a></button></div><button type='button' class='btn btn-default' onclick='print()'><i class='fa fa-print'></i>Print</button></div>");
                            filebind(Orders[i].Mail_Attachement)
                            ...
                            //  + Orders[i].Mail_Sent_Time + "</span></h5></div><div class='mailbox-controls with-border text-center'> <div class='btn-group'> <button type='button' class='btn btn-default btn-sm' data-toggle='tooltip' data-container='body' title='Reply'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "&From=" + Orders[i].sf_Name + "'><i class='fa fa-reply'></i></a></button> <button type='button' class='btn btn-default btn-sm' data-toggle='tooltip' data-container='body' title='Forward'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "'><i class='fa fa-share'></i></a></button></div> <button type='button' class='btn btn-default btn-sm' data-toggle='tooltip' title='Print' onclick='print()'> <i class='fa fa-print'></i></button></div><div class='mailbox-read-message'>"
                            //  + Orders[i].Mail_Content + "</div> <div id='showimage'></div> <br/><br/><br/><br/> <br/><br/><br/><br/> <br/><br/><br/><br/> <div class='box-footer'><div class='pull-right'><button type='button' class='btn btn-default'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "&From=" + Orders[i].sf_Name + "'><i class='fa fa-reply'></i>Reply</a></button> <button type='button' class='btn btn-default'><a href='Compose_Mail.aspx?Trans_Sl_No=" + Orders[i].Trans_Sl_No + "'><i class='fa fa-share'></i>Forward</a></button></div><button type='button' class='btn btn-default' onclick='print()'><i class='fa fa-print'></i>Print</button></div>");
                            //filebind(Orders[i].Mail_Attachement)
