<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Chem_Cat_React.aspx.cs" Inherits="MasterFiles_Chem_Cat_React" %>
<%@ Register Src="~/UserControl/MenuUserControl.ascx" TagName="Menu" TagPrefix="ucl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Chemists Category Reactivation</title>
        ...
        <tr>            
            <td colspan="2" align="center">
               <asp:GridView ID="grdChemCat" runat="server" Width="85%" HorizontalAlign="Center" 
                     ...
                     onpageindexchanging="grdChemCat_PageIndexChanging" onrowcommand="grdChemCat_RowCommand"                 
                    ...
                    AlternatingRowStyle-CssClass="alt" AllowSorting="True" >
                     ...
                     <Columns>                
                        ...
                        <asp:TemplateField HeaderStyle-ForeColor="white" HeaderText="Short Name" ItemStyle-HorizontalAlign="Left">
                            <EditItemTemplate> 
                                <asp:TextBox ID="txtChem_Cat_SName" runat="server" SkinID="TxtBxAllowSymb"  Text='<%# Bind("Chem_Cat_SName") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderStyle-ForeColor="white" HeaderText="Category Name" ItemStyle-HorizontalAlign="Left">
                            <EditItemTemplate>
                                <asp:TextBox ID="txtChemCatName"  SkinID="TxtBxAllowSymb"  runat="server" MaxLength="100" Text='<%# Bind("Chem_Cat_Name") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Reactivate" ItemStyle-HorizontalAlign="Center">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkbutDeactivate" runat="server" CommandArgument='<%# Eval("Cat_Code") %>'
                                        CommandName="Reactivate" OnClientClick="return confirm('Do you want to Reactivate the Chemists Category');">Reactivate
                                    </asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
