                ...
                <div class="col-md-6">
                    ...
                    <table>
                       ...
                       <%-- <tr>
                        ...
                        <tr>
                            <td align="right">
                                <label>FRANCHISE ERP Code</label>
                            </td>
                            <td>
                                <input class="col-xs-10" type="text" id="txtDERBCode" autocomplete="off" required />
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                    ...
                    <h3 style="font-weight: normal; font-family: 'Open Sans','arial';display:none">Price Setting</h3>
                    <button style="float: right;display:none" id="newsorder" type="button" class="btn btn-warning btn-circle btn-lg" data-toggle="modal" data-target="#exampleModal">+</button>
                </div>
                <div class="col-md-6">
                    <button style="float: right;display:none;" type="button" class="btn btn-warning btn-circle btn-lg" data-toggle="modal" data-target="#modalcontact">+</button>
              ...
              /*  loadPrice();*/
               ...
               /* loadSubName();*/
                ...
                $('#btnBack1').on('click', function () {
                    ...
                    else if ('<%=Session["sf_type"]%>' == '2') {
                        window.location.href = './PriceList_Approval.aspx';
                    }
                    else {
                ...
                if (retcode == '') { }
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#txtDERBCode').val(retlrDetails[0].FRErbCode);
            ...
            $('#btnsubmit').on('click', function () {
				...
				*/
                ...
                if (state == "---Select---") { alert("Select State."); $('#ddl_state').focus(); return false; }
                 ...
                 var classcode = $('#ddlClass option:selected').text();
                if (classcode == "---Select---") { alert("Select class."); $('#ddlClass').focus(); return false; }
                ...
                if ($('#ddlDeliveryMode option:selected').text() == "---Select---") { alert("Select Invoice Type."); $('#ddlDeliveryMode').focus(); return false; }
               ...
               /* var frezdate = $('#frezdate').val();*/
                ...
                data = { "DrCode": ListedDrCode, "DivCode": "<%=Session["div_code"]%>", "SfCode": "<%=Session["sf_code"]%>", "SfType": "<%=Session["sf_type"]%>", "DrName": DR_Name, "RetailCode": retail_code, "MobileNo": Mobile_No, "ErbCode": erbCode, "FRErbCode": FRerbCode, "ContactPerson": contact_person, "DrSpec": DR_Spec, "DrSpecName": dr_spec_name, "SalesTax": sales_Tax, "RetType": retype, "Taxgrp": Taxgrp, "Tinno": Tinno, "FssiNo": FssiNo, "DrTerr": DR_Terr, "CreditDays": credit_days, "DrClass": DR_Class, "DrClassName": dr_class_name, "DrCategory": drcategory, "DrCategoryName": dscategoryName, "Outstandng": outstandng, "Creditlmt": creditlmt, "Ad": ad, "DdlReType": DDL_Re_Type, "MilkPon": Milk_pon, "SlbVal": slbval, "Email": email, "Uom": UOM, "UomName": UOM_Name, "CusAlter": Cus_Alter, "Latitude": latitude, "Longitude": longitude, "PanNo": pan_no, "TcsApp": Tcs_App, "TdsApp": Tds_App, "DrAddress1": DR_Address1, "DrAddress2": DR_Address2, "CArr": csarr, "StateCode": State, "DrSubcategory": '', "BodyBulkData": BodyData, "outletType": outletType, "Delivery_Mode": Delivery_Type, "Dist_Code": dist_code, "SecMobile_No": SecMobile_No, "Aadhar_No": Aadhar_No };
