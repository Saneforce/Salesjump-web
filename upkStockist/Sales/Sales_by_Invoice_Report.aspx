<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_by_Invoice_Report.aspx.cs" Inherits="Stockist_Sales_Sales_by_Invoice_Report" %>
<!DOCTYPE html>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
           $.ajax({
                ...
                async: false,
                url: "Sales_by_Invoice_Report.aspx/Get_sales_data",
                data: "{}",
                dataType: "json",
        ...
        function ReloadTable() {      
            ...
            if ($i < bindArray.length) {   
                for ($i; $i < bindArray.length; $i++) {
                    ...
                    slno = $i + 1;
                    var rwStr = "";                     
                        rwStr += "<tr><td>" + slno + "</td><td>" + bindArray[$i].billdate +"</td><td><a  class='AAA' href='Sales_Invoice_Products1.aspx?order_id="+bindArray[$i].billno +"'>"+ bindArray[$i].billno + "</a></td><td>" + bindArray[$i].Stockist_Name + "</td><td>"+ bindArray[$i].ListedDr_Name + "</td><td>"+ parseFloat(bindArray[$i].gross).toFixed(2)+ "</td><td>"+ bindArray[$i].discount + "</td><td>"+ tax.toFixed(2) +"</td><td>"+ parseFloat(bindArray[$i].Total).toFixed(2) +"</td></tr>";
