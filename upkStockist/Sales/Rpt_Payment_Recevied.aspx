<%@ Page Title="" Language="C#" MasterPageFile="~/Master_DIS.master" AutoEventWireup="true" CodeFile="Rpt_Payment_Recevied.aspx.cs" Inherits="Stockist_Sales_Rpt_Payment_Recevied" %>
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Rpt_Payment_Recevied.aspx/Get_Payment_received",
