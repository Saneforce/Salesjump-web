<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sales_Invoice_Products1.aspx.cs" Inherits="Stockist_Sales_Sales_Invoice_Products1" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                async: false,
                url: "Sales_Invoice_Products1.aspx/Get_Product_Tax",
                dataType: "json",
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                async: false,
                url: "Sales_Invoice_Products1.aspx/Get_sales_products",
