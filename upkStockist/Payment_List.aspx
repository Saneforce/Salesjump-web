<%@ Page Title="" Language="C#" MasterPageFile="~/Master_DIS.master" AutoEventWireup="true" CodeFile="Payment_List.aspx.cs" Inherits="Stockist_Payment_List" %>
    ...
    <form id="frm1" runat="server">
        <div class="row">
            <div class="col-lg-12 sub-header">
                Payment<span style="float: right"><a href="../Stockist/Payment.aspx" class="btn btn-primary btn" id="newsf">Add New</a></span><span style="float: right; margin-right: 15px;">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function loadData() {
            $.ajax({
                ...
                async: false,
                url: "Payment_List.aspx/Get_Payment_detail",
