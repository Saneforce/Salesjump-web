...
<asp:Content ID="Content1"  ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
             ...
             <table class="table table-hover" id="OrderList">
                <thead class="text-warning">
                    <tr>                          
                        ...
                        <th id="Product_Detail_Code" style="text-align:left;cursor:pointer">Material Code</th>
                        <th id="Product_Detail_Name" style="text-align:left;cursor:pointer">Material Name</th>
                        ...
                        <th id="Ean_code" style="text-align:left;cursor:pointer">EAN Code</th>
                        <th id="tax" style="text-align:left;cursor:pointer">Tax</th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
    ...
    <script type="text/javascript" src="../js/plugins/datatables/dataTables.bootstrap.js"></script>
        <script language="javascript" type="text/javascript">
            ...
            var sortid = '';
            var asc = true;
            var Orders = []; pgNo = 1; PgRecords = 10; TotalPg = 0; searchKeys = "Product_Detail_Name,Sale_Erp_Code,Target_Price,product_unit,Product_Sale_Unit,HSN_Code,Retailor_Price";
            ...
            function ReloadTable() {
                ...
                for ($i = st; $i < st + PgRecords; $i++) {
                    if ($i < Orders.length) {
                        ...
                        $(tr).html("<td>" + ($i + 1) + "</td><td>" + Orders[$i].Sale_Erp_Code + "</td><td>" + Orders[$i].Product_Detail_Name + "</td><td>" + parseFloat(Orders[$i].MRP_Price).toFixed(2) + "</td><td>" + Orders[$i].product_unit + "/" + Orders[$i].Product_Sale_Unit + "</td><td>" + Orders[$i].HSN_Code + "</td><td>" + parseFloat(Orders[$i].Retailor_Price).toFixed(2) + "</td><td>" + Orders[$i].EAN_Code + "</td><td>" + "</td>");
        ...
        $(document).ready(function () {
            ...
            $('#ddlbrand').on('change', function () {
                ...
                if (productbrand != 0) {
                    $("#OrderList TBODY").html("");
                    Orders = AllOrders.filter(function (a) {
                        return a.Product_Brd_Code == productbrand;
                    });
                    ReloadTable();
                }
            });
