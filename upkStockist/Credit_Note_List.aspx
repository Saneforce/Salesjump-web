<%@ Page Title="" Language="C#" MasterPageFile="~/Master_DIS.master" AutoEventWireup="true" CodeFile="Credit_Note_List.aspx.cs" Inherits="Stockist_Credit_Note_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).on('click', '#newsorder', function () {
            window.location.href = "Credit_Note.aspx";
        });
        ...
        function popup(orderid, stk, div) {
            ...
            var url = "../Stockist/Credit_Note_View.aspx?Order_No=" + orderid + "&Stockist_Code=" + stk + "&Div_Code=" + div + ""
        ...
        function loadData() {
            $.ajax({
                ...
                async: false,
                url: "Credit_Note_List.aspx/Get_Credit_note",
