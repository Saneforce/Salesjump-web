...
public partial class MasterFiles_Goods_Received_Note : System.Web.UI.Page
{
    ...
    public static DataSet GetPOoRDERS(string Stockist_Code, string Div_Code)
    {
        ...
        DataSet ds = null;
        string strQry = "select Trans_Sl_No, Order_Date,sap_code from Trans_PriOrder_Head where Stockist_Code =  '" + Stockist_Code + "' and Order_Value> 0 and Division_Code = '" + Div_Code + "' and Order_Flag < 1 order by Trans_Sl_No  ";
        try
        {
