            ...
            if (scrTyp == 1 || scrTyp == 4)
            {
                ...
                $scope.gridOptions = {
                    ...
                    columnDefs: [{field: 'product_Nm', displayName: 'Product', enableCellEdit: false, cellTemplate: 'partials/productCellTemplate.html'},
                        ...
                        { field: 'cb_qty', displayName: "Case", enableCellEdit: true, editableCellTemplate: "partials/cellEditTemplate2.html", width: 55, "visible": $scope.condRecv },
                        { field: 'pieces', displayName: "Piece", enableCellEdit: true, editableCellTemplate: "partials/cellEditTemplate4.html", width: 90, "visible": $scope.condRecv },
