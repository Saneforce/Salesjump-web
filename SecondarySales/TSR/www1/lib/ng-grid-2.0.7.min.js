...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('footerTemplate.html',
    ...
    "            <span ng-if=\"fmcgData.value2!=0\" style=\"float:right;margin-right:100px;font-size:16px;color:green;font-weight:bold\" class=\"ngLabel\">{{i18n.ngTotalItemsLabel2}} {{fmcgData.value}}</span>\r" +
    "\n" +
      "            <span ng-if=\"fmcgData.value1!=0\" style=\"float:right;margin-right:100px;font-size:16px;color:green;font-weight:bold\" class=\"ngLabel\">{{i18n.ngTotalItemsLabel1}} {{fmcgData.netweightvaluetotal}}</span>\r" +
    "\n" +
