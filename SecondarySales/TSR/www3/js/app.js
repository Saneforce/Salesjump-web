...
//                                console.log(data)
        ...
        .controller('myTodyPlCtrl', ['$rootScope', '$scope', '$state', '$location', 'fmcgAPIservice', 'fmcgLocalStorage', '$ionicSideMenuDelegate', 'notification', '$ionicLoading', '$filter', function($rootScope, $scope, $state, $location, fmcgAPIservice, fmcgLocalStorage, $ionicSideMenuDelegate, notification, $ionicLoading, $filter) {
            $scope.$parent.navTitle = ($scope.fmcgData.DCRToday != 0) ? "Switch Route" : "My Day Plan";
                $scope.clearData();
                $scope.remarks = "";
...
//                                $scope.colors = ['#f8f8f8', '#f8756e'];
        ...
        .controller('screen1Ctrl', function($rootScope, $scope, $location, $ionicPopup, $stateParams, $state, fmcgAPIservice, fmcgLocalStorage, generateUID, notification) {
            ...
            $scope.$parent.navTitle = "Switch Route";
            if ($scope.view_MR == 1) {
       ...
       .controller('screen3sCtrl', function($rootScope,$ionicScrollDelegate, $scope, $filter, $state, $ionicModal, $ionicSideMenuDelegate, fmcgAPIservice, fmcgLocalStorage, notification) {
        ...
        .controller('screen3Ctrl', function($rootScope, $scope, $filter, $state, $ionicModal, $ionicSideMenuDelegate, fmcgAPIservice, fmcgLocalStorage, notification,$ionicLoading) {
            ...
            else
            {
                ...
                $scope.gridOptions = {
                    ...
                    showFooter: true,
                    columnDefs: [{field: 'product_Nm', displayName: 'Product', enableCellEdit: false, cellTemplate: 'partials/productCellTemplate.html'},
                        {field: 'rx_qty', displayName: QCap, enableCellEdit: true, editableCellTemplate: "partials/cellEditTemplate5.html", width: 60},
                        { field: 'remove', displayName: '', enableCellEdit: false, cellTemplate: 'partials/removeButton.html', width: 50, "visible": $scope.prodShow }]
                };
            }
            $scope.Mypl = fmcgLocalStorage.getData("mypln") || [];
        ...
        .controller('screen2Ctrl', function($rootScope, $scope, $state, $timeout, $filter, $ionicModal, fmcgAPIservice, fmcgLocalStorage, notification)
        {
            ...
            $scope.goNext = function () {
                ...
                if (($scope.fmcgData.worktype.selected.FWFlg == "F" && $scope.fmcgData.doctor == undefined) && $scope.$parent.fmcgData.customer.selected.id=="1") {
                    $scope.fmcgData.doctor = {};
