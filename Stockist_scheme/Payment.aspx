...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    $(document).ready(function () {
        ...
        //function get_adv_details(cust) {

        //    $.ajax({
        //        type: "Post",
        //        contentType: "application/json; charset=utf-8",
        //        url: "Payment.aspx/Get_customerWise_adv_note_details",
        //        data: "{'Customer_Code':'" + cust + "'}",
        //        dataType: "json",
        //        async: false,
        //        success: function (data) {
        //            adv_Details = JSON.parse(data.d);
        //            $('#adv_tbl tbody').html("");
        //            $('#adv_tbl tfoot').html("");
        //            var advt = 0;
        //            for (var a = 0; a < adv_Details.length; a++) {
        //                if (adv_Details[a].adv_bal > 0) {
        //                    var C_amout = adv_Details[a].adv_bal == "" ? adv_Details[a].adv_bal : parseFloat(adv_Details[a].adv_bal).toFixed(2);
        //                    //str = '<tr><td style="width: 11%;"></td>';
        //                    ////<label style="position: absolute; color: #a9a2a2;top: 26px;left: 9px;">'+adv_Details[a].edate+'</label>
        //                    //str += '<td class="" style="position:relative;"><label class="A_inv">' + parseFloat(adv_Details[a].Value).toFixed(2) + '</label><label style="position: absolute; color: #a9a2a2;top: 26px;left: 9px;">Date : '+adv_Details[a].edate+'</label><input type="hidden" class="A_ord_no" value="' + adv_Details[a].Num + '"></td>';
        //                    //str += '<td class="A_dt">0.00</td>';
        //                    //str += '<td ><label style="display:none;" id=""></label><input type="text" id="A_amt" style="width:70px;" readonly autocomplete="off" class="A_amt" value="' + parseFloat(adv_Details[a].adv_bal).toFixed(2) + '"</ td><td style="display:none;"><input type="hidden" id="hid_amt" value="' + parseFloat(adv_Details[a].adv_bal).toFixed(2) + '" /></td></tr>';
        //                    //$('#adv_tbl tbody').append(str);
        //                    str = '<tr><td style="width: 11%;"><input type="checkbox" name="cre_chk"  class="Credit_check" id="Credit_check" ></td>';
        //                    str += '<td class="C_inv"  class="" style="position:relative;"><label class="A_inv">' + parseFloat(adv_Details[a].Value).toFixed(2) + '</label><label style="position: absolute; color: #35bcf1;top: 26px;left: -15px;font-size:12px;"><i style="color: #35bcf1;">Date : </i> '+adv_Details[a].edate+'</label><input type="hidden" class="ord_no" value="' + adv_Details[a].Num + '"></td>';
        //                    str += '<td class="C_dt"  class="" style="position:relative;">0.00<label style="position: absolute; color: #35bcf1;top: 26px;left: 0px;font-size:12px;"><i style="color: #35bcf1;">Entry From : </i> Advance</label></td>';
        //                    str += '<td><label style="display:none;" id="b_amt"></label><input type="text" id="C_amt" style="width:70px;" readonly autocomplete="off" class="amt" value="' +  parseFloat(adv_Details[a].adv_bal).toFixed(2) + '"</ td><td style="display:none;"><input type="hidden" id="hid_amt" value="' + parseFloat(adv_Details[a].adv_bal).toFixed(2) + '" /></td></tr>';
        //                    $('#credit_tbl tbody').append(str);
        //                    advt = parseFloat(adv_Details[a].adv_bal) + advt;
        //                    $('#lbl_adv_amt').text(advt.toFixed(2));
        //                }
        //                else {
        //                    //$("#adv_tbl tfoot").html('<tr><td colspan="3">No Credit Amount is Available</td></tr>');
        //                }
        //            };
        //        },
        //        error: function (result) {
