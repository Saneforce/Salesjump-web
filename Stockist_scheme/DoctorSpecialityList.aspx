<%@ Page Title="Channel List" Language="C#" AutoEventWireup="true" MasterPageFile="~/Master_DIS.master" CodeFile="DoctorSpecialityList.aspx.cs" Inherits="MasterFiles_DoctorSpecialityList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <body>
        <script language="javascript" type="text/javascript">
            ...
            var sortid = '';
            var asc = true;
            var Orders = []; pgNo = 1; PgRecords = 10; TotalPg = 0; searchKeys = "Doc_Special_SName,Doc_Special_Name,Mas_ListedDr";
            ...
            function ReloadTable() {
                ...
                for ($i = st; $i < st + PgRecords; $i++) {
                    if ($i < Orders.length) {
                        ...
                        $(tr).html("<td>" + ($i + 1) + "</td><td>" + Orders[$i].Doc_Special_SName + "</td><td>" + Orders[$i].Doc_Special_Name + "</td><td>" + Orders[$i].Spec_Count + "</td>");
            ...
            function loadData() {
                $.ajax({
                    ...
                    //   async: false,
                    url: "DoctorSpecialityList.aspx/FillDocSpeS",
                    dataType: "json",
        ...
        <form id="form1" runat="server">
            <div>
                ...
                <h3>Customer / <span style="color: dodgerblue">Channel</span></h3>
                <%-- <table width="80%">
                    <tr>
                        <td style="width: 9.2%" />
                        <td>
                            <asp:Button ID="btnNew" runat="server" CssClass="BUTTON" Width="60px" Height="25px" Text="Add" Visible="false" OnClick="btnNew_Click" />&nbsp;               
           ...
           <asp:Button ID="btnTransfer" runat="server" CssClass="BUTTON" Width="130px" Height="25px" Text="Transfer Channel" OnClick="btnTransfer_Spec_Click" Visible="false" />&nbsp;
                                            ...
                                            <table class="table table-hover" id="OrderList">
                                                <thead class="text-warning">
                                                    <tr>
                                                        ...
                                                        <th id="Product_Detail_Code" style="text-align: left; cursor: pointer">Channel Code</th>
                                                        <th id="Product_Detail_Name" style="text-align: left; cursor: pointer">Channel Name</th>
