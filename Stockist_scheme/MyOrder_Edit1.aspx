    ...
    <script language="javascript" type="text/javascript">
        ...
        function ReloadTable() {
            ...
            for (var st = 0; st < Orders.length; st++) {
                ...
                CQ = Orders[st].qty* Orders[st].Con_Qty;
                ...
                getscheme(Orders[st].Sale_Erp_Code, CQ, Orders[st].unit, $("#OrderEntry > TBODY > tr")[idx], '', '', Orders[st].Product_Code);
        ...
        function loadscheme() {
            ...
            $.ajax({
                ...
                data: "{'date':'" + today + "','Div_Code':'" + division_Code + "','Stockist_Code':'" + Stockist_Code + "'}",
                dataType: "json",
                async: false,
                success: function (data) {
        ...
        function getscheme(pCode, cq, un, tr, ff, disss, opcode) {
            ...
            var res = scheme.filter(function (a) {/*&& a.Scheme_Unit == un*/
                return (a.Sale_Erp_Code == pCode && (Number(cq) >= Number(a.Scheme)) )
            });
