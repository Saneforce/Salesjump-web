            ...
            $(document).ready(function ($) {
                ...
                function getreload() {
                    ...
                    $("#tblCustomers >tbody >tr").each(function () {
                        ...
                        var cal = ((parseFloat(price) * (parseFloat(conf) * parseFloat(qty))) - ((parseFloat(price) * (parseFloat(conf) * parseFloat(qty))) * (dis / 100)));
                        $(this).find('[id*=total]').val(cal.toFixed(2));
                ...
                function qty_fun(row) {
                    ...
                    CQ=row.find('[id*=english]').val()*row.find('.lbl_con_fac').text();
                ...
                function schemedefinewithoutpackage(res, tr, ff, ans, index, CQ, cqvalue, pname) {
                   ...
                   // }
                    ...
                    $(tr).find('.lbl_dis_per').text(res.Discount);
