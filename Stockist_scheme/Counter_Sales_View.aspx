<%@ Page Title="" Language="C#" MasterPageFile="~/Master_DIS.master" AutoEventWireup="true" CodeFile="Counter_Sales_View.aspx.cs" Inherits="Stockist_Counter_Sales_View" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
        <div class="col-lg-12 sub-header">Counter Sales<span style="float:right"><a href="../Stockist/Counter_Sales.aspx" class="btn btn-primary btn" id="newsf">Add New</a></span><span style="float: right; margin-right: 15px;"><div id="reportrange" class="form-control mt-5 mb-5" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc;">
       ...
       // optStatus="<li><a href='#' v='0'>Active</a><a href='#' v='1'>Vacant / Block</a><a href='#' v='2'>Deactivate</a></li>"
        ...
        function loadData() {
            $.ajax({
                ...
                async: false,
                url: "Counter_Sales_View.aspx/GetCounterDetails",  
