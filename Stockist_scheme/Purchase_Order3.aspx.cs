    ...
    public static string SavePurchaseOrder(string HeadData, string DetailsData,string TaxData)
    {
        ...
        using (var scope = new TransactionScope())
        {
            try
            {
                ...
                {
                    Details += "<Prod PCode=\"" + Product_details[i].PCd + "\" PName=\"" + Product_details[i].PName + "\" Qty=\"" + Product_details[i].Qty + "\"  c_Qty=\"" + Product_details[i].Qty_c + "\"  Rate=\"" + Product_details[i].Rate + "\" Free=\"" + Product_details[i].free + "\"  Dis=\"" + Product_details[i].Discount + "\"  Dis_value=\"" + Product_details[i].dis_value + "\" Off_Pro_Code=\"" + Product_details[i].Of_Pro_Code + "\" Off_Pro_Name=\"" + Product_details[i].Of_Pro_Name + "\" Off_Pro_Unit=\"" + Product_details[i].Of_Pro_Unit + "\" Productunitcode=\"" + Product_details[i].umo_unit + "\" tax=\"" + Product_details[i].Tax_value + "\" con_fac=\"" + Product_details[i].con_fac + "\"  produnit=\"" + Product_details[i].produnit + "\" eQty=\"" + Product_details[i].eQty + "\" />";
                }
                Details += "</ROOT>";
