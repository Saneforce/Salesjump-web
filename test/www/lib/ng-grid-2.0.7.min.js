...
(function (window, $) {
    ...
    var ngColumn = function (config, $scope, grid, domUtilityService, $templateCache, $utils) {
        ...
        self.subfield = colDef.subfield;
        self.showSubField = colDef.showSubField;
        ...
        self.setVars = function (fromCol) {
            ...
            self.subfield = fromCol.subfield;
            self.showSubField = fromCol.showSubField;
  ...
  function () {
            ...
            compile: function () {
                return {
                    pre: function ($scope, iElement) {
                        ...
                        var cellTemplate = $scope.col.cellTemplate.replace(COL_FIELD, 'row.entity.' + $scope.col.field).replace(SUB_FIELD, 'row.entity.' + $scope.col.subfield);
                        ...
                        if ($scope.col.enableCellEdit) {
                            ...
                            html = html.replace(EDITABLE_CELL_TEMPLATE, $scope.col.editableCellTemplate.replace(SUB_FIELD, 'row.entity.' + $scope.col.subfield));
                        } else {
                            html = cellTemplate;
                        }
    ...
    window.ngGrid.i18n['en'] = {
        ...
        ngTotalItemsLabel1: 'Net Weight Volume:',
        ngTotalItemsLabel2: 'Total Order Value:',
    ...
    "<div ng-cell-has-focus on-tap=\"CELL_EDITABLE_CONDITION && editCell()\">\r" +
    "\n" +
    ...
    "            <span ng-if=\"fmcgData.value2!=0\" style=\"float:right;margin-top: 5px;margin-right: 30px;font-size:16px;color:green;font-weight:bold\" class=\"ngLabel\">{{i18n.ngTotalItemsLabel2}} {{fmcgData.value}}</span>\r" +
    "\n" +
      "            <span ng-if=\"fmcgData.value1!=0\" style=\"float:right;margin-top: 5px;margin-right: 30px;font-size:16px;color:green;font-weight:bold\" class=\"ngLabel\">{{i18n.ngTotalItemsLabel1}} {{fmcgData.netweightvaluetotal}}</span>\r" +
    "\n" +
    "    <div class=\"ngTotalSelectContainer\" >\r" +
    "\n" +
    "        <div class=\"ngFooterTotalItems\" ng-class=\"{'ngNoMultiSelect': !multiSelect}\" >\r" +
    "\n" +
    "            <span ng-if=\"ShowItemCnt!=0\" class=\"ngLabel\">{{i18n.ngTotalItemsLabel}} {{maxRows()}}</span><span ng-show=\"filterText.length > 0\" class=\"ngLabel\">({{i18n.ngShowingItemsLabel}} {{totalFilteredItemsLength()}})</span>\r" +
    "\n" +
    "        </div>\r" +
    "\n" +
